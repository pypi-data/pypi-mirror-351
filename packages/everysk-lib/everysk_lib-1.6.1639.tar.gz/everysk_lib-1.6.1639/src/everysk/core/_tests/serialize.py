...
class SerializeDumpsTestCase(TestCase):
    ...
    def test_bytes_decode_error(self):
        self.assertEqual(dumps({'key': b'Introdu\xe7\xe3o'}), '{"key": {"__bytes__": {"encoding": "base64", "value": "SW50cm9kdefjbw=="}}}')
    ...
    def test_complex_object(self):
        ...
        self.assertEqual(
            ...
            '{"%s": "everysk.core._tests.serialize.BaseDictTest", "_errors": null, "_is_frozen": false, "_silent": false, "var1": {"%s": "everysk.core.object.BaseDict", "_errors": null, "_is_frozen": false, "_silent": false, "a": "foo", "b": "boo"}}' % (CLASS_KEY, CLASS_KEY)
        )
    ...
    def test_complex_object_with_key_function(self):
        ...
        self.assertEqual(
            ...
            '{"%s": "everysk.core._tests.serialize.BaseDictTest2", "_errors": null, "_is_frozen": false, "_silent": false, "var1": "new_value"}' % CLASS_KEY
        )

    def test_base_object(self):
        self.assertEqual(
            dumps(BaseObject(a=1, b={}, c=[3]), sort_keys=True),
            '{"%s": "everysk.core.object.BaseObject", "_errors": null, "_is_frozen": false, "_silent": false, "a": 1, "b": {}, "c": [3]}' % CLASS_KEY
        )

    def test_base_dict(self):
        self.assertEqual(
            dumps(BaseDict(a=1, b={}, c=[3]), sort_keys=True),
            '{"%s": "everysk.core.object.BaseDict", "_errors": null, "_is_frozen": false, "_silent": false, "a": 1, "b": {}, "c": [3]}' % CLASS_KEY
        )
...
class SerializeLoadsTestCase(TestCase):
    ...
    def test_bytes_decode_error(self):
        self.assertEqual(loads('{"key": {"__bytes__": {"encoding": "base64", "value": "SW50cm9kdefjbw=="}}}'), {'key': b'Introdu\xe7\xe3o'})
    ...
    def test_base_dict(self):
        self.assertDictEqual(loads('{"%s": "everysk.core.object.BaseDict", "a": 1, "b": {}, "c": [3]}' % CLASS_KEY), BaseDict(a=1, b={}, c=[3]))

    def test_internal_entity(self):
        self.assertIsInstance(loads('{"%s": "engines.sample.Datastore", "workspace": null, "tags": [], "data": null, "id": null, "description": null, "updated_on": {"__datetime__": "2024-08-28T15:18:44.386204+00:00"}, "link_uid": null, "created_on": {"__datetime__": "2024-08-28T15:18:44.386204+00:00"}, "name": null, "level": null, "date": null, "version": "v1"}' % CLASS_KEY), Datastore)
