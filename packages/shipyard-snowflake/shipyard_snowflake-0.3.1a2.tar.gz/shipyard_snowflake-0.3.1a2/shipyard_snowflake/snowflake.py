...
# TODO: Refactor the exit codes and exceptions to come from to the new standard by the other databases
    ...
    def connect(self):
        ...
        try:
            ...
            if self.rsa_key:
                ...
                connection_args["private_key"] = utils.decode_rsa(self.rsa_key)
            else:
                connection_args["password"] = self.password

            if self.application:
                connection_args["application"] = self.application

            con = snowflake.connector.connect(**connection_args)
