...
class SmartObjectLayer(aspose.psd.fileformats.psd.layers.Layer):
    ...
    def load_contents(self, options: aspose.psd.LoadOptions) -> aspose.psd.Image:
        ...
        :param options: The options.
        :returns: The loaded  smart object instance.'''
        ...
    ...
    def new_smart_object_via_copy(self) -> aspose.psd.fileformats.psd.layers.smartobjects.SmartObjectLayer:
        ...
        If you want to share the embedded image use  method.
    ...
    def duplicate_layer(self) -> aspose.psd.fileformats.psd.layers.smartobjects.SmartObjectLayer:
        ...
        If you want to copy the embedded image use  method.
    ...
    def contents(self) -> bytes:
        ...
        The embedded smart object contents is the embedded raw image file:  and its properties.
        The linked smart object contents is the raw content of the linked image file if it is available and its properties: .
        We do not support loading from the Adobe� Photoshop� �� Graphics Library when  is true.
        For regular link files, at first, we use  to look for the file relatively
        to the source image path ,
        if it is not available we look at ,
        if not then we look for the link file in the same directory where our image is: .'''
        ...
...
class SmartObjectType(enum.Enum):
    EMBEDDED = enum.auto()
    '''The embedded content'''
    AVAILABLE_LINKED = enum.auto()
    '''The linked file that is available'''
    UNAVAILABLE_LINKED = enum.auto()
    '''The linked file that is unavailable'''
    LIBRARY_LINK = enum.auto()
