...
import aspose.psd.fileformats.psd.layers.layerresources.lfx2resources
...
class SmartObjectLayer(aspose.psd.fileformats.psd.layers.Layer):
    ...
    @overload
    @staticmethod
    def can_load(file_path : strload_options : aspose.psd.LoadOptions) -> bool:
    ...
    @overload
    @staticmethod
    def can_load(stream : io.RawIOBaseload_options : aspose.psd.LoadOptions) -> bool:
    ...
    @overload
    @staticmethod
    def get_fitting_rectangle(rectangle : aspose.psd.Rectanglewidth : int, height : int) -> aspose.psd.Rectangle:
    ...
    @overload
    @staticmethod
    def get_fitting_rectangle(rectangle : aspose.psd.Rectanglepixels : List[int], width : int, height : int) -> aspose.psd.Rectangle:
        '''Gets rectangle which fits the current image.
    ...
    @overload
    @staticmethod
    def load(file_path : strload_options : aspose.psd.LoadOptions) -> aspose.psd.Image:
    ...
    @overload
    @staticmethod
    def load(stream : io.RawIOBaseload_options : aspose.psd.LoadOptions) -> aspose.psd.Image:
    ...
    @overload
    def replace_contents(self, image : aspose.psd.Image):
    ...
    @overload
    def replace_contents(self, image : aspose.psd.Image, resolution : aspose.psd.ResolutionSetting):
        '''Replaces the smart object contents embedded in the smart object layer.
    ...
    @overload
    def replace_contents(self, linked_path : str, resolution : aspose.psd.ResolutionSetting):
    ...
    @overload
    def replace_contents(self, linked_path : str, resolution : aspose.psd.ResolutionSetting, is_replace_only_this : bool):
        '''Replaces the contents with a file.
        There is no need to call UpdateModifiedContent method afterwards.
    ...
    @overload
    def replace_contents(self, linked_path : str):
        '''Replaces the contents with a file.
        There is no need to call UpdateModifiedContent method afterwards.
    ...
    @overload
    def replace_contents(self, linked_path : str, is_replace_only_this : bool):
        '''Replaces the contents with a file.
        There is no need to call UpdateModifiedContent method afterwards.
    ...
    @staticmethod
    def create(image_options : aspose.psd.ImageOptionsBasewidth : int, height : int) -> aspose.psd.Image:
    ...
    @staticmethod
    def get_proportional_width(width : intheight : int, new_height : int) -> int:
    ...
    @staticmethod
    def get_proportional_height(width : intheight : int, new_width : int) -> int:
    ...
    def export_contents(self, file_path : str):
    ...
    def convert_to_linked(self, linked_path : str):
        '''Converts this embedded smart object to a linked smart object.
        
        :param linked_path: The linked path.'''
        ...
    
    def relink_to_file(self, linked_path : str):
    ...
    def update_modified_content(self):
    ...
    def warp_settings(self, value : aspose.psd.fileformats.psd.layers.warp.WarpSettings):
        ...
    ...
    def contents_bounds(self, value : aspose.psd.Rectangle):
        ...
    ...
    def contents_source(self, value : aspose.psd.fileformats.psd.layers.layerresources.LinkDataSource):
        ...
...
class SmartObjectType:
    ...
    @classmethod
    @property
    def EMBEDDED(cls) -> SmartObjectType:
        '''The embedded content'''
        ...
    
    @classmethod
    @property
    def AVAILABLE_LINKED(cls) -> SmartObjectType:
        '''The linked file that is available'''
        ...
    
    @classmethod
    @property
    def UNAVAILABLE_LINKED(cls) -> SmartObjectType:
        '''The linked file that is unavailable'''
        ...
    
    @classmethod
    @property
    def LIBRARY_LINK(cls) -> SmartObjectType:
