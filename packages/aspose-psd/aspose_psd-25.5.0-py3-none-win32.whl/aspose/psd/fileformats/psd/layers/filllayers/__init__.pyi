...
class FillLayer(aspose.psd.fileformats.psd.layers.Layer):
    '''Fill layer. Color Fill, Gradient Fill or Pattern Fill Layer which differs by :py:attr:`aspose.psd.fileformats.psd.layers.filllayers.FillLayer.fill_settings`'''
    ...
    def create_instance(fill_type : aspose.psd.fileformats.psd.layers.fillsettings.FillType) -> aspose.psd.fileformats.psd.layers.filllayers.FillLayer:
        '''Build a new instance of the :py:class:`aspose.psd.fileformats.psd.layers.filllayers.FillLayer` class by type of fill.
        
        :param fill_type: The type of fill layer.
        :returns: Returns a new instance of the :py:class:`aspose.psd.fileformats.psd.layers.filllayers.FillLayer` class by type of fill.'''
        ...
    
    def update(self):
        '''Updates the pixel data of the fill layer based on the current :py:class:`aspose.psd.fileformats.psd.layers.fillsettings.IFillSettings`.'''
        ...
