...
from truss.templates.control.control.helpers.errors import ModelNotReady
...
@pytest.mark.anyio
async def test_health_check_retries(client, app, caplog, capfd):
    ...
    with pytest.raises(ModelNotReady, match='Model has started running, but not ready yet.') as exc_info:
