...
from truss.templates.control.control.helpers.errors import ModelNotReady, ModelLoadFailed
        ...
        with attempt:
            try:
                ...
                if await _is_model_not_ready(resp):
                    return JSONResponse("Model has started running, but not ready yet.", status_code=503)
