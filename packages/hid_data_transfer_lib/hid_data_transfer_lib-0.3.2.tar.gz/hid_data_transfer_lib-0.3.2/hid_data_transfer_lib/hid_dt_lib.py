...
class HIDDataTransfer:
    ...
    def hdfs2hpc(
        ...
        Args:
            ...
            Returns:
                str: The id of the data tranfer process group in NIFI.
            Raises:
    ...
    def hdfs2hpc_2fa(
        ...
        try:
            ...
            execution_type = {
                ...
                "ReplaceText": ExecutionType.FOREVER,
                "MergeContent": ExecutionType.FOREVER,
                "ExtractText": ExecutionType.ONCE,
    ...
    def ckan2hpc(
        ...
        Returns:
            str: The result of the process group execution.
    ...
    def ckan2local(
        ...
        try:
            ...
            process_group_id = self.__nifi_client.run_process_group(
                "ckan2local",
                execution_type,
                arguments,
                keys_arguments,
