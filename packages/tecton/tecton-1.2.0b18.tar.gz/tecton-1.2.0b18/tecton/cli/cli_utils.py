...
def display_table(headings: List[str], display_rows: List[Tuple], center_align=True):
    table = Displayable.from_table(
        headings=headings, rows=display_rows, max_width=get_terminal_width(), center_align=center_align
    )
