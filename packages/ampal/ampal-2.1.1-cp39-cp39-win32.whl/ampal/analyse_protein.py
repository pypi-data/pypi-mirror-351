...
def classify_angle_as_rotamer(angle: float) -> t.Optional[int]:
...
def measure_sidechain_torsion_angles(
    residue, verbose=True
) -> t.Tuple[t.List[t.Optional[float]], t.List[t.Optional[int]]]:
