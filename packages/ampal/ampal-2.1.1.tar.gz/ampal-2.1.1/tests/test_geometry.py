...
class DistanceTestCase(unittest.TestCase):
    """Tests for tools.geometry.distance"""
...
class UnitVectorTestCase(unittest.TestCase):
    """Tests for tools.geometry.unit_vector"""
    ...
    def test_unit_length(self, vector):
        ...
        uv = geometry.unit_vector(vector)
...
class AngleBetweenVectorsTestCase(unittest.TestCase):
    ...
    def test_angle_range(self, vectors):
        ...
        a, b = vectors
        angle = geometry.angle_between_vectors(a, b)
...
class ClosestDistanceTestCase(unittest.TestCase):
    """Tests for tools.tool_geometry.closest_distance"""

    def test_unit_interval(self):
        """Lists of random values in [0, 1] chosen.

        Minimum distance cannot be greater than 1.
        """
        n = numpy.random.rand(5, 3)
        m = numpy.random.rand(10, 3)
        min_dist = geometry.closest_distance(points1=n, points2=m)
        self.assertLessEqual(min_dist, 1.0)

    def test_zero_case(self):
        """Random arrays with at least one shared element with closest distance of 0."""
        n = numpy.random.rand(5, 3)
        m = numpy.random.rand(10, 3)
...
class CoordinateSystemTestCase(unittest.TestCase):
    """Tests for coordinate system conversion functions in tools.geometry"""
...
class QuaternionTestCase(unittest.TestCase):
    """Tests for tools.quaternion.Quaternion class"""
...
class AxisTestCase(unittest.TestCase):
    """Tests for tools.geometry.Axis class"""
