...
from .raw_client import AsyncRawTachographActivityClient, RawTachographActivityClient


class TachographActivityClient:
    def __init__(self, *, client_wrapper: SyncClientWrapper):
        self._raw_client = RawTachographActivityClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> RawTachographActivityClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        RawTachographActivityClient
        """
    ...
    def history(
        ...
        *,
        ...
        client.drivers.tachograph_activity.history(
...
class AsyncTachographActivityClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._raw_client = AsyncRawTachographActivityClient(client_wrapper=client_wrapper)

    @property
    def with_raw_response(self) -> AsyncRawTachographActivityClient:
        """
        Retrieves a raw implementation of this client that returns raw responses.

        Returns
        -------
        AsyncRawTachographActivityClient
        """
        return self._raw_client
    ...
    async def history(
        ...
        *,
        ...
        async def main() -> None:
            await client.drivers.tachograph_activity.history(
                start_time="startTime",
                end_time="endTime",
            )
