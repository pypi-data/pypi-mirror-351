...
from .types.vehicle_get_request_fuel_type import VehicleGetRequestFuelType
from .types.vehicle_get_request_month import VehicleGetRequestMonth
from .types.vehicle_get_request_quarter import VehicleGetRequestQuarter
...
class VehicleClient:
    ...
    def get(
        ...
        *,
        year: int,
        month: typing.Optional[VehicleGetRequestMonth] = None,
        quarter: typing.Optional[VehicleGetRequestQuarter] = None,
        jurisdictions: typing.Optional[str] = None,
        fuel_type: typing.Optional[VehicleGetRequestFuelType] = None,
        ...
        **Note:** The most recent 72 hours of data may still be processing and is subject to change and latency, so it is not recommended to request data for the most recent 72 hours.
        ...
        month : typing.Optional[VehicleGetRequestMonth]
        ...
        quarter : typing.Optional[VehicleGetRequestQuarter]
        ...
        fuel_type : typing.Optional[VehicleGetRequestFuelType]
        ...
        client.reports.ifta.vehicle.get(
            year=1,
        )
        """
...
class AsyncVehicleClient:
    ...
    async def get(
        ...
        **Note:** The most recent 72 hours of data may still be processing and is subject to change and latency, so it is not recommended to request data for the most recent 72 hours.
        ...
        async def main() -> None:
            await client.reports.ifta.vehicle.get(
                year=1,
            )
