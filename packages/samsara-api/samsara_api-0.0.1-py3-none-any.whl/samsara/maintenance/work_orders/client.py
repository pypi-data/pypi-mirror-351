...
class WorkOrdersClient:
    ...
    def list(
        ...
        *,
        ...
        client.maintenance.work_orders.list()
        """
        _response = self._raw_client.list(ids=ids, after=after, request_options=request_options)
    ...
    def stream(
        ...
        *,
        ...
        client.maintenance.work_orders.stream(
...
class AsyncWorkOrdersClient:
    ...
    async def list(
        ...
        *,
        ...
        async def main() -> None:
            await client.maintenance.work_orders.list()


        asyncio.run(main())
        """
        _response = await self._raw_client.list(ids=ids, after=after, request_options=request_options)
        return _response.data
    ...
    async def stream(
        ...
        *,
        ...
        async def main() -> None:
            await client.maintenance.work_orders.stream(
                start_time="startTime",
            )
