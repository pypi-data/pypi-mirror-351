...
class AssetsUpdateAssetResponseBody(UniversalBaseModel):
    ...
    regulation_mode: typing_extensions.Annotated[
        typing.Optional[AssetsUpdateAssetResponseBodyRegulationMode], FieldMetadata(alias="regulationMode")
    ] = pydantic.Field(default=None)
    """
    ...
    type: typing.Optional[AssetsUpdateAssetResponseBodyType] = pydantic.Field(default=None)
    """
