...
class AssetsCreateAssetResponseBody(UniversalBaseModel):
    ...
    regulation_mode: typing_extensions.Annotated[
        typing.Optional[AssetsCreateAssetResponseBodyRegulationMode], FieldMetadata(alias="regulationMode")
    ] = pydantic.Field(default=None)
    """
    ...
    type: typing.Optional[AssetsCreateAssetResponseBodyType] = pydantic.Field(default=None)
    """
