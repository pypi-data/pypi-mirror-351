...
class PdfExportsClient:
    ...
    def list(
        ...
        **Beta:** This endpoint is in beta and is likely to change before being broadly available. Reach out to your Samsara Representative to have Forms APIs enabled for your organization.
        ...
        client.form_submissions.pdf_exports.list(
            pdf_id="pdfId",
        )
        """
        _response = self._raw_client.list(pdf_id=pdf_id, request_options=request_options)
...
class AsyncPdfExportsClient:
    ...
    async def list(
        ...
        **Beta:** This endpoint is in beta and is likely to change before being broadly available. Reach out to your Samsara Representative to have Forms APIs enabled for your organization.
        ...
        async def main() -> None:
            await client.form_submissions.pdf_exports.list(
                pdf_id="pdfId",
            )
        ...
        asyncio.run(main())
        """
        _response = await self._raw_client.list(pdf_id=pdf_id, request_options=request_options)
        return _response.data
