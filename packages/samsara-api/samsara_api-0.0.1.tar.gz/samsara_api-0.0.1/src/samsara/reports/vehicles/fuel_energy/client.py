...
from .types.fuel_energy_get_request_energy_type import FuelEnergyGetRequestEnergyType
...
class FuelEnergyClient:
    ...
    def get(
        ...
        *,
        ...
        energy_type: typing.Optional[FuelEnergyGetRequestEnergyType] = None,
        ...
        energy_type : typing.Optional[FuelEnergyGetRequestEnergyType]
        ...
        client.reports.vehicles.fuel_energy.get(
...
class AsyncFuelEnergyClient:
    ...
    async def get(
        ...
        *,
        ...
        async def main() -> None:
            await client.reports.vehicles.fuel_energy.get(
                start_date="startDate",
                end_date="endDate",
            )
