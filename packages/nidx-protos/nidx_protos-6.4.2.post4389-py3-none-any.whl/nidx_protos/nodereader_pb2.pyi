...
class DocumentScored(google.protobuf.message.Message):
    ...
    @property
    def metadata(self) -> nidx_protos.noderesources_pb2.SentenceMetadata: ...
    @property
    def labels(self) -> google.protobuf.internal.containers.RepeatedScalarFieldContainer[builtins.str]: ...
    def __init__(
        self,
        *,
        ...
        score: builtins.float = ...,
        metadata: nidx_protos.noderesources_pb2.SentenceMetadata | None = ...,
        labels: collections.abc.Iterable[builtins.str] | None = ...,
    ) -> None: ...
...
class GetShardRequest(google.protobuf.message.Message):
    ...
    vectorset: builtins.str
    @property
    def shard_id(self) -> nidx_protos.noderesources_pb2.ShardId: ...
    def __init__(
        self,
        *,
        shard_id: nidx_protos.noderesources_pb2.ShardId | None = ...,
        vectorset: builtins.str = ...,
    ) -> None: ...
