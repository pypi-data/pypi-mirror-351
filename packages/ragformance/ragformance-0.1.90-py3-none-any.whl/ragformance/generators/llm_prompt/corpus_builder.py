...
from ragformance.generators.generators.data_generator_interface import (
    CorpusGeneratorInterface,
)
from ragformance.models.corpus import DocModel
from ragformance.generators.generators.llm_prompt.file_processors.file_processor_interface import (
    FileProcessor,
)


class CorpusBuilder(CorpusGeneratorInterface):
