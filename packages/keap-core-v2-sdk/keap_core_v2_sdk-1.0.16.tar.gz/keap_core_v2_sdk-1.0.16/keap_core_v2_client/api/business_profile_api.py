...
class BusinessProfileApi:
    ...
    @validate_call
    def get_business_profile_using_get(
        self,
        ...
        _param = self._get_business_profile_using_get_serialize(
    ...
    @validate_call
    def get_business_profile_using_get_with_http_info(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    @validate_call
    def get_business_profile_using_get_without_preload_content(
        self,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
    ...
    def _get_business_profile_using_get_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
    ...
    @validate_call
    def update_business_profile_using_patch(
        self,
        ...
        _param = self._update_business_profile_using_patch_serialize(
    ...
    @validate_call
    def update_business_profile_using_patch_with_http_info(
        self,
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
        update_business_profile_request: Annotated[Optional[UpdateBusinessProfileRequest], Field(description="businessProfile")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def update_business_profile_using_patch_without_preload_content(
        self,
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
        update_business_profile_request: Annotated[Optional[UpdateBusinessProfileRequest], Field(description="businessProfile")] = None,
        _request_timeout: Union[
    ...
    def _update_business_profile_using_patch_serialize(
        self,
        update_mask,
