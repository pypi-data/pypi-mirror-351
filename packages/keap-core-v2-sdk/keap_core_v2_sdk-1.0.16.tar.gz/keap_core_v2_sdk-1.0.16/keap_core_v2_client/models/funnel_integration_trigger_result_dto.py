...
class FunnelIntegrationTriggerResultDTO(BaseModel):
    """
    FunnelIntegrationTriggerResultDTO
    """ # noqa: E501
    automation_id: Optional[StrictInt] = None
    goal_id: Optional[StrictInt] = None
    message: Optional[StrictStr] = None
    schema_data: Optional[StrictStr] = None
    success: Optional[StrictBool] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["automation_id", "goal_id", "message", "schema_data", "success"]
