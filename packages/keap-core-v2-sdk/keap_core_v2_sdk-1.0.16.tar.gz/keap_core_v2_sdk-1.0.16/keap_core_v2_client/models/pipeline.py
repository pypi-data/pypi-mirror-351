...
class Pipeline(BaseModel):
    ...
    name: Optional[StrictStr] = Field(default=None, description="The name of the pipeline.")
    stages: Optional[List[Stage]] = Field(default=None, description="The list of stages in the pipeline.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "name", "stages"]
