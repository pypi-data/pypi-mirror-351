...
class DealNoteListResponse(BaseModel):
    ...
    notes: Optional[List[DealNote]] = Field(default=None, description="The list of Note entities.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notes": [DealNote.from_dict(_item) for _item in obj["notes"]] if obj.get("notes") is not None else None
        })
