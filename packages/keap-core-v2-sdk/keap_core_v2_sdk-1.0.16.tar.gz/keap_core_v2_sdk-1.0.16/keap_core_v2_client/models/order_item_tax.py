...
class OrderItemTax(BaseModel):
    ...
    tax_template_id: Optional[StrictInt] = Field(default=None, alias="taxTemplateId")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["amount", "id", "name", "orderItemId", "rate", "taxTemplateId"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "rate": obj.get("rate"),
            "taxTemplateId": obj.get("taxTemplateId")
        })
