...
class NoteApi:
    ...
    def delete_note_using_delete1(
        ...
        _param = self._delete_note_using_delete1_serialize(
            contact_id=contact_id,
            note_id=note_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def delete_note_using_delete1_with_http_info(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        note_id: Annotated[StrictStr, Field(description="note_id")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_note_using_delete1_without_preload_content(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        note_id: Annotated[StrictStr, Field(description="note_id")],
        _request_timeout: Union[
    ...
    def _delete_note_using_delete1_serialize(
        self,
        contact_id,
        note_id,
        _request_auth,
    ...
    def get_note_using_get1(
        ...
        _param = self._get_note_using_get1_serialize(
            contact_id=contact_id,
            note_id=note_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_note_using_get1_with_http_info(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        note_id: Annotated[StrictStr, Field(description="note_id")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_note_using_get1_without_preload_content(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        note_id: Annotated[StrictStr, Field(description="note_id")],
        _request_timeout: Union[
    ...
    def _get_note_using_get1_serialize(
        self,
        contact_id,
        note_id,
        _request_auth,
    ...
    @validate_call
    def list_note_templates_using_get(
        self,
        ...
        _param = self._list_note_templates_using_get_serialize(
            filter=filter,
            order_by=order_by,
            page_size=page_size,
    ...
    @validate_call
    def list_note_templates_using_get_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
    ...
    @validate_call
    def list_note_templates_using_get_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
    ...
    def _list_note_templates_using_get_serialize(
        self,
        filter,
        order_by,
        page_size,
    ...
    def list_notes_using_get1(
        ...
        _param = self._list_notes_using_get1_serialize(
            contact_id=contact_id,
            filter=filter,
            order_by=order_by,
            page_size=page_size,
    ...
    @validate_call
    def list_notes_using_get1_with_http_info(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
    ...
    @validate_call
    def list_notes_using_get1_without_preload_content(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
    ...
    def _list_notes_using_get1_serialize(
        self,
        contact_id,
        filter,
        order_by,
    ...
    def update_note_using_patch(
        ...
        _param = self._update_note_using_patch_serialize(
            contact_id=contact_id,
            note_id=note_id,
    ...
    @validate_call
    def update_note_using_patch_with_http_info(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        note_id: Annotated[StrictStr, Field(description="note_id")],
        update_note_request: Annotated[UpdateNoteRequest, Field(description="updateNoteRequest")],
    ...
    @validate_call
    def update_note_using_patch_without_preload_content(
        self,
        contact_id: Annotated[StrictStr, Field(description="contact_id")],
        note_id: Annotated[StrictStr, Field(description="note_id")],
        update_note_request: Annotated[UpdateNoteRequest, Field(description="updateNoteRequest")],
    ...
    def _update_note_using_patch_serialize(
        self,
        contact_id,
        note_id,
        update_note_request,
