...
class RestSubscriptionV2(BaseModel):
    """
    RestSubscriptionV2
    """ # noqa: E501
    ...
    __properties: ClassVar[List[str]] = ["active", "allow_tax", "auto_charge", "billing_amount", "billing_cycle", "billing_frequency", "contact_id", "end_date", "id", "next_bill_date", "payment_gateway_id", "payment_method_id", "product_id", "quantity", "sale_affiliate_id", "start_date", "subscription_plan_id"]
