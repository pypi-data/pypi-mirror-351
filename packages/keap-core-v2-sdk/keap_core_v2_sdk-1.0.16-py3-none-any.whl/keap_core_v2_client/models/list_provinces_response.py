...
class ListProvincesResponse(BaseModel):
    ...
    provinces: List[Provinces] = Field(description="A key-value pair of province code and province name.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "provinces": [Provinces.from_dict(_item) for _item in obj["provinces"]] if obj.get("provinces") is not None else None
        })
