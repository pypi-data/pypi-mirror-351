...
class PaymentMethod(BaseModel):
    ...
    payment_gateway_id: Optional[StrictStr] = None
    ...
    __properties: ClassVar[List[str]] = ["card_info", "contact_id", "created_time", "payment_gateway_id", "payment_method_id", "payment_method_type", "payment_processor_type"]
