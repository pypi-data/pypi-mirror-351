...
class RestApplyCommissionRequest(BaseModel):
    ...
    referral_partner_id: StrictStr = Field(description="The referral partner id")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["commission_amount", "commission_date", "description", "pay_percent", "payout_type", "referral_partner_id"]
