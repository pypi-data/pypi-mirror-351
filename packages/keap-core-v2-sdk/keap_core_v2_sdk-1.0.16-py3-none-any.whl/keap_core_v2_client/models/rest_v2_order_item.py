...
class RestV2OrderItem(BaseModel):
    ...
    RestV2OrderItem
    """ # noqa: E501
    cost: Optional[CurrencyValue] = None
    ...
    __properties: ClassVar[List[str]] = ["cost", "description", "discount", "id", "item_type", "name", "notes", "order_item_taxes", "price", "product", "quantity", "special", "subscription", "subscription_id", "subscription_plan"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cost": CurrencyValue.from_dict(obj["cost"]) if obj.get("cost") is not None else None,
