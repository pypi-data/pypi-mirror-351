...
class DisplayProperty(BaseModel):
    ...
    """ # noqa: E501
    id: Optional[StrictStr] = Field(default=None, description="Unique identifier for the display property.")
    var_property: Optional[PipelineCustomField] = Field(default=None, description="The custom field that defines this display property.", alias="property")
    source: Optional[DisplayPropertySource] = Field(default=None, description="The source of the display property.")
    ...
    __properties: ClassVar[List[str]] = ["id", "property", "source", "system_field_record", "system_field_id", "label", "description", "helper_text", "default_value", "display_options"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "id": obj.get("id"),
            "property": PipelineCustomField.from_dict(obj["property"]) if obj.get("property") is not None else None,
