...
class DisplayForm(BaseModel):
    ...
    """ # noqa: E501
    groups: Optional[List[DisplayGroup]] = Field(default=None, description="Groups of properties to display on the form.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [DisplayGroup.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
