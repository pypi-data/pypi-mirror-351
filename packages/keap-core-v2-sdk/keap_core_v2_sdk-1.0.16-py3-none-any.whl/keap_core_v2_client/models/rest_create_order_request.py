...
class RestCreateOrderRequest(BaseModel):
    ...
    order_items: List[CreateRestOrderItemRequest]
    order_time: StrictStr
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "notes": obj.get("notes"),
            "order_items": [CreateRestOrderItemRequest.from_dict(_item) for _item in obj["order_items"]] if obj.get("order_items") is not None else None,
