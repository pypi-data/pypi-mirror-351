...
class PipelineListResponse(BaseModel):
    ...
    pipelines: Optional[List[Pipeline]] = Field(default=None, description="The list of pipelines.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "pipelines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "pipelines": [Pipeline.from_dict(_item) for _item in obj["pipelines"]] if obj.get("pipelines") is not None else None
        })
