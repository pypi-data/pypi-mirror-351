...
class PipelineCustomFieldCardProperty(BaseModel):
    """
    Class representing a property of a card custom field.
    """ # noqa: E501
    property_name: Optional[StrictStr] = Field(default=None, description="The name of the property.")
    styles: Optional[List[PipelineCustomFieldDisplayStyle]] = Field(default=None, description="The display styles associated with the property.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["property_name", "styles"]
