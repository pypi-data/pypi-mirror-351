...
class PipelineCustomFieldEmptyStateContent(BaseModel):
    """
    Class representing the content for an empty state in custom fields.
    """ # noqa: E501
    title: List[StrictStr] = Field(description="The list of titles for the empty state.")
    description: List[StrictStr] = Field(description="The list of descriptions for the empty state.")
