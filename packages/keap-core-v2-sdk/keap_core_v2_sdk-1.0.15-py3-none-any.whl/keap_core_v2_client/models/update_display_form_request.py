...
class UpdateDisplayFormRequest(BaseModel):
    """
    UpdateDisplayFormRequest
    """ # noqa: E501
    groups: List[UpdateDisplayGroupRequest] = Field(description="Groups of properties to display on the form.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "groups": [UpdateDisplayGroupRequest.from_dict(_item) for _item in obj["groups"]] if obj.get("groups") is not None else None
        })
