...
class LeadSourcesApi:
    ...
    @validate_call
    def delete_lead_source_using_delete(
        self,
        ...
        _param = self._delete_lead_source_using_delete_serialize(
    ...
    @validate_call
    def delete_lead_source_using_delete_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_lead_source_using_delete_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    def _delete_lead_source_using_delete_serialize(
        self,
        lead_source_id,
        _request_auth,
        _content_type,
    ...
    def get_lead_source_using_get(
        ...
        _param = self._get_lead_source_using_get_serialize(
            lead_source_id=lead_source_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_lead_source_using_get_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_lead_source_using_get_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        _request_timeout: Union[
            None,
    ...
    def _get_lead_source_using_get_serialize(
        self,
        lead_source_id,
        _request_auth,
        _content_type,
    ...
    @validate_call
    def update_lead_source_using_patch(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        ...
        _param = self._update_lead_source_using_patch_serialize(
            lead_source_id=lead_source_id,
            create_lead_source_request=create_lead_source_request,
    ...
    @validate_call
    def update_lead_source_using_patch_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to update a lead source")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    @validate_call
    def update_lead_source_using_patch_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of a lead source")],
        create_lead_source_request: Annotated[CreateLeadSourceRequest, Field(description="The request object to update a lead source")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    def _update_lead_source_using_patch_serialize(
        self,
        lead_source_id,
        create_lead_source_request,
        update_mask,
