...
class LeadSourceRecurringExpensesApi:
    ...
    @validate_call
    def create_lead_source_recurring_expense_using_post(
        self,
        ...
        _param = self._create_lead_source_recurring_expense_using_post_serialize(
    ...
    @validate_call
    def create_lead_source_recurring_expense_using_post_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        create_lead_source_recurring_expense_request: Annotated[CreateLeadSourceRecurringExpenseRequest, Field(description="The request object to create a new lead source recurring expense")],
        _request_timeout: Union[
    ...
    @validate_call
    def create_lead_source_recurring_expense_using_post_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        create_lead_source_recurring_expense_request: Annotated[CreateLeadSourceRecurringExpenseRequest, Field(description="The request object to create a new lead source recurring expense")],
        _request_timeout: Union[
    ...
    def _create_lead_source_recurring_expense_using_post_serialize(
        self,
        lead_source_id,
    ...
    @validate_call
    def delete_lead_source_recurring_expense_using_delete(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        ...
        _param = self._delete_lead_source_recurring_expense_using_delete_serialize(
            lead_source_id=lead_source_id,
    ...
    @validate_call
    def delete_lead_source_recurring_expense_using_delete_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        _request_timeout: Union[
    ...
    @validate_call
    def delete_lead_source_recurring_expense_using_delete_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        _request_timeout: Union[
    ...
    def _delete_lead_source_recurring_expense_using_delete_serialize(
        self,
        lead_source_id,
    ...
    @validate_call
    def get_lead_source_recurring_expense_using_get(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        _request_timeout: Union[
        ...
        _param = self._get_lead_source_recurring_expense_using_get_serialize(
            lead_source_id=lead_source_id,
            lead_source_recurring_expense_id=lead_source_recurring_expense_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_lead_source_recurring_expense_using_get_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        _request_timeout: Union[
    ...
    @validate_call
    def get_lead_source_recurring_expense_using_get_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        _request_timeout: Union[
    ...
    def _get_lead_source_recurring_expense_using_get_serialize(
        self,
        lead_source_id,
        lead_source_recurring_expense_id,
        _request_auth,
    ...
    @validate_call
    def list_expenses_incurred_from_lead_source_recurring_expense_using_get(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        ...
        _param = self._list_expenses_incurred_from_lead_source_recurring_expense_using_get_serialize(
            lead_source_id=lead_source_id,
            lead_source_recurring_expense_id=lead_source_recurring_expense_id,
            filter=filter,
            order_by=order_by,
    ...
    @validate_call
    def list_expenses_incurred_from_lead_source_recurring_expense_using_get_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are:  - (String) `title` - (Long) `amount` - (String) `incurred_time` - (String) `create_time` - (String) `update_time`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples:  - `filter=amount%3D%3D2500` - `filter=incurred_time%3D%3D2024-12-22T01:00:00.000Z`")] = None,
    ...
    @validate_call
    def list_expenses_incurred_from_lead_source_recurring_expense_using_get_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are:  - (String) `title` - (Long) `amount` - (String) `incurred_time` - (String) `create_time` - (String) `update_time`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples:  - `filter=amount%3D%3D2500` - `filter=incurred_time%3D%3D2024-12-22T01:00:00.000Z`")] = None,
    ...
    def _list_expenses_incurred_from_lead_source_recurring_expense_using_get_serialize(
        self,
        lead_source_id,
        lead_source_recurring_expense_id,
        filter,
    ...
    @validate_call
    def list_lead_source_recurring_expenses_using_get(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        ...
        _param = self._list_lead_source_recurring_expenses_using_get_serialize(
            lead_source_id=lead_source_id,
            filter=filter,
            order_by=order_by,
            page_size=page_size,
    ...
    @validate_call
    def list_lead_source_recurring_expenses_using_get_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are:  - (String) `title` - (Long) `amount` - (String) `start_time` - (String) `end_time` - (String) `next_expense_time` - (String) `create_time` - (String) `update_time`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples:  - `filter=amount%3D%3D2500` - `filter=next_expense_time%3D%3D2024-12-22T01:00:00.000Z`")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields: - `title` - `amount` - `start_time` - `end_time` - `next_expense_time` - `create_time` - `update_time`  One of the following directions: - `asc` - `desc`")] = None,
    ...
    @validate_call
    def list_lead_source_recurring_expenses_using_get_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are:  - (String) `title` - (Long) `amount` - (String) `start_time` - (String) `end_time` - (String) `next_expense_time` - (String) `create_time` - (String) `update_time`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples:  - `filter=amount%3D%3D2500` - `filter=next_expense_time%3D%3D2024-12-22T01:00:00.000Z`")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields: - `title` - `amount` - `start_time` - `end_time` - `next_expense_time` - `create_time` - `update_time`  One of the following directions: - `asc` - `desc`")] = None,
    ...
    def _list_lead_source_recurring_expenses_using_get_serialize(
        self,
        lead_source_id,
        filter,
        order_by,
    ...
    @validate_call
    def update_lead_source_recurring_expense_using_patch(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        ...
        _param = self._update_lead_source_recurring_expense_using_patch_serialize(
            lead_source_id=lead_source_id,
            lead_source_recurring_expense_id=lead_source_recurring_expense_id,
    ...
    @validate_call
    def update_lead_source_recurring_expense_using_patch_with_http_info(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        lead_source_recurring_expense_update_request: Annotated[LeadSourceRecurringExpenseUpdateRequest, Field(description="The request object to update a lead source recurring expense")],
    ...
    @validate_call
    def update_lead_source_recurring_expense_using_patch_without_preload_content(
        self,
        lead_source_id: Annotated[StrictStr, Field(description="The ID of the lead source this recurring expense belongs to")],
        lead_source_recurring_expense_id: Annotated[StrictStr, Field(description="The ID of a lead source recurring expense")],
        lead_source_recurring_expense_update_request: Annotated[LeadSourceRecurringExpenseUpdateRequest, Field(description="The request object to update a lead source recurring expense")],
    ...
    def _update_lead_source_recurring_expense_using_patch_serialize(
        self,
        lead_source_id,
        lead_source_recurring_expense_id,
