...
class DateExpressionApi:
    ...
    def query_date_expressions(
        ...
        _param = self._query_date_expressions_serialize(
            time_zone=time_zone,
            query=query,
    ...
    @validate_call
    def query_date_expressions_with_http_info(
        self,
        time_zone: Optional[StrictStr] = None,
        query: Optional[StrictStr] = None,
        _request_timeout: Union[
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[DateExpressionResponse]:
        """query_date_expressions
    ...
    @validate_call
    def query_date_expressions_without_preload_content(
        self,
        time_zone: Optional[StrictStr] = None,
        query: Optional[StrictStr] = None,
        _request_timeout: Union[
    ...
    def _query_date_expressions_serialize(
        self,
        time_zone,
        query,
        _request_auth,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/v2/dateExpressions',
