...
class OrdersApi:
    ...
    @validate_call
    def delete_order_custom_field_using_delete(
        self,
        ...
        _param = self._delete_order_custom_field_using_delete_serialize(
    ...
    @validate_call
    def delete_order_custom_field_using_delete_with_http_info(
        self,
        custom_field_id: Annotated[StrictStr, Field(description="custom_field_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_order_custom_field_using_delete_without_preload_content(
        self,
        custom_field_id: Annotated[StrictStr, Field(description="custom_field_id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_order_custom_field_using_delete_serialize(
        self,
        custom_field_id,
        _request_auth,
        _content_type,
