...
class CompanyApi:
    ...
    @validate_call
    def delete_company_using_delete(
        self,
        ...
        _param = self._delete_company_using_delete_serialize(
    ...
    @validate_call
    def delete_company_using_delete_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_company_using_delete_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_company_using_delete_serialize(
        self,
        company_id,
        _request_auth,
        _content_type,
    ...
    def get_company_using_get1(
        ...
        _param = self._get_company_using_get1_serialize(
            company_id=company_id,
            fields=fields,
            _request_auth=_request_auth,
            _content_type=_content_type,
    ...
    @validate_call
    def get_company_using_get1_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        fields: Annotated[Optional[List[StrictStr]], Field(description="Comma-delimited list of Company properties to include in the response. (Available fields are: `company_name`, `address`, `custom_fields`, `email_address`, `fax_number`, `phone_number`, `website`, `notes`)")] = None,
        _request_timeout: Union[
    ...
    @validate_call
    def get_company_using_get1_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        fields: Annotated[Optional[List[StrictStr]], Field(description="Comma-delimited list of Company properties to include in the response. (Available fields are: `company_name`, `address`, `custom_fields`, `email_address`, `fax_number`, `phone_number`, `website`, `notes`)")] = None,
        _request_timeout: Union[
    ...
    def _get_company_using_get1_serialize(
        self,
        company_id,
        fields,
        _request_auth,
    ...
    @validate_call
    def list_companies_using_get1(
        self,
        fields: Annotated[Optional[List[StrictStr]], Field(description="Comma-delimited list of Company properties to include in the response. (Fields such as `notes`, `fax_number` and `custom_fields` aren't included, by default.)")] = None,
        ...
        _param = self._list_companies_using_get1_serialize(
            fields=fields,
            filter=filter,
            order_by=order_by,
            page_size=page_size,
    ...
    @validate_call
    def list_companies_using_get1_with_http_info(
        self,
        fields: Annotated[Optional[List[StrictStr]], Field(description="Comma-delimited list of Company properties to include in the response. (Fields such as `notes`, `fax_number` and `custom_fields` aren't included, by default.)")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
    ...
    @validate_call
    def list_companies_using_get1_without_preload_content(
        self,
        fields: Annotated[Optional[List[StrictStr]], Field(description="Comma-delimited list of Company properties to include in the response. (Fields such as `notes`, `fax_number` and `custom_fields` aren't included, by default.)")] = None,
        filter: Annotated[Optional[StrictStr], Field(description="Search filter to apply to results")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items by. E.g. `given_name desc`")] = None,
    ...
    def _list_companies_using_get1_serialize(
        self,
        fields,
        filter,
        order_by,
    ...
    @validate_call
    def update_company_using_patch1(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        ...
        _param = self._update_company_using_patch1_serialize(
            company_id=company_id,
    ...
    @validate_call
    def update_company_using_patch1_with_http_info(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
        update_company_request: Annotated[Optional[UpdateCompanyRequest], Field(description="company")] = None,
    ...
    @validate_call
    def update_company_using_patch1_without_preload_content(
        self,
        company_id: Annotated[StrictStr, Field(description="company_id")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
        update_company_request: Annotated[Optional[UpdateCompanyRequest], Field(description="company")] = None,
    ...
    def _update_company_using_patch1_serialize(
        self,
        company_id,
        update_mask,
