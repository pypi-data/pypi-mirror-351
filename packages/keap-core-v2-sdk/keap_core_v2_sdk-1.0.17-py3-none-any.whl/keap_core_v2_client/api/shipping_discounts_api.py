...
class ShippingDiscountsApi:
    ...
    @validate_call
    def create_discount_using_post3(
        self,
        ...
        _param = self._create_discount_using_post3_serialize(
    ...
    @validate_call
    def create_discount_using_post3_with_http_info(
        self,
        create_shipping_discount_request: Annotated[CreateShippingDiscountRequest, Field(description="request")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def create_discount_using_post3_without_preload_content(
        self,
        create_shipping_discount_request: Annotated[CreateShippingDiscountRequest, Field(description="request")],
        _request_timeout: Union[
            None,
    ...
    def _create_discount_using_post3_serialize(
        self,
    ...
    @validate_call
    def delete_discount_using_delete3(
        self,
        ...
        _param = self._delete_discount_using_delete3_serialize(
    ...
    @validate_call
    def delete_discount_using_delete3_with_http_info(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def delete_discount_using_delete3_without_preload_content(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    def _delete_discount_using_delete3_serialize(
        self,
        discount_id,
        _request_auth,
        _content_type,
    ...
    def get_discount_using_get3(
        ...
        _param = self._get_discount_using_get3_serialize(
            discount_id=discount_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def get_discount_using_get3_with_http_info(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def get_discount_using_get3_without_preload_content(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        _request_timeout: Union[
            None,
    ...
    def _get_discount_using_get3_serialize(
        self,
        discount_id,
        _request_auth,
        _content_type,
    ...
    def list_discounts_using_get1(
        ...
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields: - `discount_type` - `discount_value` - `id`  One of the following directions: - `asc` - `desc`")] = None,
        ...
        :type filter: str
        :param order_by: Attribute and direction to order items. One of the following fields: - `discount_type` - `discount_value` - `id`  One of the following directions: - `asc` - `desc`
        :type order_by: str
        ...
        _param = self._list_discounts_using_get1_serialize(
            filter=filter,
            order_by=order_by,
            page_size=page_size,
    ...
    @validate_call
    def list_discounts_using_get1_with_http_info(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are: - (DiscountType) `discount_type`: AMOUNT or PERCENT - (Double) `discount_value`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples: - `filter=discount_type%3D%3DAMOUNT` - `filter=discount_value%3D%3D4.5` - `filter=discount_type%3D%3DAMOUNT%3Bdiscount_value%3D%3D4.5` ")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields: - `discount_type` - `discount_value` - `id`  One of the following directions: - `asc` - `desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
    ...
    @validate_call
    def list_discounts_using_get1_without_preload_content(
        self,
        filter: Annotated[Optional[StrictStr], Field(description="Filter to apply, allowed fields are: - (DiscountType) `discount_type`: AMOUNT or PERCENT - (Double) `discount_value`  You will need to apply the `==` operator to check the equality of one of the filters with your searched word, in the encoded form `%3D%3D`. For the filters listed above, here are some examples: - `filter=discount_type%3D%3DAMOUNT` - `filter=discount_value%3D%3D4.5` - `filter=discount_type%3D%3DAMOUNT%3Bdiscount_value%3D%3D4.5` ")] = None,
        order_by: Annotated[Optional[StrictStr], Field(description="Attribute and direction to order items. One of the following fields: - `discount_type` - `discount_value` - `id`  One of the following directions: - `asc` - `desc`")] = None,
        page_size: Annotated[Optional[Annotated[int, Field(le=1000, strict=True, ge=1)]], Field(description="Total number of items to return per page")] = None,
    ...
    def _list_discounts_using_get1_serialize(
        self,
        filter,
        order_by,
        page_size,
    ...
    @validate_call
    def update_discount_using_patch3(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        ...
        _param = self._update_discount_using_patch3_serialize(
            discount_id=discount_id,
    ...
    @validate_call
    def update_discount_using_patch3_with_http_info(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        update_shipping_discount_request: Annotated[UpdateShippingDiscountRequest, Field(description="request")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    @validate_call
    def update_discount_using_patch3_without_preload_content(
        self,
        discount_id: Annotated[StrictStr, Field(description="discount_id")],
        update_shipping_discount_request: Annotated[UpdateShippingDiscountRequest, Field(description="request")],
        update_mask: Annotated[Optional[List[StrictStr]], Field(description="An optional list of properties to be updated. If set, only the provided properties will be updated and others will be skipped.")] = None,
    ...
    def _update_discount_using_patch3_serialize(
        self,
        discount_id,
