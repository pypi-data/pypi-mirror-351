...
class UpdateOrderItemRequest(BaseModel):
    ...
    """ # noqa: E501
    charge_inventory: Optional[StrictBool] = Field(default=None, description="Determine if the order item has an impact on inventory.")
    cost_per_unit: Optional[Union[StrictFloat, StrictInt]] = None
    ...
    __properties: ClassVar[List[str]] = ["charge_inventory", "cost_per_unit", "description", "name", "note", "price_per_unit", "quantity", "type"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "charge_inventory": obj.get("charge_inventory"),
