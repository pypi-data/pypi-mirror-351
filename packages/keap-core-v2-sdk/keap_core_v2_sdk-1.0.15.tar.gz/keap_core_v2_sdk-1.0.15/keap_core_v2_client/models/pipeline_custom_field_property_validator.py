...
class PipelineCustomFieldPropertyValidator(BaseModel):
    """
    Class representing a validator for custom field properties.
    """ # noqa: E501
    size: PipelineCustomFieldSizeValidator = Field(description="The size validator for the custom field. This field is required.")
    required: StrictBool = Field(description="Indicates whether the custom field is required.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["size", "required"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "size": PipelineCustomFieldSizeValidator.from_dict(obj["size"]) if obj.get("size") is not None else None,
