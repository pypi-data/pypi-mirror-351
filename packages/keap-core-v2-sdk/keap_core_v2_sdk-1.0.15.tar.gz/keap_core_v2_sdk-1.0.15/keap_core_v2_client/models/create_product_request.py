...
class CreateProductRequest(BaseModel):
    ...
    price: Optional[StrictInt] = Field(default=None, description="The product price. The value is in the currency’s smallest unit. e.g. $12.50 is 1250.")
    ...
    __properties: ClassVar[List[str]] = ["active", "city_taxable", "country_taxable", "description", "name", "price", "short_description", "sku", "state_taxable", "storefront_hidden", "subscription_only", "taxable", "weight"]
