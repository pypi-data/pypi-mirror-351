...
class StageDealListResponse(BaseModel):
    """
    ...
    deals: Optional[List[Deal]] = Field(default=None, description="The list of deals in a stage.")
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["next_page_token", "deals"]
