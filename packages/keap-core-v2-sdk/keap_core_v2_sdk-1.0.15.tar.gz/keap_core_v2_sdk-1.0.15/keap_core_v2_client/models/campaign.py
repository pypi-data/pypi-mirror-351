...
class Campaign(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["active_contact_count", "completed_contact_count", "created_by_global_id", "date_created", "error_message", "goals", "id", "locked", "name", "publication_date", "published_date", "published_status", "published_time_zone", "sequences", "time_zone"]
