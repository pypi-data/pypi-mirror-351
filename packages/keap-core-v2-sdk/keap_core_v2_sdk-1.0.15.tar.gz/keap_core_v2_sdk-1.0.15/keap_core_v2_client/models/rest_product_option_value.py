...
class RestProductOptionValue(BaseModel):
    """
    ...
    price_adjustment: Optional[Union[StrictFloat, StrictInt]] = None
    sku: Optional[StrictStr] = None
    additional_properties: Dict[str, Any] = {}
    __properties: ClassVar[List[str]] = ["id", "index", "is_default", "label", "price_adjustment", "sku"]
