...
from boldsign.api_response import ApiResponse, T as ApiResponseT
import boldsign.models
from boldsign import rest
from boldsign.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
...
class ApiClient:
    ...
    def response_deserialize(
        ...
        return_data = None
        try:
            if response_type == "bytearray" or response_type == "io.IOBase":
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(boldsign.models, klass)
