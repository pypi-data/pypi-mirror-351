...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-cloudtrail)](https://pypistats.org/packages/mypy-boto3-cloudtrail)
...
`mypy-boto3-cloudtrail` dependency in production. However, there is an issue in
