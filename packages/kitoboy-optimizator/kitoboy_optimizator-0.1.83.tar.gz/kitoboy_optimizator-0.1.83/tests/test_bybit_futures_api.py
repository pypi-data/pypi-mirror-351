...
from kitoboy_optimizator.exchanges import BybitFuturesAPI
...
class TestMacro(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api_client = BybitFuturesAPI()
        return super().setUp()
    ...
    def test_get_historical_klines(self):
        ...
        self.assertEqual(first_kline_close, 1870.37, f"Expected first_kline_close = 1870.37, got {first_kline_close}")
        self.assertEqual(last_kline_close, 1855.05, f"Expected last_kline_close = 1855.05, got {last_kline_close}")
        self.assertEqual(sum_close_prices, 2717763.12, f"Expected sum_close_prices = 2717763.12, got {sum_close_prices}")
