...
from kitoboy_optimizator.exchanges import BinanceFuturesAPI
...
class TestMacro(unittest.TestCase):
    ...
    def setUp(self) -> None:
        self.api_client = BinanceFuturesAPI()
        return super().setUp()
    ...
    def test_get_historical_klines(self):
        ...
        self.assertEqual(first_kline_close, 1870.65, f"Expected first_kline_close = 1870.65, got {first_kline_close}")
        self.assertEqual(last_kline_close, 1855.39, f"Expected last_kline_close = 1855.39, got {last_kline_close}")
        self.assertEqual(sum_close_prices, 2717906.95, f"Expected sum_close_prices = 2717906.95, got {sum_close_prices}")
