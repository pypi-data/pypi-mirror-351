    ...
    while True:
        ...
        if map_event in (sg.WIN_CLOSED, "Exit"):
            ...
            try:
                ...
                # Estrai NOMERUN dal nome dei file
...
def datacube_extraction(params):
    ...
    while True:
        ...
        try:
            ...
            ifs_lmin_snr = ifs_lmin_tot #ifs_lmin_snr_default*10
            ifs_lmax_snr = ifs_lmax_tot #ifs_lmax_snr_default*10
