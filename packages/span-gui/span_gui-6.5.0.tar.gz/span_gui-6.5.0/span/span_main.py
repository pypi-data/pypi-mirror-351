...
def main():
    ...
    window1 = sg.Window('SPAN - SPectral ANalysis - 6.5 --- Daniele Gasparri ---', layout,finalize=True, scaling = scale_win)
    ...
    print ('***********************************************')
    print ('********* Welcome to SPAN version 6.5 *********')
    ...
    while True:
        ...
        if event == 'Version':
            sg.popup ('This is version 6.5 with improved and semplified layout')
