...
class Protect:
    ...
    def protect(
        ...
        Args:
            ...
            protect_rules: List of protection rule dictionaries. Optional when use_flash=True.
            ...
            timeout: Optional timeout for evaluations in milliseconds
            use_flash: Whether to use the faster ProtectFlash system (binary classification)
                       instead of the default comprehensive protection system. When True,
                       protect_rules become optional as ProtectFlash performs binary
                       harmful/not harmful classification only.
        ...
        if use_flash:
            ...
            test_case = MLLMTestCase(input=inputs[0], call_type="protect")
