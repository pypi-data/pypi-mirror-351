...
try :
    ...
    logging.warning(f"ai-evals is not installed. Please install it to add evaluations to your dataset.")
...
class Dataset(APIKeyAuth):
    ...
    def add_evaluation(
        ...
        try :
            ...
            raise DatasetError("ai-evals is not installed. Please install it to add evaluations to your dataset.")
