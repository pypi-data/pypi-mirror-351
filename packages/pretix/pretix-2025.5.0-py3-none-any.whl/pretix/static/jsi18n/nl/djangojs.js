...
'use strict';
{
  ...
  const newcatalog = {
    ...
    "Current entry status": "Huidige toegangstatus",
    ...
    "Duplicate": "duplicaat",
    "Enter page number between 1 and %(max)s.": "voer een pagina nummer tussen 1 en %(max)s in.",
    "Entry": "Binnenkomst",
    ...
    "Invalid page number.": "Ongeldig pagina nummer.",
    "Ita\u00fa": "Ita\u00fa",
    "January": "Januari",
    "July": "Juli",
    "June": "Juni",
