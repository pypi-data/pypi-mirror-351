...
class Camera:
    ...
    def close(self) -> bool:
        ...
        NOTE: It is recommended to call stop() and close() inside a finally block to ensure cleanup even on exceptions (e.g., KeyboardInterrupt).
        """
...
__version__: str = 'v1.0.8-2-g381cefb'
