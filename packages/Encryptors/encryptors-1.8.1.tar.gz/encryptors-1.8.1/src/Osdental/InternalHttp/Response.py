...
class CustomResponse(Response):
    ...
    def __init__(self, content: Dict[str,str] | None, status_code: int = 200, headers: Mapping[str, str] | None = None, media_type: str | None = None, background: BackgroundTasks | None = None, batch: str | None = None ):
    ...
    async def send_to_service_bus(self) -> None:
        ...
        message_json = {
            ...
            'bactch': self.batch if self.batch else Constant.DEFAULT_EMPTY_VALUE,
