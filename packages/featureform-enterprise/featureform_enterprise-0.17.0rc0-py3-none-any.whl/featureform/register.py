...
from .secret_provider import VaultSecretProvider
    ...
    def register_delta_table(
        ...
        **Examples**
        ...
        return self.__registrar.register_primary_data(
            name=name,
            variant=variant,
            location=UnityCatalogTable(database, schema, table, table_format=TableFormat.DELTA),
            owner=owner,
            provider=self.name(),
            description=description,
            tags=tags,
    ...
    def register_kafka_topic(
        ...
        **Examples**
        ...
        return self.__registrar.register_primary_data(
            name=name,
            variant=variant,
            location=KafkaTopic(topic=topic),
            owner=owner,
            provider=self.name(),
            description=description,
            tags=tags,
    ...
    def streaming_sql_transformation(
        ...
        for i in inputs:
            if isinstance(i, Stream):
                unwrapped = i.resource
                reg_inputs.append(unwrapped)
                streaming_inputs.append(unwrapped)
            else:
                reg_inputs.append(i)
...
class SQLTransformationDecorator:
    ...
    def __post_init__(self):
        ...
        if self.streaming_inputs is None:
...
class Registrar:
    ...
    def register_kafka(
        ...
        **Examples**:
        ...
        self.__resources.append(provider)
        return OfflineProvider(self, provider)
