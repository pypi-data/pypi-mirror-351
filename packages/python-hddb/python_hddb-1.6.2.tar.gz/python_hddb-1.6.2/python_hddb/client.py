...
class HdDB:
    ...
    def get_metadata(self, org: str, db: str, tbl: str):
        try:
            ...
            return {
                "nrow": data[0]["tb_n_rows"] or data[0]["nrow"],
                "ncol": data[0]["tb_n_columns"] or data[0]["ncol"],
                "tbl_name": data[0]["id"],
                "label": data[0]["label"],
                "description": data[0]["description"],
                "created_at": data[0]["tb_created_at"],
                "updated_at": data[0]["tb_updated_at"],
                "magnitude": data[0]["tb_magnitude"],
            }
        except duckdb.Error as e:
