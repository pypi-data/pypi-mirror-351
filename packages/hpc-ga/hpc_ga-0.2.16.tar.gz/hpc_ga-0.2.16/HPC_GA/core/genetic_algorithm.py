...
class GeneticAlgorithm:
    def __init__(
        ...
        selection: Callable = Optional[callable[[Population, int, int], List[Chromosome]]],
        ...
        self._update_population = update_population if update_population else Population.update_population
    ...
    def _evolve(self) -> None:
        offspring = []
        for _ in self.max_generations:
            parents = self.selection(self.population, nb_parents=self.nb_parents)
