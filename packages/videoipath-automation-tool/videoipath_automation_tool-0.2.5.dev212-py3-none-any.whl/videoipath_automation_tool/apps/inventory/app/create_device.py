...
class InventoryCreateDeviceMixin:
    # --------------------------------
    ...
    def create_device(self, driver: DriverLiteral) -> InventoryDevice:
        ...
        Returns an empty InventoryDevice instance with custom settings schema for the given driver, which ensures IntelliSense support.
