...
# Import all neighbor functionality from the file-based neighbor module
from .neighbors_file_based import (
    ...
    get_file_neighbor_manager as _get_neighbor_manager
)
...
def get_statistics() -> Dict[str, Any]:
    ...
    Returns:
        ...
        - state_neighbors: Number of state neighbor relationships
        - county_neighbors: Number of county neighbor relationships
        - cached_points: Number of cached point lookups
        
    Examples:
        >>> stats = get_statistics()
        >>> print(f"Database contains {stats['county_neighbors']:,} county relationships")
