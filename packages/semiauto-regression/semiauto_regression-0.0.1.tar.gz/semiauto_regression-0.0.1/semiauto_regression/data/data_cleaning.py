...
from semiauto_regression.custom_transformers import DataCleaner, CleaningParameters
...
def main(dataset_name=None):
    try:
        ...
        # Compute project root (3 levels up from current file)
        current_file = Path(__file__).resolve()
        project_root = current_file.parent.parent.parent

        # Initialize the data cleaner with project root
