...
@pytest.fixture
def data(dtype):
    return PandasDecimal128Array(np.array(make_data(), dtype=object), dtype=dtype)


@pytest.fixture
def data_missing(dtype):
    return PandasDecimal128Array(np.array([np.nan, make_datum()], dtype=object), dtype=dtype)
