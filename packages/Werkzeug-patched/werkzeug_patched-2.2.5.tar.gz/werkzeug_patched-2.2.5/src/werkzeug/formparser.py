...
def parse_form_data(
    ...
    cls: t.Optional[t.Type[MultiDict[str, t.Any]]] = None,
    silent: bool = True,
    *,
    ...
    :param max_form_parts: The maximum number of multipart to be parsed. If this is
...
class MultiPartParser:
    ...
    ) -> t.Tuple[MultiDict[str, str], MultiDict[str, FileStorage]]:
