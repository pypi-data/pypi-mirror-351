...
from pyvider.telemetry.logger.custom_processors import (
    ...
    # StructlogProcessor # Not directly asserting this type, but functionality
)
...
class TestConfigServiceNameProcessor:
    def test_service_name_processor_with_name(self):
    ...
    def test_service_name_processor_without_name(self):
...
class TestConfigEmojiProcessors:
    def test_both_emojis_enabled(self):
    ...
    def test_both_emojis_disabled(self):
...
class TestConfigJsonFormatterProcessors:
    def test_json_formatter_processors(self):
...
class TestConfigKeyValueFormatterProcessors:
    def test_keyvalue_formatter_processors_tty(self):
    ...
    def test_keyvalue_formatter_processors_not_tty(self):
        mock_stream = io.StringIO()
...
class TestBuildFormatterProcessorsList:
    def test_build_json_formatter(self):
    ...
    def test_build_keyvalue_formatter(self):
    ...
    def test_build_unknown_formatter_defaults_and_warns(self, capsys):
...
class TestBuildCoreProcessorsList:
    ...
    def test_omit_timestamp_true(self):
    ...
    def test_core_processor_order_fully_featured(self):
...
# Need to import these from core.py for testing
from pyvider.telemetry.core import (
    _create_core_setup_logger,
    _handle_globally_disabled_setup,
    _CORE_SETUP_LOGGER_NAME, # For checking logger name
)
import os # For monkeypatching environment variables
...
class TestCoreSetupHelpers:
    ...
    def test_create_core_setup_logger_levels(self, monkeypatch, capsys, env_level, expected_stdlib_level):
        """
    ...
    def test_create_core_setup_logger_globally_disabled(self):
        """
    ...
    def test_handle_globally_disabled_setup_temp_logger_already_configured(self, monkeypatch, capsys):
        """
...
from pyvider.telemetry.logger.custom_processors import (
    ...
    _EMOJI_LOOKUP_CACHE, # To inspect for cache limit test
    _EMOJI_CACHE_SIZE_LIMIT,
    clear_emoji_cache, # To reset state for cache test
    _NUMERIC_TO_LEVEL_NAME_CUSTOM # For add_log_level_custom tests
)
...
class TestCustomProcessors:
    ...
    def test_add_log_level_custom_various_scenarios(self, method_name, initial_event_dict, expected_level):
        event_dict = initial_event_dict.copy()
        processed_event = add_log_level_custom(None, method_name, event_dict)
    ...
    def test_add_logger_name_emoji_prefix_event_is_none(self):
    ...
    def test_add_logger_name_emoji_prefix_cache_limit(self):
        ...
        assert f"test.logger.0" in _EMOJI_LOOKUP_CACHE
        clear_emoji_cache() # Clean up after test

    def test_add_das_emoji_prefix_event_is_none(self):
        event_dict = {
            "event": None,
    ...
    def test_add_das_emoji_prefix_no_das_keys(self):
    ...
    def test_add_das_emoji_prefix_partial_das_keys(self):
