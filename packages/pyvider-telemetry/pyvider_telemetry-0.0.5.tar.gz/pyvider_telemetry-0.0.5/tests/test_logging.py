...
def test_pyvider_logger_direct_methods(
    ...
    assert_log_output(output, "debug", "🗣️ Direct debug message.")
...
class TestConfigWarnings:
    ...
    def test_invalid_pyvider_log_level(self, monkeypatch, capsys):
    ...
    def test_invalid_pyvider_log_console_formatter(self, monkeypatch, capsys):
    ...
    def test_invalid_pyvider_log_module_levels(
        self, monkeypatch, capsys, module_levels_env, expected_warning_parts
    ):
...
def test_default_output_is_stderr(
    ...
    """
    setup_pyvider_telemetry_for_test(None) # Use default configuration
...
import structlog # For checking ReturnLogger
...
class TestPyviderLoggerUnconfiguredAndMisc:
    ...
    def test_format_message_with_args_fallback(self):
        ...
        formatted_msg_non_string = logger_instance._format_message_with_args(12345, ("arg1",)) # type: ignore
    ...
    def test_logging_when_not_configured(self, capsys):
        """
