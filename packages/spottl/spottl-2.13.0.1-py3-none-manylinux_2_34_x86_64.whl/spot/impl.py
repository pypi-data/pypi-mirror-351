...
class formula(object):
    ...
    one_plus = _swig_new_static_method(_impl.formula_one_plus)
    ...
    is_delta1 = _swig_new_instance_method(_impl.formula_is_delta1)
    is_syntactic_obligation = _swig_new_instance_method(_impl.formula_is_syntactic_obligation)
    is_sigma2 = _swig_new_instance_method(_impl.formula_is_sigma2)
    is_pi2 = _swig_new_instance_method(_impl.formula_is_pi2)
    ...
    is_delta2 = _swig_new_instance_method(_impl.formula_is_delta2)
...
class vectorvectorunsigned(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_impl.vectorvectorunsigned_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_impl.vectorvectorunsigned___nonzero__)
    __bool__ = _swig_new_instance_method(_impl.vectorvectorunsigned___bool__)
    __len__ = _swig_new_instance_method(_impl.vectorvectorunsigned___len__)
    __getslice__ = _swig_new_instance_method(_impl.vectorvectorunsigned___getslice__)
    __setslice__ = _swig_new_instance_method(_impl.vectorvectorunsigned___setslice__)
    __delslice__ = _swig_new_instance_method(_impl.vectorvectorunsigned___delslice__)
    __delitem__ = _swig_new_instance_method(_impl.vectorvectorunsigned___delitem__)
    __getitem__ = _swig_new_instance_method(_impl.vectorvectorunsigned___getitem__)
    __setitem__ = _swig_new_instance_method(_impl.vectorvectorunsigned___setitem__)
    pop = _swig_new_instance_method(_impl.vectorvectorunsigned_pop)
    append = _swig_new_instance_method(_impl.vectorvectorunsigned_append)
    empty = _swig_new_instance_method(_impl.vectorvectorunsigned_empty)
    size = _swig_new_instance_method(_impl.vectorvectorunsigned_size)
    swap = _swig_new_instance_method(_impl.vectorvectorunsigned_swap)
    begin = _swig_new_instance_method(_impl.vectorvectorunsigned_begin)
    end = _swig_new_instance_method(_impl.vectorvectorunsigned_end)
    rbegin = _swig_new_instance_method(_impl.vectorvectorunsigned_rbegin)
    rend = _swig_new_instance_method(_impl.vectorvectorunsigned_rend)
    clear = _swig_new_instance_method(_impl.vectorvectorunsigned_clear)
    get_allocator = _swig_new_instance_method(_impl.vectorvectorunsigned_get_allocator)
    pop_back = _swig_new_instance_method(_impl.vectorvectorunsigned_pop_back)
    erase = _swig_new_instance_method(_impl.vectorvectorunsigned_erase)

    def __init__(self, *args):
        _impl.vectorvectorunsigned_swiginit(self, _impl.new_vectorvectorunsigned(*args))
    push_back = _swig_new_instance_method(_impl.vectorvectorunsigned_push_back)
    front = _swig_new_instance_method(_impl.vectorvectorunsigned_front)
    back = _swig_new_instance_method(_impl.vectorvectorunsigned_back)
    assign = _swig_new_instance_method(_impl.vectorvectorunsigned_assign)
    resize = _swig_new_instance_method(_impl.vectorvectorunsigned_resize)
    insert = _swig_new_instance_method(_impl.vectorvectorunsigned_insert)
    reserve = _swig_new_instance_method(_impl.vectorvectorunsigned_reserve)
    capacity = _swig_new_instance_method(_impl.vectorvectorunsigned_capacity)
    __swig_destroy__ = _impl.delete_vectorvectorunsigned

# Register vectorvectorunsigned in _impl:
_impl.vectorvectorunsigned_swigregister(vectorvectorunsigned)
...
class vectorofvectorofformulas(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_impl.vectorofvectorofformulas_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___nonzero__)
    __bool__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___bool__)
    __len__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___len__)
    __getslice__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___getslice__)
    __setslice__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___setslice__)
    __delslice__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___delslice__)
    __delitem__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___delitem__)
    __getitem__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___getitem__)
    __setitem__ = _swig_new_instance_method(_impl.vectorofvectorofformulas___setitem__)
    pop = _swig_new_instance_method(_impl.vectorofvectorofformulas_pop)
    append = _swig_new_instance_method(_impl.vectorofvectorofformulas_append)
    empty = _swig_new_instance_method(_impl.vectorofvectorofformulas_empty)
    size = _swig_new_instance_method(_impl.vectorofvectorofformulas_size)
    swap = _swig_new_instance_method(_impl.vectorofvectorofformulas_swap)
    begin = _swig_new_instance_method(_impl.vectorofvectorofformulas_begin)
    end = _swig_new_instance_method(_impl.vectorofvectorofformulas_end)
    rbegin = _swig_new_instance_method(_impl.vectorofvectorofformulas_rbegin)
    rend = _swig_new_instance_method(_impl.vectorofvectorofformulas_rend)
    clear = _swig_new_instance_method(_impl.vectorofvectorofformulas_clear)
    get_allocator = _swig_new_instance_method(_impl.vectorofvectorofformulas_get_allocator)
    pop_back = _swig_new_instance_method(_impl.vectorofvectorofformulas_pop_back)
    erase = _swig_new_instance_method(_impl.vectorofvectorofformulas_erase)

    def __init__(self, *args):
        _impl.vectorofvectorofformulas_swiginit(self, _impl.new_vectorofvectorofformulas(*args))
    push_back = _swig_new_instance_method(_impl.vectorofvectorofformulas_push_back)
    front = _swig_new_instance_method(_impl.vectorofvectorofformulas_front)
    back = _swig_new_instance_method(_impl.vectorofvectorofformulas_back)
    assign = _swig_new_instance_method(_impl.vectorofvectorofformulas_assign)
    resize = _swig_new_instance_method(_impl.vectorofvectorofformulas_resize)
    insert = _swig_new_instance_method(_impl.vectorofvectorofformulas_insert)
    reserve = _swig_new_instance_method(_impl.vectorofvectorofformulas_reserve)
    capacity = _swig_new_instance_method(_impl.vectorofvectorofformulas_capacity)
    __swig_destroy__ = _impl.delete_vectorofvectorofformulas

# Register vectorofvectorofformulas in _impl:
_impl.vectorofvectorofformulas_swigregister(vectorofvectorofformulas)
class setunsigned(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    iterator = _swig_new_instance_method(_impl.setunsigned_iterator)
    def __iter__(self):
        return self.iterator()
    __nonzero__ = _swig_new_instance_method(_impl.setunsigned___nonzero__)
    __bool__ = _swig_new_instance_method(_impl.setunsigned___bool__)
    __len__ = _swig_new_instance_method(_impl.setunsigned___len__)
    append = _swig_new_instance_method(_impl.setunsigned_append)
    __contains__ = _swig_new_instance_method(_impl.setunsigned___contains__)
    __getitem__ = _swig_new_instance_method(_impl.setunsigned___getitem__)
    add = _swig_new_instance_method(_impl.setunsigned_add)
    discard = _swig_new_instance_method(_impl.setunsigned_discard)

    def __init__(self, *args):
        _impl.setunsigned_swiginit(self, _impl.new_setunsigned(*args))
    empty = _swig_new_instance_method(_impl.setunsigned_empty)
    size = _swig_new_instance_method(_impl.setunsigned_size)
    clear = _swig_new_instance_method(_impl.setunsigned_clear)
    swap = _swig_new_instance_method(_impl.setunsigned_swap)
    count = _swig_new_instance_method(_impl.setunsigned_count)
    begin = _swig_new_instance_method(_impl.setunsigned_begin)
    end = _swig_new_instance_method(_impl.setunsigned_end)
    rbegin = _swig_new_instance_method(_impl.setunsigned_rbegin)
    rend = _swig_new_instance_method(_impl.setunsigned_rend)
    erase = _swig_new_instance_method(_impl.setunsigned_erase)
    find = _swig_new_instance_method(_impl.setunsigned_find)
    lower_bound = _swig_new_instance_method(_impl.setunsigned_lower_bound)
    upper_bound = _swig_new_instance_method(_impl.setunsigned_upper_bound)
    equal_range = _swig_new_instance_method(_impl.setunsigned_equal_range)
    insert = _swig_new_instance_method(_impl.setunsigned_insert)
    __swig_destroy__ = _impl.delete_setunsigned

# Register setunsigned in _impl:
_impl.setunsigned_swigregister(setunsigned)
...
bdd_to_cnf_formula = _impl.bdd_to_cnf_formula
...
class acc_cond(object):
    ...
    keep_one_inf_per_branch = _swig_new_instance_method(_impl.acc_cond_keep_one_inf_per_branch)
    ...
    mafins = _swig_new_instance_method(_impl.acc_cond_mafins)
    ...
    fin_unit_one_split_improved = _swig_new_instance_method(_impl.acc_cond_fin_unit_one_split_improved)
...
class acc_code(object):
    ...
    mafins = _swig_new_instance_method(_impl.acc_code_mafins)
    ...
    fin_unit_one_split_improved = _swig_new_instance_method(_impl.acc_code_fin_unit_one_split_improved)
    ...
    keep_one_inf_per_branch = _swig_new_instance_method(_impl.acc_code_keep_one_inf_per_branch)
...
class twa(object):
    ...
    get_highlight_state = _swig_new_instance_method(_impl.twa_get_highlight_state)
    remove_highlight_states = _swig_new_instance_method(_impl.twa_remove_highlight_states)
    highlight_edge = _swig_new_instance_method(_impl.twa_highlight_edge)
    get_highlight_edge = _swig_new_instance_method(_impl.twa_get_highlight_edge)
    remove_highlight_edges = _swig_new_instance_method(_impl.twa_remove_highlight_edges)
...
collect_literals = _impl.collect_literals
collect_aps_with_polarities = _impl.collect_aps_with_polarities
collect_equivalent_literals = _impl.collect_equivalent_literals
class realizability_simplifier_base(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    polarity = _impl.realizability_simplifier_base_polarity
    global_equiv = _impl.realizability_simplifier_base_global_equiv
    global_equiv_output_only = _impl.realizability_simplifier_base_global_equiv_output_only

    def __init__(self, *args):
        _impl.realizability_simplifier_base_swiginit(self, _impl.new_realizability_simplifier_base(*args))
    __swig_destroy__ = _impl.delete_realizability_simplifier_base
    simplify = _swig_new_instance_method(_impl.realizability_simplifier_base_simplify)

# Register realizability_simplifier_base in _impl:
_impl.realizability_simplifier_base_swigregister(realizability_simplifier_base)
class realizability_simplifier(realizability_simplifier_base):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, *args):
        _impl.realizability_simplifier_swiginit(self, _impl.new_realizability_simplifier(*args))
    simplified_formula = _swig_new_instance_method(_impl.realizability_simplifier_simplified_formula)
    get_mapping = _swig_new_instance_method(_impl.realizability_simplifier_get_mapping)
    merge_mapping = _swig_new_instance_method(_impl.realizability_simplifier_merge_mapping)
    patch_mealy = _swig_new_instance_method(_impl.realizability_simplifier_patch_mealy)
    patch_game = _swig_new_instance_method(_impl.realizability_simplifier_patch_game)
    __swig_destroy__ = _impl.delete_realizability_simplifier

# Register realizability_simplifier in _impl:
_impl.realizability_simplifier_swigregister(realizability_simplifier)
...
class random_formula(object):
    ...
    def __init__(self, proba_size, ap, output_ap=None, is_output=0):
        _impl.random_formula_swiginit(self, _impl.new_random_formula(proba_size, ap, output_ap, is_output))
    __swig_destroy__ = _impl.delete_random_formula
    ap = _swig_new_instance_method(_impl.random_formula_ap)
    output_ap = _swig_new_instance_method(_impl.random_formula_output_ap)
    is_output_fun = _swig_new_instance_method(_impl.random_formula_is_output_fun)
    patterns = _swig_new_instance_method(_impl.random_formula_patterns)
    draw_literals = _swig_new_instance_method(_impl.random_formula_draw_literals)
    ...
    has_unary_ops = _swig_new_instance_method(_impl.random_formula_has_unary_ops)
...
class random_ltl(random_formula):
    ...
    def __init__(self, ap, output_ap=None, is_output=0, subformulas=None):
        _impl.random_ltl_swiginit(self, _impl.new_random_ltl(ap, output_ap, is_output, subformulas))
...
class random_boolean(random_formula):
    ...
    def __init__(self, ap, output_ap=None, is_output=0, subformulas=None):
        _impl.random_boolean_swiginit(self, _impl.new_random_boolean(ap, output_ap, is_output, subformulas))
...
relabel_overlapping_bse = _impl.relabel_overlapping_bse
...
class aig(object):
    ...
    output = _swig_new_instance_method(_impl.aig_output)
...
reduce_buchi_acceptance_set_here = _impl.reduce_buchi_acceptance_set_here
enlarge_buchi_acceptance_set_here = _impl.enlarge_buchi_acceptance_set_here
...
restrict_dead_end_edges_here = _impl.restrict_dead_end_edges_here
...
difference_word_forq = _impl.difference_word_forq
contains_forq = _impl.contains_forq
...
update_bounds_given_here = _impl.update_bounds_given_here
update_bounds_given = _impl.update_bounds_given
bounds_simplify_here = _impl.bounds_simplify_here
bounds_simplify = _impl.bounds_simplify
stutterize_given = _impl.stutterize_given
...
containment_select_version = _impl.containment_select_version
...
match_states = _impl.match_states
match_states_decorate = _impl.match_states_decorate
MCS_TIE_ANY = _impl.MCS_TIE_ANY
MCS_TIE_SCC = _impl.MCS_TIE_SCC
maximum_cardinality_search = _impl.maximum_cardinality_search
maximum_cardinality_search_reorder_here = _impl.maximum_cardinality_search_reorder_here
minimize_monitor = _impl.minimize_monitor
minimize_wdba = _impl.minimize_wdba
minimize_obligation = _impl.minimize_obligation
minimize_obligation_guaranteed_to_work = _impl.minimize_obligation_guaranteed_to_work
...
scc_info_options_PROCESS_UNREACHABLE_STATES = _impl.scc_info_options_PROCESS_UNREACHABLE_STATES
...
class edge_separator(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    add_to_basis = _swig_new_instance_method(_impl.edge_separator_add_to_basis)
    separate_implying = _swig_new_instance_method(_impl.edge_separator_separate_implying)
    separate_compat = _swig_new_instance_method(_impl.edge_separator_separate_compat)
    basis_size = _swig_new_instance_method(_impl.edge_separator_basis_size)
    basis = _swig_new_instance_method(_impl.edge_separator_basis)

    def __init__(self):
        _impl.edge_separator_swiginit(self, _impl.new_edge_separator())
    __swig_destroy__ = _impl.delete_edge_separator

# Register edge_separator in _impl:
_impl.edge_separator_swigregister(edge_separator)
separate_edges = _impl.separate_edges
sum = _impl.sum
...
class synthesis_info(object):
    ...
    splittype_AUTO = _impl.synthesis_info_splittype_AUTO
    splittype_EXPL = _impl.synthesis_info_splittype_EXPL
    splittype_SEMISYM = _impl.synthesis_info_splittype_SEMISYM
    splittype_FULLYSYM = _impl.synthesis_info_splittype_FULLYSYM
    ...
    sp = property(_impl.synthesis_info_sp_get, _impl.synthesis_info_sp_set)
...
split_independent_formulas = _impl.split_independent_formulas
try_create_direct_strategy = _impl.try_create_direct_strategy
solve_game = _impl.solve_game
class game_relabeling_map(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    env_map = property(_impl.game_relabeling_map_env_map_get, _impl.game_relabeling_map_env_map_set)
    player_map = property(_impl.game_relabeling_map_player_map_get, _impl.game_relabeling_map_player_map_set)

    def __init__(self):
        _impl.game_relabeling_map_swiginit(self, _impl.new_game_relabeling_map())
    __swig_destroy__ = _impl.delete_game_relabeling_map

# Register game_relabeling_map in _impl:
_impl.game_relabeling_map_swigregister(game_relabeling_map)
partitioned_game_relabel_here = _impl.partitioned_game_relabel_here
relabel_game_here = _impl.relabel_game_here
...
create_alias_basis = _impl.create_alias_basis
...
partitioned_relabel_here = _impl.partitioned_relabel_here
class twa_word(object):
    ...
    intersects = _swig_new_instance_method(_impl.twa_word_intersects)
...
class automaton_parser_options(object):
    ...
    drop_false_edges = property(_impl.automaton_parser_options_drop_false_edges_get, _impl.automaton_parser_options_drop_false_edges_set)
