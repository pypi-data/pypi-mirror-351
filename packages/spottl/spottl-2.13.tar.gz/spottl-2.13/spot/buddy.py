...
class SwigPyIterator(object):
    ...
    __repr__ = _swig_repr
    __swig_destroy__ = _buddy.delete_SwigPyIterator
    value = _swig_new_instance_method(_buddy.SwigPyIterator_value)
    incr = _swig_new_instance_method(_buddy.SwigPyIterator_incr)
    decr = _swig_new_instance_method(_buddy.SwigPyIterator_decr)
    distance = _swig_new_instance_method(_buddy.SwigPyIterator_distance)
    equal = _swig_new_instance_method(_buddy.SwigPyIterator_equal)
    copy = _swig_new_instance_method(_buddy.SwigPyIterator_copy)
    next = _swig_new_instance_method(_buddy.SwigPyIterator_next)
    __next__ = _swig_new_instance_method(_buddy.SwigPyIterator___next__)
    previous = _swig_new_instance_method(_buddy.SwigPyIterator_previous)
    advance = _swig_new_instance_method(_buddy.SwigPyIterator_advance)
    __eq__ = _swig_new_instance_method(_buddy.SwigPyIterator___eq__)
    __ne__ = _swig_new_instance_method(_buddy.SwigPyIterator___ne__)
    __iadd__ = _swig_new_instance_method(_buddy.SwigPyIterator___iadd__)
    __isub__ = _swig_new_instance_method(_buddy.SwigPyIterator___isub__)
    __add__ = _swig_new_instance_method(_buddy.SwigPyIterator___add__)
    __sub__ = _swig_new_instance_method(_buddy.SwigPyIterator___sub__)
    def __iter__(self):
        return self

# Register SwigPyIterator in _buddy:
_buddy.SwigPyIterator_swigregister(SwigPyIterator)
...
class minterms_of(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, fun, vars):
        _buddy.minterms_of_swiginit(self, _buddy.new_minterms_of(fun, vars))
    __swig_destroy__ = _buddy.delete_minterms_of
    begin = _swig_new_instance_method(_buddy.minterms_of_begin)
    end = _swig_new_instance_method(_buddy.minterms_of_end)
    done = _swig_new_instance_method(_buddy.minterms_of_done)
    __ref__ = _swig_new_instance_method(_buddy.minterms_of___ref__)
    __iter__ = _swig_new_instance_method(_buddy.minterms_of___iter__)

# Register minterms_of in _buddy:
_buddy.minterms_of_swigregister(minterms_of)
