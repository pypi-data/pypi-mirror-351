...
class Table:
    ...
    def insert_many(
        ...
        """
        logger.debug(f"Bulk inserting rows into table '{self.name}' with columns {columns}")
    ...
    def query(
        ...
        Only allows parameterized queries or SELECT statements with optional WHERE clauses.
        Optionally parses date columns as datetime objects.
        """
    ...
    def delete_duplicates(self, by: Optional[list[str]] = None, keep: str = "last") -> None:
        """
