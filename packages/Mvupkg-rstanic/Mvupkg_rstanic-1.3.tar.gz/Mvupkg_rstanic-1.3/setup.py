...
if __name__ == '__main__':
    setup_dict = {
        'name': 'Mvupkg_rstanic',
        'version': '1.3',
        'description': 'Maximum Variance Unfolding (MVU) dimensionality reduction algorithm ported from MATLAB to Python.',
        'platforms': ['Linux', 'Windows', 'macOS'],
        'packages': [
            'Mvupkg_rstanic', 'Mvupkg_rstanic.algorithms'
        ],
        'package_data': {'Mvupkg_rstanic': ['*.ctf']}
    }
