...
def _uniffi_check_api_checksums(lib):
    ...
    if lib.uniffi_rgblibuniffi_checksum_constructor_address_new() != 14676:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
    if lib.uniffi_rgblibuniffi_checksum_constructor_invoice_from_invoice_data() != 50849:
        raise InternalError("UniFFI API checksum mismatch: try cleaning and rebuilding your project")
...
class InvoiceData:
    ...
    def __init__(self, *, recipient_id: "str", asset_schema: "typing.Optional[AssetSchema]", asset_id: "typing.Optional[str]", amount: "typing.Optional[int]", network: "BitcoinNetwork", expiration_timestamp: "typing.Optional[int]", transport_endpoints: "typing.List[str]"):
    ...
    def __str__(self):
        return "InvoiceData(recipient_id={}, asset_schema={}, asset_id={}, amount={}, network={}, expiration_timestamp={}, transport_endpoints={})".format(self.recipient_id, self.asset_schema, self.asset_id, self.amount, self.network, self.expiration_timestamp, self.transport_endpoints)
...
class Keys:
    ...
    account_xpub_colored_fingerprint: "str"
    def __init__(self, *, mnemonic: "str", xpub: "str", account_xpub_vanilla: "str", account_xpub_colored: "str", account_xpub_colored_fingerprint: "str"):
        self.mnemonic = mnemonic
        self.xpub = xpub
        self.account_xpub_vanilla = account_xpub_vanilla
        self.account_xpub_colored = account_xpub_colored
        self.account_xpub_colored_fingerprint = account_xpub_colored_fingerprint

    def __str__(self):
        return "Keys(mnemonic={}, xpub={}, account_xpub_vanilla={}, account_xpub_colored={}, account_xpub_colored_fingerprint={})".format(self.mnemonic, self.xpub, self.account_xpub_vanilla, self.account_xpub_colored, self.account_xpub_colored_fingerprint)
    ...
    def __eq__(self, other):
        ...
        if self.account_xpub_colored != other.account_xpub_colored:
            return False
        if self.account_xpub_colored_fingerprint != other.account_xpub_colored_fingerprint:
            return False
        return True
...
class _UniffiConverterTypeKeys(_UniffiConverterRustBuffer):
    ...
    def read(buf):
        return Keys(
            ...
            account_xpub_colored_fingerprint=_UniffiConverterString.read(buf),
        )
    ...
    def check_lower(value):
        ...
        _UniffiConverterString.check_lower(value.account_xpub_colored_fingerprint)
    ...
    def write(value, buf):
        ...
        _UniffiConverterString.write(value.account_xpub_colored_fingerprint, buf)
...
class WalletData:
    ...
    def __init__(self, *, data_dir: "str", bitcoin_network: "BitcoinNetwork", database_type: "DatabaseType", max_allocations_per_utxo: "int", account_xpub_vanilla: "str", account_xpub_colored: "str", mnemonic: "typing.Optional[str]", vanilla_keychain: "typing.Optional[int]"):
    ...
    def __str__(self):
        return "WalletData(data_dir={}, bitcoin_network={}, database_type={}, max_allocations_per_utxo={}, account_xpub_vanilla={}, account_xpub_colored={}, mnemonic={}, vanilla_keychain={})".format(self.data_dir, self.bitcoin_network, self.database_type, self.max_allocations_per_utxo, self.account_xpub_vanilla, self.account_xpub_colored, self.mnemonic, self.vanilla_keychain)
