...
def generate_provider(openapi_spec: Dict[str, Any], config: Dict[str, Any]):
    ...
    try:
        import terraform_it.helpers
        from terraform_it.generate_provider import generate_provider
        from terraform_it.generate_resource import generate_resource
        from terraform_it.generate_shared_models import generate_shared_models
        from terraform_it.generate_data_source import generate_data_source
    except ImportError:
