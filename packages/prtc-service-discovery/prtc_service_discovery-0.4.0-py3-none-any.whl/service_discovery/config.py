...
class DiscoveryConfig(BaseSettings):
    ...
    enable_registration: bool = Field(
        default=True, alias="ENABLE_REGISTRATION", description="Enable/disable Consul registration"
    )
    service_name: str | None = Field(
        default=None, alias="SERVICE_NAME", description="Application name for automatic service registration"
    )
