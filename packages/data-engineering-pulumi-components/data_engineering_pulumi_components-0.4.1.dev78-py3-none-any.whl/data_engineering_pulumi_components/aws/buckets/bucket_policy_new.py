...
class BucketPolicyBuilder(ComponentResource):
    def __init__(
        ...
        glue_put_permissions: Optional[Sequence[BucketPutPermissionsArgs]] = None,
        ...
        self._glue_put_permissions = glue_put_permissions
        self._statements = []
    ...
    def add_basic_access_permissions(
        ...
        self._statements = Output.all(
            ...
            put_permissions=self._put_permissions if self._put_permissions else {},
    ...
    def _get_basic_access_policy(self, args):
        ...
        all_principals = []
        statements = []
        for item in args.get("put_permissions"):
    ...
    def add_glue_permissions(self):
        self._glue_statements = Output.all(
            ...
            **{
                str(i): item.__dict__
                for i, item in enumerate(self._glue_put_permissions)
            }
            if self._glue_put_permissions
            else {},
