...
def main():
    ...
    job_stop_parser.add_argument('--name', type=str, required=True, help='Job Name to stop.')
    ...
    job_download_parser.add_argument('--name', type=str, required=True, help='Job Name to download.')
...
''')
    job_submit_parser.add_argument('--name', type=str, required=False, help='Job Name to submit.', default=None)
    job_submit_parser.add_argument('--task-type', type=str, required=False, help='Task Type to submit.', 
    choices=['sp', 'spt', 'pysisyphus'])
    ...
    task_list_parser.add_argument('-f', '--filter', type=str, help='Filter output based on job name.')
    ...
    task_dl_parser.add_argument('--id', type=str, help='Task Id.')
    task_dl_parser.add_argument('--label', type=str, required=False, default=None, help='Task label')
