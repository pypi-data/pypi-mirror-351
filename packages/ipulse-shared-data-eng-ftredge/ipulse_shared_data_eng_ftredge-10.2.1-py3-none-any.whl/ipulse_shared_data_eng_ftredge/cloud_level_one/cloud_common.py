...
from ipulse_shared_base_ftredge import CloudProvider, DataResource, DuplicationHandling, MatchCondition
...
def write_file_to_cloud_storage_extended(cloud_storage:CloudProvider | DataResource,
                                ...
                                max_retries:int=2, max_matched_deletable_files:int=1, file_extension:DataResource =None,
...
def read_file_from_cloud_storage_extended(cloud_storage:CloudProvider | DataResource, storage_client,
                                          bucket_name:str, file_path:str,file_extension:DataResource=None,
                                          pipelinemon:Pipelinemon=None,logger=None, print_out:bool=False, raise_e:bool=False)-> Dict[str, Any]: 
