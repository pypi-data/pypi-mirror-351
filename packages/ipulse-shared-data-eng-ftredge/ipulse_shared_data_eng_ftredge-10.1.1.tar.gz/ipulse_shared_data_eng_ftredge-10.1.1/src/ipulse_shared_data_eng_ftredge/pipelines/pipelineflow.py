...
class Step:
    ...
    def progress_status(self, value: Union[ProgressStatus, str]) -> None:
            """Set progress status fomr Value or string"""
            if isinstance(value, str):
                self._progress_status = ProgressStatus[value]
            else:
...
class PipelineTask(Step, StatusTrackingMixin):
    ...
    def _generate_final_report(self) -> None:
        ...
        report_parts = [
            ...
            f"Progress Status: {self.progress_status.name}",
...
class PipelineDynamicIterator(Step):
    ...
    def remove_iteration_and_update_couts(self, iteration_ref: Union[int, str]) -> None:
        """
    ...
    def final(self, force_if_closed:bool=False, force_status:Optional[ProgressStatus]=None) -> None:
        ...
        for iter_ref in remaining_iterations:
            self.remove_iteration_and_update_couts(iter_ref)
