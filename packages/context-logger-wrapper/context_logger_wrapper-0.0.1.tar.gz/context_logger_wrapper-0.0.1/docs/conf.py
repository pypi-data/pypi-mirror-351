#!/usr/bin/env python
#
# context_logger_wrapper documentation build configuration file, created by sphinx-quickstart.
#
...
project = "context-logger-wrapper"
...
version = context_logger_wrapper.__version__
# The full version, including alpha/beta/rc tags.
release = context_logger_wrapper.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(context_logger_wrapper.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "context_logger_wrapper/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/context-logger-wrapper/blob/%s/%s" % (tag, filename)
...
html_theme_options = {
    ...
    # "github_user": "maximz",
    # "github_repo": "context-logger-wrapper",
    # "github_banner": True,
    # "github_type": "star",
    # "show_related": False,
    # "note_bg": "#FFF59C",
...
htmlhelp_basename = "context_logger_wrapperdoc"
...
latex_documents = [
    (
        master_doc,
        "context_logger_wrapper.tex",
        "context-logger-wrapper Documentation",
        author,
        "manual",
    ),
]
