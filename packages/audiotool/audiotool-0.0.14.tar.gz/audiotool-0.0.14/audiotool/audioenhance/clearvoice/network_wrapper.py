...
class network_wrapper(nn.Module):
    ...
    def load_args_se(self):
        ...
        parser.add_argument(
            "--config", help="Config file path", action=yamlargparse.ActionConfigFile
        )
        parser.add_argument(
            "--mode", type=str, default="inference", help="Modes: train or inference"
        )
        parser.add_argument(
            "--checkpoint-dir",
            dest="checkpoint_dir",
            type=str,
            default="checkpoints/FRCRN_SE_16K",
        ...
        parser.add_argument(
            ...
            dest="input_path",
            type=str,
            help="Path for noisy audio input",
        )
        parser.add_argument(
            "--output-dir",
            dest="output_dir",
            type=str,
            help="Directory for enhanced audio output",
        )
        parser.add_argument(
            "--use-cuda",
            dest="use_cuda",
            default=1,
            type=int,
            help="Enable CUDA (1=True, 0=False)",
        )
        parser.add_argument(
            "--num-gpu",
            dest="num_gpu",
        ...
        parser.add_argument(
            "--network",
            type=str,
            help="Select SE models: FRCRN_SE_16K, MossFormer2_SE_48K",
        )
        parser.add_argument(
            "--sampling-rate",
            dest="sampling_rate",
        ...
        parser.add_argument(
            "--one-time-decode-length",
            dest="one_time_decode_length",
            type=int,
            default=60,
            help="Max segment length for one-pass decoding",
        )
        parser.add_argument(
            "--decode-window",
            dest="decode_window",
        ...
        parser.add_argument(
            ...
            type=int,
            default=400,
            help="Window length for framing",
        )
        parser.add_argument(
            "--window-inc",
            dest="win_inc",
        ...
        parser.add_argument(
            ...
            type=int,
            default=512,
            help="FFT length for feature extraction",
        )
        parser.add_argument(
            "--num-mels",
            dest="num_mels",
        ...
        parser.add_argument(
            ...
            type=str,
            default="hamming",
            help="Window type: hamming or hanning",
        )
    ...
    def load_args_ss(self):
        ...
        parser.add_argument(
            ...
            dest="input_path",
            type=str,
            help="Path for mixed audio input",
        )
        parser.add_argument(
            "--output-dir",
            dest="output_dir",
            type=str,
            help="Directory for separated audio output",
        )
        parser.add_argument(
            "--use-cuda",
            dest="use_cuda",
        ...
        parser.add_argument(
            "--network", type=str, help="Select SS models: MossFormer2_SS_16K"
        )
        parser.add_argument(
            "--sampling-rate",
            dest="sampling_rate",
        ...
        parser.add_argument(
            ...
            type=int,
            default=16,
            help="Kernel size for Conv1D encoder",
        )
        parser.add_argument(
            "--encoder-embedding-dim",
            dest="encoder_embedding_dim",
            type=int,
            default=512,
        ...
        parser.add_argument(
            "--mossformer-squence-dim",
            dest="mossformer_sequence_dim",
            type=int,
            default=512,
            help="Sequence dimension for MossFormer",
        )
        parser.add_argument(
            "--num-mossformer_layer",
            dest="num_mossformer_layer",
            type=int,
            default=24,
            help="Number of MossFormer layers",
        )
    ...
    def load_args_tse(self):
        ...
        parser.add_argument(
            ...
            dest="checkpoint_dir",
            type=str,
            default="checkpoint_dir/AV_MossFormer2_TSE_16K",
            help="Checkpoint directory",
        )
        parser.add_argument(
            "--input-path",
        ...
        parser.add_argument(
            "--network",
            type=str,
            help="Select TSE models(currently supports AV_MossFormer2_TSE_16K)",
        )
        parser.add_argument(
            "--sampling-rate",
            dest="sampling_rate",
            type=int,
            default=16000,
            help="Sampling rate (currently supports 16 kHz)",
        )
        parser.add_argument(
            "--network_reference",
            type=dict,
            help="a dictionary that contains the parameters of auxilary reference signal",
        )
        parser.add_argument(
            "--network_audio",
            type=dict,
            help="a dictionary that contains the network parameters",
        )
        ...
        parser.add_argument(
            ...
            type=int,
            default=1,
            help="Chunk length for streaming",
        )
    ...
    def __call__(self, task, model_name):
        ...
        if task == "speech_enhancement":
            ...
            print(
                f"{task} is not supported, please select from: "
        ...
        if self.args.network == "FRCRN_SE_16K":
            ...
            self.network = CLS_AV_MossFormer2_TSE_16K(
                self.args
            )  # Load AV MossFormer2 model for target speaker extraction
        else:
