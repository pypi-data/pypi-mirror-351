...
class NewFunctionAuthSecret(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["auth_provider_name", "revision", "function_auth_type", "sha", "salt", "expiration"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of NewFunctionAuthSecret from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "auth_provider_name": obj.get("auth_provider_name"),
