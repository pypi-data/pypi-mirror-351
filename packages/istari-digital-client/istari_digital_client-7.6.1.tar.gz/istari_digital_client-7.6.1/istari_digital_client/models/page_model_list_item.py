...
class PageModelListItem(BaseModel):
    """
    PageModelListItem
    """ # noqa: E501
    ...
    def client(self) -> Optional["ClientApi"]:
        return self.items[0].revision.client

    @client.setter
    def client(self, value: "ClientApi"):
        for item in self.items:
            item.revision.client = value
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of PageModelListItem from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of PageModelListItem from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "items": [ModelListItem.from_dict(_item) for _item in obj["items"]] if obj.get("items") is not None else None,
            "total": obj.get("total"),
            "page": obj.get("page"),
            "size": obj.get("size"),
            "pages": obj.get("pages")
