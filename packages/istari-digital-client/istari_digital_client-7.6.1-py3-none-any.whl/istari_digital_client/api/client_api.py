...
class ClientApi:
    ...
    def poll_job(self, job_id: str) -> JobStatusName:
    ...
    def _create_model_job(
        ...
        agent_identifier: Annotated[Optional[StrictStr], Field(description="An agent identifier for the agent.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param agent_identifier: An agent identifier for the agent.
    ...
    def create_function_auth_provider(
        self,
        auth_provider_name: Annotated[StrictStr, Field(description="The unique name of the FunctionAuthProvider to create")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        """This method creates a new FunctionAuthProvider by auth provider name if name does not exist.

        This method creates a new FunctionAuthProvider by auth provider name if name does not exist.

        :param auth_provider_name: The unique name of the FunctionAuthProvider to create (required)
    ...
    def create_module(
        ...
        This method creates a new module.
    ...
    def create_tenant_public_key(
        ...
        Creates a new tenant public key.
    ...
    def find_function_auth_secret(
        self,
        auth_provider_name: Annotated[Optional[StrictStr], Field(description="The name of the auth provider to filter by.")] = None,
        auth_type: Annotated[Optional[FunctionAuthType], Field(description="The type of the auth secret to filter by.")] = None,
        expiration: Annotated[Optional[datetime], Field(description="The expiration date to filter by.")] = None,
        latest: Annotated[Optional[StrictBool], Field(description="If true, only the latest function auth secret will be returned.")] = None,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param auth_provider_name: The name of the auth provider to filter by.
        :type auth_provider_name: str
        :param auth_type: The type of the auth secret to filter by.
        :type auth_type: FunctionAuthType
        :param expiration: The expiration date to filter by.
        :type expiration: datetime
        :param latest: If true, only the latest function auth secret will be returned.
        :type latest: bool
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def get_control_tag_revision_history(
        ...
        Gets the full list of every revision of a given control tag, starting at the original revision when it was created and one for each update made thereafter.
    ...
    def get_object_control_tags(
        ...
        Gets the list of control tags for all active control taggings applied to an opject
    ...
    def list_control_tags(
        ...
        This method lists all control tags defined on the system that the calling user has access to.
    ...
    def list_function_access(
        self,
        function_id: Annotated[StrictStr, Field(description="ID of the function to get access relationships for")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param function_id: ID of the function to get access relationships for (required)
        :type function_id: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
    ...
    def list_function_auth_provider(
        ...
        """This method lists all FunctionAuthProviders a user has access to.
    ...
    def list_resources(
        ...
        created_timestamp: Annotated[Optional[List[datetime]], Field(description="A list of file creation timestamps to filter on")] = None,
        ...
        :type created_timestamp: List[datetime]
    ...
    def patch_function_access(
        self,
        function_id: Annotated[StrictStr, Field(description="ID of the function to modify access permissions on")],
        access_relationship: AccessRelationship,
        ...
        :param function_id: ID of the function to modify access permissions on (required)
        :type function_id: str
        :param access_relationship: (required)
        :type access_relationship: AccessRelationship
    ...
    def update_function_auth_provider(
        self,
        auth_provider_name: Annotated[StrictStr, Field(description="The unique name of the FunctionAuthProvider to update")],
        ...
        """This method updates an FunctionAuthProvider with a new auth provider name.

        This method updates an FunctionAuthProvider with a new auth provider name.

        :param auth_provider_name: The unique name of the FunctionAuthProvider to update (required)
        :type auth_provider_name: str
