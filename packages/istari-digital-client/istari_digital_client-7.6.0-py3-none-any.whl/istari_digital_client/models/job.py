...
class Job(FileHaving, Shareable):
    """
    Job
    """ # noqa: E501
    id: StrictStr
    ...
    __properties: ClassVar[List[str]] = ["id", "created", "file", "comments", "archive_status_history", "created_by_id", "function", "model_id", "status_history"]
    ...
    def poll_job(self) -> JobStatusName:
        ...
        return self.client.poll_job(self.id)
