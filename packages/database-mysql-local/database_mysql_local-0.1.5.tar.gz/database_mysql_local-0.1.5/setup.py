...
setuptools.setup(
    ...
    install_requires=[
        "mysql-connector-python>=9.0.0",  # https://pypi.org/project/mysql-connector-python/
        "url-remote>=0.0.108",  # https://pypi.org/project/url-remote/
        "logger-local>=0.0.166",  # https://pypi.org/project/logger-local/
        # database-infrastructure-local 0.0.35 generic_crud_abstract.py GenericCrudAbstract
        "database-infrastructure-local>=0.1.4",  # https://pypi.org/project/database-infrastructure-local/
