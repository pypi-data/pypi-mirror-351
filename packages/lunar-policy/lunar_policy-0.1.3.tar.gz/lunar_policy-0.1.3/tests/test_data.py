...
from src.lunar_policy.data import SnippetData, Path
...
class TestDataLoading():
    def test_from_component_json(self):
        ...
        data = SnippetData.from_component_json(json.dumps(component_json))
        assert_result(
    ...
    def test_from_json(self):
        ...
        data = SnippetData.from_json(json.dumps(test_data))
        assert_result(
            data.get_merged(Path('.string')),
            'hello world',
            ['string']
    ...
    def test_from_file(self):
        ...
        data = SnippetData.from_file(FSPath(tmp_path))
        assert_result(
            data.get_merged(Path('.string')),
            'hello world',
            ['string']
...
class TestGetMerged():
    ...
    def test_get_missing(self, snippet_data):
        result = snippet_data.get_merged(Path('.missing'))
...
class TestGetAll():
    ...
    def test_get_missing(self, snippet_data):
        result = snippet_data.get_all(Path('.missing'))
        assert_all_results(result, [])
