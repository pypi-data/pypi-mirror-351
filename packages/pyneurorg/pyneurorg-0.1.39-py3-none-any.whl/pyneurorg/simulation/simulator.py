...
class Simulator:
    ...
    def add_stimulus(self, electrode_id: int, stimulus_waveform: b2.TimedArray,
                     ...
                     flag_variable_template: str = "stim_target_flag{id}"):
        ...
        if current_flag_name not in target_ng.variables:
            raise AttributeError(
                ...
                f"'{current_flag_name}' defined in its equations. Ensure neuron model "
                f"includes it via 'num_stimulus_flags' parameter."
            )
