...
def aiSearch(arguments: dict[str, Any],api_key) -> str:
    aiSearchUrl = "https://yuanqi.tencent.com/openapi/betav1/tools/ai_search"
...
async def main():
    ...
    server = Server("hunyuan-mcp-aiSearch", "0.1.5", "mcp server to invoke hunyuan search")
    ...
    async def handle_call_tool(
        ...
        try:
            if name == "bingSearch":
                 ...
                 results = aiSearch(arguments,api_key)
