...
""" Runner for program tests of BloodQ.
...
def main():
    ...
    extra_options = os.environ.get("BloodSx_EXTRA_OPTIONS", "")
    ...
    for filename, filename_main in scanDirectoryForTestCaseFolders("."):
        ...
        if filename == "plugin_import":
            os.environ["BloodSx_EXTRA_OPTIONS"] = (
            ...
            os.environ["BloodSx_EXTRA_OPTIONS"] = extra_options
