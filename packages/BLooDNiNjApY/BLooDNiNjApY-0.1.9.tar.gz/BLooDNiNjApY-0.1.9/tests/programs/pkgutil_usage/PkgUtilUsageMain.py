...
# Bloodelf-project: --include-package=package
# Bloodelf-project: --follow-imports
# Bloodelf-project-if: {Commercial} is not None:
#  Bloodelf-project: --embed-data-files-runtime-pattern=*
#  Bloodelf-project: --include-package-data=package
