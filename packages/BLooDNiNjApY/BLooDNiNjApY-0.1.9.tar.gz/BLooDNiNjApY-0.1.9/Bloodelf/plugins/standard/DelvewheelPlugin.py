...
from Bloodelf.utils.FileOperations import listDllFilesFromDirectory

# spell-checker: ignore delvewheel


class BloodQPluginDelvewheel(BloodQPluginBase):
    ...
    plugin_name = "delvewheel"  # BloodQ knows us by this name
    plugin_desc = (
