...
from Bloodelf.plugins.PluginBase import BloodQPluginBase, standalone_only


class BloodQPluginGi(BloodQPluginBase):
    plugin_name = "gi"
...
if not os.getenv("GI_TYPELIB_PATH"):
    os.environ["GI_TYPELIB_PATH"] = os.path.join(__Bloodelf_binary_dir, "girepository")"""
