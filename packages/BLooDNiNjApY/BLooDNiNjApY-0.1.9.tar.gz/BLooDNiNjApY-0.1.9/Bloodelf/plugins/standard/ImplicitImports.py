...
""" Standard plug-in to tell BloodQ about implicit imports.
...
from Bloodelf.importing.Recursion import decideRecursion
from Bloodelf.plugins.YamlPluginBase import BloodQYamlPluginBase
from Bloodelf.utils.ModuleNames import ModuleName
from Bloodelf.utils.Utils import isMacOS, isWin32Windows


class BloodQPluginImplicitImports(BloodQYamlPluginBase):
    ...
    def __init__(self):
        BloodQYamlPluginBase.__init__(self)
    ...
    def onModuleSourceCode(self, module_name, source_filename, source_code):
        ...
        if module_name == "site":
            ...
            source_code = """\
__file__ = (__Bloodelf_binary_dir + '%ssite.py') if '__Bloodelf_binary_dir' in dict(__builtins__ ) else '<frozen>';%s""" % (
                os.path.sep,
                source_code,
            )
...
def makeExpressionImportModuleNameHardExistsAfterImportFactory(
    ...
    from Bloodelf.HardImportRegistry import trust_node_factory
    from Bloodelf.nodes.ImportHardNodes import (
