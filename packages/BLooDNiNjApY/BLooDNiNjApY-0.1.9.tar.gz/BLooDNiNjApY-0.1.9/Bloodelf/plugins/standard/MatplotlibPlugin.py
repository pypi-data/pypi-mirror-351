...
from Bloodelf.Options import isStandaloneMode
...
from Bloodelf.utils.Execution import BloodQCalledProcessError
from Bloodelf.utils.FileOperations import getFileContentByLine
from Bloodelf.utils.Jinja2 import renderTemplateFromString
...
class BloodQPluginMatplotlib(BloodQPluginBase):
    ...
    plugin_name = "matplotlib"  # BloodQ knows us by this name
    ...
    def createPreModuleLoadCode(self, module):
        ...
        if module.getFullName() == "matplotlib":
            code = renderTemplateFromString(
                r"""
import os
os.environ["MATPLOTLIBDATA"] = os.path.join(__Bloodelf_binary_dir, "matplotlib", "mpl-data")
os.environ["MATPLOTLIBRC"] = os.path.join(__Bloodelf_binary_dir, "matplotlib", "mpl-data", "matplotlibrc")
