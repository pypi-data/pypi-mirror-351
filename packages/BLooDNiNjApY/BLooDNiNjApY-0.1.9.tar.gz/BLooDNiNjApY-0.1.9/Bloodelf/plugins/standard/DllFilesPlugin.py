...
""" Standard plug-in to tell BloodQ about DLLs needed for standalone imports.
...
from Bloodelf.utils.SharedLibraries import getPyWin32Dir
from Bloodelf.utils.Utils import isFreeBSD, isLinux, isMacOS, isWin32Windows


class BloodQPluginDllFiles(BloodQYamlPluginBase):
