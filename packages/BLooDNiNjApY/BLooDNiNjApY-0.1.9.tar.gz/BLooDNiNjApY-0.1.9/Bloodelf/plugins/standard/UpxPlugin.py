...
from Bloodelf.Options import isOnefileMode, isOnefileTempDirMode
from Bloodelf.plugins.PluginBase import BloodQPluginBase
from Bloodelf.utils.AppDirs import getCacheDir
from Bloodelf.utils.Execution import executeToolChecked, getExecutablePath
from Bloodelf.utils.FileOperations import copyFile, makePath
from Bloodelf.utils.Hashing import Hash, getFileContentsHash
from Bloodelf.utils.Utils import isLinux


class BloodQPluginUpx(BloodQPluginBase):
    ...
    plugin_name = "upx"  # BloodQ knows us by this name
