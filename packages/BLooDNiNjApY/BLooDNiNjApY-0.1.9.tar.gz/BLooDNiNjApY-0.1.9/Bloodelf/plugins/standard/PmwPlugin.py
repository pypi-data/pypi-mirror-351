...
from Bloodelf.__past__ import StringIO
from Bloodelf.plugins.PluginBase import BloodQPluginBase
from Bloodelf.utils.FileOperations import getFileContents, listDir
...
class BloodQPluginPmw(BloodQPluginBase):
...
class BloodQPluginDetectorPmw(BloodQPluginBase):
    detector_for = BloodQPluginPmw
