...
from Bloodelf.Options import isStandaloneMode, shallCreateAppBundle
from Bloodelf.plugins.PluginBase import BloodQPluginBase
from Bloodelf.PythonFlavors import isHomebrewPython
from Bloodelf.PythonVersions import getSystemPrefixPath, getTkInterVersion
...
class BloodQPluginTkinter(BloodQPluginBase):
    ...
    plugin_name = "tk-inter"  # BloodQ knows us by this name
...
Please report as a issue."""
    ...
    def createPreModuleLoadCode(module):
        ...
        if _isTkInterModule(module):
            ...
            code = r"""
import os
os.environ["TCL_LIBRARY"] = os.path.join(__Bloodelf_binary_dir, "tcl")
os.environ["TK_LIBRARY"] = os.path.join(__Bloodelf_binary_dir, "tk")"""
    ...
    def addPluginCommandLineOptions(cls, group):
        group.add_option(
            ...
            default=None,
            help="""\
The Tk library dir. BloodQ is supposed to automatically detect it, but you can
...
that works, report a bug so it can be added to BloodQ."""
            )
...
class BloodQPluginDetectorTkinter(BloodQPluginBase):
    ...
    detector_for = BloodQPluginTkinter
