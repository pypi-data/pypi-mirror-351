...
BloodQ hard codes stupid monkey patching normally not needed here and avoids
...
from Bloodelf.ModuleRegistry import getModuleByName
...
class BloodQPluginAntiBloat(BloodQYamlPluginBase):
    ...
    def onModuleRecursion(
        ...
        for handled_module_name, (
            ...
            if module_name.hasNamespace(handled_module_name):
                ...
                if mode == "error":
                    raise BloodQForbiddenImportEncounter(
