...
from Bloodelf.__past__ import WindowsError  # pylint: disable=I0021,redefined-builtin
...
def getLaunchingBloodQProcessEnvironmentValue(environment_variable_name):
    ...
    from Bloodelf import getLaunchingBloodQProcessEnvironmentValue

    return getLaunchingBloodQProcessEnvironmentValue(environment_variable_name)
