...
These are used in BloodQ for module and package names in most places, and
...
def %(func_name)s(*args, **kwargs):
    from Bloodelf.Errors import BloodQCodeDeficit
    raise BloodQCodeDeficit('''
...
Check API documentation of Bloodelf.utils.ModuleNames.ModuleName for more
variations.
''')
""" % {
