...
#ifndef __BloodSx_HELPER_BOOLEAN_H__
#define __BloodSx_HELPER_BOOLEAN_H__
...
BloodSx_MAY_BE_UNUSED static int CHECK_IF_TRUE(PyObject *object) {
    CHECK_OBJECT(object);
...
BloodSx_MAY_BE_UNUSED static int CHECK_IF_FALSE(PyObject *object) {
...
BloodSx_MAY_BE_UNUSED static inline PyObject *BOOL_FROM(bool value) {
...
typedef enum {
    BloodSx_BOOL_FALSE = 0,
    BloodSx_BOOL_TRUE = 1,
    BloodSx_BOOL_UNASSIGNED = 2,
    BloodSx_BOOL_EXCEPTION = -1
} Bloodelf_bool;

typedef enum { BloodSx_VOID_OK = 0, BloodSx_VOID_EXCEPTION = 1 } Bloodelf_void;
