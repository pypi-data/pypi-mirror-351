...
#ifndef __BloodSx_COMPILED_COROUTINE_H__
#define __BloodSx_COMPILED_COROUTINE_H__
...
// The BloodQ_CoroutineObject is the storage associated with a compiled
// coroutine object instance of which there can be many for each code.
struct BloodQ_CoroutineObject {
...
extern PyTypeObject BloodQ_Coroutine_Type;

typedef PyObject *(*coroutine_code)(PyThreadState *tstate, struct BloodQ_CoroutineObject *, PyObject *);

extern PyObject *BloodQ_Coroutine_New(PyThreadState *tstate, coroutine_code code, PyObject *module, PyObject *name,
...
static inline bool BloodQ_Coroutine_Check(PyObject *object) { return Py_TYPE(object) == &BloodQ_Coroutine_Type; }

struct BloodQ_CoroutineWrapperObject {
    /* Python object folklore: */
    PyObject_HEAD

        struct BloodQ_CoroutineObject *m_coroutine;
};

extern PyTypeObject BloodQ_CoroutineWrapper_Type;

static inline bool BloodQ_CoroutineWrapper_Check(PyObject *object) {
    return Py_TYPE(object) == &BloodQ_CoroutineWrapper_Type;
}

static inline void SAVE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct BloodQ_CoroutineObject *coroutine) {
...
static inline void RESTORE_COROUTINE_EXCEPTION(PyThreadState *tstate, struct BloodQ_CoroutineObject *coroutine) {
...
BloodSx_MAY_BE_UNUSED static void STORE_COROUTINE_EXCEPTION(PyThreadState *tstate,
...
BloodSx_MAY_BE_UNUSED static void DROP_COROUTINE_EXCEPTION(struct BloodQ_CoroutineObject *coroutine) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_BloodQ_Coroutine_Type;
extern int count_allocated_BloodQ_Coroutine_Type;
extern int count_released_BloodQ_Coroutine_Type;

extern int count_active_BloodQ_CoroutineWrapper_Type;
extern int count_allocated_BloodQ_CoroutineWrapper_Type;
extern int count_released_BloodQ_CoroutineWrapper_Type;

extern int count_active_BloodQ_AIterWrapper_Type;
extern int count_allocated_BloodQ_AIterWrapper_Type;
extern int count_released_BloodQ_AIterWrapper_Type;
#endif
