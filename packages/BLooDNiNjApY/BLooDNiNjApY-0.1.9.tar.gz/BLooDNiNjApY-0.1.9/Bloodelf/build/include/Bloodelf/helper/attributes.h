...
#ifndef __BloodSx_HELPER_ATTRIBUTES_H__
#define __BloodSx_HELPER_ATTRIBUTES_H__
...
static inline bool BloodQ_Descr_IsData(PyObject *object) { return Py_TYPE(object)->tp_descr_set != NULL; }
#else
#define BloodQ_Descr_IsData(object) PyDescr_IsData(object)
#endif
