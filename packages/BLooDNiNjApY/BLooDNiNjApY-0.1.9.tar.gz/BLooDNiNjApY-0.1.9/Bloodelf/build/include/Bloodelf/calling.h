...
#ifndef __BloodSx_CALLING_H__
#define __BloodSx_CALLING_H__
...
BloodSx_MAY_BE_UNUSED static inline PyObject *BloodQ_CheckFunctionResult(PyThreadState *tstate, PyObject *callable,
                                                                        PyObject *result) {
    if (result == NULL) {
        ...
        // Some buggy C functions do this, and BloodQ inner workings can get
        // upset from it.
...
BloodSx_MAY_BE_UNUSED static PyObject *CALL_FUNCTION(PyThreadState *tstate, PyObject *function_object,
    ...
    return BloodQ_CheckFunctionResult(tstate, function_object, result);
}
...
BloodSx_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_POS_ARGS(PyThreadState *tstate, PyObject *function_object,
...
BloodSx_MAY_BE_UNUSED static PyObject *CALL_FUNCTION_WITH_KW_ARGS(PyThreadState *tstate, PyObject *function_object,
                                                                 PyObject *named_args) {
...
#include "Bloodelf/helper/calling_generated.h"
