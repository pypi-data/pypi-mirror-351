...
#ifndef __BloodSx_FILESYSTEM_PATH_OPS_H__
#define __BloodSx_FILESYSTEM_PATH_OPS_H__
...
#define BloodQ_String_FromFilename(filename) BloodQUnicode_FromWideChar(filename, -1)
#else
...
#define BloodQ_String_FromFilename BloodQ_String_FromString
#endif
