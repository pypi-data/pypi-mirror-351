...
#ifndef __BloodSx_IMPORTING_H__
#define __BloodSx_IMPORTING_H__
...
BloodSx_MAY_BE_UNUSED static PyObject *BloodQ_GetSysModules(void) {
...
BloodSx_MAY_BE_UNUSED static bool BloodQ_HasModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_HAS_ITEM(tstate, BloodQ_GetSysModules(), module_name) == 1;
}

// Replacement for "PyImport_GetModule" working across all versions and less checks.
BloodSx_MAY_BE_UNUSED static PyObject *BloodQ_GetModule(PyThreadState *tstate, PyObject *module_name) {
    return DICT_GET_ITEM1(tstate, BloodQ_GetSysModules(), module_name);
}

// Replacement for PyImport_GetModule working across all versions and less checks.
BloodSx_MAY_BE_UNUSED static PyObject *BloodQ_GetModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = BloodQ_String_FromString(module_name);
    PyObject *result = BloodQ_GetModule(tstate, module_name_object);
...
BloodSx_MAY_BE_UNUSED static bool BloodQ_SetModule(PyObject *module_name, PyObject *module) {
    CHECK_OBJECT(module_name);
    CHECK_OBJECT(module);
    assert(PyModule_Check(module));

    return DICT_SET_ITEM(BloodQ_GetSysModules(), module_name, module);
}

// Add a module to the modules dictionary from name C string
BloodSx_MAY_BE_UNUSED static bool BloodQ_SetModuleString(char const *module_name, PyObject *module) {
    PyObject *module_name_object = BloodQ_String_FromString(module_name);
    bool result = BloodQ_SetModule(module_name_object, module);
    Py_DECREF(module_name_object);
...
BloodSx_MAY_BE_UNUSED static bool BloodQ_DelModule(PyThreadState *tstate, PyObject *module_name) {
    CHECK_OBJECT(module_name);
...
BloodSx_MAY_BE_UNUSED static bool BloodQ_DelModuleString(PyThreadState *tstate, char const *module_name) {
    PyObject *module_name_object = BloodQ_String_FromString(module_name);
    bool result = BloodQ_DelModule(tstate, module_name_object);
    Py_DECREF(module_name_object);
...
BloodSx_MAY_BE_UNUSED static PyObject *BloodQ_GetFilenameObject(PyThreadState *tstate, PyObject *module) {
#if PYTHON_VERSION < 0x300
