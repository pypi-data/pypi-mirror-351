...
#ifndef __BloodSx_MAPPINGS_H__
#define __BloodSx_MAPPINGS_H__

extern Py_ssize_t BloodQ_PyMapping_Size(PyObject *mapping);

BloodSx_MAY_BE_UNUSED static int MAPPING_HAS_ITEM(PyThreadState *tstate, PyObject *mapping, PyObject *key) {
