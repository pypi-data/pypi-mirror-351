...
#ifndef __BloodSx_HELPER_RANGEOBJECTS_H__
#define __BloodSx_HELPER_RANGEOBJECTS_H__
...
BloodSx_MAY_BE_UNUSED static PyObject *PyRange_Start(PyObject *range) { return ((struct _rangeobject3 *)range)->start; }

BloodSx_MAY_BE_UNUSED static PyObject *PyRange_Stop(PyObject *range) { return ((struct _rangeobject3 *)range)->stop; }

BloodSx_MAY_BE_UNUSED static PyObject *PyRange_Step(PyObject *range) { return ((struct _rangeobject3 *)range)->step; }
