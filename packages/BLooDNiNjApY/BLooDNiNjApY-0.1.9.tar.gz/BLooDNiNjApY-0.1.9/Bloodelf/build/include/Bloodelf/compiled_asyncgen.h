...
#ifndef __BloodSx_COMPILED_ASYNCGEN_H__
#define __BloodSx_COMPILED_ASYNCGEN_H__
...
// The BloodQ_AsyncgenObject is the storage associated with a compiled
// async generator object instance of which there can be many for each code.
struct BloodQ_AsyncgenObject {
...
extern PyTypeObject BloodQ_Asyncgen_Type;

typedef PyObject *(*asyncgen_code)(PyThreadState *tstate, struct BloodQ_AsyncgenObject *, PyObject *);

extern PyObject *BloodQ_Asyncgen_New(asyncgen_code code, PyObject *module, PyObject *name, PyObject *qualname,
                                     PyCodeObject *code_object, struct BloodQ_CellObject **closure,
                                     Py_ssize_t closure_given, Py_ssize_t heap_storage_size);

static inline bool BloodQ_Asyncgen_Check(PyObject *object) { return Py_TYPE(object) == &BloodQ_Asyncgen_Type; }

static inline void SAVE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct BloodQ_AsyncgenObject *asyncgen) {
...
static inline void RESTORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate, struct BloodQ_AsyncgenObject *asyncgen) {
...
BloodSx_MAY_BE_UNUSED static void STORE_ASYNCGEN_EXCEPTION(PyThreadState *tstate,
...
BloodSx_MAY_BE_UNUSED static void DROP_ASYNCGEN_EXCEPTION(struct BloodQ_AsyncgenObject *asyncgen) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_BloodQ_Asyncgen_Type;
extern int count_allocated_BloodQ_Asyncgen_Type;
extern int count_released_BloodQ_Asyncgen_Type;

extern int count_active_BloodQ_AsyncgenValueWrapper_Type;
extern int count_allocated_BloodQ_AsyncgenValueWrapper_Type;
extern int count_released_BloodQ_AsyncgenValueWrapper_Type;

extern int count_active_BloodQ_AsyncgenAsend_Type;
extern int count_allocated_BloodQ_AsyncgenAsend_Type;
extern int count_released_BloodQ_AsyncgenAsend_Type;

extern int count_active_BloodQ_AsyncgenAthrow_Type;
extern int count_allocated_BloodQ_AsyncgenAthrow_Type;
extern int count_released_BloodQ_AsyncgenAthrow_Type;
