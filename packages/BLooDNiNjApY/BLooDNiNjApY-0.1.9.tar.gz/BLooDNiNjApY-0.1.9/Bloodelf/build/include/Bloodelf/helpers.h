...
#ifndef __BloodSx_HELPERS_H__
#define __BloodSx_HELPERS_H__
...
// For profiling of BloodQ compiled binaries
#if _BloodSx_PROFILE
extern void startProfiling(void);
extern void stopProfiling(void);
#endif

#include "Bloodelf/helper/boolean.h"
#include "Bloodelf/helper/dictionaries.h"
#include "Bloodelf/helper/indexes.h"
#include "Bloodelf/helper/mappings.h"
#include "Bloodelf/helper/operations_builtin_types.h"
#include "Bloodelf/helper/sets.h"
#include "Bloodelf/helper/strings.h"

#include "Bloodelf/helper/raising.h"

#include "Bloodelf/helper/ints.h"
#include "Bloodelf/helper/richcomparisons.h"
#include "Bloodelf/helper/sequences.h"

static inline bool BloodQ_Function_Check(PyObject *object);
static inline PyObject *BloodQ_Function_GetName(PyObject *object);

static inline bool BloodQ_Generator_Check(PyObject *object);
static inline PyObject *BloodQ_Generator_GetName(PyObject *object);

#include "Bloodelf/calling.h"
#include "Bloodelf/helper/bytes.h"
#include "Bloodelf/helper/complex.h"
#include "Bloodelf/helper/floats.h"

BloodSx_MAY_BE_UNUSED static PyObject *LOOKUP_VARS(PyThreadState *tstate, PyObject *source) {
    CHECK_OBJECT(source);
...
#include "Bloodelf/helper/attributes.h"
#include "Bloodelf/helper/bytearrays.h"
#include "Bloodelf/helper/iterators.h"
#include "Bloodelf/helper/lists.h"
#include "Bloodelf/helper/rangeobjects.h"
#include "Bloodelf/helper/slices.h"
#include "Bloodelf/helper/subscripts.h"
#include "Bloodelf/helper/tuples.h"

#include "Bloodelf/builtins.h"
...
Bloodelf_bool compareFilePaths(PyThreadState *tstate, PyObject *filename_a, PyObject *filename_b);
...
#include "Bloodelf/importing.h"

// Hard imports have their own helpers.
#include "Bloodelf/helper/import_hard.h"
...
#include "Bloodelf/constants_blob.h"
...
BloodSx_MAY_BE_UNUSED static PyObject *MODULE_NAME1(PyThreadState *tstate, PyObject *module) {
...
BloodSx_MAY_BE_UNUSED static PyObject *MODULE_NAME0(PyThreadState *tstate, PyObject *module) {
    assert(PyModule_Check(module));
    PyObject *module_dict = ((PyModuleObject *)module)->md_dict;
...
extern PyTypeObject *BloodQ_PyUnion_Type;

// Force a garbage collection, for debugging purposes.
BloodSx_MAY_BE_UNUSED static void forceGC(void) {
...
extern void BloodQ_PyType_Ready(PyTypeObject *type, PyTypeObject *base, bool generic_get_attr, bool generic_set_attr,
                                bool self_iter, bool await_self_iter, bool self_aiter);

#if PYTHON_VERSION >= 0x3b0
#include "Bloodelf/exception_groups.h"
#endif

#if PYTHON_VERSION >= 0x3c0
#include "Bloodelf/type_aliases.h"
#endif
