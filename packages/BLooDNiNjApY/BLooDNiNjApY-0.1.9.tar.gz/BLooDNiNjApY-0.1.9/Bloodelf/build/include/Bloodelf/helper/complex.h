...
#ifndef __BloodSx_HELPER_COMPLEX_H__
#define __BloodSx_HELPER_COMPLEX_H__

BloodSx_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX1(PyThreadState *tstate, PyObject *real) {
    CHECK_OBJECT(real);
...
BloodSx_MAY_BE_UNUSED static PyObject *BUILTIN_COMPLEX2(PyThreadState *tstate, PyObject *real, PyObject *imag) {
    if (real == NULL) {
        assert(imag != NULL);
