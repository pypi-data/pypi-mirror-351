...
#ifndef __BloodSx_COMPILED_GENERATOR_H__
#define __BloodSx_COMPILED_GENERATOR_H__
...
// The BloodQ_GeneratorObject is the storage associated with a compiled
// generator object instance of which there can be many for each code.
struct BloodQ_GeneratorObject {
...
#if PYTHON_VERSION >= 0x300
    struct BloodQ_ExceptionStackItem m_resume_exception;
#endif
...
extern PyTypeObject BloodQ_Generator_Type;

typedef PyObject *(*generator_code)(PyThreadState *tstate, struct BloodQ_GeneratorObject *, PyObject *);

extern PyObject *BloodQ_Generator_New(generator_code code, PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                      PyObject *qualname,
#endif
...
extern PyObject *BloodQ_Generator_NewEmpty(PyObject *module, PyObject *name,
#if PYTHON_VERSION >= 0x350
                                           PyObject *qualname,
#endif
                                           PyCodeObject *code_object, struct BloodQ_CellObject **closure,
...
extern PyObject *BloodQ_Generator_qiter(PyThreadState *tstate, struct BloodQ_GeneratorObject *generator,
                                        bool *finished);

static inline bool BloodQ_Generator_Check(PyObject *object) { return Py_TYPE(object) == &BloodQ_Generator_Type; }

static inline PyObject *BloodQ_Generator_GetName(PyObject *object) {
    return ((struct BloodQ_GeneratorObject *)object)->m_name;
}

static inline void SAVE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct BloodQ_GeneratorObject *generator) {
...
static inline void RESTORE_GENERATOR_EXCEPTION(PyThreadState *tstate, struct BloodQ_GeneratorObject *generator) {
...
extern void BloodQ_PreserveHeap(void *dest, ...);
extern void BloodQ_RestoreHeap(void *source, ...);

BloodSx_MAY_BE_UNUSED static void STORE_GENERATOR_EXCEPTION(PyThreadState *tstate,
...
BloodSx_MAY_BE_UNUSED static void DROP_GENERATOR_EXCEPTION(struct BloodQ_GeneratorObject *generator) {
#if PYTHON_VERSION < 0x3b0
...
#if _DEBUG_REFCOUNTS
extern int count_active_BloodQ_Generator_Type;
extern int count_allocated_BloodQ_Generator_Type;
extern int count_released_BloodQ_Generator_Type;
#endif
