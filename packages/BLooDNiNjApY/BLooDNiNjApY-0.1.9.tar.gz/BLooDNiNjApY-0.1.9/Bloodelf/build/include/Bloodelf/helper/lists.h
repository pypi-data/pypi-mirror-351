...
#ifndef __BloodSx_HELPER_LISTS_H__
#define __BloodSx_HELPER_LISTS_H__
...
#define BloodSx_LIST_HAS_FREELIST 1
extern PyObject *MAKE_LIST_EMPTY(PyThreadState *tstate, Py_ssize_t size);
#else
#define BloodSx_LIST_HAS_FREELIST 0
...
BloodSx_MAY_BE_UNUSED static PyObject *MAKE_LIST_REPEATED(PyThreadState *tstate, Py_ssize_t size, PyObject *element) {
