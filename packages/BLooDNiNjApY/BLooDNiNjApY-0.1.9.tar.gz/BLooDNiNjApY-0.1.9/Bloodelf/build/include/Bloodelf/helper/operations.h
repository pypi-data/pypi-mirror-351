...
#ifndef __BloodSx_OPERATIONS_H__
#define __BloodSx_OPERATIONS_H__
...
BloodSx_MAY_BE_UNUSED static PyObject *UNICODE_CONCAT(PyThreadState *tstate, PyObject *left, PyObject *right) {
...
BloodSx_MAY_BE_UNUSED static PyObject *UNARY_OPERATION(unary_api api, PyObject *operand) {
...
#include "Bloodelf/helper/operations_binary_add.h"
#include "Bloodelf/helper/operations_binary_bitand.h"
#include "Bloodelf/helper/operations_binary_bitor.h"
#include "Bloodelf/helper/operations_binary_bitxor.h"
#include "Bloodelf/helper/operations_binary_divmod.h"
#include "Bloodelf/helper/operations_binary_floordiv.h"
#include "Bloodelf/helper/operations_binary_lshift.h"
#include "Bloodelf/helper/operations_binary_mod.h"
#include "Bloodelf/helper/operations_binary_mult.h"
#include "Bloodelf/helper/operations_binary_pow.h"
#include "Bloodelf/helper/operations_binary_rshift.h"
#include "Bloodelf/helper/operations_binary_sub.h"
#include "Bloodelf/helper/operations_binary_truediv.h"

// Generated helpers to execute operations on dual types.
#include "Bloodelf/helper/operations_binary_dual_add.h"

#include "Bloodelf/helper/operations_inplace_add.h"
#include "Bloodelf/helper/operations_inplace_bitand.h"
#include "Bloodelf/helper/operations_inplace_bitor.h"
#include "Bloodelf/helper/operations_inplace_bitxor.h"
#include "Bloodelf/helper/operations_inplace_floordiv.h"
#include "Bloodelf/helper/operations_inplace_lshift.h"
#include "Bloodelf/helper/operations_inplace_mod.h"
#include "Bloodelf/helper/operations_inplace_mult.h"
#include "Bloodelf/helper/operations_inplace_pow.h"
#include "Bloodelf/helper/operations_inplace_rshift.h"
#include "Bloodelf/helper/operations_inplace_sub.h"
#include "Bloodelf/helper/operations_inplace_truediv.h"

#if PYTHON_VERSION < 0x300
// Classical division is Python2 only.
#include "Bloodelf/helper/operations_binary_olddiv.h"
#include "Bloodelf/helper/operations_inplace_olddiv.h"
#endif
#if PYTHON_VERSION >= 0x350
// Matrix multiplication is Python3.5 or higher only.
#include "Bloodelf/helper/operations_binary_matmult.h"
#include "Bloodelf/helper/operations_inplace_matmult.h"
#endif
