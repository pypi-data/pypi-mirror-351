...
#if defined(_WIN32)
#if defined(_BloodSx_ATTACH_CONSOLE_WINDOW)
#include <io.h>
...
#if !defined(BloodSx_FORCED_STDERR_PATH) && !defined(BloodSx_FORCED_STDERR_NONE_BOOL) &&                                 \
    !defined(BloodSx_FORCED_STDERR_NULL_BOOL)
