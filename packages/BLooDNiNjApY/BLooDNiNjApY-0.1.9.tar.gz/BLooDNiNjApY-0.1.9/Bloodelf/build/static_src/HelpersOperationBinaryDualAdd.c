 ...
 */
bool BINARY_OPERATION_ADD_NILONG_NILONG_NILONG(Bloodelf_ilong *result, Bloodelf_ilong *operand1, Bloodelf_ilong *operand2) {
 ...
 * Python objects. */
bool BINARY_OPERATION_ADD_NILONG_NILONG_DIGIT(Bloodelf_ilong *result, Bloodelf_ilong *operand1, long operand2) {
    CHECK_NILONG_OBJECT(operand1);
...
#pragma warning(pop)
    ...
    exit_result_ok_clong:
        ...
        BloodSx_CANNOT_GET_HERE("cannot happen with types NILONG DIGIT");
        return false;
    }
}
