...
extern "C" void initSplashScreen(void) {
    ...
    if (unlikely(bool_res == false)) {
        BloodSx_PRINT_TIMING("Failed expand indicator path.");
        return;
    }
    ...
    BloodSx_PRINT_TIMING("ONEFILE: Done with splash screen.");
}

static void closeSplashScreen(void) {
    BloodSx_PRINT_TIMING("ONEFILE: Check splash screen indicator file.");
