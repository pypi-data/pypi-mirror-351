...
from Bloodelf.utils.Utils import decoratorRetries
...
def runClCache(compiler, compiler_args, env):
    """ Entry point, designed to be used by external tools like BloodQ's scons. """
    ...
    # Preferred order in BloodQ scons is output, error, exit_code and we expect
    # bytes.
