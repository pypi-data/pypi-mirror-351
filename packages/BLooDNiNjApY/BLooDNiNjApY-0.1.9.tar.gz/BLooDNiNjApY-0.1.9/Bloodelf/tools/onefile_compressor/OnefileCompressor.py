...
from Bloodelf.__past__ import to_byte
...
from Bloodelf.Tracing import onefile_logger
...
from Bloodelf.utils.Hashing import Hash, HashCRC32
...
def main():
    ...
    if os.getenv("BloodSx_PROGRESS_BAR") == "1":
        enableProgressBar()
