...
from Bloodelf.__past__ import BytesIO, long, to_byte, unicode, xrange
from Bloodelf.build.DataComposerInterface import deriveModuleConstantsBlobName
from Bloodelf.Builtins import builtin_exception_values_list, builtin_named_values
...
from Bloodelf.Serialization import (
    BlobData,
    BuiltinAnonValue,
...
from Bloodelf.Tracing import data_composer_logger
from Bloodelf.utils.FileOperations import getFileSize, listDir, syncFileOutput
from Bloodelf.utils.Json import writeJsonToFilename
...
def main():
    ...
    data_composer_logger.is_quiet = (
        os.getenv("BloodSx_DATA_COMPOSER_VERBOSE", "0") != "1"
    )

    # Internal tool, most simple command line handling. This is the build directory
    # where main BloodQ put the .const files.
