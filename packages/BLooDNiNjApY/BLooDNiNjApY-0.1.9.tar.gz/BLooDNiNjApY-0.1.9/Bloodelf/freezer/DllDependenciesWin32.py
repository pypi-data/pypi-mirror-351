...
from Bloodelf.build.SconsUtils import readSconsReport
from Bloodelf.containers.OrderedSets import OrderedSet
from Bloodelf.Options import isExperimental, isShowProgress
...
from Bloodelf.utils.Hashing import Hash
from Bloodelf.utils.SharedLibraries import getPEFileUsedDllNames, getPyWin32Dir
from Bloodelf.utils.Utils import getArchitecture
from Bloodelf.Version import version_string
...
def _getCacheFilename(
    ...
    # Take BloodQ version into account as well, ought to catch code changes.
