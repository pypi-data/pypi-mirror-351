...
from Bloodelf.PythonVersions import getSystemPrefixPath
from Bloodelf.Tracing import general, inclusion_logger
from Bloodelf.utils.FileOperations import areInSamePaths, isFilenameBelowPath
from Bloodelf.utils.SharedLibraries import copyDllFile, setSharedLibraryRPATH
...
def checkFreezingModuleSet():
    ...
    """
    # Cyclic dependency
    from Bloodelf import ModuleRegistry
...
def _detectBinaryDLLs(
    ...
    if is_main_executable and isBloodQPython():
        return OrderedSet()
