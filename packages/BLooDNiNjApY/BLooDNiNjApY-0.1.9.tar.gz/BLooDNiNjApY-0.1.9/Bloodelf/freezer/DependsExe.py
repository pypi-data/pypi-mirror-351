...
from Bloodelf.__past__ import WindowsError
from Bloodelf.containers.OrderedSets import OrderedSet
from Bloodelf.Options import assumeYesForDownloads
from Bloodelf.Tracing import inclusion_logger
from Bloodelf.utils.Download import getCachedDownload
from Bloodelf.utils.Execution import executeProcess, withEnvironmentVarOverridden
...
from Bloodelf.utils.SharedLibraries import getWindowsRunningProcessDLLPaths
...
def getDependsExePath():
    ...
    return getCachedDownload(
        ...
        message="""\
BloodQ will make use of Dependency Walker (https://dependencywalker.com) tool
to analyze the dependencies of Python extension modules.""",
        reject="BloodQ does not work in --standalone or --onefile on Windows without.",
