...
from Bloodelf.utils.CStrings import encodePythonStringToC, encodePythonUnicodeToC
...
def getModuleMetaPathLoaderEntryCode(module, bytecode_accessor):
    ...
    if module.isUncompiledPythonModule():
        ...
        flags.append("BloodSx_BYTECODE_FLAG")
        if is_package:
            flags.append("BloodSx_PACKAGE_FLAG")
        ...
        flags.append("BloodSx_EXTENSION_MODULE_FLAG")
...
PyThreadState *tstate, PyObject *, struct BloodQ_MetaPathBasedLoaderEntry const *);"""
