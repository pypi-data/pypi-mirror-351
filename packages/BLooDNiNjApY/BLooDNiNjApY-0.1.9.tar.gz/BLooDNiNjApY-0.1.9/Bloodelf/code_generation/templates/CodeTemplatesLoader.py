...
static struct BloodQ_MetaPathBasedLoaderEntry meta_path_loader_entries[] = {
...
// in this un-optimized form. These are not compiled by BloodQ, and therefore
...
void copyFrozenModulesTo(struct _frozen *destination) {
    BloodSx_PRINT_TIMING("copyFrozenModulesTo(): Calling _loadBytesCodesBlob.");
    _loadBytesCodesBlob(NULL);

    BloodSx_PRINT_TIMING("copyFrozenModulesTo(): Updating frozen module table sizes.");
...
struct BloodQ_MetaPathBasedLoaderEntry const *getLoaderEntry(char const *name) {
    struct BloodQ_MetaPathBasedLoaderEntry *current = meta_path_loader_entries;
