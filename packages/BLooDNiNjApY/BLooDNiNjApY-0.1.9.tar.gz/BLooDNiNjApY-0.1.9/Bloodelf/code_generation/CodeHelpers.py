...
from Bloodelf.nodes.NodeMetaClasses import BloodQNodeDesignError
from Bloodelf.Options import shallTraceExecution
from Bloodelf.PythonVersions import python_version
from Bloodelf.Tracing import printError
...
def decideConversionCheckNeeded(to_name, expression):
    if to_name.c_type == "Bloodelf_bool":
...
def assignConstantNoneResult(to_name, emit, context):
    ...
    if to_name.c_type == "Bloodelf_void":
