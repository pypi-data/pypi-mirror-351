...
In the "Bloodelf.tree.TreeHelpers" module, the dispatching is happening. One function
...
from Bloodelf import ModuleRegistry, OutputDirectories, SourceCodeReferences
from Bloodelf.__past__ import long, unicode
from Bloodelf.BytecodeCaching import (
    getCachedImportedModuleUsageAttempts,
    hasCachedImportedModuleUsageAttempts,
)
from Bloodelf.Bytecodes import loadCodeObjectData
from Bloodelf.containers.OrderedSets import OrderedSet
from Bloodelf.Errors import CodeTooComplexCode
from Bloodelf.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from Bloodelf.importing import Importing
from Bloodelf.importing.ImportCache import addImportedModule
from Bloodelf.importing.PreloadedPackages import getPthImportedPackages
from Bloodelf.importing.StandardLibrary import isStandardLibraryPath
...
from Bloodelf.nodes.BuiltinRefNodes import quick_names
from Bloodelf.nodes.BuiltinTypeNodes import ExpressionBuiltinStrP3
from Bloodelf.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from Bloodelf.nodes.ConstantRefNodes import (
    ExpressionConstantEllipsisRef,
    ExpressionConstantNoneRef,
    makeConstantRefNode,
)
from Bloodelf.nodes.ExceptionNodes import (
    StatementRaiseException,
    StatementReraiseException,
)
from Bloodelf.nodes.FutureSpecs import FutureSpec
from Bloodelf.nodes.GeneratorNodes import (
    StatementGeneratorReturn,
    StatementGeneratorReturnNone,
)
from Bloodelf.nodes.ImportNodes import (
    isHardModuleWithoutSideEffect,
    makeExpressionImportModuleFixed,
)
from Bloodelf.nodes.LoopNodes import StatementLoopBreak, StatementLoopContinue
from Bloodelf.nodes.ModuleAttributeNodes import (
    ExpressionModuleAttributeFileRef,
    ExpressionModuleAttributeSpecRef,
)
from Bloodelf.nodes.ModuleNodes import (
...
from Bloodelf.nodes.OperatorNodes import makeBinaryOperationNode
from Bloodelf.nodes.OperatorNodesUnary import makeExpressionOperationUnary
...
from Bloodelf.nodes.StatementNodes import StatementExpressionOnly
from Bloodelf.nodes.StringConcatenationNodes import ExpressionStringConcatenation
from Bloodelf.nodes.VariableNameNodes import (
    ExpressionVariableNameRef,
    StatementAssignmentVariableName,
)
from Bloodelf.optimizations.BytecodeDemotion import demoteSourceCodeToBytecode
...
from Bloodelf.utils import MemoryUsage
from Bloodelf.utils.ModuleNames import ModuleName
from Bloodelf.utils.Utils import withNoSyntaxWarning
    ...
    if source_filename is not None and not is_namespace and module_kind == "py":
        ...
        if source_code is None:
            try:
                ...
                if not hasattr(e, "generated_by_Bloodelf"):
                    raise
