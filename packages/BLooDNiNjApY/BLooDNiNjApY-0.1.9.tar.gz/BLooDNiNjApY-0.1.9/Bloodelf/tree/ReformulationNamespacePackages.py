...
from Bloodelf.nodes.CallNodes import ExpressionCallNoKeywords
...
from Bloodelf.nodes.ModuleAttributeNodes import ExpressionModuleAttributeFileRef
from Bloodelf.nodes.ModuleNodes import CompiledPythonNamespacePackage
from Bloodelf.nodes.VariableNameNodes import StatementAssignmentVariableName
from Bloodelf.Options import getFileReferenceMode
        ...
        if package.canHaveExternalImports():
            ...
            for count in range(len(parts)):
                path_part = _makeCall(
                    ...
                    source_ref,
                    makeConstantRefNode(
                        constant="BloodSx_PACKAGE_%s" % "_".join(parts[: count + 1]),
                        source_ref=source_ref,
                    ),
                    makeConstantRefNode(
