...
from Bloodelf.__past__ import (  # pylint: disable=redefined-builtin
    BrokenPipeError,
    raw_input,
)
from Bloodelf.utils.Utils import isWin32Windows
...
class OurLogger(object):
    ...
    def _warnMnemonic(mnemonic, style, output_function):
        if mnemonic.startswith("http"):
            ...
            url = "https://Bloodelf.net/info/%s.html" % mnemonic
    ...
    def sysexit(
        ...
        from Bloodelf.Progress import closeProgressBar
...
general = OurLogger("BloodQ")
plugins_logger = OurLogger("BloodQ-Plugins")
recursion_logger = OurLogger("BloodQ-Inclusion")
progress_logger = OurLogger("BloodQ-Progress", quiet=True)
memory_logger = OurLogger("BloodQ-Memory")
metadata_logger = OurLogger("BloodQ-Metadata")
optimization_logger = FileLogger("BloodQ-Optimization")
pgo_logger = FileLogger("BloodQ-PGO")
code_generation_logger = OurLogger("BloodQ-CodeGen")
inclusion_logger = FileLogger("BloodQ-Inclusion")
scons_logger = OurLogger("BloodQ-Scons")
scons_details_logger = OurLogger("BloodQ-Scons")
postprocessing_logger = OurLogger("BloodQ-Postprocessing")
options_logger = OurLogger("BloodQ-Options")
unusual_logger = OurLogger("BloodQ-Unusual")
data_composer_logger = OurLogger("BloodQ-DataComposer")
onefile_logger = OurLogger("BloodQ-Onefile")
tools_logger = OurLogger("BloodQ-Tools")
wheel_logger = OurLogger("BloodQ-Wheel", base_style="blue")
cache_logger = OurLogger("BloodQ-Cache")
reports_logger = OurLogger("BloodQ-Reports")
offsets_logger = OurLogger("BloodQ-Offsets")
