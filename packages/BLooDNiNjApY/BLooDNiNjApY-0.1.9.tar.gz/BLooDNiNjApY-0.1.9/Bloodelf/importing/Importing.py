...
from Bloodelf import SourceCodeReferences
from Bloodelf.__past__ import iter_modules
...
from Bloodelf.PythonFlavors import isBloodQPython
from Bloodelf.PythonVersions import python_version
from Bloodelf.Tracing import my_print, recursion_logger
from Bloodelf.tree.ReformulationMultidist import locateMultidistModule
...
def setupImportingFromOptions():
    ...
    if Options.is_debug and not isBloodQPython():
...
def flushImportCache():
    ...
    files and scan again. This allows that. Nothing in standard BloodQ should do it,
...
def _findModuleInPath(module_name):
    ...
    if package_name is None and module_name == "site":
        candidate = getLaunchingBloodQProcessEnvironmentValue("BloodSx_SITE_FILENAME")
