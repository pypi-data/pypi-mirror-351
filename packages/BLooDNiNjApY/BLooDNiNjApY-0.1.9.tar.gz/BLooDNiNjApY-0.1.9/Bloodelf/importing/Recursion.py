...
from Bloodelf import ModuleRegistry, Options
from Bloodelf.Errors import BloodQForbiddenImportEncounter
from Bloodelf.freezer.ImportDetection import (
    detectEarlyImports,
    detectStdlibAutoInclusionModules,
)
from Bloodelf.importing import ImportCache, StandardLibrary
from Bloodelf.ModuleRegistry import addUsedModule, getRootTopModule
from Bloodelf.pgo.PGO import decideInclusionFromPGO
from Bloodelf.plugins.Plugins import Plugins
from Bloodelf.PythonVersions import python_version
from Bloodelf.Tracing import recursion_logger
from Bloodelf.utils.FileOperations import listDir
...
def _recurseTo(module_name, module_filename, module_kind, reason):
    from Bloodelf.tree import Building
...
def _decideRecursion(
    ...
    if not is_stdlib or Options.shallFollowStandardLibrary():
        ...
        from Bloodelf.tree.Building import decideCompilationMode
...
def considerUsedModules(module, pass_count):
    ...
    for used_module in module.getUsedModules():
        ...
        except BloodQForbiddenImportEncounter as e:
