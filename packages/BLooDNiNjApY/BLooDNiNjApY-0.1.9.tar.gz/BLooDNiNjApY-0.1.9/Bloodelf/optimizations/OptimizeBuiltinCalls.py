...
from Bloodelf.__past__ import unicode, xrange
from Bloodelf.Errors import BloodQAssumptionError
from Bloodelf.nodes.AttributeNodes import (
    ExpressionBuiltinGetattr,
    ExpressionBuiltinHasattr,
    ExpressionBuiltinSetattr,
    makeExpressionAttributeLookup,
)
from Bloodelf.nodes.BuiltinAllNodes import ExpressionBuiltinAll
from Bloodelf.nodes.BuiltinAnyNodes import ExpressionBuiltinAny
from Bloodelf.nodes.BuiltinComplexNodes import (
    ExpressionBuiltinComplex1,
    ExpressionBuiltinComplex2,
)
from Bloodelf.nodes.BuiltinDecodingNodes import (
    ExpressionBuiltinChr,
    ExpressionBuiltinOrd,
)
from Bloodelf.nodes.BuiltinDecoratorNodes import (
    ExpressionBuiltinClassmethod,
    ExpressionBuiltinStaticmethod,
)
from Bloodelf.nodes.BuiltinDictNodes import ExpressionBuiltinDict
from Bloodelf.nodes.BuiltinFormatNodes import (
...
from Bloodelf.nodes.BuiltinHashNodes import ExpressionBuiltinHash
from Bloodelf.nodes.BuiltinInputNodes import ExpressionBuiltinInput
from Bloodelf.nodes.BuiltinIntegerNodes import (
    ExpressionBuiltinInt1,
    ExpressionBuiltinInt2,
)
from Bloodelf.nodes.BuiltinIteratorNodes import (
    ExpressionBuiltinIter1,
    ExpressionBuiltinIter2,
)
from Bloodelf.nodes.BuiltinLenNodes import ExpressionBuiltinLen
from Bloodelf.nodes.BuiltinNextNodes import (
    ExpressionBuiltinNext1,
    ExpressionBuiltinNext2,
)
from Bloodelf.nodes.BuiltinOpenNodes import (
    ExpressionBuiltinOpenP2,
    ExpressionBuiltinOpenP3,
)
from Bloodelf.nodes.BuiltinRangeNodes import (
...
from Bloodelf.nodes.BuiltinRefNodes import (
    ExpressionBuiltinAnonymousRef,
    makeExpressionBuiltinTypeRef,
)
from Bloodelf.nodes.BuiltinSumNodes import (
    ExpressionBuiltinSum1,
    ExpressionBuiltinSum2,
)
from Bloodelf.nodes.BuiltinTypeNodes import (
...
from Bloodelf.nodes.BuiltinVarsNodes import ExpressionBuiltinVars
from Bloodelf.nodes.CallNodes import makeExpressionCall
from Bloodelf.nodes.ClassNodes import ExpressionBuiltinType3
from Bloodelf.nodes.ComparisonNodes import ExpressionComparisonIs
from Bloodelf.nodes.ConditionalNodes import (
    ExpressionConditional,
    makeStatementConditional,
)
from Bloodelf.nodes.ConstantRefNodes import makeConstantRefNode
from Bloodelf.nodes.ContainerMakingNodes import makeExpressionMakeTupleOrConstant
from Bloodelf.nodes.ExecEvalNodes import (
    ExpressionBuiltinCompile,
    ExpressionBuiltinEval,
)
from Bloodelf.nodes.GlobalsLocalsNodes import (
    ExpressionBuiltinDir1,
    ExpressionBuiltinGlobals,
)
from Bloodelf.nodes.ImportNodes import ExpressionBuiltinImport
from Bloodelf.nodes.KeyValuePairNodes import (
    makeKeyValuePairExpressionsFromKwArgs,
)
from Bloodelf.nodes.NodeMakingHelpers import (
    makeConstantReplacementNode,
    makeExpressionBuiltinLocals,
    makeRaiseExceptionReplacementExpression,
    makeRaiseExceptionReplacementExpressionFromInstance,
)
from Bloodelf.nodes.OperatorNodes import ExpressionOperationBinaryDivmod
from Bloodelf.nodes.OperatorNodesUnary import (
    ExpressionOperationNot,
    ExpressionOperationUnaryAbs,
    ExpressionOperationUnaryRepr,
)
from Bloodelf.nodes.OutlineNodes import ExpressionOutlineBody
from Bloodelf.nodes.ReturnNodes import makeStatementReturn
from Bloodelf.nodes.SliceNodes import makeExpressionBuiltinSlice
from Bloodelf.nodes.TypeNodes import (
...
from Bloodelf.nodes.VariableAssignNodes import (
    makeStatementAssignmentVariable,
    makeStatementDelVariable,
)
from Bloodelf.nodes.VariableRefNodes import (
    ExpressionTempVariableRef,
    ExpressionVariableRef,
)
from Bloodelf.PythonVersions import python_version
from Bloodelf.specs import BuiltinParameterSpecs
from Bloodelf.tree.ReformulationExecStatements import wrapEvalGlobalsAndLocals
from Bloodelf.tree.ReformulationTryFinallyStatements import (
    makeTryFinallyStatement,
)
from Bloodelf.tree.TreeHelpers import (
    makeCallNode,
...
def range_extractor(node):
    ...
    def makeRange0(source_ref):
        ...
        try:
            ...
            raise BloodQAssumptionError("range without argument is expected to raise")
...
if python_version < 0x300:
    from Bloodelf.nodes.ExecEvalNodes import ExpressionBuiltinExecfile
...
if python_version >= 0x300:
    from Bloodelf.nodes.ExecEvalNodes import ExpressionBuiltinExec
...
def open_extractor(node):
    def makeOpen0(source_ref):
        ...
        try:
            ...
            raise BloodQAssumptionError("open without argument is expected to raise")
...
def check():
    from Bloodelf.Builtins import builtin_names
