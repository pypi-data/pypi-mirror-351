...
from Bloodelf import ModuleRegistry, Options, Variables
from Bloodelf.importing.Importing import addExtraSysPaths
from Bloodelf.importing.Recursion import considerUsedModules
...
from Bloodelf.Tracing import general, optimization_logger, progress_logger
from Bloodelf.utils.MemoryUsage import MemoryWatch, reportMemoryUsage
...
def restoreFromXML(text):
    from Bloodelf.nodes.NodeBases import fromXML
    from Bloodelf.TreeXML import fromString
