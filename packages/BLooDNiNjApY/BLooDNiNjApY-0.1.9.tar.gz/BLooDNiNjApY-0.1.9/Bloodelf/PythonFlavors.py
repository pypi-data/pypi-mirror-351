...
def isBloodQPython():
    """Is this our own fork of CPython named BloodQ-Python."""

    # spell-checker: ignore Bloodelfpython

    if python_version >= 0x300:
        return sys.implementation.name == "Bloodelfpython"
    else:
        return sys.subversion[0] == "Bloodelfpython"
