...
from Bloodelf.build.DataComposerInterface import getConstantBlobFilename
from Bloodelf.ModuleRegistry import getImportedModuleNames
from Bloodelf.PythonFlavors import isSelfCompiledPythonUninstalled
from Bloodelf.PythonVersions import getTargetPythonDLLPath, python_version
from Bloodelf.Tracing import postprocessing_logger
from Bloodelf.utils.Execution import wrapCommandForDebuggerForExec
...
from Bloodelf.utils.Images import convertImageToIconFormat
from Bloodelf.utils.Importing import importFromInlineCopy
from Bloodelf.utils.MacOSApp import createPlistInfoFile
...
from Bloodelf.utils.Utils import isAndroidBasedLinux, isMacOS, isWin32Windows
from Bloodelf.utils.WindowsResources import (
    RT_GROUP_ICON,
    RT_ICON,
    RT_RCDATA,
    addResourceToFile,
...
def createScriptFileForExecution(result_filename):
    ...
    if isWin32Windows():
        script_contents = """
@echo off
rem This script was created by BloodQ to execute '%(exe_filename)s' with Python DLL being found.
set PATH=%(dll_directory)s;%%PATH%%
set PYTHONHOME=%(python_home)s
set BloodSx_PYTHONPATH=%(python_path)s
...
export PYTHONHOME
BloodSx_PYTHONPATH="%(python_path)s"
export BloodSx_PYTHONPATH
...
Error, expected 'libpython dependency not found. Please report the bug."""
    ...
    if Options.shallMakeModule() and Options.shallCreatePyiFile():
        ...
        contents = """\
# This file was generated by BloodQ
"""
