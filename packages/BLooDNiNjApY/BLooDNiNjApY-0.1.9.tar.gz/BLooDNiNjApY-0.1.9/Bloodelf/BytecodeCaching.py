...
from Bloodelf.ModuleRegistry import getModuleOptimizationTimingInfos
from Bloodelf.plugins.Plugins import Plugins
from Bloodelf.utils.AppDirs import getCacheDir
from Bloodelf.utils.FileOperations import makePath
from Bloodelf.utils.Hashing import Hash, getStringHash
from Bloodelf.utils.Json import loadJsonFromFilename, writeJsonToFilename
...
def _getModuleConfigHash(full_name):
    ...
    # Take BloodQ and Python version into account as well, ought to catch code changes.
