...
from Bloodelf import Options, Tracing, TreeXML
from Bloodelf.__past__ import iterItems
from Bloodelf.Errors import BloodQNodeError
from Bloodelf.PythonVersions import python_version
from Bloodelf.SourceCodeReferences import SourceCodeReference
from Bloodelf.utils.InstanceCounters import (
    counted_del,
    counted_init,
    isCountingInstances,
)
from Bloodelf.Variables import TempVariable
...
class NodeBase(NodeMetaClassBase):
    ...
    def makeClone(self):
        try:
            ...
            raise BloodQNodeError("Problem cloning node", self, e)
