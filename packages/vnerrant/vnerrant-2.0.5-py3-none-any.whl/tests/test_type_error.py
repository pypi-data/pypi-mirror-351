...
@pytest.mark.parametrize(
    "original, corrected",
    [
        ("They won't be able to attend the meeting.", "They will not be able to attend the meeting."),
        ("She'd like to visit the museum.", "She would like to visit the museum."),
        ("It doesn't make any sense.", "It does not make any sense."),
        ("She'll finish the task by tomorrow.", "She will finish the task by tomorrow."),
...
@pytest.mark.parametrize(
    "original, corrected",
    [
        ("The book I bought yesterday is interesting.", "The book that I bought yesterday is interesting."),
        ("The car she drives is very fast.", "The car which she drives is very fast."),
        ("The teacher I admire the most is Mr. Smith.", "The teacher whom I admire the most is Mr. Smith."),
    ],
)
