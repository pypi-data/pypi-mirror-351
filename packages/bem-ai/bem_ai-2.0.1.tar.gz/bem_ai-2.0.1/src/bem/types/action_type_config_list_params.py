...
__all__ = ["ActionTypeConfigListParams"]


class ActionTypeConfigListParams(TypedDict, total=False):
    ...
    `endingBefore` is an action type config ID that defines your place in the list.
    """
    ...
    `startingAfter` is an action type config ID that defines your place in the list.
    """
