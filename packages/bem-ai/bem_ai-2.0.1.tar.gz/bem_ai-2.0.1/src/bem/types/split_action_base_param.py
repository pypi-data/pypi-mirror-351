...
__all__ = ["SplitActionBaseParam"]


class SplitActionBaseParam(TypedDict, total=False):
    input_content: Required[Annotated[Union[str, Base64FileInput], PropertyInfo(alias="inputContent", format="base64")]]
    """The file content you want to split as a base64 encoded string.
...
set_pydantic_config(SplitActionBaseParam, {"arbitrary_types_allowed": True})
