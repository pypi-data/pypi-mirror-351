...
#define ECCODES_BUILD_TIMESTAMP  "20250529100137"
...
#define ECCODES_DEVELOPER_SRC_DIR "/opt/actions-runner/work/_work/python-develop-bundle/python-develop-bundle/src/eckit/src/fckit/src/eccodes"
...
#define ECCODES_Fortran_COMPILER_VERSION "14.2.0"

#define ECCODES_Fortran_COMPILER "/usr/local/bin/gfortran"
