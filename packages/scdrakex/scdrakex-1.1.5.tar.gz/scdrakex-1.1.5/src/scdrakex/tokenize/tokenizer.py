...
def get_default_gene_vocab() -> GeneVocab:
    ...
    logger.logger.info(f"Loading gene vocabulary from {vocab_file}")
...
def _build_default_gene_vocab(
    ...
    logger.logger.info(f"Building gene vocabulary from {gene_collection_file}")
