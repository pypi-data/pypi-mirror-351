...
def _render_env_file(target_dir: Path) -> None:
    ...
    # No longer needed - .env.example is included in template
    # Users should copy .env.example to .env manually
    pass
...
def _write_project_marker(target_dir: Path, project_name: str) -> None:
    ...
    # No longer needed - project detection will use alembic.ini presence
    pass
