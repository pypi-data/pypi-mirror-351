"""HTTP client for communicating with the Ruru API."""
...
class RuruClient:
    """HTTP client for the Ruru API."""

    def __init__(self, api_key: str, config: Optional[Config] = None):
        """Initialize the Ruru API client.
    ...
    def _make_request(
        ...
        Raises:
            ...
            RuruAPIError: For other API errors
        """
        ...
        try:
            with httpx.Client(
                ...
                if response.status_code == 401:
                    ...
                    error_detail = self._extract_error_detail(response)
                    raise RuruAPIError(error_detail, response.status_code)
            ...
            raise RuruAPIError(f"Request failed: {str(e)}")
    ...
    def login(self, username: str, password: str) -> Dict[str, Any]:
        ...
        # Create API key
        api_key_name = f"ruru-cli-{username}"
