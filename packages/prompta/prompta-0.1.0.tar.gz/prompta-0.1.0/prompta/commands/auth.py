"""Authentication commands for Ruru CLI."""

import click

from ..client import RuruClient
from ..config import ConfigManager
from ..exceptions import AuthenticationError, RuruAPIError
...
def init_command():
    ...
    click.echo("Enter your Ruru API key:")
    ...
    try:
        ...
        config_manager.load()
        client = RuruClient(api_key=api_key, config=config_manager.config)
...
def status_command():
    ...
    if api_key:
        ...
        click.echo("No API key found. Run 'ruru auth init' to set up authentication.")
