...
#         return "unknown"
# ── Utility: Real client IP detection ──
...
# ── Utility: Hostname resolution with Docker/IP filtering ──
def resolve_hostname(ip: str) -> str:
    try:
        if ip.startswith("10.") or ip.startswith("172.") or ip.startswith("192.168.") or ip in ["127.0.0.1", "::1"]:
