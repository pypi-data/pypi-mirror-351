...
class EgressMatrixCellDefaultArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] default_rule: Can be used only if sgacls not specified. Final Catch All Rule - Choices: `NONE`, `DENY_IP`, `PERMIT_IP`
...
class EgressMatrixCellDefault(pulumi.CustomResource):
    ...
    def get(resource_name: str,
            ...
            description: Optional[pulumi.Input[builtins.str]] = None,
            matrix_cell_status: Optional[pulumi.Input[builtins.str]] = None,
            sgacls: Optional[pulumi.Input[Sequence[pulumi.Input[builtins.str]]]] = None) -> 'EgressMatrixCellDefault':
        """
    ...
    @property
    @pulumi.getter(name="defaultRule")
    def default_rule(self) -> pulumi.Output[Optional[builtins.str]]:
        """
        Can be used only if sgacls not specified. Final Catch All Rule - Choices: `NONE`, `DENY_IP`, `PERMIT_IP`
        """
        return pulumi.get(self, "default_rule")
