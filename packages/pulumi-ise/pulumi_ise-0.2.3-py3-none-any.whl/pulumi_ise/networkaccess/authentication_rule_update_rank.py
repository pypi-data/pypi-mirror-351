...
class AuthenticationRuleUpdateRankArgs:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[builtins.str] rule_id: Authentication rule ID
        """
...
class AuthenticationRuleUpdateRank(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        super(AuthenticationRuleUpdateRank, __self__).__init__(
            'ise:networkaccess/authenticationRuleUpdateRank:AuthenticationRuleUpdateRank',
            resource_name,
            __props__,
            opts)
    ...
    def get(resource_name: str,
            ...
            policy_set_id: Optional[pulumi.Input[builtins.str]] = None,
            rank: Optional[pulumi.Input[builtins.int]] = None,
            rule_id: Optional[pulumi.Input[builtins.str]] = None) -> 'AuthenticationRuleUpdateRank':
        """
