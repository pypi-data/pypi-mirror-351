...
\\@author Aveyzan
```
in module aveytense.types_collection # to 0.3.26b3 in module tense.types
```
...
# statement since 0.3.46: ellipsis in tuple type inspection
if _sys.version_info >= (3, 9):
    # since 0.3.25, lose of dict and defaultdict support, added frozenset, renamed from SupportsAbroadPackValues (0.3.26b3)
    AbroadPackType = _types.Union[list[_T], tuple[_T, ...], _collections.deque[_T], set[_T], enumerate[_T], frozenset[_T]] 
    # since 0.3.25, renamed from SupportsAbroadVividValues (0.3.26)
    AbroadVividType = _types.Union[ 
        tuple[AbroadValue1[_V1]],
        tuple[AbroadValue1[_V1], AbroadValue2[_V2]],
        tuple[AbroadValue1[_V1], AbroadValue2[_V2], AbroadModifier[_M]]
    ]
    # AbroadInitializer = list[_T] # since 0.3.25; < 0.3.44
    AbroadMultiInitializer = list[list[_T]] # since 0.3.25
    
else:
    AbroadPackType = _types.Union[_typing.List[_T], _typing.Tuple[_T, ...], _typing.Deque[_T], _typing.Set[_T], enumerate, _typing.FrozenSet[_T]]    
    AbroadVividType = _types.Union[
        _typing.Tuple[AbroadValue1[_V1]],
        _typing.Tuple[AbroadValue1[_V1], AbroadValue2[_V2]],
        _typing.Tuple[AbroadValue1[_V1], AbroadValue2[_V2], AbroadModifier[_M]]
    ]
    AbroadMultiInitializer = _typing.List[_typing.List[_T]]
...
class _AbroadUnknownInitializer(_types.Generic[_T]):
    ...
    def __init__(self, seq: _types.Iterable[_T], v1: int, v2: int, m: int, /):
    ...
    def __repr__(self):
        ...
        return "<<'{}.{}' object :: {}> defined in line {}>".format(__module__, type(self).__name__, self.__str__(), self.__frame)
    ...
    def __add__(self, other: _types.Union[_types.Iterable[_T], _types.Self]):
        """
        \\@since 0.3.32. `self + other`
        """
        if not isinstance(other, (_types.Iterable, type(self))):
        ...
        if (isinstance(other, type(self)) and len(list(other)) == 0) or (isinstance(other, _types.Iterable) and len(other) == 0):
            return self
    ...
    def __radd__(self, other: _types.Union[_types.Iterable[_T], _types.Self]):
        """
