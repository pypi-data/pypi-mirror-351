...
class Command:
    ...
    def annotate(
        ...
        if not video_file_found:
            raise FileNotFoundError(f"Video file {video_file_path} not found in the current directory or its subdirectories.")
        ...
        # Use 'avc1' (H.264) codec for better compression if available
        ...
        while cap.isOpened():
            ...
            if frame_data.get("hand_left_landmarks") and bbox:
