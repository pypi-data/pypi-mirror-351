...
class PaymentServiceDefinitions(BaseSDK):
    def list(
        self,
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListPaymentServiceDefinitionsResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.CollectionPaymentServiceDefinition
                ),
                next=next_func,
            )
    ...
    def get(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.PaymentServiceDefinition)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.Error400Data)
            raise errors.Error400(data=response_data)
        if utils.match_response(http_res, "401", "application/json"):
    ...
    def session(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(http_res.text, models.CreateSession)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.Error400Data)
            raise errors.Error400(data=response_data)
        if utils.match_response(http_res, "401", "application/json"):
