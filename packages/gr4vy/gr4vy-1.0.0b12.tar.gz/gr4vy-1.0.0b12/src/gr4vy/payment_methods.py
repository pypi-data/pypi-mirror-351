...
from gr4vy.network_tokens import NetworkTokens
from gr4vy.payment_service_tokens import PaymentServiceTokens
...
class PaymentMethods(BaseSDK):
    payment_service_tokens: PaymentServiceTokens
    ...
    def _init_sdks(self):
        self.payment_service_tokens = PaymentServiceTokens(self.sdk_configuration)
        self.network_tokens = NetworkTokens(self.sdk_configuration)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.ListPaymentMethodsResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.CollectionPaymentMethod
                ),
                next=next_func,
            )
