...
class NetworkTokens(BaseSDK):
    ...
    def list(
        ...
        *,
    ...
    ) -> models.CollectionNoCursorNetworkToken:
        r"""List network tokens
        ...
        req = self._build_request(
            ...
            _globals=models.ListPaymentMethodNetworkTokensGlobals(
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return utils.unmarshal_json(
                http_res.text, models.CollectionNoCursorNetworkToken
            )
    ...
    def create(
        ...
        *,
        ...
        req = self._build_request(
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.CreatePaymentMethodNetworkTokenGlobals(
                merchant_account_id=self.sdk_configuration.globals.merchant_account_id,
            ),
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.network_token_create,
                False,
                False,
                "json",
        ...
        if utils.match_response(http_res, "201", "application/json"):
            return utils.unmarshal_json(http_res.text, models.NetworkToken)
        if utils.match_response(http_res, "400", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, errors.Error400Data)
            raise errors.Error400(data=response_data)
        if utils.match_response(http_res, "401", "application/json"):
    ...
    def suspend(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/payment-methods/{payment_method_id}/network-tokens/{network_token_id}/suspend",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.SuspendPaymentMethodNetworkTokenGlobals(
                merchant_account_id=self.sdk_configuration.globals.merchant_account_id,
            ),
            security=self.sdk_configuration.security,
            timeout_ms=timeout_ms,
    ...
    def resume(
        ...
        *,
        ...
        req = self._build_request(
            method="POST",
            path="/payment-methods/{payment_method_id}/network-tokens/{network_token_id}/resume",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.ResumePaymentMethodNetworkTokenGlobals(
                merchant_account_id=self.sdk_configuration.globals.merchant_account_id,
            ),
            security=self.sdk_configuration.security,
            timeout_ms=timeout_ms,
    ...
    def delete(
        ...
        *,
        ...
        req = self._build_request(
            method="DELETE",
            path="/payment-methods/{payment_method_id}/network-tokens/{network_token_id}",
            base_url=base_url,
            url_variables=url_variables,
            request=request,
            request_body_required=False,
            ...
            accept_header_value="application/json",
            http_headers=http_headers,
            _globals=models.DeletePaymentMethodNetworkTokenGlobals(
                merchant_account_id=self.sdk_configuration.globals.merchant_account_id,
            ),
            security=self.sdk_configuration.security,
            timeout_ms=timeout_ms,
