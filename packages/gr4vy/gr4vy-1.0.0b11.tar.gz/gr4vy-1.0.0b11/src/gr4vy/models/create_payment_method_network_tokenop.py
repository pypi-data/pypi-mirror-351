...
class CreatePaymentMethodNetworkTokenGlobalsTypedDict(TypedDict):
    merchant_account_id: NotRequired[str]
    r"""The ID of the merchant account to use for this request."""


class CreatePaymentMethodNetworkTokenGlobals(BaseModel):
...
class CreatePaymentMethodNetworkTokenRequest(BaseModel):
    payment_method_id: Annotated[
        str, FieldMetadata(path=PathParamMetadata(style="simple", explode=False))
    ]
    r"""The ID of the payment method"""

    network_token_create: Annotated[
        NetworkTokenCreate,
