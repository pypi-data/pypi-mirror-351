...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-events)](https://pypistats.org/packages/mypy-boto3-events)
...
`mypy-boto3-events` dependency in production. However, there is an issue in
