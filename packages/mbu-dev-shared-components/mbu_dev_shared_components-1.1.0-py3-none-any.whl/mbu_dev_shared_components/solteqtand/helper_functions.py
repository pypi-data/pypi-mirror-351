"""
Helper functions for working with SolteqTand RPA solutions.
"""
import os
import zipfile
import shutil
...
def add_black_bar_and_text_to_image(
    ...
    try:
        ...
        if image_type == 4:
            ...
            new_image.save(final_path, format="TIFF", compression="tiff_lzw")

        print(f"Saved modified image at: {final_path}")

        os.remove(copied_path)
        print(f"Deleted original file: {copied_path}")
