...
class TestShowtimes:
    ...
    def test_method_get_by_vendor_showtime_id(self, client: AtomTickets) -> None:
        showtime = client.partner.v1.venue.by_vendor_venue_id.showtimes.get_by_vendor_showtime_id(
            vendor_showtime_id="vendorShowtimeId",
            vendor_venue_id="vendorVenueId",
        )
    ...
    def test_raw_response_get_by_vendor_showtime_id(self, client: AtomTickets) -> None:
        response = client.partner.v1.venue.by_vendor_venue_id.showtimes.with_raw_response.get_by_vendor_showtime_id(
            vendor_showtime_id="vendorShowtimeId",
            vendor_venue_id="vendorVenueId",
        )
    ...
    def test_streaming_response_get_by_vendor_showtime_id(self, client: AtomTickets) -> None:
        with client.partner.v1.venue.by_vendor_venue_id.showtimes.with_streaming_response.get_by_vendor_showtime_id(
            vendor_showtime_id="vendorShowtimeId",
            vendor_venue_id="vendorVenueId",
        ) as response:
    ...
    def test_path_params_get_by_vendor_showtime_id(self, client: AtomTickets) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `vendor_venue_id` but received ''"):
            client.partner.v1.venue.by_vendor_venue_id.showtimes.with_raw_response.get_by_vendor_showtime_id(
                vendor_showtime_id="vendorShowtimeId",
                vendor_venue_id="",
            )
...
class TestAsyncShowtimes:
    ...
    async def test_method_get_by_vendor_showtime_id(self, async_client: AsyncAtomTickets) -> None:
        showtime = await async_client.partner.v1.venue.by_vendor_venue_id.showtimes.get_by_vendor_showtime_id(
            vendor_showtime_id="vendorShowtimeId",
            vendor_venue_id="vendorVenueId",
        )
        assert_matches_type(ShowtimeDetails, showtime, path=["response"])
    ...
    async def test_raw_response_get_by_vendor_showtime_id(self, async_client: AsyncAtomTickets) -> None:
        response = await async_client.partner.v1.venue.by_vendor_venue_id.showtimes.with_raw_response.get_by_vendor_showtime_id(
            vendor_showtime_id="vendorShowtimeId",
            vendor_venue_id="vendorVenueId",
        )
    ...
    async def test_streaming_response_get_by_vendor_showtime_id(self, async_client: AsyncAtomTickets) -> None:
        async with async_client.partner.v1.venue.by_vendor_venue_id.showtimes.with_streaming_response.get_by_vendor_showtime_id(
            vendor_showtime_id="vendorShowtimeId",
            vendor_venue_id="vendorVenueId",
        ) as response:
            assert not response.is_closed
    ...
    async def test_path_params_get_by_vendor_showtime_id(self, async_client: AsyncAtomTickets) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `vendor_venue_id` but received ''"):
            await (
                async_client.partner.v1.venue.by_vendor_venue_id.showtimes.with_raw_response.get_by_vendor_showtime_id(
                    vendor_showtime_id="vendorShowtimeId",
                    vendor_venue_id="",
                )
            )
