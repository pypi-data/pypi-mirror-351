...
from .....types.partner.v1.production import search_get_by_name_params
...
class SearchResource(SyncAPIResource):
    ...
    def get_by_name(
        ...
        *,
        ...
        """
        Returns productions matching a search term
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                timeout=timeout,
                query=maybe_transform({"name": name}, search_get_by_name_params.SearchGetByNameParams),
            ),
        ...
        *,
        ...
        return await self._get(
            ...
            options=make_request_options(
                ...
                extra_body=extra_body,
                timeout=timeout,
                query=await async_maybe_transform({"name": name}, search_get_by_name_params.SearchGetByNameParams),
            ),
            cast_to=ProductionDetails,
        )
