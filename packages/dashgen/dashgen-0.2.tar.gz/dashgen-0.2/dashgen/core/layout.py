...
class Column:
    ...
    def add_card(self, title, value, target, currency="R$", style=None):
        self.content.append(render_card(title, value, target, style=style, currency=currency))
        self._types.append("card")
        return self

    def add_table(self, title, data, headers, progress_columns=None):
        self.content.append(render_table(title, data, headers, progress_columns=progress_columns))
