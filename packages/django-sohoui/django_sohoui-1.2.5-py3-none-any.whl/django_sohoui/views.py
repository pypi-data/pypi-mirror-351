...
def home(request):
    ...
    name = [
        {"number": "125.12", "percent": "-12.32%", "description": "订单统计信息", "icon": "admin/img/bg1.webp"},
        {"number": "653.33", "percent": "+42.32%", "description": "月度计划信息", "icon": "admin/img/bg1.webp"},
        {"number": "125.65", "percent": "+17.32%", "description": "年度计划信息", "icon": "admin/img/bg1.webp"},
        {"number": "520.43", "percent": "-10.01%", "description": "访问统计信息", "icon": "admin/img/bg1.webp"},
    ]
