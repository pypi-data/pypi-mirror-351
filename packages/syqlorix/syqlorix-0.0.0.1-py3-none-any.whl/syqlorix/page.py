...
class Page:
    AUTO_ADD_TAGS = {
        ...
        # These are now auto-addable for direct use
        "img", "input", "br", "hr", "embed", "wbr"
    }
    RETURN_ONLY_TAGS = {
        # These must typically be children of specific parents or are compositional
        "li", "meta", "link", "base", "area", "col", "param", "source", "track", "title"
    }
    ...
    def __init__(self, title: str = ""):
        ...
        if title:
            title_element = self.title(title)
            self._head.add_child(title_element)
