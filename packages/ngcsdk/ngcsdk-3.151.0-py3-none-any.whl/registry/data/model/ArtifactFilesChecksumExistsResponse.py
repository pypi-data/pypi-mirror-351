...
from .ArtifactFileChecksumValidated import ArtifactFileChecksumValidated
...
str(repr(ArtifactFileChecksumValidated))
...
class ArtifactFilesChecksumExistsResponse(object):
    """Request to check if file exists by checksum"""
    def __init__(self, propDict=None):
        ...
        self.files = (
            ...
            else [ ArtifactFileChecksumValidated(i)
    ...
    @property
    def files(self):
        """list: An array of file checksums and checksum metadata"""
        return self._files
    ...
    def files(self, value):
        ...
        if (value is None) or isinstance(value, list):
            ...
            raise TypeError(
                'Property "files" of type "list<ArtifactFileChecksumValidated'
                '>" set to wrong type'
            )
