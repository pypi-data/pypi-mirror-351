...
from dataflow.generator.utils.Prompts import CodeCommentGeneratorPrompt as CCP
import pandas as pd
...
class CodeCommentGenerator:
    ...
    def get_desc(self, lang):
        return "给代码添加注释" if lang == "zh" else "Add comments to the code"
    ...
    def reformat_prompt(self, dataframe : pd.DataFrame):
        ...
        # use prompt
        ccp = CCP()
        inputs = [ccp.code_comment_generator_prompt(code) for code in input_list]
        return inputs
