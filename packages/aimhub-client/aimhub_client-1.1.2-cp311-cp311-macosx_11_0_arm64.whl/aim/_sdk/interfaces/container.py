...
from typing import Iterable, Iterator, TypeVar, List, Any, Optional, Tuple
...
class ContainerCollection(Iterable[ContainerType]):
    ...
    @abstractmethod
    def sparse_filter(self, expr: str) -> 'ContainerCollection[ContainerType]':
        ...

    @abstractmethod
    def limit(self, n: int) -> 'ContainerCollection[ContainerType]':
        ...

    @abstractmethod
    def offset(self, offset: Tuple[int, str]) -> 'ContainerCollection[ContainerType]':
        ...
