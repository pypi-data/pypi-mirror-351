"""
Setup script for types-boto3-cost-optimization-hub.
...
setup(
    name="types-boto3-cost-optimization-hub",
    version="1.38.25",
    packages=["types_boto3_cost_optimization_hub"],
    ...
    package_data={"types_boto3_cost_optimization_hub": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
