...
#                                   dataset_file = "PurdueShapes5-20-train.gz", 
                                   dataset_file = "PurdueShapes5-10000-train-noise-20.gz",          ## 20% noise
#                                   dataset_file = "PurdueShapes5-10000-train-noise-50.gz",         ## 50% noise
#                                   dataset_file = "PurdueShapes5-10000-train-noise-80.gz",         ## 80% noise
                                                                      )
dataserver_test = DLStudio.DetectAndLocalize.PurdueShapes5Dataset(
                                   train_or_test = 'test',
                                   dl_studio = dls,
#                                   dataset_file = "PurdueShapes5-20-test.gz"
                                   dataset_file = "PurdueShapes5-1000-test-noise-20.gz"             ## 20% noise
#                                   dataset_file = "PurdueShapes5-1000-test-noise-50.gz"            ## 50% noise
#                                   dataset_file = "PurdueShapes5-1000-test-noise-80.gz"            ## 80% noise
                                                                  )
...
#detector.run_code_for_training_with_CrossEntropy_and_BCE_Losses(model, show_images=True)
