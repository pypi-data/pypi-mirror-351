...
##  The call shown below results in the parameter 'input_size' of the nn.GRU constructor
##  to be set to 'vocab_size'. We deliberately want that because each word of the input 
##  sequence of words will be represented by a one-hot vector spanning the entire vocab.  
##  [This is merely to illustrate the shortcomings of one-hot vector input word
##  representation.]  As for the number of words in the input sequence, that will 
##  be determined by what is fed into the instance of the nn.GRU.
