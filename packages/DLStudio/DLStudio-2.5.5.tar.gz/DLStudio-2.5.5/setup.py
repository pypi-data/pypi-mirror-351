...
setup(name='DLStudio',
      ...
      url='https://engineering.purdue.edu/kak/distDLS/DLStudio-2.5.5.html',
      download_url='https://engineering.purdue.edu/kak/distDLS/DLStudio-2.5.5.tar.gz',
...
::
      ...
      classifiers=['Topic :: Scientific/Engineering', 'Programming Language :: Python :: 3.10'],
      packages=['DLStudio','AdversarialLearning','Seq2SeqLearning','DataPrediction','Transformers','MetricLearning','GenerativeDiffusion']
)
