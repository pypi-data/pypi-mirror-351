#!/usr/bin/env python
#
# uncalibrated_linearsvc documentation build configuration file, created by sphinx-quickstart.
#
...
project = "uncalibrated-linearsvc"
...
version = uncalibrated_linearsvc.__version__
# The full version, including alpha/beta/rc tags.
release = uncalibrated_linearsvc.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(uncalibrated_linearsvc.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "uncalibrated_linearsvc/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/uncalibrated-linearsvc/blob/%s/%s" % (tag, filename)
...
html_theme_options = {
    ...
    # "github_user": "maximz",
    # "github_repo": "uncalibrated-linearsvc",
    # "github_banner": True,
    # "github_type": "star",
    # "show_related": False,
    # "note_bg": "#FFF59C",
...
htmlhelp_basename = "uncalibrated_linearsvcdoc"
...
latex_documents = [
    (
        master_doc,
        "uncalibrated_linearsvc.tex",
        "uncalibrated-linearsvc Documentation",
        author,
        "manual",
    ),
]
