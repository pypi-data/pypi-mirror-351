...
class ProjectDeploymentTarget(BaseModel):
    name: StrictStr = ...
    ...
    __properties = ["name", "description", "image", "imageClasses", "format", "latencyDevice", "hasEonCompiler", "hasTensorRT", "hasTensaiFlow", "hasDRPAI", "hasTIDL", "hasAkida", "hasMemryx", "hasStAton", "hideOptimizations", "badge", "uiSection", "customDeployId", "integrateUrl", "ownerOrganizationName", "supportedEngines", "preferredEngine", "url", "docsUrl", "firmwareRepoUrl", "modelVariants", "recommendedForProject", "disabledForProject", "reasonTargetDisabled"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> ProjectDeploymentTarget:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> ProjectDeploymentTarget:
        """Create an instance of ProjectDeploymentTarget from a dict"""
        if obj is None:
            return None

        if type(obj) is not dict:
            return ProjectDeploymentTarget.construct(**obj)

        _obj = ProjectDeploymentTarget.construct(**{
            "name": obj.get("name"),
