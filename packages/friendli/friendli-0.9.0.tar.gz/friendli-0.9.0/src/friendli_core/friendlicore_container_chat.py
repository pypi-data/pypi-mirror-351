...
class BaseFriendliCoreContainerChat(BaseSDK):
    pass


class SyncFriendliCoreContainerChat(BaseFriendliCoreContainerChat, SyncSDK):
    def complete(
        self,
        *,
...
class AsyncFriendliCoreContainerChat(BaseFriendliCoreContainerChat, AsyncSDK):
    async def complete(
        self,
        *,
        messages: Union[List[models.Message], List[models.MessageTypedDict]],
