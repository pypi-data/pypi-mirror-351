...
from .platformfileslistbody import PlatformFilesListBody, PlatformFilesListBodyTypedDict


class PlatformFilesListRequestTypedDict(TypedDict):
    platform_files_list_body: PlatformFilesListBodyTypedDict
    x_friendli_team: NotRequired[Nullable[str]]
    r"""ID of team to run requests as (optional parameter)."""


class PlatformFilesListRequest(BaseModel):
    platform_files_list_body: Annotated[
