...
class PlatformFilesUploadRequestTypedDict(TypedDict):
    platform_files_upload_body: PlatformFilesUploadBodyTypedDict
    x_friendli_team: NotRequired[Nullable[str]]
    r"""ID of team to run requests as (optional parameter)."""


class PlatformFilesUploadRequest(BaseModel):
    platform_files_upload_body: Annotated[
        PlatformFilesUploadBody,
