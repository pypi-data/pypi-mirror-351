...
class BaseFriendliCoreCompletions(BaseSDK):
    pass


class SyncFriendliCoreCompletions(BaseFriendliCoreCompletions, SyncSDK):
    def complete(
        self,
        *,
...
class AsyncFriendliCoreCompletions(BaseFriendliCoreCompletions, AsyncSDK):
    async def complete(
        self,
        *,
        dedicated_completions_body: Union[
