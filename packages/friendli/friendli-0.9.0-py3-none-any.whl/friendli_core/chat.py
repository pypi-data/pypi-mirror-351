...
from friendli_core.utils import eventstreaming, get_security_from_env

from .basesdk import AsyncSDK, BaseSDK, SyncSDK


class BaseChat(BaseSDK):
    pass


class SyncChat(BaseChat, SyncSDK):
    def complete(
        self,
        *,
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.serverless_chat_completion_body,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="serverlessChatComplete",
                oauth2_scopes=[],
    ...
    def stream(
        ...
        *,
        ...
        req = self._build_request(
            ...
            security=self.sdk_configuration.security,
            get_serialized_body=lambda: utils.serialize_request_body(
                request.serverless_chat_completion_stream_body,
                False,
                False,
                "json",
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                base_url=base_url or "",
                operation_id="serverlessChatStream",
                oauth2_scopes=[],
                security_source=get_security_from_env(
                    self.sdk_configuration.security, models.Security
                ),
...
class AsyncChat(BaseChat, AsyncSDK):
    async def complete(
        self,
        *,
        messages: Union[List[models.Message], List[models.MessageTypedDict]],
