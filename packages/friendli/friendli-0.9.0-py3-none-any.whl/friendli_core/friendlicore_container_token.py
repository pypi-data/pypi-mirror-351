...
class BaseFriendliCoreContainerToken(BaseSDK):
    pass


class SyncFriendliCoreContainerToken(BaseFriendliCoreContainerToken, SyncSDK):
    def tokenization(
        self,
        *,
        prompt: str,
...
class AsyncFriendliCoreContainerToken(BaseFriendliCoreContainerToken, AsyncSDK):
