...
class BaseFriendliCoreContainerCompletions(BaseSDK):
    pass


class SyncFriendliCoreContainerCompletions(
    BaseFriendliCoreContainerCompletions, SyncSDK
):
    def complete(
        self,
        *,
...
class AsyncFriendliCoreContainerCompletions(
    BaseFriendliCoreContainerCompletions, AsyncSDK
):
    async def complete(
        self,
        *,
