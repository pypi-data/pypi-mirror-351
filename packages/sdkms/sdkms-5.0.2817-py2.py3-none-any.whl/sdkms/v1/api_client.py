...
from .models.base_enum_object import BaseEnumObject
from .models.base_list_object import BaseListObject
...
class ApiClient(object):
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None):
        ...
        self.user_agent = 'Swagger-Codegen/5.0.2817/python'
    ...
    def __call_api(self, resource_path, method,
        ...
        # query parameters
        if query_params:
            query_params = self.prepare_query_parameters(query_params)
        ...
        x_request_id = response_data.getheader("x-request-id")
        ...
        logger.info("%s, %s, X-Request-Id: %s, Status: %s, Latency: %d ms", url, method.upper(), x_request_id, response_data.status, (end_timestamp - start_timestamp))
    ...
    def sanitize_for_serialization(self, obj):
        ...
        If obj is enum, return the enumeration value
        if obj is a custom enum type (BaseEnumObject), return the enum value.
        ...
        if obj is None:
            ...
            return obj.value
        elif isinstance(obj, BaseEnumObject):
            return obj.value
        ...
        elif isinstance(obj, BaseListObject):
            return [self.sanitize_for_serialization(sub_obj)
                    for sub_obj in obj.list]
    ...
    def __deserialize(self, data, klass):
        ...
        if klass in self.PRIMITIVE_TYPES:
        ...
        elif issubclass(klass, BaseEnumObject):
            return klass(data)
        elif klass == object:
            ...
            return klass(data)
        elif issubclass(klass, bytearray):
            return klass(base64.b64decode(data))
        else:
    ...
    def call_api(self, resource_path, method,
                 path_params=None, query_params=None, header_params=None,
                 body=None, post_params=None, files=None,
                 response_type=None, auth_settings=None, async_call=None,
                 _return_http_data_only=None, collection_formats=None, _preload_content=True,
                 _request_timeout=None):
        """
        ...
        :param async_call bool: execute request asynchronously
    ...
    # query params not to have any None values.
    def prepare_query_parameters(self, query_params=None):
        params = []
                
        if query_params:
            for k, v in iteritems(query_params) if isinstance(query_params, dict) else query_params:
                if v is not None:
	                params.append((k, v))
    ...
    def __deserialize_model(self, data, klass):
        ...
        :return: model object.
        """
        if issubclass(klass, BaseListObject):
            sub_kls = klass.inner_type
            instance = klass()
            for sub_data in data:
                instance.append(self.__deserialize(sub_data, sub_kls))
            return instance
