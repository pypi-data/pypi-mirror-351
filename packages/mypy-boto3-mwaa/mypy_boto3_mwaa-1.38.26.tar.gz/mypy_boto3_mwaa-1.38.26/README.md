...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-mwaa)](https://pypistats.org/packages/mypy-boto3-mwaa)
...
`mypy-boto3-mwaa` dependency in production. However, there is an issue in
