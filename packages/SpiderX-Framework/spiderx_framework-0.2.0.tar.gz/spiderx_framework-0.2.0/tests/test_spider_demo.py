...
from src.spiderx_demo.spider_demo import SpiderDemoDouBan
from src.spiderx_framework.common_init import CommonInit

spider: SpiderDemoDouBan or None = None
DEF_CONFIG_PATH = os.path.join(Path(__file__).resolve().parent.parent, 'src', 'spiderx_demo', 'configs', 'config_def.py')
