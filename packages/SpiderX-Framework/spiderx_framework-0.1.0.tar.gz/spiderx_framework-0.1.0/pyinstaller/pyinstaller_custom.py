...
from src.spider_demo.__version__ import version
from src.spider_demo.spider_demo import DEF_CONFIG_PATH
import PyInstaller.__main__

src_path = fr'{project_dir}\src'
main_path = fr'{src_path}\spider_demo\spider_demo.py'
