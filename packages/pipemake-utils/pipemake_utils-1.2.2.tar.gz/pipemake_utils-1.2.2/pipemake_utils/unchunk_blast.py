...
def unchunkArgs():
    ...
    parser.add_argument("--chunked-blast", help = "Input file containing chunked BLAST results.", required = True)
    parser.add_argument("--unchunked-blast", help = "Output file for unchunked BLAST results.", default = "unchunked_blast.out")
...
def unchunkBlast(input_filename, output_filename): 
    with open(input_filename, 'r') as input_file, open(output_filename, 'w') as output_file:
        ...
        for input_row in input_reader:
            ...
            input_row[6] = int(input_row[6]) + input_start - 1
            input_row[7] = int(input_row[7]) + input_start - 1
