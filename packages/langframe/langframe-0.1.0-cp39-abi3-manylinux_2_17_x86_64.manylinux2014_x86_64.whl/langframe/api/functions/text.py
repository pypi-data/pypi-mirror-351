...
from langframe._backends.local.polars_plugins import ChunkCharacterSet, ChunkLengthFunction
from pydantic import ConfigDict, validate_call


@validate_call(config=ConfigDict(strict=True, arbitrary_types_allowed=True))
def extract(template: str, column: ColumnOrName) -> Column:
    """
    ...
    return Column._from_logical_expr(
        TextractExpr(template, Column._from_col_or_name(column)._logical_expr)
    )
