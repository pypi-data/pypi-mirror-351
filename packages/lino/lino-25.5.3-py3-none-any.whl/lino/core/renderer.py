...
from lino.utils.html import E, tostring, iselement, forcetext, to_rst, assert_safe
    ...
    def table2story(
        ...
        **kwargs
        ...
        if header_level is not None:
            ...
            yield format_html("<{}>{}</{}>", k, ar.get_title(), k)
...
class JsCacheRenderer(JsRenderer):
    ...
    def build_js_cache(self, force, verbosity=1):
        ...
        return settings.SITE.kernel.make_cache_file(fn, write, force, verbosity)
