...
def write_file(
        ...
        m=None, mi=None,
        c=None, ci=None,
        ma=None, mo=None, mie=None, mm=None,
        t=False, g=None,
        encoding='utf-8'):
    def _hit(*xx):
    ...
    if filepath is None or t:
        ...
        if _hit(s, b, sb):
            ...
            write_file(fp, s=s, b=b, sb=sb, g=g)
...
def iter_relative_path(src, glob=None):
    def walk(p):
    ...
    if os.path.isdir(src):
        if glob is None:
            ...
            yield from iglob(glob, root=src, file=True, relpath=None)
