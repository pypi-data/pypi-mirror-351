...
def ISAJson_encoder(id_map: Any | None, c: Component) -> IEncodable:
    ...
    def _arrow2479(value: str, id_map: Any=id_map, c: Any=c) -> IEncodable:
    ...
    def _arrow2480(oa: OntologyAnnotation, id_map: Any=id_map, c: Any=c) -> IEncodable:
        return OntologyAnnotation_ISAJson_encoder(id_map, oa)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("componentName", _arrow2479, Component__get_ComponentName(c)), try_include("componentType", _arrow2480, c.ComponentType)]))
    class ObjectExpr2481(IEncodable):
    ...
    return ObjectExpr2481()


def _arrow2483(get: IGetters) -> Component:
    name: str | None
    ...
    return Component(pattern_input_1[0], pattern_input_1[1], _arrow2482())


ISAJson_decoder: Decoder_1[Component] = object(_arrow2483)
