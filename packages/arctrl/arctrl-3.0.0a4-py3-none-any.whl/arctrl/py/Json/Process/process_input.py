...
def _arrow2626(Item: Sample) -> ProcessInput:
    return ProcessInput(1, Item)


def _arrow2627(Item_1: Source) -> ProcessInput:
    return ProcessInput(0, Item_1)


def _arrow2628(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2629(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ROCrate_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2626, ROCrate_decoder_1), map(_arrow2627, ROCrate_decoder_2), map(_arrow2628, ROCrate_decoder_3), map(_arrow2629, ROCrate_decoder_4)]))
...
def _arrow2631(Item: Source) -> ProcessInput:
    return ProcessInput(0, Item)


def _arrow2632(Item_1: Sample) -> ProcessInput:
    return ProcessInput(1, Item_1)


def _arrow2633(Item_2: Data) -> ProcessInput:
    return ProcessInput(2, Item_2)


def _arrow2634(Item_3: Material) -> ProcessInput:
    return ProcessInput(3, Item_3)


ISAJson_decoder: Decoder_1[ProcessInput] = one_of(of_array([map(_arrow2631, ISAJson_decoder_1), map(_arrow2632, ISAJson_decoder_2), map(_arrow2633, ISAJson_decoder_3), map(_arrow2634, ISAJson_decoder_4)]))
