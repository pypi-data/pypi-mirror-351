...
def _arrow1852(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1846()), ("bio", ObjectExpr1847()), ("Source", ObjectExpr1848()), ("name", ObjectExpr1849()), ("characteristics", ObjectExpr1850())])
