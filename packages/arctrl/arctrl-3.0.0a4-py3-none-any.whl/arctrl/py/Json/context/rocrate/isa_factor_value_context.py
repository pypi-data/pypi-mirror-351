...
def _arrow1684(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1673()), ("FactorValue", ObjectExpr1674()), ("additionalType", ObjectExpr1675()), ("category", ObjectExpr1676()), ("categoryName", ObjectExpr1677()), ("categoryCode", ObjectExpr1678()), ("value", ObjectExpr1679()), ("valueCode", ObjectExpr1680()), ("unit", ObjectExpr1681()), ("unitCode", ObjectExpr1682())])
