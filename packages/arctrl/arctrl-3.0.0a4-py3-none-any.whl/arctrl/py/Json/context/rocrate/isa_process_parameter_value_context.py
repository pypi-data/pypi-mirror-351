...
IContext_reflection = _expr1791

def _arrow1802(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1792()), ("additionalType", ObjectExpr1793()), ("ProcessParameterValue", ObjectExpr1794()), ("category", ObjectExpr1795()), ("categoryCode", ObjectExpr1796()), ("value", ObjectExpr1797()), ("valueCode", ObjectExpr1798()), ("unit", ObjectExpr1799()), ("unitCode", ObjectExpr1800())])
...
context_jsonvalue: IEncodable = _arrow1802()
