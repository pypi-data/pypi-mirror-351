...
IContext_reflection = _expr1756

def _arrow1771(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1757()), ("Person", ObjectExpr1758()), ("orcid", ObjectExpr1759()), ("firstName", ObjectExpr1760()), ("lastName", ObjectExpr1761()), ("midInitials", ObjectExpr1762()), ("email", ObjectExpr1763()), ("address", ObjectExpr1764()), ("phone", ObjectExpr1765()), ("fax", ObjectExpr1766()), ("comments", ObjectExpr1767()), ("roles", ObjectExpr1768()), ("affiliation", ObjectExpr1769())])
...
context_jsonvalue: IEncodable = _arrow1771()
...
def _arrow1776(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1772()), ("Person", ObjectExpr1773()), ("name", ObjectExpr1774())])
...
context_minimal_json_value: IEncodable = _arrow1776()
