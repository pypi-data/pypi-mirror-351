...
IContext_reflection = _expr1750

def _arrow1755(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1751()), ("Organization", ObjectExpr1752()), ("name", ObjectExpr1753())])
...
context_jsonvalue: IEncodable = _arrow1755()
