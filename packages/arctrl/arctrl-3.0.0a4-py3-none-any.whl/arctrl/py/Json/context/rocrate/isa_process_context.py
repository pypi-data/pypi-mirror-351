...
IContext_reflection = _expr1777

def _arrow1790(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1778()), ("bio", ObjectExpr1779()), ("Process", ObjectExpr1780()), ("name", ObjectExpr1781()), ("executesProtocol", ObjectExpr1782()), ("parameterValues", ObjectExpr1783()), ("performer", ObjectExpr1784()), ("date", ObjectExpr1785()), ("inputs", ObjectExpr1786()), ("outputs", ObjectExpr1787()), ("comments", ObjectExpr1788())])
...
context_jsonvalue: IEncodable = _arrow1790()
