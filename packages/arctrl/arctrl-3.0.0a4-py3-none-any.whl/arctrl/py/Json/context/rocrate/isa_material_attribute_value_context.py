...
def _arrow1721(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1711()), ("MaterialAttributeValue", ObjectExpr1712()), ("additionalType", ObjectExpr1713()), ("category", ObjectExpr1714()), ("categoryCode", ObjectExpr1715()), ("value", ObjectExpr1716()), ("valueCode", ObjectExpr1717()), ("unit", ObjectExpr1718()), ("unitCode", ObjectExpr1719())])
