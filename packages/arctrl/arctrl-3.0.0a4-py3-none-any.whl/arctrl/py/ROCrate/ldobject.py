...
LDRef_reflection = _expr1451

def LDRef__ctor_Z721C83C5(id: str) -> LDRef:
    return LDRef(id)


def _expr1456() -> TypeInfo:
...
class LDGraph(DynamicObj):
    ...
    def TryGetNode(self, id: str) -> LDNode | None:
        ...
        out_arg: LDNode = None
        def _arrow1452(__unit: None=None) -> LDNode:
            return out_arg

        def _arrow1453(v: LDNode) -> None:
            nonlocal out_arg
            out_arg = v

        match_value = (try_get_value(this.mappings, id, FSharpRef(_arrow1452, _arrow1453)), out_arg)
    ...
    def set_context(context: LDContext) -> Callable[[__G], None]:
        def _arrow1454(roc: __G | None=None) -> None:
    ...
    def try_get_context(__unit: None=None) -> Callable[[__F], LDContext | None]:
        def _arrow1455(roc: __F | None=None) -> LDContext | None:
...
class LDNode(DynamicObj):
    ...
    def GetPropertyValues(self, property_name: str, filter: Callable[[Any, LDContext | None], bool] | None=None, context: LDContext | None=None) -> Array[Any]:
        this: LDNode = self
        def _arrow1458(_arg: Any=None) -> Callable[[LDContext | None], bool]:
            def _arrow1457(_arg_1: LDContext | None=None) -> bool:
                return True

            return _arrow1457

        filter_1: Callable[[Any, LDContext | None], bool] = default_arg(map(curry2, filter), _arrow1458)
        match_value: Any | None = this.TryGetProperty(property_name, context)
        ...
        if pattern_matching_result == 0:
            ...
            en: IEnumerator[Any] = get_enumerator(e)
            def _arrow1461(__unit: None=None) -> IEnumerable_1[Any]:
                def _arrow1459(__unit: None=None) -> bool:
                    return en.System_Collections_IEnumerator_MoveNext()

                def _arrow1460(__unit: None=None) -> IEnumerable_1[Any]:
                ...
                return enumerate_while(_arrow1459, delay(_arrow1460))

            return list(to_list(delay(_arrow1461)))
    ...
    def TryGetPropertyAsSingleNode(self, property_name: str, graph: LDGraph | None=None, context: LDContext | None=None) -> LDNode | None:
        ...
        if match_value is not None:
            if isinstance(value_3(match_value), LDNode):
                ...
                def _arrow1462(__unit: None=None) -> bool:
            ...
            if pattern_matching_result == 0:
                ...
                if match_value is None:
                    ...
                    if filter is None:
                        ...
                        def _arrow1463(f: Callable[[LDNode, LDContext | None], bool], o: Any=o) -> Callable[[LDNode, LDContext | None], bool]:
                            return curry2(f)

                        f_1: Callable[[LDNode, LDContext | None], bool] = map(_arrow1463, filter)
                        return n
                ...
                if filter is None:
                    ...
                    def _arrow1464(f: Callable[[LDNode, LDContext | None], bool], o: Any=o) -> Callable[[LDNode, LDContext | None], bool]:
                        return curry2(f)

                    f_3: Callable[[LDNode, LDContext | None], bool] = map(_arrow1464, filter)
                    return n_1
    ...
    def HasProperty(self, property_name: str, context: LDContext | None=None) -> bool:
        ...
        def _arrow1465(__unit: None=None) -> bool:
            v_2: Any = value_3(v)
            return False

        def _arrow1466(__unit: None=None) -> bool:
            e: IEnumerable[Any] = value_3(v)
            return get_enumerator(e).System_Collections_IEnumerator_MoveNext()

        return (_arrow1465() if equals(value_3(v), None) else (_arrow1466() if is_iterable(value_3(v)) else True)) if (v is not None) else False
    ...
    def set_context(context: LDContext) -> Callable[[__C], None]:
        def _arrow1467(roc: __C | None=None) -> None:
            roc.SetContext(context)
    ...
    def try_get_context(__unit: None=None) -> Callable[[__B], LDContext | None]:
        def _arrow1468(roc: __B | None=None) -> LDContext | None:
            return roc.TryGetContext()
    ...
    def MergeAppendInto_InPlace(self, other: LDNode, flatten_to: LDGraph | None=None) -> None:
        ...
        if flatten_to is None:
            def _arrow1469(x: Any=None) -> Any:
                return x

            flatten_to_singleton = _arrow1469
        ...
        if flatten_to is None:
            def _arrow1470(x_1: Array[Any]) -> Array[Any]:
                return x_1

            flatten_to_ra = _arrow1470

        else: 
            graph_1: LDGraph = flatten_to
            def _arrow1471(a: Array[Any]) -> Array[Any]:
                return ResizeArray_map(flatten_to_singleton, a)

            flatten_to_ra = _arrow1471

        flatten_to_any: Callable[[Any], Any]
        if flatten_to is None:
            def _arrow1472(x_2: Any=None) -> Any:
                return x_2

            flatten_to_any = _arrow1472
            ...
            def f_2(o_1: Any=None) -> Any:
                if isinstance(o_1, LDNode):
                    ...
                    if active_pattern_result is not None:
                        ...
                        def _arrow1476(__unit: None=None, o_1: Any=o_1) -> IEnumerable_1[Any]:
                            def _arrow1473(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(e)

                            def _arrow1474(enumerator: IEnumerator[Any]) -> bool:
                                return enumerator.System_Collections_IEnumerator_MoveNext()

                            def _arrow1475(enumerator_1: IEnumerator[Any]) -> Any:
                                return enumerator_1.System_Collections_IEnumerator_get_Current()

                            return map_1(f_2, enumerate_from_functions(_arrow1473, _arrow1474, _arrow1475))

                        return list(to_list(delay(_arrow1476)))
        ...
        def action(pn: str) -> None:
            ...
            if match_value is None:
                ...
                if pattern_matching_result == 0:
                    def _arrow1486(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                        def _arrow1477(v_1: Any=None) -> Any:
                            return v_1

                        def _arrow1478(__unit: None=None) -> IEnumerator[Any]:
                            return get_enumerator(e2)

                        def _arrow1479(enumerator_2: IEnumerator[Any]) -> bool:
                            return enumerator_2.System_Collections_IEnumerator_MoveNext()

                        def _arrow1480(enumerator_3: IEnumerator[Any]) -> Any:
                            return enumerator_3.System_Collections_IEnumerator_get_Current()

                        def _arrow1485(__unit: None=None) -> IEnumerable_1[Any]:
                            def _arrow1481(v_2: Any=None) -> Any:
                                return v_2

                            def _arrow1482(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(e1)

                            def _arrow1483(enumerator_4: IEnumerator[Any]) -> bool:
                                return enumerator_4.System_Collections_IEnumerator_MoveNext()

                            def _arrow1484(enumerator_5: IEnumerator[Any]) -> Any:
                                return enumerator_5.System_Collections_IEnumerator_get_Current()

                            return map_1(_arrow1481, enumerate_from_functions(_arrow1482, _arrow1483, _arrow1484))

                        return append(map_1(_arrow1477, enumerate_from_functions(_arrow1478, _arrow1479, _arrow1480)), delay(_arrow1485))

                    class ObjectExpr1487:
                        @property
                    ...
                    l: Array[Any] = flatten_to_ra(list(List_distinctBy(to_equalitor, to_list(delay(_arrow1486)), ObjectExpr1487())))
                    ...
                    if active_pattern_result_3 is not None:
                        ...
                        def _arrow1492(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                            def _arrow1488(this_val_1: Any=None) -> IEnumerable_1[Any]:
                            ...
                            def _arrow1489(__unit: None=None) -> IEnumerator[Any]:
                                return get_enumerator(these_vals)

                            def _arrow1490(enumerator_6: IEnumerator[Any]) -> bool:
                                return enumerator_6.System_Collections_IEnumerator_MoveNext()

                            def _arrow1491(enumerator_7: IEnumerator[Any]) -> Any:
                                return enumerator_7.System_Collections_IEnumerator_get_Current()

                            return collect(_arrow1488, enumerate_from_functions(_arrow1489, _arrow1490, _arrow1491))

                        l_1: Array[Any] = list(to_list(delay(_arrow1492)))
                        if not is_contained:
                        ...
                        if active_pattern_result_4 is not None:
                            ...
                            def _arrow1499(__unit: None=None, pn: Any=pn) -> IEnumerable_1[Any]:
                                def _arrow1495(other_val_2: Any=None) -> IEnumerable_1[Any]:
                                    def _expr1493():
                                        nonlocal is_contained_1
                                        is_contained_1 = True
                                        return empty()

                                    def _arrow1494(__unit: None=None) -> IEnumerable_1[Any]:
                                        return singleton_2(other_val_2)

                                    return append(_expr1493() if equals(to_equalitor(this_val), to_equalitor(other_val_2)) else empty(), delay(_arrow1494))

                                def _arrow1496(__unit: None=None) -> IEnumerator[Any]:
                                    return get_enumerator(other_vals)

                                def _arrow1497(enumerator_8: IEnumerator[Any]) -> bool:
                                    return enumerator_8.System_Collections_IEnumerator_MoveNext()

                                def _arrow1498(enumerator_9: IEnumerator[Any]) -> Any:
                                    return enumerator_9.System_Collections_IEnumerator_get_Current()

                                return collect(_arrow1495, enumerate_from_functions(_arrow1496, _arrow1497, _arrow1498))

                            l_2: Array[Any] = list(to_list(delay(_arrow1499)))
    ...
    def Compact_InPlace(self, context: LDContext | None=None, set_context: bool | None=None) -> None:
        ...
        if context_1 is not None:
            ...
            def _arrow1501(__unit: None=None) -> IEnumerable_1[str]:
                def _arrow1500(st: str) -> IEnumerable_1[str]:
                    match_value: str | None = context_2.TryGetTerm(st)
                    return singleton_2(st) if (match_value is None) else singleton_2(match_value)

                return collect(_arrow1500, this.SchemaType)

            new_types: Array[str] = list(to_list(delay(_arrow1501)))
        ...
        def compact_value_in_place(o: Any=None) -> Any:
            ...
            if pattern_matching_result == 0:
                ...
                en: IEnumerator[Any] = get_enumerator(e)
                def _arrow1504(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow1502(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow1503(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(compact_value_in_place(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow1502, delay(_arrow1503))

                l: Array[Any] = list(to_list(delay(_arrow1504)))
                if len(l) == 1:
                    return l[0]
    ...
    def Flatten(self, graph: LDGraph | None=None) -> LDGraph:
        ...
        def flatten_value(o: Any=None) -> Any:
            if isinstance(o, LDNode):
                ...
                def _arrow1507(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow1505(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow1506(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(flatten_value(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow1505, delay(_arrow1506))

                return list(to_list(delay(_arrow1507)))
    ...
    def Unflatten(self, graph: LDGraph) -> None:
        ...
        def unflatten_value(o: Any=None) -> Any:
            if isinstance(o, LDRef):
                ...
                en: IEnumerator[Any] = get_enumerator(o)
                def _arrow1510(__unit: None=None, o: Any=o) -> IEnumerable_1[Any]:
                    def _arrow1508(__unit: None=None) -> bool:
                        return en.System_Collections_IEnumerator_MoveNext()

                    def _arrow1509(__unit: None=None) -> IEnumerable_1[Any]:
                        return singleton_2(unflatten_value(en.System_Collections_IEnumerator_get_Current()))

                    return enumerate_while(_arrow1508, delay(_arrow1509))

                return list(to_list(delay(_arrow1510)))
    ...
    def remove_context(__unit: None=None) -> Callable[[__A], bool]:
        def _arrow1511(roc: __A | None=None) -> bool:
    ...
    def try_from_dynamic_obj(dyn_obj: DynamicObj) -> LDNode | None:
        ...
        if pattern_matching_result_1 == 0:
            def _arrow1512(__unit: None=None) -> Array[str] | None:
            ...
            roc: LDNode = LDNode(id, st, _arrow1512())
