...
from ...Json.encode import try_include_list
from ...Json.Process.material import ISAJson_encoder as ISAJson_encoder_2
from ...Json.Process.sample import ISAJson_encoder as ISAJson_encoder_1
from ...Json.Process.source import ISAJson_encoder
...
def encoder(id_map: Any | None, ps: FSharpList[Process]) -> IEncodable:
    ...
    def _arrow3546(oa: Source, id_map: Any=id_map, ps: Any=ps) -> IEncodable:
        return ISAJson_encoder(id_map, oa)

    def _arrow3547(oa_1: Sample, id_map: Any=id_map, ps: Any=ps) -> IEncodable:
        return ISAJson_encoder_1(id_map, oa_1)

    def _arrow3548(c: Material, id_map: Any=id_map, ps: Any=ps) -> IEncodable:
        return ISAJson_encoder_2(id_map, c)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include_list("sources", _arrow3546, source), try_include_list("samples", _arrow3547, samples), try_include_list("otherMaterials", _arrow3548, materials)]))
    class ObjectExpr3549(IEncodable):
