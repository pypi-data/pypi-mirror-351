...
from ...fable_modules.fable_library.date import (year, month, day, hour, minute, second)
from ...fable_modules.fable_library.option import value as value_1
from ...fable_modules.fable_library.seq import fold as fold_1
from ...fable_modules.fable_library.types import Array
from ...fable_modules.fable_library.util import (identity_hash, number_hash, IEnumerable_1)
...
def box_hash_option(a: Any | None=None) -> Any:
    def _arrow510(__unit: None=None, a: Any=a) -> int:
        copy_of_struct: _A = value_1(a)
        return identity_hash(copy_of_struct)

    def _arrow511(__unit: None=None, a: Any=a) -> int:
        copy_of_struct_1: int = 0
        return number_hash(copy_of_struct_1)

    return _arrow510() if (a is not None) else _arrow511()
...
__all__ = ["merge_hashes", "hash_date_time", "hash_1", "box_hash_option", "box_hash_array", "box_hash_seq"]
