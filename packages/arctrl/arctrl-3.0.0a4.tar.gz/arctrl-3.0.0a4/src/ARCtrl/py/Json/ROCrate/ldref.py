...
def _arrow1896(decoders: IGetters) -> LDRef:
    def _arrow1895(__unit: None=None) -> str:
        object_arg: IRequiredGetter = decoders.Required
        return object_arg.Field("@id", string)

    return LDRef(_arrow1895())


decoder: Decoder_1[LDRef] = object(_arrow1896)

def encoder(r: LDRef) -> IEncodable:
    def _arrow1898(__unit: None=None, r: Any=r) -> IEncodable:
        value: str = r.Id
    ...
    values: FSharpList[tuple[str, IEncodable]] = singleton(("@id", _arrow1898()))
