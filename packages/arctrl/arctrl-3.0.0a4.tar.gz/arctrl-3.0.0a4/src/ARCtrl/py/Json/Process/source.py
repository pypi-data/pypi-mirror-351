...
def ROCrate_encoder(oa: Source) -> IEncodable:
    ...
    def _arrow2592(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2596(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2592()), ("@type", list_1_1(singleton(ObjectExpr2593()))), ("additionalType", ObjectExpr2594()), try_include("name", _arrow2596, oa.Name), try_include_list_opt("characteristics", ROCrate_encoder_1, oa.Characteristics), ("@context", context_jsonvalue)]))
...
def _arrow2601(get: IGetters) -> Source:
    ...
    def _arrow2598(__unit: None=None) -> str | None:
    ...
    def _arrow2600(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
    ...
    return Source(_arrow2598(), _arrow2599(), _arrow2600())


ROCrate_decoder: Decoder_1[Source] = object(_arrow2601)
...
def ISAJson_encoder(id_map: Any | None, oa: Source) -> IEncodable:
    def f(oa_1: Source, id_map: Any=id_map, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2605(value: str, oa_1: Any=oa_1) -> IEncodable:
        ...
        def _arrow2607(value_2: str, oa_1: Any=oa_1) -> IEncodable:
            class ObjectExpr2606(IEncodable):
                def Encode(self, helpers_1: IEncoderHelpers_1[Any]) -> Any:
                    return helpers_1.encode_string(value_2)

            return ObjectExpr2606()

        def _arrow2608(oa_2: MaterialAttributeValue, oa_1: Any=oa_1) -> IEncodable:
            return ISAJson_encoder_1(id_map, oa_2)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2605, ROCrate_genID(oa_1)), try_include("name", _arrow2607, oa_1.Name), try_include_list_opt("characteristics", _arrow2608, oa_1.Characteristics)]))
    ...
    if id_map is not None:
        def _arrow2610(s_1: Source, id_map: Any=id_map, oa: Any=oa) -> str:
            return ROCrate_genID(s_1)

        return encode(_arrow2610, f, oa, id_map)
...
def _arrow2614(get: IGetters) -> Source:
    def _arrow2611(__unit: None=None) -> str | None:
        object_arg: IOptionalGetter = get.Optional
        return object_arg.Field("@id", Decode_uri)

    def _arrow2612(__unit: None=None) -> str | None:
    ...
    return Source(_arrow2611(), _arrow2612(), _arrow2613())


ISAJson_decoder: Decoder_1[Source] = Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2614)
