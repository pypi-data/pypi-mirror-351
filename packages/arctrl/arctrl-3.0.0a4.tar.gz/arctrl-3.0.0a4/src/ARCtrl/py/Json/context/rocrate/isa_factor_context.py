...
def _arrow1671(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1663()), ("Factor", ObjectExpr1664()), ("factorName", ObjectExpr1665()), ("annotationValue", ObjectExpr1666()), ("termSource", ObjectExpr1667()), ("termAccession", ObjectExpr1668()), ("comments", ObjectExpr1669())])
...
context_jsonvalue: IEncodable = _arrow1671()
