...
def ROCrate_encoder(oa: Material) -> IEncodable:
    ...
    def _arrow2557(__unit: None=None, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2561(value_3: str, oa: Any=oa) -> IEncodable:
    ...
    def _arrow2562(value_5: MaterialType, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder_1(value_5)

    def _arrow2563(oa_1: Material, oa: Any=oa) -> IEncodable:
        return ROCrate_encoder(oa_1)

    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2557()), ("@type", list_1_1(singleton(ObjectExpr2558()))), ("additionalType", ObjectExpr2559()), try_include("name", _arrow2561, oa.Name), try_include("type", _arrow2562, oa.MaterialType), try_include_list_opt("characteristics", ROCrate_encoder_2, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2563, oa.DerivesFrom), ("@context", context_jsonvalue)]))
    class ObjectExpr2564(IEncodable):
    ...
    return ObjectExpr2564()


def _arrow2571(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2570(get: IGetters) -> Material:
            ...
            def _arrow2565(__unit: None=None) -> str | None:
            ...
            def _arrow2567(__unit: None=None) -> MaterialType | None:
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("type", ROCrate_decoder_1)

            def _arrow2568(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2569(__unit: None=None) -> FSharpList[Material] | None:
                arg_13: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_6: IOptionalGetter = get.Optional
                return object_arg_6.Field("derivesFrom", arg_13)

            return Material(_arrow2565(), _arrow2566(), _arrow2567(), _arrow2568(), _arrow2569())

        return object(_arrow2570)

    return decode(None)


ROCrate_decoder: Decoder_1[Material] = _arrow2571()
...
def ISAJson_encoder(id_map: Any | None, c: Material) -> IEncodable:
    def f(oa: Material, id_map: Any=id_map, c: Any=c) -> IEncodable:
        ...
        def _arrow2575(value: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2577(value_2: str, oa: Any=oa) -> IEncodable:
        ...
        def _arrow2578(oa_1: MaterialAttributeValue, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder_2(id_map, oa_1)

        def _arrow2579(c_1: Material, oa: Any=oa) -> IEncodable:
            return ISAJson_encoder(id_map, c_1)

        values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([try_include("@id", _arrow2575, ROCrate_genID(oa)), try_include("name", _arrow2577, oa.Name), try_include("type", ISAJson_encoder_1, oa.MaterialType), try_include_list_opt("characteristics", _arrow2578, oa.Characteristics), try_include_list_opt("derivesFrom", _arrow2579, oa.DerivesFrom)]))
    ...
    if id_map is not None:
        def _arrow2581(m_1: Material, id_map: Any=id_map, c: Any=c) -> str:
            return ROCrate_genID(m_1)

        return encode(_arrow2581, f, c, id_map)
...
def _arrow2588(__unit: None=None) -> Decoder_1[Material]:
    def decode(__unit: None=None) -> Decoder_1[Material]:
        def _arrow2587(get: IGetters) -> Material:
            def _arrow2582(__unit: None=None) -> str | None:
                object_arg: IOptionalGetter = get.Optional
                return object_arg.Field("@id", Decode_uri)

            def _arrow2583(__unit: None=None) -> str | None:
                object_arg_1: IOptionalGetter = get.Optional
                return object_arg_1.Field("name", string)

            def _arrow2584(__unit: None=None) -> MaterialType | None:
                object_arg_2: IOptionalGetter = get.Optional
                return object_arg_2.Field("type", ISAJson_decoder_1)

            def _arrow2585(__unit: None=None) -> FSharpList[MaterialAttributeValue] | None:
            ...
            def _arrow2586(__unit: None=None) -> FSharpList[Material] | None:
                arg_9: Decoder_1[FSharpList[Material]] = list_1_2(decode(None))
                object_arg_4: IOptionalGetter = get.Optional
                return object_arg_4.Field("derivesFrom", arg_9)

            return Material(_arrow2582(), _arrow2583(), _arrow2584(), _arrow2585(), _arrow2586())

        return Decode_objectNoAdditionalProperties(ISAJson_allowedFields, _arrow2587)

    return decode(None)


ISAJson_decoder: Decoder_1[Material] = _arrow2588()
