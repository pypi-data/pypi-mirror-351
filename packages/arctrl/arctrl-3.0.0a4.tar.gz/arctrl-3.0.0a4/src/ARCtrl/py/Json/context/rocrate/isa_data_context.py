...
IContext_reflection = _expr1652

def _arrow1661(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1653()), ("Data", ObjectExpr1654()), ("type", ObjectExpr1655()), ("encodingFormat", ObjectExpr1656()), ("usageInfo", ObjectExpr1657()), ("name", ObjectExpr1658()), ("comments", ObjectExpr1659())])
...
context_jsonvalue: IEncodable = _arrow1661()
