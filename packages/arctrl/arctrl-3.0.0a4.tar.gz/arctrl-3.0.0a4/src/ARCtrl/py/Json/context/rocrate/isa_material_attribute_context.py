...
def _arrow1709(__unit: None=None) -> IEncodable:
    ...
    values: IEnumerable_1[tuple[str, IEncodable]] = to_enumerable([("sdo", ObjectExpr1703()), ("arc", ObjectExpr1704()), ("MaterialAttribute", ObjectExpr1705()), ("ArcMaterialAttribute", ObjectExpr1706()), ("characteristicType", ObjectExpr1707())])
...
context_jsonvalue: IEncodable = _arrow1709()
