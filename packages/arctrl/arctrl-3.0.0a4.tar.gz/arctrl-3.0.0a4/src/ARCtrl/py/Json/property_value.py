...
def encoder(pv: IPropertyValue) -> IEncodable:
    ...
    if match_value_1 is None:
        ...
        if v.tag == 1:
            ...
            pattern_input_1 = (ObjectExpr2087(), None)

        elif v.tag == 0:
            oa_1: OntologyAnnotation = v.fields[0]
            def _arrow2089(value_3: str, pv: Any=pv) -> IEncodable:
            ...
            def _arrow2091(value_5: str, pv: Any=pv) -> IEncodable:
            ...
            pattern_input_1 = (map(_arrow2089, oa_1.Name), map(_arrow2091, oa_1.TermAccessionNumber))
            ...
            pattern_input_1 = (ObjectExpr2092(), None)
    ...
    def _arrow2096(__unit: None=None, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2099(__unit: None=None, pv: Any=pv) -> IEncodable:
        value_10: str = pv.GetAdditionalType()
        class ObjectExpr2098(IEncodable):
            def Encode(self, helpers_7: IEncoderHelpers_1[Any]) -> Any:
                return helpers_7.encode_string(value_10)

        return ObjectExpr2098()

    def _arrow2101(value_11: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2103(value_13: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2105(value_15: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2107(value_17: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2109(value_19: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2110(x: IEncodable, pv: Any=pv) -> IEncodable:
        return x

    def _arrow2111(x_1: IEncodable, pv: Any=pv) -> IEncodable:
        return x_1

    def _arrow2113(value_21: str, pv: Any=pv) -> IEncodable:
    ...
    def _arrow2115(value_23: str, pv: Any=pv) -> IEncodable:
    ...
    values: FSharpList[tuple[str, IEncodable]] = choose(chooser, of_array([("@id", _arrow2096()), ("@type", ObjectExpr2097()), ("additionalType", _arrow2099()), try_include("alternateName", _arrow2101, pv.AlternateName()), try_include("measurementMethod", _arrow2103, pv.MeasurementMethod()), try_include("description", _arrow2105, pv.Description()), try_include("category", _arrow2107, pattern_input[0]), try_include("categoryCode", _arrow2109, pattern_input[1]), try_include("value", _arrow2110, pattern_input_1[0]), try_include("valueCode", _arrow2111, pattern_input_1[1]), try_include("unit", _arrow2113, pattern_input_2[0]), try_include("unitCode", _arrow2115, pattern_input_2[1]), ("@context", context_jsonvalue)]))
...
def decoder(create: Callable[[str | None, str | None, str | None, OntologyAnnotation | None, Value_4 | None, OntologyAnnotation | None], _T]) -> Decoder_1[Any]:
    def _arrow2118(get: IGetters, create: Any=create) -> _T:
        ...
        def _arrow2117(__unit: None=None) -> Value_4 | None:
            value: str | None
        ...
        return create(alternate_name, measurement_method, description, category, _arrow2117(), unit)

    return object(_arrow2118)
