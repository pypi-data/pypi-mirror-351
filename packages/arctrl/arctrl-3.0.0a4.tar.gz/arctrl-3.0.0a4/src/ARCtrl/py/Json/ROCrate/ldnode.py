...
def generic_encoder(obj: Any=None) -> IEncodable:
    if str(type(obj)) == "<class \'str\'>":
        ...
        return ObjectExpr1926()

    elif is_iterable(obj):
        def _arrow1930(__unit: None=None, obj: Any=obj) -> IEnumerable_1[IEncodable]:
            def _arrow1927(__unit: None=None) -> IEnumerator[Any]:
                return get_enumerator(obj)

            def _arrow1928(enumerator: IEnumerator[Any]) -> bool:
                return enumerator.System_Collections_IEnumerator_MoveNext()

            def _arrow1929(enumerator_1: IEnumerator[Any]) -> Any:
                return enumerator_1.System_Collections_IEnumerator_get_Current()

            return map(generic_encoder, enumerate_from_functions(_arrow1927, _arrow1928, _arrow1929))

        return list_1(to_list(delay(_arrow1930)))
...
def encoder(obj: LDNode) -> IEncodable:
    def _arrow1943(__unit: None=None, obj: Any=obj) -> IEnumerable_1[tuple[str, IEncodable]]:
        def _arrow1932(__unit: None=None) -> IEncodable:
            value: str = obj.Id
        ...
        def _arrow1942(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
            def _arrow1934(value_1: str) -> IEncodable:
            ...
            def _arrow1941(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                def _arrow1936(value_3: str) -> IEncodable:
                ...
                def _arrow1940(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                    def _arrow1937(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                    ...
                    def _arrow1939(__unit: None=None) -> IEnumerable_1[tuple[str, IEncodable]]:
                        def _arrow1938(kv: Any) -> IEnumerable_1[tuple[str, IEncodable]]:
                            l: str = kv[0].lower()
                        ...
                        return collect(_arrow1938, obj.GetProperties(True))

                    return append(_arrow1937(), delay(_arrow1939))

                return append(singleton(("additionalType", resize_array_or_singleton(_arrow1936, obj.AdditionalType))) if (len(obj.AdditionalType) != 0) else empty(), delay(_arrow1940))

            return append(singleton(("@type", resize_array_or_singleton(_arrow1934, obj.SchemaType))), delay(_arrow1941))

        return append(singleton(("@id", _arrow1932())), delay(_arrow1942))

    values: FSharpList[tuple[str, IEncodable]] = to_list(delay(_arrow1943))
...
def get_decoder(expect_object: bool) -> Decoder_1[Any]:
    def decode(expect_object_1: bool, expect_object: Any=expect_object) -> Decoder_1[Any]:
        class ObjectExpr1947(Decoder_1[LDNode]):
        ...
        decode_object: Decoder_1[LDNode] = ObjectExpr1947()
        class ObjectExpr1949(Decoder_1[Array[Any]]):
                    ...
                    def folder(acc: FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]], value_2: __A_) -> FSharpResult_2[Array[Any], tuple[str, ErrorReason_1[__A_]]]:
                        ...
                        if acc.tag == 0:
                            ...
                            if match_value_1.tag == 0:
                                ...
                                def _arrow1948(__unit: None=None, acc: Any=acc, value_2: Any=value_2) -> tuple[str, ErrorReason_1[__A_]]:
                                ...
                                return FSharpResult_2(1, _arrow1948())
        ...
        resize_array: Decoder_1[Array[Any]] = ObjectExpr1949()
        if expect_object_1:
            def _arrow1950(value_4: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_4

            return map_1(_arrow1950, decode_object)

        else: 
            def _arrow1952(value_5: LDValue, expect_object_1: Any=expect_object_1) -> Any:
                return value_5

            def _arrow1953(value_6: LDNode, expect_object_1: Any=expect_object_1) -> Any:
                return value_6

            def _arrow1954(value_7: LDRef, expect_object_1: Any=expect_object_1) -> Any:
                return value_7

            def _arrow1955(value_8: Array[Any], expect_object_1: Any=expect_object_1) -> Any:
                return value_8

            def _arrow1956(value_9: str, expect_object_1: Any=expect_object_1) -> Any:
                return value_9

            def _arrow1957(value_10: int, expect_object_1: Any=expect_object_1) -> Any:
                return value_10

            def _arrow1958(value_11: Decimal, expect_object_1: Any=expect_object_1) -> Any:
                return value_11

            return one_of(of_array([map_1(_arrow1952, decoder_2), map_1(_arrow1953, decode_object), map_1(_arrow1954, decoder_3), map_1(_arrow1955, resize_array), map_1(_arrow1956, string), map_1(_arrow1957, int_1), map_1(_arrow1958, decimal)]))


    return decode(expect_object)


def _arrow1959(value: Any=None) -> LDNode:
    return value


decoder: Decoder_1[LDNode] = map_1(_arrow1959, get_decoder(True))
