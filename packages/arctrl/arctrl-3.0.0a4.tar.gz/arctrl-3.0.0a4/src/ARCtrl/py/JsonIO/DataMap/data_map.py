...
from ...Json.DataMap.data_context import (encoder as encoder_1, decoder as decoder_1)
...
def encoder(dm: DataMap) -> IEncodable:
    ...
    class ObjectExpr3565(IEncodable):
    ...
    return ObjectExpr3565()


def _arrow3567(get: IGetters) -> DataMap:
    def _arrow3566(__unit: None=None) -> Array[DataContext]:
        arg_1: Decoder_1[Array[DataContext]] = resize_array(decoder_1)
        object_arg: IRequiredGetter = get.Required
        return object_arg.Field("dataContexts", arg_1)

    return DataMap__ctor_4E3220A7(_arrow3566())


decoder: Decoder_1[DataMap] = object(_arrow3567)
