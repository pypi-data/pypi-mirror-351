...
from ...Json.Process.factor_value import (ISAJson_decoder, ISAJson_encoder)
...
def ARCtrl_Process_FactorValue__FactorValue_toISAJsonString_Static_Z3B036AA(spaces: int | None=None, use_idreferencing: bool | None=None) -> Callable[[FactorValue], str]:
    ...
    def _arrow3519(f: FactorValue, spaces: Any=spaces, use_idreferencing: Any=use_idreferencing) -> str:
