...
class LabProcess(LDNode):
    ...
    def get_name() -> Callable[[LabProcess], str]:
        def _arrow1576(lp: LabProcess) -> str:
            return lp.GetName()
    ...
    def get_agent() -> Callable[[LabProcess], str]:
        def _arrow1577(lp: LabProcess) -> str:
            return lp.GetAgent()
    ...
    def get_object() -> Callable[[LabProcess], str]:
        def _arrow1578(lp: LabProcess) -> str:
            return lp.GetObject()
    ...
    def get_result() -> Callable[[LabProcess], str]:
        def _arrow1579(lp: LabProcess) -> str:
            return lp.GetResult()

        return _arrow1579


LabProcess_reflection = _expr1580
