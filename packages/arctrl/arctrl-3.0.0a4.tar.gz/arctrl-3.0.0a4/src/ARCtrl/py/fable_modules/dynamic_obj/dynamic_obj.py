    ...
    def DeepCopyPropertiesTo(self, target: Any, over_write: bool | None=None, include_instance_properties: bool | None=None) -> None:
        ...
        def action(kv: Any) -> None:
            ...
            if match_value is None:
                ...
                def _arrow24(__unit: None=None, kv: Any=kv) -> bool:
                    pi: PropertyHelper = match_value
                    return over_write_1
...
def HashUtils_deepHash_4E60E31B(o: Any=None) -> int:
    if isinstance(o, DynamicObj):
        ...
        return box_hash_key_val_seq_by(f, sort_by(projection, o.GetProperties(True), ObjectExpr28()))
        ...
        def _arrow31(__unit: None=None, o: Any=o) -> IEnumerable_1[int]:
            def _arrow29(__unit: None=None) -> bool:
                return en.System_Collections_IEnumerator_MoveNext()

            def _arrow30(__unit: None=None) -> IEnumerable_1[int]:
                return singleton(HashUtils_deepHash_4E60E31B(en.System_Collections_IEnumerator_get_Current()))

            return enumerate_while(_arrow29, delay(_arrow30))

        l: FSharpList[int] = to_list(delay(_arrow31))
        if is_empty(l):
            return 0

        else: 
            def _arrow32(hash_1: int, hash_2: int, o: Any=o) -> int:
                return merge_hashes(hash_1, hash_2)

            return reduce(_arrow32, l)
...
def CopyUtils_tryDeepCopyObj_75B3D832(o: Any=None, include_instance_properties: bool | None=None) -> Any:
    ...
    def try_deep_copy_obj(o_1: Any=None, o: Any=o, include_instance_properties: Any=include_instance_properties) -> Any:
        ...
        if pattern_matching_result == 0:
            ...
            new_dict: Any = Dictionary([], ObjectExpr33())
            ...
            def _arrow34(__unit: None=None, o_1: Any=o_1) -> IEnumerable_1[DynamicObj]:
                return map_1(try_deep_copy_obj, o_1)

            return list(to_list(delay(_arrow34)))

        elif pattern_matching_result == 3:
            def _arrow35(__unit: None=None, o_1: Any=o_1) -> IEnumerable_1[DynamicObj]:
                return map_1(try_deep_copy_obj, o_1)
