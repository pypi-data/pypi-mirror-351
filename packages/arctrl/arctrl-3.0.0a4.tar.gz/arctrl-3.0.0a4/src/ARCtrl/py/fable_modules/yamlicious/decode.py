...
def int_1(value: YAMLElement) -> int:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: int = 0
        def _arrow428(__unit: None=None, value: Any=value) -> int:
            return out_arg

        def _arrow429(v_1: int, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1 or 0

        match_value = (try_parse(v.Value, 511, False, 32, FSharpRef(_arrow428, _arrow429)), out_arg)
        if match_value[0]:
...
def float_1(value: YAMLElement) -> float:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: float = 0.0
        def _arrow430(__unit: None=None, value: Any=value) -> float:
            return out_arg

        def _arrow431(v_1: float, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_1(v.Value, FSharpRef(_arrow430, _arrow431)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def bool_1(value: YAMLElement) -> bool:
    ...
    if pattern_matching_result == 0:
        ...
        out_arg: bool = False
        def _arrow432(__unit: None=None, value: Any=value) -> bool:
            return out_arg

        def _arrow433(v_1: bool, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_2(v.Value, FSharpRef(_arrow432, _arrow433)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def map(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return of_list(map_1(mapping, value.fields[0]), ObjectExpr434())
...
def dict_1(key_decoder: Callable[[str], _A], value_decoder: Callable[[YAMLElement], _B], value: YAMLElement) -> Any:
    if value.tag == 3:
        ...
        return Dictionary(of_seq(map_1(mapping, value.fields[0]), ObjectExpr435()), ObjectExpr436())
...
def datetime(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow437(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow438(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_3(v.Value, FSharpRef(_arrow437, _arrow438)), out_arg)
        if match_value[0]:
            return match_value[1]
...
def datetime_offset(value: YAMLElement) -> Any:
    ...
    if pattern_matching_result == 0:
        ...
        def _arrow439(__unit: None=None, value: Any=value) -> Any:
            return out_arg

        def _arrow440(v_1: Any, value: Any=value) -> None:
            nonlocal out_arg
            out_arg = v_1

        match_value = (try_parse_4(v.Value, FSharpRef(_arrow439, _arrow440)), out_arg)
        if match_value[0]:
            return match_value[1]
...
class Getter:
    def __init__(self, ele: YAMLElement) -> None:
        def _arrow445(__unit: None=None) -> IRequiredGetter:
            _this: Any = self
            class ObjectExpr444(IRequiredGetter):
            ...
            return ObjectExpr444()

        self.required: IRequiredGetter = _arrow445()
        def _arrow449(__unit: None=None) -> IOptionalGetter:
            _this_1: Any = self
            class ObjectExpr448(IOptionalGetter):
        ...
        self.optional: IOptionalGetter = _arrow449()
        def _arrow452(__unit: None=None) -> IMultipleOptionalGetter:
            _this_2: Any = self
            class ObjectExpr451(IMultipleOptionalGetter):
            ...
            return ObjectExpr451()

        self.multiple_optional: IMultipleOptionalGetter = _arrow452()
        def _arrow456(__unit: None=None) -> IOverflowGetter:
            _this_3: Any = self
            class ObjectExpr455(IOverflowGetter):
            ...
            return ObjectExpr455()

        self.overflow: IOverflowGetter = _arrow456()
