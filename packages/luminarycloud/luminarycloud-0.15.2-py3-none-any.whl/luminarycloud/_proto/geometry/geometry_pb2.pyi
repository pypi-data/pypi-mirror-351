...
class Feature(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing_extensions.Literal["boolean", b"boolean", "configurations", b"configurations", "create", b"create", "delete", b"delete", "farfield", b"farfield", "import", b"import", "imprint", b"imprint", "operation", b"operation", "pattern", b"pattern", "shrinkwrap", b"shrinkwrap", "transform", b"transform"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing_extensions.Literal["boolean", b"boolean", "configurations", b"configurations", "create", b"create", "delete", b"delete", "farfield", b"farfield", "feature_name", b"feature_name", "id", b"id", "import", b"import", "imprint", b"imprint", "operation", b"operation", "pattern", b"pattern", "shrinkwrap", b"shrinkwrap", "transform", b"transform"]) -> None: ...
    def WhichOneof(self, oneof_group: typing_extensions.Literal["operation", b"operation"]) -> typing_extensions.Literal["import", "create", "delete", "boolean", "imprint", "transform", "shrinkwrap", "farfield", "pattern", "configurations"] | None: ...
