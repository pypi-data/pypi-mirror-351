...
class TestM3ter:
    ...
    def test_copy(self) -> None:
        ...
        copied = self.client.copy(api_secret="another My API Secret")
        assert copied.api_secret == "another My API Secret"
        assert self.client.api_secret == "My API Secret"
    ...
    def test_base_url_trailing_slash(self, client: M3ter) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: M3ter) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: M3ter) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
...
class TestAsyncM3ter:
    ...
    def test_base_url_trailing_slash(self, client: AsyncM3ter) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncM3ter) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncM3ter) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncM3ter, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
