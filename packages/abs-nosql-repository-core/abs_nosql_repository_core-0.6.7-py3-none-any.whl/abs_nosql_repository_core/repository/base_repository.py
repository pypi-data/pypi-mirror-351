...
class BaseRepository:
    ...
    def _build_reference_stage(
        ...
        for ref in references:
            ...
            project_fields = ref.view_fields  # The fields you want to project
            use_graph_lookup = ref.use_graph_lookup

            # Step 1: Lookup or Graph Lookup
            if use_graph_lookup:
                pipeline.append({
                    "$graphLookup": {
            ...
            # # Step 2: Project only selected fields
            # if project_fields:
            #     project_stage = {
            #         "$project": {}
            #     }

            #     # Add the fields from `project_fields` to the `$project` stage
            #     for field in project_fields:
            #         project_stage["$project"][f"{as_field}.{field}"] = 1
