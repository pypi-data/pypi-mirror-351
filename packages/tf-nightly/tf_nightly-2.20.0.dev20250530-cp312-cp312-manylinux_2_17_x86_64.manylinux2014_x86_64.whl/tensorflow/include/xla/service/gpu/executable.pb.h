...
PROTOBUF_EXPORT extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xla_2fservice_2fgpu_2fexecutable_2eproto;
namespace xla {
namespace gpu {
...
PROTOBUF_NAMESPACE_OPEN
template<> PROTOBUF_EXPORT ::xla::gpu::ClusterDimProto* Arena::CreateMaybeMessage<::xla::gpu::ClusterDimProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::CompilationCacheEntryProto* Arena::CreateMaybeMessage<::xla::gpu::CompilationCacheEntryProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::CompilationCacheProto* Arena::CreateMaybeMessage<::xla::gpu::CompilationCacheProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::CompilationCacheProto_EntriesEntry_DoNotUse* Arena::CreateMaybeMessage<::xla::gpu::CompilationCacheProto_EntriesEntry_DoNotUse>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::CompilationResultProto* Arena::CreateMaybeMessage<::xla::gpu::CompilationResultProto>(Arena*);
template<> PROTOBUF_EXPORT ::xla::gpu::CompilationResultProto_DnnCompiledGraphsEntry_DoNotUse* Arena::CreateMaybeMessage<::xla::gpu::CompilationResultProto_DnnCompiledGraphsEntry_DoNotUse>(Arena*);
...
class PROTOBUF_EXPORT CompilationResultProto final :
...
class PROTOBUF_EXPORT CompilationCacheEntryProto final :
...
class PROTOBUF_EXPORT CompilationCacheProto final :
