...
class UserInterface(EricMainWindow):
    ...
    def __initMenus(self):
        ...
        self.__menus["extras"] = QMenu(self.tr("E&xtras"))
        ...
        self.__menus["wizards"] = QMenu(self.tr("Wi&zards"))
        ...
        pluginsMenu = QMenu(self.tr("P&lugins"))
        ...
        self.__menus["testing"] = QMenu(self.tr("&Testing"))
        ...
        self.toolGroupsMenu = QMenu(self.tr("Select Tool Group"))
        ...
        self.__menus["settings"] = QMenu(self.tr("Se&ttings"))
        ...
        self.__menus["window"] = QMenu(self.tr("&Window"))
        ...
        self.__menus["help"] = QMenu(self.tr("&Help"))
    ...
    def __initToolsMenus(self, menu):
        ...
        @type QMenu
        """
        btMenu = QMenu(self.tr("&Builtin Tools"))
        if self.designer4Act is not None:
        ...
        ptMenu = QMenu(self.tr("&Plugin Tools"))
        ptMenu.aboutToShow.connect(self.__showPluginToolsMenu)

        utMenu = QMenu(self.tr("&User Tools"))
