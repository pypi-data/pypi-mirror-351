...
class Tk:
    ...
    def update():
        ...
        self.canvas.configure(
            scrollreagion=self.canvas.bbox('all')
        )
    ...
    def add_component(
        ...
        **kwargs
        ...
        parent_frame = parent_frame if parent_frame is not None else self.window.tkinter
        component = component_class(parent=parent, fill=FILL['both'], **kwargs)
