...
def make_comparison_plot(fields: cp.Field | List[cp.Field], output_file: Optional[str] = None, plot_type: Optional[str] = "box",
                         layers: Optional[List[str] | str] = None, yaxis_label: Optional[str] = None, field_labels: Optional[List[str]] = None,
                         unit: Optional[List[str]] = None, title: Optional[str] = None, palette: Optional[str] = None,
                         custom_palette: Optional[List[str]] = None, horizontal: bool = False, vertical_xlabels: bool = False, dark_mode: bool = False,
                         transparent: bool = False, x_fig: float = 10, y_fig: float = 10, return_fig: Optional[bool] = False, **kwargs):
    """
