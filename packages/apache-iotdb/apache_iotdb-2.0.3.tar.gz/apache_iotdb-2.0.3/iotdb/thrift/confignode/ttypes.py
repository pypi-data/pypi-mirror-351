...
class TUpdateModelInfoReq(object):
    ...
    def __init__(self, modelId=None, modelStatus=None, attributes=None, aiNodeIds=None, inputLength=None, outputLength=None,):
        self.modelId = modelId
        self.modelStatus = modelStatus
        self.attributes = attributes
        self.aiNodeIds = aiNodeIds
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.I32:
                    self.modelStatus = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i710 in range(_size706):
                        ...
                        self.aiNodeIds.append(_elem711)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.I32:
                    self.inputLength = iprot.readI32()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.I32:
    ...
    def write(self, oprot):
        ...
        if self.modelId is not None:
            ...
            oprot.writeString(self.modelId.encode('utf-8') if sys.version_info[0] == 2 else self.modelId)
            oprot.writeFieldEnd()
        if self.modelStatus is not None:
            oprot.writeFieldBegin('modelStatus', TType.I32, 2)
            oprot.writeI32(self.modelStatus)
            oprot.writeFieldEnd()
        if self.attributes is not None:
            ...
            oprot.writeFieldEnd()
        if self.aiNodeIds is not None:
            oprot.writeFieldBegin('aiNodeIds', TType.LIST, 4)
            oprot.writeListBegin(TType.I32, len(self.aiNodeIds))
            for iter712 in self.aiNodeIds:
                oprot.writeI32(iter712)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.inputLength is not None:
            oprot.writeFieldBegin('inputLength', TType.I32, 5)
            oprot.writeI32(self.inputLength)
            oprot.writeFieldEnd()
        if self.outputLength is not None:
            oprot.writeFieldBegin('outputLength', TType.I32, 6)
    ...
    def validate(self):
        if self.modelId is None:
            raise TProtocolException(message='Required field modelId is unset!')
        if self.modelStatus is None:
            raise TProtocolException(message='Required field modelStatus is unset!')
        return
...
class TDataSchemaForTable(object):
    """
    Attributes:
     - databaseList
     - tableList
    ...
    def __init__(self, databaseList=None, tableList=None, curDatabase=None,):
        self.databaseList = databaseList
        self.tableList = tableList
        self.curDatabase = curDatabase
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i717 in range(_size713):
                        _elem718 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.databaseList.append(_elem718)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 2:
                if ftype == TType.LIST:
                    ...
                    for _i723 in range(_size719):
                        _elem724 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.tableList.append(_elem724)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.STRING:
                    self.curDatabase = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                else:
                    iprot.skip(ftype)
            else:
                iprot.skip(ftype)
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TDataSchemaForTable')
        if self.databaseList is not None:
            oprot.writeFieldBegin('databaseList', TType.LIST, 1)
            oprot.writeListBegin(TType.STRING, len(self.databaseList))
            for iter725 in self.databaseList:
                oprot.writeString(iter725.encode('utf-8') if sys.version_info[0] == 2 else iter725)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.tableList is not None:
            oprot.writeFieldBegin('tableList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRING, len(self.tableList))
            for iter726 in self.tableList:
                oprot.writeString(iter726.encode('utf-8') if sys.version_info[0] == 2 else iter726)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.curDatabase is not None:
            oprot.writeFieldBegin('curDatabase', TType.STRING, 3)
            oprot.writeString(self.curDatabase.encode('utf-8') if sys.version_info[0] == 2 else self.curDatabase)
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()

    def validate(self):
        if self.databaseList is None:
            raise TProtocolException(message='Required field databaseList is unset!')
        if self.tableList is None:
            raise TProtocolException(message='Required field tableList is unset!')
        if self.curDatabase is None:
            raise TProtocolException(message='Required field curDatabase is unset!')
        return
...
class TDataSchemaForTree(object):
    """
    Attributes:
     - path
            ...
            if fid == 1:
                if ftype == TType.LIST:
                    ...
                    for _i731 in range(_size727):
                        _elem732 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.path.append(_elem732)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
...
class TCreateTrainingReq(object):
    """
    Attributes:
     - modelId
     - modelType
    ...
    def __init__(self, modelId=None, modelType=None, isTableModel=None, dataSchemaForTable=None, dataSchemaForTree=None, useAllData=None, parameters=None, existingModelId=None, timeRanges=None,):
        self.modelId = modelId
        self.modelType = modelType
        self.isTableModel = isTableModel
        self.dataSchemaForTable = dataSchemaForTable
        self.dataSchemaForTree = dataSchemaForTree
    ...
    def read(self, iprot):
        ...
        while True:
            ...
            if fid == 1:
                ...
                if ftype == TType.STRUCT:
                    self.dataSchemaForTable = TDataSchemaForTable()
                    self.dataSchemaForTable.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 5:
                if ftype == TType.STRUCT:
                    self.dataSchemaForTree = TDataSchemaForTree()
                    self.dataSchemaForTree.read(iprot)
                else:
                    iprot.skip(ftype)
            elif fid == 6:
                if ftype == TType.BOOL:
                    self.useAllData = iprot.readBool()
                else:
                    iprot.skip(ftype)
            elif fid == 7:
                if ftype == TType.MAP:
                    ...
                    for _i738 in range(_size734):
                        _key739 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val740 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        self.parameters[_key739] = _val740
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 8:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i745 in range(_size741):
                        ...
                        for _i751 in range(_size747):
                            ...
                            _elem746.append(_elem752)
                        iprot.readListEnd()
                        self.timeRanges.append(_elem746)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        if oprot._fast_encode is not None and self.thrift_spec is not None:
            oprot.trans.write(oprot._fast_encode(self, [self.__class__, self.thrift_spec]))
            return
        oprot.writeStructBegin('TCreateTrainingReq')
        if self.modelId is not None:
            oprot.writeFieldBegin('modelId', TType.STRING, 1)
            oprot.writeString(self.modelId.encode('utf-8') if sys.version_info[0] == 2 else self.modelId)
            oprot.writeFieldEnd()
        if self.modelType is not None:
            oprot.writeFieldBegin('modelType', TType.STRING, 2)
        ...
        if self.isTableModel is not None:
            ...
            oprot.writeBool(self.isTableModel)
            oprot.writeFieldEnd()
        if self.dataSchemaForTable is not None:
            oprot.writeFieldBegin('dataSchemaForTable', TType.STRUCT, 4)
            self.dataSchemaForTable.write(oprot)
            oprot.writeFieldEnd()
        if self.dataSchemaForTree is not None:
            oprot.writeFieldBegin('dataSchemaForTree', TType.STRUCT, 5)
            self.dataSchemaForTree.write(oprot)
            oprot.writeFieldEnd()
        if self.useAllData is not None:
            oprot.writeFieldBegin('useAllData', TType.BOOL, 6)
            oprot.writeBool(self.useAllData)
            oprot.writeFieldEnd()
        if self.parameters is not None:
            oprot.writeFieldBegin('parameters', TType.MAP, 7)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.parameters))
            for kiter753, viter754 in self.parameters.items():
                oprot.writeString(kiter753.encode('utf-8') if sys.version_info[0] == 2 else kiter753)
                oprot.writeString(viter754.encode('utf-8') if sys.version_info[0] == 2 else viter754)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        if self.existingModelId is not None:
            oprot.writeFieldBegin('existingModelId', TType.STRING, 8)
            oprot.writeString(self.existingModelId.encode('utf-8') if sys.version_info[0] == 2 else self.existingModelId)
            oprot.writeFieldEnd()
        if self.timeRanges is not None:
            oprot.writeFieldBegin('timeRanges', TType.LIST, 9)
            oprot.writeListBegin(TType.LIST, len(self.timeRanges))
            for iter755 in self.timeRanges:
                oprot.writeListBegin(TType.I64, len(iter755))
                for iter756 in iter755:
    ...
    def validate(self):
        ...
        if self.isTableModel is None:
            raise TProtocolException(message='Required field isTableModel is unset!')
        return
...
class TSpaceQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i761 in range(_size757):
                        ...
                        _val763 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val763.read(iprot)
                        self.spaceQuota[_key762] = _val763
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
                if ftype == TType.MAP:
                    ...
                    for _i768 in range(_size764):
                        _key769 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val770 = iotdb.thrift.common.ttypes.TSpaceQuota()
                        _val770.read(iprot)
                        self.spaceQuotaUsage[_key769] = _val770
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.spaceQuota is not None:
            ...
            for kiter771, viter772 in self.spaceQuota.items():
...
class TThrottleQuotaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i779 in range(_size775):
                        _key780 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val781 = iotdb.thrift.common.ttypes.TThrottleQuota()
                        _val781.read(iprot)
                        self.throttleQuota[_key780] = _val781
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.throttleQuota is not None:
            ...
            for kiter782, viter783 in self.throttleQuota.items():
                oprot.writeString(kiter782.encode('utf-8') if sys.version_info[0] == 2 else kiter782)
                viter783.write(oprot)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
...
class TAINodeConfigurationResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i788 in range(_size784):
                        ...
                        _val790 = iotdb.thrift.common.ttypes.TAINodeConfiguration()
                        _val790.read(iprot)
                        self.aiNodeConfigurationMap[_key789] = _val790
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.aiNodeConfigurationMap is not None:
            ...
            for kiter791, viter792 in self.aiNodeConfigurationMap.items():
                oprot.writeI32(kiter791)
...
class TAINodeRegisterResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i797 in range(_size793):
                        _elem798 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem798.read(iprot)
                        self.configNodeList.append(_elem798)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter799 in self.configNodeList:
                iter799.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        if self.aiNodeId is not None:
...
class TAINodeRestartResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i804 in range(_size800):
                        _elem805 = iotdb.thrift.common.ttypes.TConfigNodeLocation()
                        _elem805.read(iprot)
                        self.configNodeList.append(_elem805)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.configNodeList is not None:
            oprot.writeFieldBegin('configNodeList', TType.LIST, 2)
            oprot.writeListBegin(TType.STRUCT, len(self.configNodeList))
            for iter806 in self.configNodeList:
                iter806.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i811 in range(_size807):
                        _elem812 = TTableInfo()
                        _elem812.read(iprot)
                        self.tableInfoList.append(_elem812)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableInfoList is not None:
            ...
            for iter813 in self.tableInfoList:
                iter813.write(oprot)
            oprot.writeListEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
...
class TShowTable4InformationSchemaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i818 in range(_size814):
                        ...
                        iprot.readListEnd()
                        self.databaseTableInfoMap[_key819] = _val820
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.databaseTableInfoMap is not None:
            ...
            for kiter827, viter828 in self.databaseTableInfoMap.items():
                oprot.writeString(kiter827.encode('utf-8') if sys.version_info[0] == 2 else kiter827)
                oprot.writeListBegin(TType.STRUCT, len(viter828))
...
class TDescTableResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i834 in range(_size830):
                        ...
                        self.preDeletedColumns.add(_elem835)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.preDeletedColumns is not None:
            ...
            for iter836 in self.preDeletedColumns:
...
class TDescTable4InformationSchemaResp(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.MAP:
                    ...
                    for _i841 in range(_size837):
                        _key842 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                        _val843 = {}
                        (_ktype845, _vtype846, _size844) = iprot.readMapBegin()
                        for _i848 in range(_size844):
                            _key849 = iprot.readString().decode('utf-8', errors='replace') if sys.version_info[0] == 2 else iprot.readString()
                            _val850 = TTableColumnInfo()
                            _val850.read(iprot)
                            _val843[_key849] = _val850
                        iprot.readMapEnd()
                        self.tableColumnInfoMap[_key842] = _val843
                    iprot.readMapEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.tableColumnInfoMap is not None:
            ...
            for kiter851, viter852 in self.tableColumnInfoMap.items():
                oprot.writeString(kiter851.encode('utf-8') if sys.version_info[0] == 2 else kiter851)
                oprot.writeMapBegin(TType.STRING, TType.STRUCT, len(viter852))
                for kiter853, viter854 in viter852.items():
                    oprot.writeString(kiter853.encode('utf-8') if sys.version_info[0] == 2 else kiter853)
...
class TTableColumnInfo(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.SET:
                    ...
                    for _i859 in range(_size855):
                        ...
                        self.preDeletedColumns.add(_elem860)
                    iprot.readSetEnd()
                else:
                    iprot.skip(ftype)
            else:
    ...
    def write(self, oprot):
        ...
        if self.preDeletedColumns is not None:
            ...
            oprot.writeSetBegin(TType.STRING, len(self.preDeletedColumns))
            for iter861 in self.preDeletedColumns:
...
TUpdateModelInfoReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'modelId', 'UTF8', None, ),  # 1
    (2, TType.I32, 'modelStatus', None, None, ),  # 2
    (3, TType.STRING, 'attributes', 'UTF8', None, ),  # 3
    (4, TType.LIST, 'aiNodeIds', (TType.I32, None, False), None, ),  # 4
    (5, TType.I32, 'inputLength', None, None, ),  # 5
    (6, TType.I32, 'outputLength', None, None, ),  # 6
)
all_structs.append(TDataSchemaForTable)
TDataSchemaForTable.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'databaseList', (TType.STRING, 'UTF8', False), None, ),  # 1
    (2, TType.LIST, 'tableList', (TType.STRING, 'UTF8', False), None, ),  # 2
    (3, TType.STRING, 'curDatabase', 'UTF8', None, ),  # 3
)
all_structs.append(TDataSchemaForTree)
TDataSchemaForTree.thrift_spec = (
    None,  # 0
    (1, TType.LIST, 'path', (TType.STRING, 'UTF8', False), None, ),  # 1
)
all_structs.append(TCreateTrainingReq)
TCreateTrainingReq.thrift_spec = (
    None,  # 0
    (1, TType.STRING, 'modelId', 'UTF8', None, ),  # 1
    (2, TType.STRING, 'modelType', 'UTF8', None, ),  # 2
    (3, TType.BOOL, 'isTableModel', None, None, ),  # 3
    (4, TType.STRUCT, 'dataSchemaForTable', [TDataSchemaForTable, None], None, ),  # 4
    (5, TType.STRUCT, 'dataSchemaForTree', [TDataSchemaForTree, None], None, ),  # 5
    (6, TType.BOOL, 'useAllData', None, None, ),  # 6
    (7, TType.MAP, 'parameters', (TType.STRING, 'UTF8', TType.STRING, 'UTF8', False), None, ),  # 7
    (8, TType.STRING, 'existingModelId', 'UTF8', None, ),  # 8
    (9, TType.LIST, 'timeRanges', (TType.LIST, (TType.I64, None, False), False), None, ),  # 9
)
