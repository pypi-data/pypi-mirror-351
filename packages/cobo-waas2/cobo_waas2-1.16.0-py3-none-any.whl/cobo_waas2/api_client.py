...
from urllib.parse import quote, urlparse, urlencode, urlunparse, parse_qsl
from typing import Tuple, Optional, List, Dict, Union
from pydantic import SecretStr

from cobo_waas2.configuration import Configuration
from cobo_waas2.api_response import ApiResponse, T as ApiResponseT
import cobo_waas2.models
from cobo_waas2 import rest
from cobo_waas2.crypto.signing_helper import SignHelper
...
class ApiClient:
    ...
    def __init__(
        ...
        self.user_agent = 'cobo-waas2-python-sdk/1.16.0'
    ...
    def param_serialize(
        ...
        if header_params:
            ...
            header_params = dict(
                self.parameters_to_tuples(header_params, None)
            )
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(cobo_waas2.models, klass)
    ...
    def parameters_to_tuples(self, params, collection_formats: Union[Dict, None]):
    ...
    def parameters_to_url_query(self, params, collection_formats: Union[Dict, None]):
        """Get parameters as list of tuples, formatting collections.
