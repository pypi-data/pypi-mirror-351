...
def download_resources():
    ...
    # site-packages papkasiga Manba papkasini yaratish
    save_dir = os.path.join(site.getsitepackages()[0], "Manba")
    ...
    print(f"Barcha fayllar {save_dir} papkasiga chiqarildi.")
