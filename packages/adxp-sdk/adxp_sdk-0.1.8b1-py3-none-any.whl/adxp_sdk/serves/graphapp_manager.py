...
def set_up_graph_routes(app: FastAPI, graph_path: str, graph_name: str = ""):
...
@logged
def create_graph_app(graph_path: str) -> FastAPI:
...
@logged
def create_multiple_graphs_app(graph_paths: List[GraphPath | dict]) -> FastAPI:
    ...
    for graph_path in graph_paths:
        ...
        app = set_up_graph_routes(
            app=app, graph_path=graph_path.object_path, graph_name=graph_path.name
        )
    app = add_login(app=app)
    return app
