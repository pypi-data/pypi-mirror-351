...
def discover_celery_tasks_from_app(app_path: str) -> list[dict[str, Any]]:
    """
    ...
    def _patched_send_task(self, name, args=None, kwargs=None, **options):
        ...
        from tasks_worker.services.celery_discovery import DummyAsyncResult
...
def discover_celery_periodic_tasks(app_path: str):
    """
