...
from seeq.spy._archive import archive
...
__all__ = ['acl', 'addons', 'archive', 'assets', 'docs', 'workbooks', 'widgets', 'login', 'logout', 'plot',
           'pull', 'push', 'search', 'swap',
           'PATH_ROOT', 'DEFAULT_WORKBOOK_PATH', 'GLOBALS_ONLY', 'GLOBALS_AND_ALL_WORKBOOKS',
