...
def pull(workbooks_df: Union[pd.DataFrame, str], *, include_referenced_workbooks: bool = True,
    ...
    include_archived : bool
        If True, includes trashed/archived items, worksheets, and content. If
        False, no trashed/archived items or content are included which means
        that any worksheets or documents that referred to such items may not
        function.

        By default, backward compatibility will be maintained: Archived
        worksheets will be excluded but archived inventory/content will be
        included.
