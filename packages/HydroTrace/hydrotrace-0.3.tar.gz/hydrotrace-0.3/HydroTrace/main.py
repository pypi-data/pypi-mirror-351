...
0.1 - Initial release
0.2 - Bug update
0.3 - Updated for PyQt6
'''
__author__ = "M.J. Roy"
__version__ = "0.3"
__email__ = "matthew.roy@manchester.ac.uk"
__status__ = "Experimental"
__copyright__ = "(c) M. J. Roy, 2019-2025"
...
class HT_main_window(object):
    ...
    def setupUi(self, MainWindow):
        ...
        ico = importlib.resources.files('HydroTrace') / 'meta/icon.png'
        with importlib.resources.as_file(ico) as path:
            MainWindow.setWindowIcon(QIcon(path.__str__()))
        ...
        horizLine.setFrameStyle(QtWidgets.QFrame.Shape.HLine)
        image = QtWidgets.QLabel()
        image.setGeometry(QtCore.QRect(0, 0, 10, 10))
        
        img = importlib.resources.files('HydroTrace') / 'meta/InstitutionLogo.png'
        with importlib.resources.as_file(img) as path:
            pixmap = QtGui.QPixmap(path.__str__())
        ...
        horizLine1.setFrameStyle(QtWidgets.QFrame.Shape.HLine)
        ...
        try:
            ...
            fc = importlib.resources.files('HydroTrace') / 'HydroTraceSettings.yml'
            with importlib.resources.as_file(fc) as path:
                self.filec = path.__str__()
        except:
