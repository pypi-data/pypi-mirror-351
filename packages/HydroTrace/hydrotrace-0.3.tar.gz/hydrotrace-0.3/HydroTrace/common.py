...
class Ui_get_config_dialog(object):
    ...
    def setupUi(self, get_config_dialog):
        ...
        with importlib.resources.as_file(ico) as path:
            get_config_dialog.setWindowIcon(QIcon(path.__str__()))
...
def make_splash():
    ...
    '''
    spl_fname = importlib.resources.files('HydroTrace') / 'meta/Logo.png'
    splash_pix = QPixmap(spl_fname.__str__(),'PNG')
    ...
    splash.showMessage('v%s'%__version__, Qt.AlignmentFlag.AlignRight | Qt.AlignmentFlag.AlignTop, QColor("darkGray"))
    return splash