...
class LocalUser:
    ...
    def unsubscribe_audio(self, user_id):
        ...
        ret = agora_local_user_unsubscribe_audio(self.user_handle, ctypes.c_uint(int(user_id)))
        if ret < 0:
    ...
    def unsubscribe_video(self, user_id):
        user_id = user_id.encode("utf-8")
        ret = agora_local_user_unsubscribe_video(self.user_handle, ctypes.c_uint(int(user_id)))
        if ret < 0:
