...
class TestUserCriteria:
    ...
    def test_method_update(self, client: WebRecruitmentSDK) -> None:
        user_criterion = client.protocols.user_criteria.update(
            protocol_id=0,
    ...
    def test_raw_response_update(self, client: WebRecruitmentSDK) -> None:
        response = client.protocols.user_criteria.with_raw_response.update(
            protocol_id=0,
            active_criteria_ids=[0],
        )
    ...
    def test_streaming_response_update(self, client: WebRecruitmentSDK) -> None:
        with client.protocols.user_criteria.with_streaming_response.update(
            protocol_id=0,
            active_criteria_ids=[0],
        ) as response:
    ...
    def test_method_list(self, client: WebRecruitmentSDK) -> None:
        user_criterion = client.protocols.user_criteria.list(
            protocol_id=0,
        )
        assert_matches_type(UserCriterionListResponse, user_criterion, path=["response"])
    ...
    def test_raw_response_list(self, client: WebRecruitmentSDK) -> None:
        response = client.protocols.user_criteria.with_raw_response.list(
            protocol_id=0,
        )
    ...
    def test_streaming_response_list(self, client: WebRecruitmentSDK) -> None:
        with client.protocols.user_criteria.with_streaming_response.list(
            protocol_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncUserCriteria:
    ...
    async def test_method_update(self, async_client: AsyncWebRecruitmentSDK) -> None:
        user_criterion = await async_client.protocols.user_criteria.update(
            protocol_id=0,
            active_criteria_ids=[0],
        )
        assert_matches_type(UserCriterionUpdateResponse, user_criterion, path=["response"])
    ...
    async def test_raw_response_update(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.protocols.user_criteria.with_raw_response.update(
            protocol_id=0,
            active_criteria_ids=[0],
        )
    ...
    async def test_streaming_response_update(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.protocols.user_criteria.with_streaming_response.update(
            protocol_id=0,
            active_criteria_ids=[0],
        ) as response:
            assert not response.is_closed
    ...
    async def test_method_list(self, async_client: AsyncWebRecruitmentSDK) -> None:
        user_criterion = await async_client.protocols.user_criteria.list(
            protocol_id=0,
        )
        assert_matches_type(UserCriterionListResponse, user_criterion, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.protocols.user_criteria.with_raw_response.list(
            protocol_id=0,
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.protocols.user_criteria.with_streaming_response.list(
            protocol_id=0,
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
