...
class TestBulk:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_update_profile_embeddings(self, client: WebRecruitmentSDK) -> None:
        bulk = client.system.patients.bulk.update_profile_embeddings(
            tenant_db_name="tenant_db_name",
            body=[
                {
                    "category": "category",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_update_profile_embeddings(self, client: WebRecruitmentSDK) -> None:
        response = client.system.patients.bulk.with_raw_response.update_profile_embeddings(
            tenant_db_name="tenant_db_name",
            body=[
                {
                    "category": "category",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_update_profile_embeddings(self, client: WebRecruitmentSDK) -> None:
        with client.system.patients.bulk.with_streaming_response.update_profile_embeddings(
            tenant_db_name="tenant_db_name",
            body=[
                {
                    "category": "category",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_path_params_update_profile_embeddings(self, client: WebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_db_name` but received ''"):
            client.system.patients.bulk.with_raw_response.update_profile_embeddings(
                tenant_db_name="",
                body=[
                    {
                        "category": "category",
...
class TestAsyncBulk:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_update_profile_embeddings(self, async_client: AsyncWebRecruitmentSDK) -> None:
        bulk = await async_client.system.patients.bulk.update_profile_embeddings(
            tenant_db_name="tenant_db_name",
            body=[
                {
                    "category": "category",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_update_profile_embeddings(self, async_client: AsyncWebRecruitmentSDK) -> None:
        response = await async_client.system.patients.bulk.with_raw_response.update_profile_embeddings(
            tenant_db_name="tenant_db_name",
            body=[
                {
                    "category": "category",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_update_profile_embeddings(self, async_client: AsyncWebRecruitmentSDK) -> None:
        async with async_client.system.patients.bulk.with_streaming_response.update_profile_embeddings(
            tenant_db_name="tenant_db_name",
            body=[
                {
                    "category": "category",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_path_params_update_profile_embeddings(self, async_client: AsyncWebRecruitmentSDK) -> None:
        with pytest.raises(ValueError, match=r"Expected a non-empty value for `tenant_db_name` but received ''"):
            await async_client.system.patients.bulk.with_raw_response.update_profile_embeddings(
                tenant_db_name="",
                body=[
                    {
                        "category": "category",
