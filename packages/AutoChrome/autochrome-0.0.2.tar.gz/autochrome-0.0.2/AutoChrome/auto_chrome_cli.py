...
Date: 2025-05-29 11:28:13
LastEditTime: 2025-05-29 12:45:20
Description:  AutoChrome 命令行工具
FilePath: /AutoChrome/AutoChrome/auto_chrome_cli.py
...
def main():
    parser = argparse.ArgumentParser(
        prog="autochrome",
        description="AutoChrome 命令行工具：用于下载绿色版Chrome/Chromium浏览器。\n"
        "功能：\n"
