...
class QuerySetBase(Generic[ModelType]):
    ...
    def __init__(self, entity: type[ModelType], executor: ExecutorBase[ModelType] | None = None, async_executor: AsyncExecutorBase[ModelType] | None = None) -> None: ...
    @property
    ...
    async def _aexecute_query(self) -> list[dict[str, Any]]: ...
    ...
    async def _acreate_instance(self, *, _is_partial: bool, **kwargs: Any) -> ModelType: ...
