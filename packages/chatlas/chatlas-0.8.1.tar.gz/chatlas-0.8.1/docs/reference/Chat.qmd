...
| echo           | [Optional](`typing.Optional`)\[[Literal](`typing.Literal`)\[\'text\', \'all\', \'none\'\]\] | Whether to echo text content, all content (i.e., tool calls), or no content. Defaults to `"none"` when `stream=True` and `"text"` when `stream=False`. | `None`    |
...
| echo   | [Literal](`typing.Literal`)\[\'text\', \'all\', \'none\'\]                            | Whether to echo text content, all content (i.e., tool calls), or no content.         | `'text'`  |
| stream | [bool](`bool`)                                                                        | Whether to stream the response (i.e., have the response appear in chunks).           | `True`    |
| kwargs | [Optional](`typing.Optional`)\[[SubmitInputArgsT](`chatlas._chat.SubmitInputArgsT`)\] | Additional keyword arguments to pass to the method used for requesting the response. | `None`    |
...
|--------|---------------------------------------------------------------------------------------|-------------------------------------------------------------------------------------------|-----------|
| args   | [Content](`chatlas._content.Content`) \| [str](`str`)                                 | The user input(s) to generate a response from.                                            | `()`      |
| echo   | [Literal](`typing.Literal`)\[\'text\', \'all\', \'none\'\]                            | Whether to echo text content, all content (i.e., tool calls, images, etc), or no content. | `'text'`  |
| stream | [bool](`bool`)                                                                        | Whether to stream the response (i.e., have the response appear in chunks).                | `True`    |
| kwargs | [Optional](`typing.Optional`)\[[SubmitInputArgsT](`chatlas._chat.SubmitInputArgsT`)\] | Additional keyword arguments to pass to the method used for requesting the response.      | `None`    |
...
| include               | [Literal](`typing.Literal`)\[\'text\', \'all\'\]                                               | Whether to include text content, all content (i.e., tool calls), or no content.       | `'text'`   |
...
| echo       | [Literal](`typing.Literal`)\[\'text\', \'all\', \'none\'\] | Whether to echo text content, all content (i.e., tool calls), or no content. | `'none'`   |
