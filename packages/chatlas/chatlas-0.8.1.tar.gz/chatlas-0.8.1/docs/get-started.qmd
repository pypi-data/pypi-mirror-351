...
Writing a good prompt, which is called __prompt design__, is key to effective use of LLMs. It is discussed in more detail in  the [prompt design article](prompt-design.qmd).
...
Learn more in the article on [structured data extraction](structured-data.qmd).
