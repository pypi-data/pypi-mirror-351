...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-fsx)](https://pypistats.org/packages/mypy-boto3-fsx)
...
`mypy-boto3-fsx` dependency in production. However, there is an issue in
