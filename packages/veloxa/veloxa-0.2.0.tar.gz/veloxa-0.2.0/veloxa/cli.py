...
def init_command(force=False):
    ...
    files_exist = any(current_dir.iterdir())
    ...
    if files_exist and not force:
        ...
        if not proceed:
            ...
            return
    elif files_exist and force:
        # Force mode - remove all existing files
        print(f"🗑️  Force mode: Removing all files in '{project_name}' directory...")
