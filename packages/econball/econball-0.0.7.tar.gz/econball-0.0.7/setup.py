...
setup(
    name='econball',
    version='0.0.7',
    description='A library for pulling in and normalising economic data.',
    ...
    keywords='economics, timeseries',
    url='https://github.com/8W9aG/econball',
    ...
    entry_points = {
        'console_scripts': ['econball=econball.__main__:main'],
    },
)
