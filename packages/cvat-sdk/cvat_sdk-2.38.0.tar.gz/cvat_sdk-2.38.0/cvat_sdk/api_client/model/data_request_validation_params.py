...
def lazy_import():
    ...
    from cvat_sdk.api_client.model.validation_params_request import ValidationParamsRequest
    globals()['FrameSelectionMethod'] = FrameSelectionMethod
    globals()['ValidationMode'] = ValidationMode
    globals()['ValidationParamsRequest'] = ValidationParamsRequest


class DataRequestValidationParams(ModelComposed):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, mode, frame_selection_method, *args, **kwargs) -> DataRequestValidationParams:  # noqa: E501
        """DataRequestValidationParams - a model defined in OpenAPI
