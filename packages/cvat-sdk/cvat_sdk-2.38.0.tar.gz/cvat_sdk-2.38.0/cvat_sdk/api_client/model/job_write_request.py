...
class JobWriteRequest(ModelNormal, IJobWriteRequest):
    ...
    Attributes:
      ...
      frame_selection_method (FrameSelectionMethod): [optional]  # noqa: E501

      frame_count (int): The number of frames included in the GT job. Applicable only to the \"random_uniform\" frame selection method . [optional]  # noqa: E501

      frame_share (float): The share of frames included in the GT job. Applicable only to the \"random_uniform\" frame selection method . [optional]  # noqa: E501

      frames_per_job_count (int): The number of frames included in the GT job from each annotation job. Applicable only to the \"random_per_job\" frame selection method . [optional]  # noqa: E501

      frames_per_job_share (float): The share of frames included in the GT job from each annotation job. Applicable only to the \"random_per_job\" frame selection method . [optional]  # noqa: E501
      ...
      seed (int): Deprecated. Use random_seed instead.. [optional]  # noqa: E501

      frames ([int]): The list of frame ids. Applicable only to the \"manual\" frame selection method . [optional]  # noqa: E501
