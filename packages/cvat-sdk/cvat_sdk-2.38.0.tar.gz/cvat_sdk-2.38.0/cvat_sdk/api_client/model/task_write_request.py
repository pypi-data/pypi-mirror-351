...
class ITaskWriteRequest(IModelData):
    ...
    labels: list[PatchedLabelRequest] # noqa: E501
    """
    [optional]
    [PatchedLabelRequest]
    """
...
class TaskWriteRequest(ModelNormal, ITaskWriteRequest):
    ...
    Attributes:
      ...
      consensus_replicas (int): The number of consensus replica jobs for each annotation job. Configured at task creation . [optional] if omitted the server will use the default value of 0  # noqa: E501
