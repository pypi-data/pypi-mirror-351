...
from pyodide_mkdocs_theme.pyodide_macros.tools_and_constants import PmtTests, SequentialFilter, SequentialRun
...
SEQUENTIAL_CONFIG = SubConfigSrc(
    'sequential',
    long_accessor = True,
    docs = "Réglages Pour lier les exécutions de différents éléments entre elles.",
    elements = (
    ConfigOptionSrc(
        'run', str,
