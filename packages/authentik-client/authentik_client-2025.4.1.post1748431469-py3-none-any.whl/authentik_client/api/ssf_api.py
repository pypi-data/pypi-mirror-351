...
class SsfApi:
    ...
    def ssf_streams_list(
        ...
        _param = self._ssf_streams_list_serialize(
    ...
    @validate_call
    def ssf_streams_list_with_http_info(
        self,
        delivery_method: Optional[StrictStr] = None,
        endpoint_url: Optional[StrictStr] = None,
        ordering: Annotated[Optional[StrictStr], Field(description="Which field to use when ordering the results.")] = None,
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[PaginatedSSFStreamList]:
        """ssf_streams_list
    ...
    @validate_call
    def ssf_streams_list_without_preload_content(
        self,
        delivery_method: Optional[StrictStr] = None,
        endpoint_url: Optional[StrictStr] = None,
        ordering: Annotated[Optional[StrictStr], Field(description="Which field to use when ordering the results.")] = None,
    ...
    def _ssf_streams_list_serialize(
        self,
        delivery_method,
        endpoint_url,
        ordering,
    ...
    @validate_call
    def ssf_streams_retrieve(
        self,
        uuid: Annotated[StrictStr, Field(description="A UUID string identifying this SSF Stream.")],
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :param uuid: A UUID string identifying this SSF Stream. (required)
        :type uuid: str
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
        ...
        _param = self._ssf_streams_retrieve_serialize(
            uuid=uuid,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    @validate_call
    def ssf_streams_retrieve_with_http_info(
        self,
        uuid: Annotated[StrictStr, Field(description="A UUID string identifying this SSF Stream.")],
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def ssf_streams_retrieve_without_preload_content(
        self,
        uuid: Annotated[StrictStr, Field(description="A UUID string identifying this SSF Stream.")],
        _request_timeout: Union[
            None,
    ...
    def _ssf_streams_retrieve_serialize(
        self,
        uuid,
        _request_auth,
        _content_type,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/ssf/streams/{uuid}/',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
