...
class LDAPSource(BaseModel):
    ...
    user_membership_attribute: Optional[StrictStr] = Field(default=None, description="Attribute which matches the value of `group_membership_field`.")
