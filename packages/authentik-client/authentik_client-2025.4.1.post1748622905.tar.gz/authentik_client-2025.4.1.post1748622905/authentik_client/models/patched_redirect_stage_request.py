...
class PatchedRedirectStageRequest(BaseModel):
    """
    ...
    mode: Optional[RedirectStageModeEnum] = None
    target_static: Optional[StrictStr] = None
    target_flow: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["name", "flow_set", "keep_context", "mode", "target_static", "target_flow"]
