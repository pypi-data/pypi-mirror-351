...
class PatchedSAMLSourceRequest(BaseModel):
    ...
    sso_url: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="URL that the initial Login request is sent to.")
    slo_url: Optional[StrictStr] = Field(default=None, description="Optional URL if your IDP supports Single-Logout.")
