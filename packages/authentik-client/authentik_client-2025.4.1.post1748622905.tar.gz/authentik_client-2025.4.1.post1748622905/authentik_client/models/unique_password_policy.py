...
class UniquePasswordPolicy(BaseModel):
    """
    ...
    num_historical_passwords: Optional[Annotated[int, Field(le=2147483647, strict=True, ge=0)]] = Field(default=None, description="Number of passwords to check against.")
    __properties: ClassVar[List[str]] = ["pk", "name", "execution_logging", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "bound_to", "password_field", "num_historical_passwords"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "num_historical_passwords": obj.get("num_historical_passwords")
        })
        return _obj
