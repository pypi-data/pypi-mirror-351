...
from authentik_client.models.cert_attribute_enum import CertAttributeEnum
...
class PatchedMutualTLSStageRequest(BaseModel):
    """
    MutualTLSStage Serializer
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    flow_set: Optional[List[FlowSetRequest]] = None
    mode: Optional[MutualTLSStageModeEnum] = None
    certificate_authorities: Optional[List[StrictStr]] = Field(default=None, description="Configure certificate authorities to validate the certificate against. This option has a higher priority than the `client_certificate` option on `Brand`.")
    cert_attribute: Optional[CertAttributeEnum] = None
    user_attribute: Optional[UserAttributeEnum] = None
    __properties: ClassVar[List[str]] = ["name", "flow_set", "mode", "certificate_authorities", "cert_attribute", "user_attribute"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "mode": obj.get("mode"),
            "certificate_authorities": obj.get("certificate_authorities"),
            "cert_attribute": obj.get("cert_attribute"),
