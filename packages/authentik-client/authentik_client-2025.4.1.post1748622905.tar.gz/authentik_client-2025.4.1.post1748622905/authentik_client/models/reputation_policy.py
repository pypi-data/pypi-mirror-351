...
class ReputationPolicy(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["pk", "name", "execution_logging", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "bound_to", "check_ip", "check_username", "threshold"]
