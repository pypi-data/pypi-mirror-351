...
class PatchedInitialPermissionsRequest(BaseModel):
    """
    InitialPermissions serializer
    """ # noqa: E501
    name: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=150)]] = None
    mode: Optional[InitialPermissionsModeEnum] = None
    role: Optional[StrictStr] = None
    permissions: Optional[List[StrictInt]] = None
    __properties: ClassVar[List[str]] = ["name", "mode", "role", "permissions"]
