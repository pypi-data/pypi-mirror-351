...
class SourceStage(BaseModel):
    ...
    source: StrictStr
    resume_timeout: Optional[StrictStr] = Field(default=None, description="Amount of time a user can take to return from the source to continue the flow (Format: hours=-1;minutes=-2;seconds=-3)")
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "source", "resume_timeout"]
