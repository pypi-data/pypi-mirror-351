...
class PatchedGoogleWorkspaceProviderRequest(BaseModel):
    """
    ...
    delegated_subject: Optional[Annotated[str, Field(min_length=1, strict=True, max_length=254)]] = None
    ...
    default_group_email_domain: Optional[Annotated[str, Field(min_length=1, strict=True)]] = None
    ...
    __properties: ClassVar[List[str]] = ["name", "property_mappings", "property_mappings_group", "delegated_subject", "credentials", "scopes", "exclude_users_service_account", "filter_group", "user_delete_action", "group_delete_action", "default_group_email_domain", "dry_run"]
