...
from authentik_client.models.authorization_code_auth_method_enum import AuthorizationCodeAuthMethodEnum
...
class OAuthSource(BaseModel):
    ...
    authorization_code_auth_method: Optional[AuthorizationCodeAuthMethodEnum] = Field(default=None, description="How to perform authentication during an authorization_code token request flow")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "authorization_code_auth_method": obj.get("authorization_code_auth_method")
        })
        return _obj
