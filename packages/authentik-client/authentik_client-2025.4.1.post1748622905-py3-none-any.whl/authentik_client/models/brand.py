...
class Brand(BaseModel):
    ...
    branding_custom_css: Optional[StrictStr] = None
    ...
    client_certificates: Optional[List[StrictStr]] = Field(default=None, description="Certificates used for client authentication.")
    attributes: Optional[Any] = None
    __properties: ClassVar[List[str]] = ["brand_uuid", "domain", "default", "branding_title", "branding_logo", "branding_favicon", "branding_custom_css", "branding_default_flow_background", "flow_authentication", "flow_invalidation", "flow_recovery", "flow_unenrollment", "flow_user_settings", "flow_device_code", "default_application", "web_certificate", "client_certificates", "attributes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "branding_default_flow_background": obj.get("branding_default_flow_background"),
            ...
            "client_certificates": obj.get("client_certificates"),
