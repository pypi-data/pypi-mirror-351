...
class LDAPSourceRequest(BaseModel):
    ...
    server_uri: Annotated[str, Field(min_length=1, strict=True)]
    ...
    base_dn: Annotated[str, Field(min_length=1, strict=True)]
    ...
    user_membership_attribute: Optional[Annotated[str, Field(min_length=1, strict=True)]] = Field(default=None, description="Attribute which matches the value of `group_membership_field`.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "user_membership_attribute": obj.get("user_membership_attribute"),
            ...
            "lookup_groups_from_user": obj.get("lookup_groups_from_user"),
            "delete_not_found_objects": obj.get("delete_not_found_objects")
        })
        return _obj
