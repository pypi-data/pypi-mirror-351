...
class AppEnum(str, Enum):
    ...
    AUTHENTIK_DOT_POLICIES_DOT_GEOIP = 'authentik.policies.geoip'
    ...
    AUTHENTIK_DOT_PROVIDERS_DOT_RAC = 'authentik.providers.rac'
    ...
    AUTHENTIK_DOT_SOURCES_DOT_KERBEROS = 'authentik.sources.kerberos'
    ...
    AUTHENTIK_DOT_STAGES_DOT_REDIRECT = 'authentik.stages.redirect'
    ...
    AUTHENTIK_DOT_ENTERPRISE_DOT_STAGES_DOT_AUTHENTICATOR_ENDPOINT_GDTC = 'authentik.enterprise.stages.authenticator_endpoint_gdtc'
    AUTHENTIK_DOT_ENTERPRISE_DOT_STAGES_DOT_MTLS = 'authentik.enterprise.stages.mtls'
