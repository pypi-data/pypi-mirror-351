...
class GroupKerberosSourceConnection(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["pk", "group", "source", "source_obj", "identifier", "created", "last_updated"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # override the default output from pydantic by calling `to_dict()` of source_obj
        if self.source_obj:
            _dict['source_obj'] = self.source_obj.to_dict()
        return _dict
