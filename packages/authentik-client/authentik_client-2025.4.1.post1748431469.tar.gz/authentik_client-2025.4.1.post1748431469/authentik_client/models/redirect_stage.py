...
from authentik_client.models.redirect_stage_mode_enum import RedirectStageModeEnum
from typing import Optional, Set
from typing_extensions import Self

class RedirectStage(BaseModel):
    """
    ...
    keep_context: Optional[StrictBool] = None
    mode: RedirectStageModeEnum
    target_static: Optional[StrictStr] = None
    target_flow: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "keep_context", "mode", "target_static", "target_flow"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * OpenAPI `readOnly` fields are excluded.
        ...
        # set to None if target_flow (nullable) is None
        # and model_fields_set contains the field
        if self.target_flow is None and "target_flow" in self.model_fields_set:
            _dict['target_flow'] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "keep_context": obj.get("keep_context"),
            "mode": obj.get("mode"),
            "target_static": obj.get("target_static"),
            "target_flow": obj.get("target_flow")
        })
        return _obj
