...
class KerberosSource(BaseModel):
    """
    ...
    realm: StrictStr = Field(description="Kerberos realm")
    ...
    connectivity: Optional[Dict[str, StrictStr]] = Field(description="Get cached source connectivity")
