...
class AuthenticatorEmailStage(BaseModel):
    """
    ...
    token_expiry: Optional[StrictStr] = Field(default=None, description="Time the token sent is valid (Format: hours=3,minutes=17,seconds=300).")
    template: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["pk", "name", "component", "verbose_name", "verbose_name_plural", "meta_model_name", "flow_set", "configure_flow", "friendly_name", "use_global_settings", "host", "port", "username", "password", "use_tls", "use_ssl", "timeout", "from_address", "subject", "token_expiry", "template"]
