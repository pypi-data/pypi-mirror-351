...
class CMakeBuild(build_ext):
    ...
    def build_extension(self, ext):
        ...
        build_lib_path = os.path.join(self.build_lib, lib_name)
        ...
        if os.path.exists(build_lib_path):
            ...
            print("Copying", build_lib_path, "→", package_lib_path)
            shutil.copy(build_lib_path, package_lib_path)
        else:
            print("构建后未找到动态库:", build_lib_path)
            raise FileNotFoundError(build_lib_path)
