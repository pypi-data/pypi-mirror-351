...
from vnaddress_aws.functions.acronym_layer import acronym_execute_raw_address, acronym_execute_list_address
...
STANDARDIZER_MODEL_PATH = 'vnaddress_aws/models'
