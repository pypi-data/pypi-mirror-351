...
class TestMLPWithKMeansPlusPlus:
    ...
    def test_integrated_mlp_with_partitioned_training(self, regression_dataset):
        """Test using MLPRegressor with KMEANS_PLUS_PLUS partitioning via train_models_on_partitions."""
        X, y = regression_dataset
        ...
        # Train models on partitions using the helper function
    ...
    def test_adaptive_regressor_with_string_partition_mode(self, regression_dataset):
        """Test AdaptivePartitionRegressor with string partition mode 'kmeans++'."""
        X, y = regression_dataset
        ...
        # Create a PartitionTransformer with string partition mode
