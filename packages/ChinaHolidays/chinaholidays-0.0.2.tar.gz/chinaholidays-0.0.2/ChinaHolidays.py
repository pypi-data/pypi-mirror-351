...
class ChinaHolidays:
    ...
    def __init__(self, year: int = None):
        ...
        OFFICIAL_INFO = os.path.join(os.path.dirname(__file__), "official_info.toml")
        with open(OFFICIAL_INFO, "r", encoding="utf-8") as f:
            self.official_info = toml.load(f)
...
if __name__ == "__main__":
    ...
    pprint(get_all_holidays())
    pprint(filter_holidays(datetime(2025, 5, 28), datetime(2025, 6, 4)))
