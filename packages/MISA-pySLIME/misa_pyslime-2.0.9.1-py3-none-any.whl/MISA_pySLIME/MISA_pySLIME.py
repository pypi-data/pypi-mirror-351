...
ne_model_dict = np.load(os.path.join(MODEL_DIR, 'ne_model_2_0_9.npy'), allow_pickle=True).item()
ti_model_dict = np.load(os.path.join(MODEL_DIR, 'ti_model_2_0_9.npy'), allow_pickle=True).item()
te_model_dict = np.load(os.path.join(MODEL_DIR, 'te_model_2_0_9.npy'), allow_pickle=True).item()
