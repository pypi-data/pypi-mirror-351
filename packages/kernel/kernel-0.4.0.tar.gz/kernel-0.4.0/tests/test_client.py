...
class TestKernel:
    ...
    def test_client_timeout_option(self) -> None:
        client = Kernel(base_url=base_url, api_key=api_key, _strict_response_validation=True, timeout=httpx.Timeout(0))
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(KernelError):
            with update_env(**{"KERNEL_API_KEY": Omit()}):
                client2 = Kernel(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_multipart_repeating_array(self, client: Kernel) -> None:
        request = client._build_request(
    ...
    def test_base_url_setter(self) -> None:
        client = Kernel(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    @pytest.mark.parametrize(
        "client",
        [
            Kernel(base_url="http://localhost:5000/custom/path/", api_key=api_key, _strict_response_validation=True),
            Kernel(
    ...
    def test_base_url_trailing_slash(self, client: Kernel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: Kernel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: Kernel) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_client_max_retries_validation(self) -> None:
        with pytest.raises(TypeError, match=r"max_retries cannot be None"):
            Kernel(base_url=base_url, api_key=api_key, _strict_response_validation=True, max_retries=cast(Any, None))
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = Kernel(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_omit_retry_count_header(
        self, client: Kernel, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
...
class TestAsyncKernel:
    ...
    def test_multipart_repeating_array(self, async_client: AsyncKernel) -> None:
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncKernel(base_url=base_url, api_key=api_key, _strict_response_validation=True)
