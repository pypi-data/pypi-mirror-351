...
class DetectorListElement(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "description", "serial_number", "base_ipv4_addr", "udp_interface_count", "nmodules", "width", "height", "readout_time_us", "min_frame_time_us", "min_count_time_us", "type"]
