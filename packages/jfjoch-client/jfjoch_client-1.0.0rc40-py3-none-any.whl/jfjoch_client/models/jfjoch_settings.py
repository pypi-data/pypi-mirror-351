...
class JfjochSettings(BaseModel):
    ...
    inference_server_addr: Optional[List[Annotated[str, Field(strict=True)]]] = Field(default=None, description="Address to ML-based inference servers")
    ...
    __properties: ClassVar[List[str]] = ["pcie", "zeromq", "instrument", "file_writer", "detector", "indexing", "detector_settings", "azim_int", "image_format", "image_buffer_MiB", "receiver_threads", "numa_policy", "frontend_directory", "inference_server_addr", "image_pusher", "zeromq_preview", "zeromq_metadata"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "inference_server_addr": obj.get("inference_server_addr"),
