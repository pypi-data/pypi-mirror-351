...
class DatasetSettings(BaseModel):
    ...
    space_group_number: Optional[Annotated[int, Field(le=194, strict=True, ge=0)]] = Field(default=0, description="Number of space group for the crystal. Currently used solely as metadata, not relevant for image processing done in Jungfraujoch.")
    ...
    __properties: ClassVar[List[str]] = ["images_per_trigger", "ntrigger", "image_time_us", "beam_x_pxl", "beam_y_pxl", "detector_distance_mm", "incident_energy_keV", "file_prefix", "images_per_file", "space_group_number", "sample_name", "compression", "total_flux", "transmission", "goniometer", "grid_scan", "header_appendix", "image_appendix", "data_reduction_factor_serialmx", "pixel_value_low_threshold", "run_number", "run_name", "experiment_group", "poisson_compression", "write_nxmx_hdf5_master", "save_calibration", "unit_cell"]
