...
from vyomcloudbridge.constants.constants import MAX_FILE_SIZE, data_buffer_key, default_project_id
    ...
    def write_from_file(
        ...
        try:
            ...
            fileinfo_message = {
                ...
                "topic": f"{file_dir}/file_properties/{filename}.json",
                "message_type": "json",
            ...
            if should_chunk:
                ...
                try:
                    ...
                    # TODO, below will be removed later
                    # chunk_message = {
                    #     "data": base64.b64encode(file_data).decode("utf-8"),
                    #     "message_type": "binary",
                    #     "topic": f"{chunk_dir}/{filename}_1.bin",
                    #     "destination_ids": destination_ids,
                    #     "data_source": data_source,
                    #     # meta data
                    #     "buffer_key": buffer_key,
