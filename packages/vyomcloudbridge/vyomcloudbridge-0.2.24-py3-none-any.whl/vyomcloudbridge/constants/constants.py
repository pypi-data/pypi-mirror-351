...
log_file = os.path.join(log_dir, "vyomcloudbridge.log")
...
BUFFER_API_URL = f"{base_api_url}/machine/buffer/"
# MISSION_STATS_API_URL = f"{base_api_url}/mission-stats/"
MACHINE_REGISTER_API_URL = f"{base_api_url}/device/register/"
MACHINE_MODELS_API_URL = f"{base_api_url}/machine-model/"
MACHINE_TOPICS_API_URL = f"{base_api_url}/machine-model/topic/list/"
...
default_upload_dir = (
    "_upload_"  # default project id for non-mission related data uploads
)
