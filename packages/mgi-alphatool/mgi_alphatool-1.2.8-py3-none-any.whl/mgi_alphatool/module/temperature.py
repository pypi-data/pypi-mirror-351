...
class TemperatureModule(Module):
    ...
    def set_temp(self, celsius: int, wait_for_temp: bool = True) -> 'TemperatureModule':
        ...
        Args:
            celsius (int): The target temperature in Celsius. Valid range is 4°C-90°C.
        ...
        """
        if celsius < 4 or celsius > 90:
            raise ValueError("Invalid temperature. Valid range is 4°C-90°C.")
