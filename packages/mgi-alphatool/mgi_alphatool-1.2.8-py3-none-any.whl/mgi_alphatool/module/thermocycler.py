...
class ThermocyclerModule(Module):
    ...
    def set_lid_temp(self, celsius: int, wait_for_temp:bool=True) -> 'ThermocyclerModule':
        ...
        Args:
            celsius (int): Temperature of the lid in Celsius. Valid range is 100°C-110°C.
        ...
        if celsius < 100 or celsius > 110:
            raise ValueError("Invalid lid temperature. Valid range is 100°C-110°C.")
    ...
    def set_block_temp(self, celsius: int, wait_for_temp:bool=True) -> 'ThermocyclerModule':
        ...
        Args:
            celsius (int): Temperature of the block in Celsius. Valid range is 4°C-99°C.
            wait_for_temp (bool, optional): Whether to wait for the block temperature to be reached. Defaults to True.
            
        Returns:
            ThermocyclerModule: The current module instance.
        """
        if celsius < 4 or celsius > 99:
            raise ValueError("Invalid block temperature. Valid range is 4°C-99°C.")
        ...
        for _ in range(cycle):
            for s in steps:
                if s['celsius'] < 4 or s['celsius'] > 99:
                    raise ValueError("Invalid temperature. Valid range is 4°C-99°C.")
