...
def concat_pcr_app_steps(commands: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
...
def concat_pcr_profile_app_steps(commands: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    """Concatenate consecutive PCR profile steps in app commands.
...
def concat_pcr_state_app_steps(commands: Dict[str, Dict[str, Any]]) -> Dict[str, Dict[str, Any]]:
    ...
    for current_id, current_command in commands.items():
        ...
        is_previous_state = (previous_command_id and \
