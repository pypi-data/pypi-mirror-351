...
class DlnirspParameters(ParameterBase, ParameterWavelengthMixin, ParameterArmIdMixin):
    ...
    def static_bad_pixel_map(self) -> np.ndarray:
        ...
        param_dict = self._find_parameter_for_arm("dlnirsp_static_bad_pixel_map")
        return self._load_param_value_from_fits(param_dict)

    @property
    def bad_pixel_gain_median_smooth_size(self) -> tuple[int, int]:
        """
    ...
    @property
    def bad_pixel_dark_median_smooth_size(self) -> tuple[int, int]:
        """
