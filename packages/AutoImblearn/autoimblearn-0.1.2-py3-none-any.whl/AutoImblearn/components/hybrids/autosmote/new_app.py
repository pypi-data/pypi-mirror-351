...
if __name__ == "__main__":
    ...
    __package__ = "AutoImblearn.clients"

import logging

from autosmote.classifiers import get_clf, name2f
from autosmote.rl.training import train

from AutoImblearn.components.clients.base_model_api import BaseModelAPI

import numpy as np


class RunAutosmoteAPI(BaseModelAPI):
