...
from ....types.v2.document_generate_response import DocumentGenerateResponse
from ....types.v2.document_retrieve_response import DocumentRetrieveResponse
from ....types.v2.document_extraction_response import DocumentExtractionResponse
...
class DocumentsResource(SyncAPIResource):
    ...
    def extraction(
        ...
        *,
        ...
        """
        Initiates an asynchronous data extraction process from specified documents based
        on answer schemas. Returns an ID to track the async result.

        Args:
          answer_schemas: An array of answer schemas defining what data to extract.

          documents: An array of documents to process for data extraction.
    ...
    def generate(
        ...
        *,
        ...
        """
        Initiates an asynchronous process to generate a document (e.g., PDF, report)
        from a template slug and variables. Returns an ID for tracking.

        Args:
          slug: The slug of the document template to use.

          type: The type of document to generate ('pdf' or 'report').

          variables: An object containing key-value pairs for template variables.
