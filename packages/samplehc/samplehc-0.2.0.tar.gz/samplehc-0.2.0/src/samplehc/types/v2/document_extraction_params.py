...
class DocumentExtractionParams(TypedDict, total=False):
    answer_schemas: Required[Annotated[Iterable[AnswerSchema], PropertyInfo(alias="answerSchemas")]]
    """An array of answer schemas defining what data to extract."""

    documents: Required[Iterable[Document]]
    """An array of documents to process for data extraction."""
