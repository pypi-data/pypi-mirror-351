...
- <code title="put /api/v2/workflow-runs/{workflowRunId}/cancel">client.v2.workflow_runs.<a href="./src/samplehc/resources/v2/workflow_runs/workflow_runs.py">cancel</a>(workflow_run_id) -> <a href="./src/samplehc/types/v2/workflow_run_cancel_response.py">object</a></code>
...
- <code title="post /api/v2/documents/extraction">client.v2.documents.<a href="./src/samplehc/resources/v2/documents/documents.py">extraction</a>(\*\*<a href="src/samplehc/types/v2/document_extraction_params.py">params</a>) -> <a href="./src/samplehc/types/v2/document_extraction_response.py">DocumentExtractionResponse</a></code>
- <code title="post /api/v2/documents/generate">client.v2.documents.<a href="./src/samplehc/resources/v2/documents/documents.py">generate</a>(\*\*<a href="src/samplehc/types/v2/document_generate_params.py">params</a>) -> <a href="./src/samplehc/types/v2/document_generate_response.py">DocumentGenerateResponse</a></code>
...
```python
from samplehc.types.v2 import CommunicationSendEmailResponse
```

Methods:

- <code title="post /api/v2/communication/send-email">client.v2.communication.<a href="./src/samplehc/resources/v2/communication.py">send_email</a>(\*\*<a href="src/samplehc/types/v2/communication_send_email_params.py">params</a>) -> <a href="./src/samplehc/types/v2/communication_send_email_response.py">object</a></code>
...
from samplehc.types.v2 import (
    ...
    ClearinghouseCoordinationOfBenefitsResponse,
)
```
...
- <code title="post /api/v2/clearinghouse/coordination-of-benefits">client.v2.clearinghouse.<a href="./src/samplehc/resources/v2/clearinghouse/clearinghouse.py">coordination_of_benefits</a>(\*\*<a href="src/samplehc/types/v2/clearinghouse_coordination_of_benefits_params.py">params</a>) -> <a href="./src/samplehc/types/v2/clearinghouse_coordination_of_benefits_response.py">object</a></code>
