...
class TestDocuments:
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_extraction(self, client: SampleHealthcare) -> None:
        document = client.v2.documents.extraction(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
        ...
        assert_matches_type(DocumentExtractionResponse, document, path=["response"])

    @pytest.mark.skip()
    @parametrize
    def test_raw_response_extraction(self, client: SampleHealthcare) -> None:
        response = client.v2.documents.with_raw_response.extraction(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_extraction(self, client: SampleHealthcare) -> None:
        with client.v2.documents.with_streaming_response.extraction(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_generate(self, client: SampleHealthcare) -> None:
        document = client.v2.documents.generate(
            slug="slug",
            type="pdf",
    ...
    @pytest.mark.skip()
    @parametrize
    def test_method_generate_with_all_params(self, client: SampleHealthcare) -> None:
        document = client.v2.documents.generate(
            slug="slug",
            type="pdf",
            variables={"foo": "string"},
    ...
    @pytest.mark.skip()
    @parametrize
    def test_raw_response_generate(self, client: SampleHealthcare) -> None:
        response = client.v2.documents.with_raw_response.generate(
            slug="slug",
            type="pdf",
            variables={"foo": "string"},
        )
    ...
    @pytest.mark.skip()
    @parametrize
    def test_streaming_response_generate(self, client: SampleHealthcare) -> None:
        with client.v2.documents.with_streaming_response.generate(
            slug="slug",
            type="pdf",
            variables={"foo": "string"},
        ) as response:
...
class TestAsyncDocuments:
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_extraction(self, async_client: AsyncSampleHealthcare) -> None:
        document = await async_client.v2.documents.extraction(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_extraction(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.v2.documents.with_raw_response.extraction(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_extraction(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.v2.documents.with_streaming_response.extraction(
            answer_schemas=[
                {
                    "label": "label",
                    "question": "question",
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_generate(self, async_client: AsyncSampleHealthcare) -> None:
        document = await async_client.v2.documents.generate(
            slug="slug",
            type="pdf",
            variables={"foo": "string"},
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_method_generate_with_all_params(self, async_client: AsyncSampleHealthcare) -> None:
        document = await async_client.v2.documents.generate(
            slug="slug",
            type="pdf",
            variables={"foo": "string"},
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_raw_response_generate(self, async_client: AsyncSampleHealthcare) -> None:
        response = await async_client.v2.documents.with_raw_response.generate(
            slug="slug",
            type="pdf",
            variables={"foo": "string"},
        )
    ...
    @pytest.mark.skip()
    @parametrize
    async def test_streaming_response_generate(self, async_client: AsyncSampleHealthcare) -> None:
        async with async_client.v2.documents.with_streaming_response.generate(
            slug="slug",
            type="pdf",
            variables={"foo": "string"},
        ) as response:
