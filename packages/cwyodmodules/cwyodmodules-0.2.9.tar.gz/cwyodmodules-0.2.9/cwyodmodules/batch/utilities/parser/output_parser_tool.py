    ...
    def parse(
        ...
        **kwargs: dict,
        ...
        with tracer.start_as_current_span("OutputParserTool.parse"):
            ...
            logger.info(f"Answer before cleanup: {answer}")
            logger.info(f"Question before cleanup: {question}")
            logger.info(f"Source documents before cleanup: {source_documents}")
