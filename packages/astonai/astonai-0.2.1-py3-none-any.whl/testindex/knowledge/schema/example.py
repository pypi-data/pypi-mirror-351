...
def create_test_node() -> TestNode:
    """Create an example TestNode."""
    node = TestNode(
...
def create_tests_relationship(test_node: TestNode, impl_node: ImplementationNode) -> TestsRelationship:
    """Create an example TestsRelationship."""
...
def create_uses_fixture_relationship(test_node: TestNode, fixture_node: FixtureNode) -> UsesFixtureRelationship:
    """Create an example UsesFixtureRelationship."""
...
def main():
    ...
    deserialized_node = demonstrate_deserialization(node_dict, TestNode)
    
    logger.info("Building example knowledge graph")
    graph = build_knowledge_graph_example()
    logger.info(f"Graph contains {len(graph['nodes'])} nodes and {len(graph['relationships'])} relationships")
