...
class Mysql():
    ...
    def __init__(self, configuration_file=None, section="mysql",host=None, port=3306, user=None, password=None, charset="utf8"):
...
if __name__ == "__main__":
    print(get_domain("https://www.baidu.com:8080/path/to/page"))