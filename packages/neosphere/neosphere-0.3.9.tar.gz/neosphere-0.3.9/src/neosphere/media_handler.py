...
class NeosphereMediaClient:
    ...
    def save_media(self, parent_id, media_file, filename=None, content_type=None, delete_after_upload=False) -> tuple[str, bool]:
        """
        ...
        Parameters:
            ...
            owner_id (str): The ID of the media owner. The token should have access to this owner.
