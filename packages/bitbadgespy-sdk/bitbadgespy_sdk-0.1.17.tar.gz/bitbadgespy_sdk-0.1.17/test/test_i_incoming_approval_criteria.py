...
class TestIIncomingApprovalCriteria(unittest.TestCase):
    """IIncomingApprovalCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IIncomingApprovalCriteria:
        """Test IIncomingApprovalCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IIncomingApprovalCriteria`
        """
        model = IIncomingApprovalCriteria()
        if include_optional:
            return IIncomingApprovalCriteria(
                coin_transfers = [
    ...
    def testIIncomingApprovalCriteria(self):
        """Test IIncomingApprovalCriteria"""
