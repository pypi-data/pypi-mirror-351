...
class TestIBalanceDoc(unittest.TestCase):
    """IBalanceDoc unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IBalanceDoc:
        """Test IBalanceDoc
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IBalanceDoc`
        """
        model = IBalanceDoc()
        if include_optional:
            return IBalanceDoc(
