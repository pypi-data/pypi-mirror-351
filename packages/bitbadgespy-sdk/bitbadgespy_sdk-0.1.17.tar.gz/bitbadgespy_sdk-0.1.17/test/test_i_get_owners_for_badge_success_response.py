...
class TestIGetOwnersForBadgeSuccessResponse(unittest.TestCase):
    """IGetOwnersForBadgeSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetOwnersForBadgeSuccessResponse:
        """Test IGetOwnersForBadgeSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetOwnersForBadgeSuccessResponse`
        """
        model = IGetOwnersForBadgeSuccessResponse()
        if include_optional:
            return IGetOwnersForBadgeSuccessResponse(
                owners = [
    ...
    def testIGetOwnersForBadgeSuccessResponse(self):
        """Test IGetOwnersForBadgeSuccessResponse"""
