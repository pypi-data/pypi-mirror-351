...
class TestIGetBadgesViewForUserSuccessResponse(unittest.TestCase):
    """IGetBadgesViewForUserSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBadgesViewForUserSuccessResponse:
        """Test IGetBadgesViewForUserSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBadgesViewForUserSuccessResponse`
        """
        model = IGetBadgesViewForUserSuccessResponse()
        if include_optional:
            return IGetBadgesViewForUserSuccessResponse(
    ...
    def testIGetBadgesViewForUserSuccessResponse(self):
        """Test IGetBadgesViewForUserSuccessResponse"""
