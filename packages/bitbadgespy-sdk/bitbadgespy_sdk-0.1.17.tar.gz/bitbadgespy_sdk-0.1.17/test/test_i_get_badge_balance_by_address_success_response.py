...
class TestIGetBadgeBalanceByAddressSuccessResponse(unittest.TestCase):
    """IGetBadgeBalanceByAddressSuccessResponse unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IGetBadgeBalanceByAddressSuccessResponse:
        """Test IGetBadgeBalanceByAddressSuccessResponse
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IGetBadgeBalanceByAddressSuccessResponse`
        """
        model = IGetBadgeBalanceByAddressSuccessResponse()
        if include_optional:
            return IGetBadgeBalanceByAddressSuccessResponse(
                balances = [
    ...
    def testIGetBadgeBalanceByAddressSuccessResponse(self):
        """Test IGetBadgeBalanceByAddressSuccessResponse"""
