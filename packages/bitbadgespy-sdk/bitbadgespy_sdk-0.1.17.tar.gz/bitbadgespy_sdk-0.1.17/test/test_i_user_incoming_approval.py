...
class TestIUserIncomingApproval(unittest.TestCase):
    """IUserIncomingApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUserIncomingApproval:
        """Test IUserIncomingApproval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUserIncomingApproval`
        """
        model = IUserIncomingApproval()
        if include_optional:
            return IUserIncomingApproval(
                from_list_id = '',
    ...
    def testIUserIncomingApproval(self):
        """Test IUserIncomingApproval"""
