...
class TestICollectionApproval(unittest.TestCase):
    """ICollectionApproval unit test stubs"""
    ...
    def make_instance(self, include_optional) -> ICollectionApproval:
        """Test ICollectionApproval
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `ICollectionApproval`
        """
        model = ICollectionApproval()
        if include_optional:
            return ICollectionApproval(
                to_list_id = '',
                ...
                uri = '',
                custom_data = '',
                approval_criteria = bitbadgespy_sdk.models.i_approval_criteria.iApprovalCriteria(
                    coin_transfers = [
                    ...
                    overrides_from_outgoing_approvals = True, 
                    overrides_to_incoming_approvals = True, ),
                version = None
            )
        else:
            return ICollectionApproval(
    ...
    def testICollectionApproval(self):
        """Test ICollectionApproval"""
