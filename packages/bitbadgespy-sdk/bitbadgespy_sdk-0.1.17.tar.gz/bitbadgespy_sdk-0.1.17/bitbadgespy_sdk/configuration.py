...
AuthSettings = TypedDict(
    "AuthSettings",
    {
        ...
        "frontendOnly": APIKeyAuthSetting,
    },
    total=False,
)
...
conf = bitbadgespy_sdk.Configuration(
    ...
    def __init__(
        ...
        *,
        ...
        """Constructor
        """
        self._base_path = "https://api.bitbadges.io/api/v0" if host is None else host
        """Default Base url
        """
        ...
        """Logging Settings
        """
        self.logger["package_logger"] = logging.getLogger("bitbadgespy_sdk")
    ...
    def auth_settings(self)-> AuthSettings:
        ...
        if 'frontendOnly' in self.api_key:
            auth['frontendOnly'] = {
                'type': 'api_key',
                'in': 'header',
                'key': 'Origin',
