...
class IApprovalCriteria(BaseModel):
    """
    IApprovalCriteria
    """ # noqa: E501
    coin_transfers: Optional[List[ICoinTransfer]] = Field(default=None, description="The $BADGE transfers to be executed upon every approval.", alias="coinTransfers")
    ...
    require_from_equals_initiated_by: Optional[StrictBool] = Field(default=None, description="Whether the from address must equal the initiatedBy address.", alias="requireFromEqualsInitiatedBy")
    ...
    require_from_does_not_equal_initiated_by: Optional[StrictBool] = Field(default=None, description="Whether the from address must not equal the initiatedBy address.", alias="requireFromDoesNotEqualInitiatedBy")
    overrides_from_outgoing_approvals: Optional[StrictBool] = Field(default=None, description="Whether this approval overrides the from address's approved outgoing transfers.", alias="overridesFromOutgoingApprovals")
    overrides_to_incoming_approvals: Optional[StrictBool] = Field(default=None, description="Whether this approval overrides the to address's approved incoming transfers.", alias="overridesToIncomingApprovals")
    __properties: ClassVar[List[str]] = ["coinTransfers", "merkleChallenges", "predeterminedBalances", "approvalAmounts", "maxNumTransfers", "requireToEqualsInitiatedBy", "requireFromEqualsInitiatedBy", "requireToDoesNotEqualInitiatedBy", "requireFromDoesNotEqualInitiatedBy", "overridesFromOutgoingApprovals", "overridesToIncomingApprovals"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of IApprovalCriteria from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of IApprovalCriteria from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            ...
            "requireFromEqualsInitiatedBy": obj.get("requireFromEqualsInitiatedBy"),
            "requireToDoesNotEqualInitiatedBy": obj.get("requireToDoesNotEqualInitiatedBy"),
            "requireFromDoesNotEqualInitiatedBy": obj.get("requireFromDoesNotEqualInitiatedBy"),
            "overridesFromOutgoingApprovals": obj.get("overridesFromOutgoingApprovals"),
            "overridesToIncomingApprovals": obj.get("overridesToIncomingApprovals")
        })
        return _obj
