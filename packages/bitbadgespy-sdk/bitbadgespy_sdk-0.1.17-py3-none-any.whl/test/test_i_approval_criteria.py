...
class TestIApprovalCriteria(unittest.TestCase):
    """IApprovalCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IApprovalCriteria:
        """Test IApprovalCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IApprovalCriteria`
        """
        model = IApprovalCriteria()
        if include_optional:
            return IApprovalCriteria(
                coin_transfers = [
    ...
    def testIApprovalCriteria(self):
        """Test IApprovalCriteria"""
