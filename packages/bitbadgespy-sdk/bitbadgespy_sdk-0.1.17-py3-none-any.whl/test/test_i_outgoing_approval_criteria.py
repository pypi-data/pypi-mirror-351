...
class TestIOutgoingApprovalCriteria(unittest.TestCase):
    """IOutgoingApprovalCriteria unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IOutgoingApprovalCriteria:
        """Test IOutgoingApprovalCriteria
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IOutgoingApprovalCriteria`
        """
        model = IOutgoingApprovalCriteria()
        if include_optional:
            return IOutgoingApprovalCriteria(
                coin_transfers = [
    ...
    def testIOutgoingApprovalCriteria(self):
        """Test IOutgoingApprovalCriteria"""
