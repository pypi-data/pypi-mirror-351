...
class TestIMsgUpdateUserApprovals(unittest.TestCase):
    """IMsgUpdateUserApprovals unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IMsgUpdateUserApprovals:
        """Test IMsgUpdateUserApprovals
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IMsgUpdateUserApprovals`
        """
        model = IMsgUpdateUserApprovals()
        if include_optional:
            return IMsgUpdateUserApprovals(
                creator = '',
                collection_id = '',
                update_outgoing_approvals = True,
                outgoing_approvals = [
                ...
                update_incoming_approvals = True,
                incoming_approvals = [
                ...
                update_auto_approve_self_initiated_outgoing_transfers = True,
                auto_approve_self_initiated_outgoing_transfers = True,
                update_auto_approve_self_initiated_incoming_transfers = True,
                auto_approve_self_initiated_incoming_transfers = True,
                update_auto_approve_all_incoming_transfers = True,
    ...
    def testIMsgUpdateUserApprovals(self):
        """Test IMsgUpdateUserApprovals"""
