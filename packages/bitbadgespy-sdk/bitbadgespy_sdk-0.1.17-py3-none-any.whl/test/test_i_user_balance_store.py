...
class TestIUserBalanceStore(unittest.TestCase):
    """IUserBalanceStore unit test stubs"""
    ...
    def make_instance(self, include_optional) -> IUserBalanceStore:
        """Test IUserBalanceStore
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `IUserBalanceStore`
        """
        model = IUserBalanceStore()
        if include_optional:
            return IUserBalanceStore(
                balances = [
    ...
    def testIUserBalanceStore(self):
        """Test IUserBalanceStore"""
