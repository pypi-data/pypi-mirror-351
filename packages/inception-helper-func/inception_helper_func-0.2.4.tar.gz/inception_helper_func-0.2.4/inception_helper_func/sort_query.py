ES_SORT_QUERY = {
    ...
    "lowest_to_highest": {"position": {"order": "asc"}},
    "highest_to_lowest": {"position": {"order": "desc"}},
}
...
MONGO_DB_SORT_QUERY = {
    ...
    "a_z": {"name": 1},
    "z_a": {"name": -1},
    "lowest_to_highest": {"position": 1},
    "highest_to_lowest": {"position": -1},
}
...
def sort_query_es(
    ...
    numeric_sort_field: str = "position"
) -> dict:
    """
    ...
    Args:
        ...
        alpha_sort_field (str, optional): The field name to use for alphabetical sorting.
            Defaults to "name".
        numeric_sort_field (str, optional): The field name to use for numeric sorting.
    ...
    if sort_by in ["a_z", "z_a"] and alpha_sort_field:
        ...
        return {numeric_sort_field: ES_SORT_QUERY[sort_by]["position"]}
    else:
...
def sort_query_mongo(
    ...
    if sort_by in ["a_z", "z_a"] and alpha_sort_field:
        ...
        return {numeric_sort_field: MONGO_DB_SORT_QUERY[sort_by]["position"]}
    else:
