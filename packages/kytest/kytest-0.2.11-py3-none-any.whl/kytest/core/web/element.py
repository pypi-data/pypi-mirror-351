...
class Elem:
    ...
    def all_text_content(self):
        logger.info(f"获取控件{self._kwargs}的多个文本")
        elems = self.find().all()
    ...
    def click_exists(self, timeout=5, *args, **kwargs):
        ...
        @return:
        """
        logger.info(f"控件{self._kwargs}存在才点击")
        try:
            self.find(timeout=timeout, n=0).click(*args, **kwargs)
            logger.info("点击完成")
        except:
    ...
    def click(self, timeout=5, *args, **kwargs):
        ...
        @return: 
        """
        logger.info(f"控件{self._kwargs}点击")
    ...
    def scroll_into_view_if_needed(self, timeout=5):
        ...
        @return:
        """
        logger.info(f"控件{self._kwargs}滚动到可视区")
    ...
    def download(self, save_path: str, timeout=5):
        ...
        @return:
        """
        logger.info(f"点击控件{self._kwargs}进行下载")
    ...
    def popup(self, timeout=5):
        ...
        @return:
        """
        logger.info(f"点击控件{self._kwargs}打开新页签")
