...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-emr-serverless)](https://pypistats.org/packages/mypy-boto3-emr-serverless)
...
`mypy-boto3-emr-serverless` dependency in production. However, there is an
