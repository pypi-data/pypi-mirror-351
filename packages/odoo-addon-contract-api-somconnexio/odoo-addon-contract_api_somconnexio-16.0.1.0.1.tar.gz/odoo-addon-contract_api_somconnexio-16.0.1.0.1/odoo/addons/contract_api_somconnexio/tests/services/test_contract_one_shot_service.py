...
class TestContractOneShotService(BaseRestCaseAdmin):
    ...
    @patch(
        "odoo.addons.somconnexio.wizards.contract_one_shot_request.contract_one_shot_request.ContractOneShotRequestWizard.button_add"  # noqa
    )
    def test_route_right_run_wizard(self, mock_button_add):
        ...
        mock_button_add.assert_called_once()
