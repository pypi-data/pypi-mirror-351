...
class ClerkWebhooks(BaseSDK):
    def handle(
        ...
        *,
        ...
        :param svix_id:
        :param svix_timestamp:
        :param svix_signature:
        ...
        request = models.HandleClerkWebhookEndpointClerkWebhooksPostRequest(
            svix_id=svix_id,
        ...
        http_res = self.do_request(
            hook_ctx=HookContext(
                ...
                operation_id="handle_clerk_webhook_endpoint_clerk_webhooks__post",
                oauth2_scopes=[],
