...
from gllm_inference.schema import ANY_EXTENSION as ANY_EXTENSION, LMOutput as LMOutput, MimeType as MimeType, ModelId as ModelId, ModelProvider as ModelProvider, MultimodalContent as MultimodalContent, MultimodalOutput as MultimodalOutput, MultimodalPrompt as MultimodalPrompt, PromptRole as PromptRole, ResponseSchema as ResponseSchema, TokenUsage as TokenUsage, ToolCall as ToolCall, ToolResult as ToolResult
...
class OpenAICompatibleLMInvoker(BaseLMInvoker):
    ...
    Output types:
        ...
        2. `LMOutput`: A Pydantic model with the following attributes if any additional output is needed:
            ...
            2.3. structured_output (StructuredOutput | None): The structured output, if the `response_schema` parameter
    ...
    def __init__(self, model_name: str, base_url: str, api_key: str, model_kwargs: dict[str, Any] | None = None, default_hyperparameters: dict[str, Any] | None = None, tools: list[Tool] | None = None, response_schema: ResponseSchema | None = None, output_analytics: bool = False, bind_tools_params: dict[str, Any] | None = None, with_structured_output_params: dict[str, Any] | None = None) -> None:
        ...
        Args:
            ...
            api_key (str): The API key for authenticating with the OpenAI compatible endpoint.
