...
class AzureOpenAILMInvoker(OpenAILMInvoker):
    ...
    Attributes:
        ...
        model_name (str): The name of the Azure OpenAI model deployment.
    ...
    '''
    client: Incomplete
    def __init__(self, azure_endpoint: str, azure_deployment: str, api_version: str, api_key: str, model_kwargs: dict[str, Any] | None = None, default_hyperparameters: dict[str, Any] | None = None, tools: list[Tool] | None = None, response_schema: ResponseSchema | None = None, output_analytics: bool = False, reasoning_effort: ReasoningEffort | None = None, reasoning_summary: ReasoningSummary | None = None, bind_tools_params: dict[str, Any] | None = None, with_structured_output_params: dict[str, Any] | None = None) -> None:
