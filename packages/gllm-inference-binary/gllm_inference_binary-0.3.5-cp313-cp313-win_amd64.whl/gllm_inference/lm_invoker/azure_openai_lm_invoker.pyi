...
class AzureOpenAILMInvoker(OpenAILMInvoker):
    ...
    '''
    client: Incomplete
    def __init__(self, azure_endpoint: str, azure_deployment: str, api_key: str, api_version: str = '2025-03-01-preview', model_kwargs: dict[str, Any] | None = None, default_hyperparameters: dict[str, Any] | None = None, tools: list[Tool] | None = None, response_schema: ResponseSchema | None = None, output_analytics: bool = False, reasoning_effort: ReasoningEffort | None = None, reasoning_summary: ReasoningSummary | None = None, bind_tools_params: dict[str, Any] | None = None, with_structured_output_params: dict[str, Any] | None = None) -> None:
        ...
        Args:
            ...
            api_version (str, optional): The API version of the Azure OpenAI service. Defaults to "2025-03-01-preview".
