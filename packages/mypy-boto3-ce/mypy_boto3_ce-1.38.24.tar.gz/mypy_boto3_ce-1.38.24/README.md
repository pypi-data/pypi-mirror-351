...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-ce)](https://pypistats.org/packages/mypy-boto3-ce)
...
`mypy-boto3-ce` dependency in production. However, there is an issue in
...
`mypy_boto3_ce.paginator` module contains type annotations for all paginators.
