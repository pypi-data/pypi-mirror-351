...
__all__ = ["EmployeeGetTransactionsResponse", "EmployeeGetTransactionsResponseItem"]


class EmployeeGetTransactionsResponseItem(BaseModel):
...
EmployeeGetTransactionsResponse: TypeAlias = List[EmployeeGetTransactionsResponseItem]
