...
def _get_open_connections(client: AmbientSDK | AsyncAmbientSDK) -> int:
...
class TestAmbientSDK:
    client = AmbientSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "ambient_sdk/_legacy_response.py",
                        "ambient_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "ambient_sdk/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(AmbientSDKError):
            with update_env(**{"AMBIENT_SDK_API_KEY": Omit()}):
                client2 = AmbientSDK(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_setter(self) -> None:
        client = AmbientSDK(base_url="https://example.com/from_init", api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(AMBIENT_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AmbientSDK(api_key=api_key, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: AmbientSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AmbientSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AmbientSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AmbientSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = AmbientSDK(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/authorization").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: AmbientSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.authorization.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.authorization.with_raw_response.retrieve(extra_headers={"x-stainless-retry-count": "42"})

        assert response.http_request.headers.get("x-stainless-retry-count") == "42"


class TestAsyncAmbientSDK:
    client = AsyncAmbientSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)
    ...
    def test_validate_headers(self) -> None:
        ...
        with pytest.raises(AmbientSDKError):
            with update_env(**{"AMBIENT_SDK_API_KEY": Omit()}):
                client2 = AsyncAmbientSDK(base_url=base_url, api_key=None, _strict_response_validation=True)
            _ = client2
    ...
    def test_base_url_env(self) -> None:
        with update_env(AMBIENT_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncAmbientSDK(api_key=api_key, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncAmbientSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncAmbientSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncAmbientSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncAmbientSDK(base_url=base_url, api_key=api_key, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            await strict_client.get("/foo", cast_to=Model)

        client = AsyncAmbientSDK(base_url=base_url, api_key=api_key, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        ...
        response = await client.authorization.with_raw_response.retrieve()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncAmbientSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
    ...
    def test_get_platform(self) -> None:
        ...
        from ambient_sdk._utils import asyncify
        from ambient_sdk._base_client import get_platform
