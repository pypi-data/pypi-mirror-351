...
from ffquant.symbols.US_Stock import US_Stock

class VolStrengthUSStock(IndexListIndicator):
    lines = (
    ...
    def next(self):
        ...
        us_stock_sym = US_Stock()
        if not us_stock_sym.is_trading_time(cur_bar_local_time):
    ...
    def prepare_params(self, start_time_str, end_time_str):
        params = {
            'symbol': "zg_stock_us",
            'type': 'indicator_volume_us_strength',
            'key_list': 'vol_list',
