...
from feng_tools.web.amis.constants import (
    BarcodeEnum,
    DisplayModeEnum,
    LevelEnum,
    PlacementEnum,
...
from feng_tools.web.amis.schema.amis_types import (
    API,
    AmisNode,
    BaseAmisModel,
    Expression,
...
class PageSchema(AmisNode):
    ...
    schema_: Optional[Union[Page, "Iframe"]] = Field(None, alias="schema")  # The configuration of the page, please go to the
    ...
    def as_page_body(self, group_extra: Dict[str, Any] = None, item_extra: Dict[str, Any] = None):
        if self.children:
            ...
            if self.tabsMode is None:
                body = App(pages=[PageSchema(children=self.children,schema=None)])
