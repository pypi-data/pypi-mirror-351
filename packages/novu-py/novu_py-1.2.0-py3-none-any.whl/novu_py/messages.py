...
class Messages(BaseSDK):
    ...
    def retrieve(
        ...
        *,
        request: Union[
            models.MessagesControllerGetMessagesRequest,
            models.MessagesControllerGetMessagesRequestTypedDict,
        ] = models.MessagesControllerGetMessagesRequest(),
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, models.MessagesControllerGetMessagesRequest
            )
        request = cast(models.MessagesControllerGetMessagesRequest, request)
    ...
    def delete(
        ...
        *,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.MessagesControllerDeleteMessageResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.DeleteMessageResponseDto
                ),
                headers=utils.get_response_headers(http_res.headers),
            )
        if utils.match_response(http_res, "414", "application/json"):
    ...
    def delete_by_transaction_id(
        ...
        *,
        ...
        if utils.match_response(http_res, "204", "*"):
            return models.MessagesControllerDeleteMessagesByTransactionIDResponse(
                headers=utils.get_response_headers(http_res.headers)
            )
        if utils.match_response(http_res, "414", "application/json"):
            response_data = utils.unmarshal_json(http_res.text, models.ErrorDtoData)
    ...
    async def delete_by_transaction_id_async(
        self,
        *,
        transaction_id: str,
        channel: Optional[models.QueryParamChannel] = None,
