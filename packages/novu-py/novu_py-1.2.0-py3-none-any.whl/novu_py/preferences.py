...
class Preferences(BaseSDK):
    def list(
        ...
        *,
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerGetSubscriberPreferencesResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.GetSubscriberPreferencesDto
                ),
    ...
    def update(
        ...
        *,
        subscriber_id: str,
        patch_subscriber_preferences_dto: Union[
            models.PatchSubscriberPreferencesDto,
            models.PatchSubscriberPreferencesDtoTypedDict,
        ],
        idempotency_key: Optional[str] = None,
        retries: OptionalNullable[utils.RetryConfig] = UNSET,
        server_url: Optional[str] = None,
        ...
        **workflowId** is optional field, if provided, this API will update that workflow preference,
        ...
        request = models.SubscribersControllerUpdateSubscriberPreferencesRequest(
            subscriber_id=subscriber_id,
            idempotency_key=idempotency_key,
            patch_subscriber_preferences_dto=utils.get_pydantic_model(
                patch_subscriber_preferences_dto, models.PatchSubscriberPreferencesDto
            ),
        )
        ...
        req = self._build_request(
            ...
            get_serialized_body=lambda: utils.serialize_request_body(
                request.patch_subscriber_preferences_dto,
                False,
                False,
                "json",
                models.PatchSubscriberPreferencesDto,
        ...
        response_data: Any = None
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerUpdateSubscriberPreferencesResponse(
                result=utils.unmarshal_json(
                    http_res.text, models.GetSubscriberPreferencesDto
                ),
                headers=utils.get_response_headers(http_res.headers),
