...
class NovuTopics(BaseSDK):
    def list(
        self,
        *,
        request: Union[
            models.SubscribersControllerListSubscriberTopicsRequest,
            models.SubscribersControllerListSubscriberTopicsRequestTypedDict,
        ],
        ...
        if not isinstance(request, BaseModel):
            request = utils.unmarshal(
                request, models.SubscribersControllerListSubscriberTopicsRequest
            )
        request = cast(models.SubscribersControllerListSubscriberTopicsRequest, request)
        ...
        if utils.match_response(http_res, "200", "application/json"):
            return models.SubscribersControllerListSubscriberTopicsResponse(
