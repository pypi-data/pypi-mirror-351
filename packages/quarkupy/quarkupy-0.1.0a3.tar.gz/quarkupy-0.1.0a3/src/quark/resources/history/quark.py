...
from ...types.registry.quark.files.quark_history_item import QuarkHistoryItem
    ...
    def update(
        ...
        *,
        ...
        Args:
          ...
          lattice_id: Identifier of the associated Lattice.

          output: Output data produced by the Quark execution, stored as a JSON value.

          quark_id: Unique identifier for the Quark.

          registry_identifier: Identifier for the registry where the Quark is defined.
