...
def time(
    ...
    **attrs: Unpack[TimeAttrs],
    ...
    It may include the `datetime` attribute to translate dates into machine-readable
    format, allowing for better search engine results or custom feats such as reminders.
