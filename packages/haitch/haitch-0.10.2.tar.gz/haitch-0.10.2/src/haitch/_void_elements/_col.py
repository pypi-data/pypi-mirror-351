...
def col(
    ...
    **attrs: Unpack[ColAttrs],
    ...
    Note: The `<col>` element is only valid as a child of a `<colgroup>` element that
    has no span attribute defined.
...
class ColAttrs(GlobalAttrs):
    ...
    Warning: the value must be a positive integer greater than zero. If not present,
