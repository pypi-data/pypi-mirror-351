...
def article(
    ...
    **attrs: Unpack[GlobalAttrs],
    ...
    """Represents self-contained composition in a document, page, application, or site.

    The `<article>` element is intended to be independently distributable or reusable
    (e.g., in syndication). Examples include: a forum post, a magazine or newspaper
    article, or a blog entry, a product card, a user-submitted comment, an interactive
