...
class ThermistorEmulationInterface:
    def __init__(self,name=None,ref_resistance=10000.0,ref_temperature=25.0,beta=3950.0,series_resistance=10000.0,
                 ref_voltage=3.3,dac_interface:DACInterface=None,data_interface:DataCollectionInterface=None,register_for_log=False):
        ...
        self.data_dict={str(self.name)+"__set_temperature":self.current_temperature}     
        ...
        if(self.data_interface):
            self.data_interface.register_for_data_collection(self.data_dict,self.register_for_log)
            self.data_interface.update_data(self.data_dict)
    ...
    def set_temperature(self,temperature):
        ...
        self.data_dict[str(self.name)+"__set_temperature"]=temperature
        if(self.data_interface):
            self.data_interface.update_data(self.data_dict)
