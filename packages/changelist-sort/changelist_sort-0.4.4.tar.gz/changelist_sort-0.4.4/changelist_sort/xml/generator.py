...
**Returns:**
 ElementTree - The XML ElementTree containing the Initial Changelists Config Information.
    ...
    changelists_cl.append(changelist_files := Element(reader.FILES_TAG))
    changelist_files.set(reader.FILES_PATH_START, '.changelists')
    changelist_files.set(reader.FILES_FILENAME_PREFIX, 'sort')
    changelist_files.set(reader.FILES_EXTENSION, 'xml')
