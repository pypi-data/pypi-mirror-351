...
#readme_path =  readme_path.exists()
readme_path_exists = False
if readme_path_exists:
...
setup(
    name="prfr-data-streamlit-fork",
    version=VERSION,
    description="A faster way to build and share data apps",
    long_description=long_description,
    long_description_content_type="text/markdown",
    url="https://github.com/pernod-ricard-france-data/prfr-data-streamlit-fork",
    project_urls={
        "Source Code": "https://github.com/pernod-ricard-france-data/prfr-data-streamlit-fork",
        "Bug Tracker": "https://github.com/pernod-ricard-france-data/prfr-data-streamlit-fork/issues",
        "Release notes": "https://github.com/pernod-ricard-france-data/prfr-data-streamlit-fork/releases",
