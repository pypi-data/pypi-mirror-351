"""
Setup script for types-boto3-autoscaling.
...
setup(
    ...
    description="Type annotations for boto3 AutoScaling 1.38.26 service generated with mypy-boto3-builder 8.11.0",
    classifiers=[
    ...
    package_data={"types_boto3_autoscaling": ["py.typed", "*.pyi"]},
    python_requires=">=3.8",
    project_urls={
