...
class ComputeStats(object):
    ...
    .. versionadded:: 3.3
        three-population site configuration statistic (``triconfig``).

    .. versionadded:: 3.4
        admixture statistics (``f2``, ``f3``, ``f4`` and ``Dp``).
    ...
    def configure(self,
        ...
        :param struct: a :class:`.Structure` instance describing the
            structure of objects that will be passed.
