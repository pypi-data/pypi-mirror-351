...
from .schema import ReplicateImagen3Input


class ReplicateTextToImageAdapter(IReplicateAdapter):
    """Adapter for text-to-image generation using Imagen3 model on Replicate."""
    ...
    def convert_input(self, data) -> dict:
        ...
        replicate_input = ReplicateImagen3Input(
    ...
    def get_request_url(self) -> str:
        ...
        return "https://api.replicate.com/v1/models/google/imagen-3/predictions"
