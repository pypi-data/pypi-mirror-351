...
service = BaseAPIService(
    ...
    description="API for ElevenLabs Turbo V2.5 text-to-audio generation",
    version="2.5",
...
@service.app.post(
    ...
    description="Convert text into audio using ElevenLabs Turbo V2.5 model",
)
...
registry_items = {
    f"{model_path}/text-to-audio": [
        {
            "service_provider": ServiceProviderEnum.ELEVENLABS_OFFICIAL.value,
