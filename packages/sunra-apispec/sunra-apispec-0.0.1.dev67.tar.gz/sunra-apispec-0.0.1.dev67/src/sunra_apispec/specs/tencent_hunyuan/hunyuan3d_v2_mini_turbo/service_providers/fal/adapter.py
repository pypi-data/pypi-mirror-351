...
class FalImageTo3DAdapter(IFalAdapter):
    """Adapter for FAL Hunyuan3D V2 Mini Turbo Image-to-3D API."""
    ...
    def convert_input(self, data: dict) -> dict:
        ...
        fal_input = FalImageTo3DInput(
            input_image_url=input_model.image,
    ...
    def get_fal_model(self) -> str:
        """Return the FAL model endpoint URL."""
        return "fal-ai/hunyuan3d/v2/mini/turbo"
