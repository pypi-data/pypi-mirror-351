...
from .service_providers.replicate.adapter import MinimaxSpeechInput
...
service = BaseAPIService(
    title="Minimax speech-02-hd API",
    description="API for Minimax speech-02-hd text-to-audio generation model",
    version="1.0.0",
