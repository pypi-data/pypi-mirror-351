...
class ReplicateImageToVideoAdapter(IReplicateAdapter):
    """Adapter for image-to-video generation using Kling v1.5 Standard model on Replicate."""
    ...
    def get_request_url(self) -> str:
        ...
        return "https://api.replicate.com/v1/models/kwaivgi/kling-v1.5-standard/predictions"
