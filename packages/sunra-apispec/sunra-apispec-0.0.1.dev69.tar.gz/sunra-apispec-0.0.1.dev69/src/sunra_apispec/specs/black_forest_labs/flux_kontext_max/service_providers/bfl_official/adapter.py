"""
Adapter for Black Forest Labs Official FLUX Kontext Max API service provider.
...
class BFLFluxKontextMaxTextToImageAdapter(IBlackForestLabsAdapter):
    """Adapter for FLUX Kontext Max text-to-image generation using BFL Official API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra TextToImageInput to BFL Official BFLFluxKontextMaxInput format."""
        input_model = TextToImageInput.model_validate(data)
        
        bfl_input = BFLFluxKontextMaxInput(
    ...
    def get_bfl_model(self) -> str:
        """Get the BFL model identifier for FLUX Kontext Max."""
...
class BFLFluxKontextMaxImageToImageAdapter(IBlackForestLabsAdapter):
    """Adapter for FLUX Kontext Max image-to-image generation using BFL Official API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra ImageToImageInput to BFL Official BFLFluxKontextMaxInput format."""
