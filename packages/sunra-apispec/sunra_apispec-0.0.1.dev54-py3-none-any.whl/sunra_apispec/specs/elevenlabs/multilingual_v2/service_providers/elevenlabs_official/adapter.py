...
class ElevenLabsMultilingualV2Adapter(IElevenLabsAdapter):
    """Adapter for ElevenLabs Multilingual V2 text-to-speech model."""
    ...
    def convert_input(self, data) -> dict:
        ...
        elevenlabs_input = ElevenLabsMultilingualV2Input(
