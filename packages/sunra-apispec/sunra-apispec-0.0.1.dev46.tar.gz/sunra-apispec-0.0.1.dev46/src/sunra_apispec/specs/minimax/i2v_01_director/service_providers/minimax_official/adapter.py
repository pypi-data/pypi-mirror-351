...
class MinimaxImageToVideoDirectorAdapter(IMinimaxAdapter):
    """Adapter for image-to-video generation using MiniMax I2V-01-Director model."""
    ...
    def convert_input(self, data: dict) -> dict:
        ...
        minimax_input = MinimaxVideoGenInput(
            model=ModelEnum.I2V_01_DIRECTOR,
