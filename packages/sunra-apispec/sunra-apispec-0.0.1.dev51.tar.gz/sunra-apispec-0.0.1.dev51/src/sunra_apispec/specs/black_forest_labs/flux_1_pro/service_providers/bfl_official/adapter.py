"""
Adapter for Black Forest Labs Official FLUX 1.0 Pro API service provider.
...
from .schema import BFLFluxV1ProInput, OutputFormat


class BFLFluxV1ProTextToImageAdapter(IBlackForestLabsAdapter):
    """Adapter for FLUX 1.0 Pro text-to-image generation using BFL Official API."""
    
    def convert_input(self, data) -> dict:
        """Convert Sunra TextToImageInput to BFL Official BFLFluxV1ProInput format."""
    ...
    def get_bfl_model(self) -> str:
        """Get the BFL model identifier for FLUX 1.0 Pro."""
        return "flux-pro"
...
class BFLFluxV1ProImageToImageAdapter(IBlackForestLabsAdapter):
