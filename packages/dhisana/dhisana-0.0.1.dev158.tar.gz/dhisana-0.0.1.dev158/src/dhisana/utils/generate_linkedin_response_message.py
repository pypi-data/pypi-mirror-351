...
async def generate_linkedin_response_message_copy(
    ...
    prompt = f"""
        ...
        {[thread_item.model_dump() for thread_item in cleaned_context.current_conversation_context.current_linkedin_thread] 
            if cleaned_context.current_conversation_context.current_linkedin_thread else []}
        ...
        propose next step.  
        • Never contradict, trash-talk, or disparage {cleaned_context.lead_info.organization_name}.  
