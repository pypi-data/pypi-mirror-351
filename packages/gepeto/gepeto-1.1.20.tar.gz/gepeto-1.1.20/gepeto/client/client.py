...
class Gepeto:
    def __init__(self, api_key: Optional[str] = None, x_trace_id: Optional[str] = None):
        ...
        self.base_url = os.environ.get("GEPETO_BASE_URL", "https://gateway.start248.com")
        self.auth_url = os.environ.get("GEPETO_AUTH_URL", f"{self.base_url}/auth/api/v1")
        self.server_url = os.environ.get("GEPETO_SERVER_URL", f"{self.base_url}/server/api/v1")
        ...
        self.agents = Agents(api_key=self.api_key, base_url=self.server_url, prompts=self.prompts, x_trace_id=self.x_trace_id)
