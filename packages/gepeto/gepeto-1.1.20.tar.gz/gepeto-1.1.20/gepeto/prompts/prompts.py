...
class Prompts:
    ...
    def create(self, name: str, content: str, description: str = None) -> Prompt:
        ...
        return Prompt(created_at=json_data["created_at"], updated_at=json_data["updated_at"], id=json_data["id"], prompt_id=json_data["prompt_id"], name=json_data["prompt"]["name"])
