...
def _get_open_connections(client: HubmapSearchSDK | AsyncHubmapSearchSDK) -> int:
...
class TestHubmapSearchSDK:
    client = HubmapSearchSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)
            ...
            for frame in diff.traceback:
                if any(
                    ...
                    for fragment in [
                        ...
                        "hubmap_search_sdk/_legacy_response.py",
                        "hubmap_search_sdk/_response.py",
                        # pydantic.BaseModel.model_dump || pydantic.BaseModel.dict leak memory for some reason.
                        "hubmap_search_sdk/_compat.py",
    ...
    def test_validate_headers(self) -> None:
        ...
        client2 = HubmapSearchSDK(base_url=base_url, bearer_token=None, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(HUBMAP_SEARCH_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = HubmapSearchSDK(bearer_token=bearer_token, _strict_response_validation=True)
    ...
    def test_base_url_trailing_slash(self, client: HubmapSearchSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: HubmapSearchSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: HubmapSearchSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
    ...
    def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = HubmapSearchSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=True)

        with pytest.raises(APIResponseValidationError):
            strict_client.get("/foo", cast_to=Model)

        client = HubmapSearchSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    def test_retries_taken(
        ...
        respx_mock.get("/indices").mock(side_effect=retry_handler)
    ...
    def test_omit_retry_count_header(
        self, client: HubmapSearchSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = client.with_options(max_retries=4)
        ...
        response = client.indices.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    def test_overwrite_retry_count_header(
        ...
        response = client.indices.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
...
class TestAsyncHubmapSearchSDK:
    ...
    def test_validate_headers(self) -> None:
        ...
        client2 = AsyncHubmapSearchSDK(base_url=base_url, bearer_token=None, _strict_response_validation=True)
    ...
    def test_base_url_env(self) -> None:
        with update_env(HUBMAP_SEARCH_SDK_BASE_URL="http://localhost:5000/from/env"):
            client = AsyncHubmapSearchSDK(bearer_token=bearer_token, _strict_response_validation=True)
            assert client.base_url == "http://localhost:5000/from/env/"
    ...
    def test_base_url_trailing_slash(self, client: AsyncHubmapSearchSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_base_url_no_trailing_slash(self, client: AsyncHubmapSearchSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="/foo",
    ...
    def test_absolute_request_url(self, client: AsyncHubmapSearchSDK) -> None:
        request = client._build_request(
            FinalRequestOptions(
                method="post",
                url="https://myapi.com/foo",
    ...
    async def test_received_text_for_expected_json(self, respx_mock: MockRouter) -> None:
        ...
        strict_client = AsyncHubmapSearchSDK(
        ...
        client = AsyncHubmapSearchSDK(base_url=base_url, bearer_token=bearer_token, _strict_response_validation=False)
    ...
    async def test_retries_taken(
        self,
        async_client: AsyncHubmapSearchSDK,
        failures_before_success: int,
        failure_mode: Literal["status", "exception"],
        respx_mock: MockRouter,
    ) -> None:
        ...
        response = await client.indices.with_raw_response.list()
    ...
    async def test_omit_retry_count_header(
        self, async_client: AsyncHubmapSearchSDK, failures_before_success: int, respx_mock: MockRouter
    ) -> None:
        client = async_client.with_options(max_retries=4)
        ...
        response = await client.indices.with_raw_response.list(extra_headers={"x-stainless-retry-count": Omit()})
    ...
    async def test_overwrite_retry_count_header(
        ...
        response = await client.indices.with_raw_response.list(extra_headers={"x-stainless-retry-count": "42"})
