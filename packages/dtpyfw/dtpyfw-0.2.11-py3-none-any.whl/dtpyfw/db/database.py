        ...
        try:
            ...
            try:
                ...
                footprint.leave(
                    ...
                    controller='DatabaseInstance.get_db',
        ...
        try:
            ...
            try:
                ...
                footprint.leave(
                    log_type='warning',
                    message="We could not close the database because of an error.",
                    controller='DatabaseInstance.get_db_cm',
                    subject=f'Closing Database Connection Error',
                    payload=exception_to_dict(e),
                )
    ...
    def check_database_health(self):
        try:
            ...
            footprint.leave(
                ...
                controller='DatabaseInstance.check_database_health',
        ...
        try:
            ...
            try:
                ...
                footprint.leave(
                    log_type='warning',
                    message="We could not close the database because of an error.",
                    controller='DatabaseInstance.async_get_db',
