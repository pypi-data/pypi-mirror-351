...
class Consumer:
    ...
    def __init__(
        ...
        **consumer_kwargs: Any
        ...
        self._consumer: KafkaConsumer = kafka_instance.get_consumer(topics, **consumer_kwargs)
    ...
    def commit(self) -> None:
        ...
        Call this after successfully processing messages when auto-commit is disabled.
        """
        try:
            ...
            footprint.leave(
                ...
                controller='kafka.Consumer.commit',
                    ...
                    for handler in self._handlers.get(msg.topic, []):
                        try:
                            ...
                            footprint.leave(
                                ...
                                controller='kafka.Consumer.consume',
