...
custom_tool_list.append(
    CustomTool(
        ...
        custom_tool_folder=CustomToolFolder(
            ...
            custom_tool_def_list = [
                CustomToolDef(
                    name="Preflight Only - Quick (No Cook)", command = pwsh_tool_exe, add_separator_before = True,
                    arguments = f"{pwsh_cmd_base} {base_cmd_quick_no_commit}"
                ),
                CustomToolDef(
                    name="Preflight Only - Full (Cook)", command = pwsh_tool_exe,
                    arguments = f"{pwsh_cmd_base} {base_cmd_full_no_commit}"
                ),
                CustomToolDef(
                    name="Preflight and Commit - Quick (No Cook)", command = pwsh_tool_exe, add_separator_before = True,
                    arguments = f"{pwsh_cmd_base} {base_cmd_quick}"
                ),
                CustomToolDef(
                    name="Preflight and Commit - Full (Cook)", command = pwsh_tool_exe,
...
custom_tool_list.append(
    CustomTool(
        ...
        custom_tool_folder=CustomToolFolder(
            ...
            custom_tool_def_list = [
                CustomToolDef(
                    name = "Preflight Only - Quick (No Cook)", command = powershell_tool_exe, add_separator_before = True,
                    arguments = f"{powershell_cmd_base} \"{base_cmd_quick_no_commit}\" '"
                ),
                CustomToolDef(
                    name = "Preflight Only - Full (Cook)", command = powershell_tool_exe,
                    arguments = f"{powershell_cmd_base} \"{base_cmd_full_no_commit}\" '"
                ),
                CustomToolDef(
                    name = "Preflight and Commit - Quick (No Cook)", command = powershell_tool_exe, add_separator_before = True,
                    arguments = f"{powershell_cmd_base} \"{base_cmd_quick}\" '"
                ),
                CustomToolDef(
                    name = "Preflight and Commit - Full (Cook)", command = powershell_tool_exe,
