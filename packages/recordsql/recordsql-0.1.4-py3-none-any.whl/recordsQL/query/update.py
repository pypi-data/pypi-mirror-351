...
class UpdateQuery(RecordQuery):
    ...
    def __init__(self, table_name: str = None, set_clauses: dict = None,
                 condition: SQLCondition = no_condition, returning:List[SQLCol] = None, ignore_forbidden_characters:bool = False) -> None:
    ...
    def normalize_set_clauses(self, clauses: Union[Dict[str, SQLInput], List[Tuple[str, SQLInput]]]) -> Dict[str, SQLInput]:
        set_clauses = {}
...
def UPDATE(table_name: str, *set_clauses: Union[Dict[str, SQLInput], List[Tuple[str, SQLInput]]], 
           ignore_forbidden_characters: bool = False) -> UpdateQuery:
    """
    ...
    return UpdateQuery(table_name=table_name, set_clauses=set_clauses, ignore_forbidden_characters=ignore_forbidden_characters)
