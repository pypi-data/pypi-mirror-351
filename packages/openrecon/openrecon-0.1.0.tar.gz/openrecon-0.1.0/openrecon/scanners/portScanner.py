...
def save_scan_results(scanner, target):
    ...
    for host in scanner.all_hosts():
        host_data = {
            ...
            "hostnames": [{"name": h["name"], "type": h["type"]} for h in scanner[host].hostnames()],
            "protocols": {}
        }
        ...
        result_data["hosts"][host] = host_data
    ...
    try:
        ...
        json_output_file = reports_dir / f"portscan_{clean_target}_{timestamp}.json"
