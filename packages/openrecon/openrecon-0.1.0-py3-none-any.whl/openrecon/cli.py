...
""")
    ...
    # ---- Enum ----
        ...
        if args.output:
            output_path = get_reports_dir() / args.output
    ...
    # ---- SQLi scanner ----
        ...
        options = {
            ...
            'verbose': args.verbose,
            'output': str(get_reports_dir() / args.output) if args.output else None,
  ...
  "blacklist": [".png", ".jpg", ".jpeg", ".gif", ".svg", ".mp3", ".mp4", ".avi", ".pdf"]
        ...
        try:
            ...
            if results and args.output:
                out_path = str(get_reports_dir() / f"{args.output}.{args.format}")
