...
class TemplatesApi:
    ...
    def delete_workflow_template(
        ...
        _param = self._delete_workflow_template_serialize(
    ...
    def _delete_workflow_template_serialize(
        self,
        ...
        return self.api_client.param_serialize(
            method='DELETE',
            resource_path='/api/templates/workflows/{workflow_template_id}',
    ...
    def get_workflow_template_record(
        ...
        _param = self._get_workflow_template_record_serialize(
            workflow_template_id=workflow_template_id,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
    ...
    def _get_workflow_template_record_serialize(
        self,
        workflow_template_id,
        _request_auth,
        _content_type,
    ...
    def get_workflow_template_records(
        ...
        _param = self._get_workflow_template_records_serialize(
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def get_workflow_template_records_with_http_info(
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[GetWorkflowTemplateRecordsResponse]:
        """Get Workflow Templates
    ...
    def _get_workflow_template_records_serialize(
        self,
        _request_auth,
        _content_type,
        _headers,
        ...
        return self.api_client.param_serialize(
            method='GET',
            resource_path='/api/templates/workflows',
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def workflow_template(
        ...
        :param post_workflow_template_record_request: (required)
        :type post_workflow_template_record_request: PostWorkflowTemplateRecordRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._workflow_template_serialize(
            post_workflow_template_record_request=post_workflow_template_record_request,
            _request_auth=_request_auth,
            _content_type=_content_type,
            _headers=_headers,
            _host_index=_host_index
    ...
    def _workflow_template_serialize(
        self,
        post_workflow_template_record_request,
        _request_auth,
        _content_type,
        _headers,
        _host_index,
        ...
        # process the form parameters
        # process the body parameter
        if post_workflow_template_record_request is not None:
            _body_params = post_workflow_template_record_request
