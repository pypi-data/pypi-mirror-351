...
class GetResourceRecordsResponse(BaseModel):
    """
    GetResourceRecordsResponse
    """ # noqa: E501
    resource_records: List[ResourceRecordOutput]
    __properties: ClassVar[List[str]] = ["resource_records"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "resource_records": [ResourceRecordOutput.from_dict(_item) for _item in obj["resource_records"]] if obj.get("resource_records") is not None else None
        })
        return _obj
