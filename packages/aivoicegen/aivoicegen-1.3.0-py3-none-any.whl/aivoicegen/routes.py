...
def register_routes(app):
    ...
    def optimize_text():
        ...
        try:
            ...
            # Simple optimization for now - in a full implementation this would
            # call OpenAI or Gemini APIs for text enhancement
            optimized_text = f"Enhanced: {text}"
    ...
    def get_api_config():
        ...
        try:
            ...
            config_status = {
                ...
                "google_configured": bool(config.get("GOOGLE_APPLICATION_CREDENTIALS")),
