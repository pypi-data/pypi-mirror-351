...
class RDS():
    ...
    def restore_rds_cluster_from_snapshot(self: object, 
                                          ...
                                          kms_key_id: str = None,
                                          reset_master_password: bool = False) -> tuple:
        """
        ...
        Returns:
            tuple: Returns a tuple containing the cluster name and instance name.
    ...
    def create_db_instance(self: object, db_name: str, instance_type: str, engine: str) -> str: 
        """
        ...
        Returns:
            str: Return the created RDS instance name.
    ...
    def get_db_instances_from_cluster(self: object, cluster_identifier: str) -> list:
        """
        Retrieves the DB instance identifiers associated with a given RDS cluster.

        Parameters:
            cluster_identifier (str): The identifier of the RDS cluster (Aurora).

        Returns:
            list: A list of DB instance identifiers that are part of the cluster.
        ...
        try:
            ...
            instance_ids = [member['DBInstanceIdentifier'] for member in cluster.get('DBClusterMembers', [])]

            return instance_ids

        except Exception as e:

            print(f"Error retrieving DB instances from cluster: {e}")
