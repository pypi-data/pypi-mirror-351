...
*VDBsApi* | [**export_vdb_from_bookmark**](docs/VDBsApi.md#export_vdb_from_bookmark) | **POST** /vdbs/{vdbId}/export-from-bookmark | Export a dSource using bookmark to physical file system
*VDBsApi* | [**export_vdb_in_place**](docs/VDBsApi.md#export_vdb_in_place) | **POST** /vdbs/{vdbId}/in-place-export | Convert a Virtual PDB to a physical PDB on Physical file system.
*VDBsApi* | [**export_vdb_to_asm_by_bookmark**](docs/VDBsApi.md#export_vdb_to_asm_by_bookmark) | **POST** /vdbs/{vdbId}/asm-export-from-bookmark | Export a vdb using using bookmark to an ASM file system
