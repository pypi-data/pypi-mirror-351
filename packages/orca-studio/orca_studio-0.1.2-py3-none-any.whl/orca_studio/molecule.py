...
from orca_parse.common import OrcaParsingError
...
class Geometry:
    ...
    def displace_along_normal_mode(
        ...
        selected_mode = normal_modes.select(pl.col(str(mode))).to_numpy().flatten()
...
class Molecule:
    ...
    def __repr__(self) -> str:
        json_metadata = '{"charge": ' + str(self.charge) + ', "mult": ' + str(self.mult) + '}'
