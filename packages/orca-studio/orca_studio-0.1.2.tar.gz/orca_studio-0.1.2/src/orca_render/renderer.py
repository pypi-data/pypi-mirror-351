...
from orca_render.isosurface_renderer import IsosurfaceRenderer
from orca_render.molecular_render import MolecularRenderer
...
class Renderer:
    ...
    def _add_molecule_to_figure(self) -> None:
        ...
        molecule_meshes = self.mol_renderer.render_molecule()
    ...
    def add_isosurface(
        ...
        positive_mesh, negative_mesh = iso_renderer.render_isosurface(
            isovalue=isovalue, colors=colors, smoothness_factor=smoothness_factor, opacity=opacity
        )
