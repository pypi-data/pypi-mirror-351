...
class LearningModuleLoader(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr

    def __init__(self, core: "Core *"):
        _pyglass.LearningModuleLoader_swiginit(self, _pyglass.new_LearningModuleLoader(core))

    def LoadFromXML(self, moduleFilePath: "std::string const &") -> "std::vector< LearningModule,std::allocator< LearningModule > >":
        return _pyglass.LearningModuleLoader_LoadFromXML(self, moduleFilePath)

    def LoadFromSYA(self, moduleFilePath: "std::string const &", isFileInNarrationsTab: "bool"=True) -> "LearningModule":
        return _pyglass.LearningModuleLoader_LoadFromSYA(self, moduleFilePath, isFileInNarrationsTab)

    def GetErrorMessage(self) -> "std::string":
        return _pyglass.LearningModuleLoader_GetErrorMessage(self)
    __swig_destroy__ = _pyglass.delete_LearningModuleLoader

# Register LearningModuleLoader in _pyglass:
_pyglass.LearningModuleLoader_swigregister(LearningModuleLoader)
