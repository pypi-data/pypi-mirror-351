...
def _compare_results_console(left_side: CompareArgs, right_side: CompareArgs):
    ...
    print(tabulate(summary_table, headers=headers, tablefmt='heavy_grid'))
    ...
    print(tabulate(details_table, headers=headers, tablefmt='heavy_grid'))  # maxcolwidths=... fails for some reason
