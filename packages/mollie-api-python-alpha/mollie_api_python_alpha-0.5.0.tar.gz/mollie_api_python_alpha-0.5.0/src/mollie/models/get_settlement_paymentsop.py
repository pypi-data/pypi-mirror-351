...
class GetSettlementPaymentsSettlementsDocumentationTypedDict(TypedDict):
...
class GetSettlementPaymentsSettlementsDocumentation(BaseModel):
    r"""The URL to the generic Mollie API error handling guide."""
...
class GetSettlementPaymentsSettlementsLinksTypedDict(TypedDict):
    documentation: GetSettlementPaymentsSettlementsDocumentationTypedDict
    r"""The URL to the generic Mollie API error handling guide."""


class GetSettlementPaymentsSettlementsLinks(BaseModel):
    documentation: GetSettlementPaymentsSettlementsDocumentation
    r"""The URL to the generic Mollie API error handling guide."""


class GetSettlementPaymentsSettlementsResponseBodyData(BaseModel):
    status: int
...
class GetSettlementPaymentsSettlementsResponseBody(Exception):
    ...
    data: GetSettlementPaymentsSettlementsResponseBodyData

    def __init__(self, data: GetSettlementPaymentsSettlementsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(
            self.data, GetSettlementPaymentsSettlementsResponseBodyData
        )


class GetSettlementPaymentsAmountTypedDict(TypedDict):
...
class GetSettlementPaymentsAmount(BaseModel):
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
...
class GetSettlementPaymentsAmountRefundedTypedDict(TypedDict):
...
class GetSettlementPaymentsAmountRefunded(BaseModel):
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""
...
class GetSettlementPaymentsAmountRemainingTypedDict(TypedDict):
...
class GetSettlementPaymentsAmountRemaining(BaseModel):
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
...
class GetSettlementPaymentsAmountCapturedTypedDict(TypedDict):
...
class GetSettlementPaymentsAmountCaptured(BaseModel):
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
...
class GetSettlementPaymentsAmountChargedBackTypedDict(TypedDict):
...
class GetSettlementPaymentsAmountChargedBack(BaseModel):
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""
...
class GetSettlementPaymentsSettlementAmountTypedDict(TypedDict):
...
class GetSettlementPaymentsSettlementAmount(BaseModel):
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
...
class GetSettlementPaymentsUnitPriceTypedDict(TypedDict):
...
class GetSettlementPaymentsUnitPrice(BaseModel):
    r"""The price of a single item including VAT.
...
class GetSettlementPaymentsDiscountAmountTypedDict(TypedDict):
...
class GetSettlementPaymentsDiscountAmount(BaseModel):
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type."""
...
class GetSettlementPaymentsSettlementsResponse200AmountTypedDict(TypedDict):
...
class GetSettlementPaymentsSettlementsResponse200Amount(BaseModel):
    r"""Total amount and currency of the recurring item."""
...
class GetSettlementPaymentsRecurringTypedDict(TypedDict):
    ...
    amount: NotRequired[GetSettlementPaymentsSettlementsResponse200AmountTypedDict]
    r"""Total amount and currency of the recurring item."""
...
class GetSettlementPaymentsRecurring(BaseModel):
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout to inform the shopper of the details for recurring products in the payments."""
    ...
    amount: Optional[GetSettlementPaymentsSettlementsResponse200Amount] = None
    r"""Total amount and currency of the recurring item."""
...
class GetSettlementPaymentsTotalAmountTypedDict(TypedDict):
...
class GetSettlementPaymentsTotalAmount(BaseModel):
    r"""The total amount of the line, including VAT and discounts.
...
class GetSettlementPaymentsVatAmountTypedDict(TypedDict):
...
class GetSettlementPaymentsVatAmount(BaseModel):
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
...
class GetSettlementPaymentsCategories(str, Enum):
    MEAL = "meal"
    ECO = "eco"
    GIFT = "gift"
...
class GetSettlementPaymentsLinesTypedDict(TypedDict):
    description: str
    r"""A description of the line item. For example *LEGO 4440 Forest Police Station*."""
    quantity: int
    r"""The number of items."""
    unit_price: GetSettlementPaymentsUnitPriceTypedDict
    r"""The price of a single item including VAT.
    ...
    The unit price can be zero in case of free items.
    """
    total_amount: GetSettlementPaymentsTotalAmountTypedDict
    r"""The total amount of the line, including VAT and discounts.
    ...
    discount_amount: NotRequired[GetSettlementPaymentsDiscountAmountTypedDict]
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type."""
    recurring: NotRequired[GetSettlementPaymentsRecurringTypedDict]
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout to inform the shopper of the details for recurring products in the payments."""
    ...
    vat_amount: NotRequired[GetSettlementPaymentsVatAmountTypedDict]
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
    ...
    categories: NotRequired[List[GetSettlementPaymentsCategories]]
...
class GetSettlementPaymentsLines(BaseModel):
    description: str
    r"""A description of the line item. For example *LEGO 4440 Forest Police Station*."""
    ...
    unit_price: Annotated[
        GetSettlementPaymentsUnitPrice, pydantic.Field(alias="unitPrice")
    ]
    r"""The price of a single item including VAT.
    ...
    total_amount: Annotated[
        GetSettlementPaymentsTotalAmount, pydantic.Field(alias="totalAmount")
    ]
    r"""The total amount of the line, including VAT and discounts.
    ...
    discount_amount: Annotated[
        Optional[GetSettlementPaymentsDiscountAmount],
        pydantic.Field(alias="discountAmount"),
    ] = None
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type."""

    recurring: Optional[GetSettlementPaymentsRecurring] = None
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout to inform the shopper of the details for recurring products in the payments."""
    ...
    vat_amount: Annotated[
        Optional[GetSettlementPaymentsVatAmount], pydantic.Field(alias="vatAmount")
    ] = None
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
    ...
    categories: Optional[List[GetSettlementPaymentsCategories]] = None
    r"""An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](integrating-vouchers) guide for more information."""
...
class GetSettlementPaymentsBillingAddressTypedDict(TypedDict):
...
class GetSettlementPaymentsBillingAddress(BaseModel):
    r"""The customer's billing address details. We advise to provide these details to improve fraud protection and conversion.
...
class GetSettlementPaymentsShippingAddressTypedDict(TypedDict):
...
class GetSettlementPaymentsShippingAddress(BaseModel):
    r"""The customer's shipping address details. We advise to provide these details to improve fraud protection and conversion.
...
class GetSettlementPaymentsMetadata2TypedDict(TypedDict):
    pass


class GetSettlementPaymentsMetadata2(BaseModel):
    pass


GetSettlementPaymentsMetadataTypedDict = TypeAliasType(
    "GetSettlementPaymentsMetadataTypedDict",
    Union[GetSettlementPaymentsMetadata2TypedDict, str, List[str]],
)
...
GetSettlementPaymentsMetadata = TypeAliasType(
    "GetSettlementPaymentsMetadata",
    Union[GetSettlementPaymentsMetadata2, str, List[str]],
)
r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB."""


class GetSettlementPaymentsSettlementsAmountTypedDict(TypedDict):
...
class GetSettlementPaymentsSettlementsAmount(BaseModel):
    r"""The fee that you wish to charge.
...
class GetSettlementPaymentsApplicationFeeTypedDict(TypedDict):
    ...
    amount: NotRequired[GetSettlementPaymentsSettlementsAmountTypedDict]
    r"""The fee that you wish to charge.
...
class GetSettlementPaymentsApplicationFee(BaseModel):
    r"""With Mollie Connect you can charge fees on payments that your app is processing on behalf of other Mollie merchants.
    ...
    amount: Optional[GetSettlementPaymentsSettlementsAmount] = None
    r"""The fee that you wish to charge.
...
class GetSettlementPaymentsSettlementsResponseAmountTypedDict(TypedDict):
...
class GetSettlementPaymentsSettlementsResponseAmount(BaseModel):
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
...
class GetSettlementPaymentsDestinationTypedDict(TypedDict):
...
class GetSettlementPaymentsDestination(BaseModel):
    r"""The destination of this portion of the payment."""
...
class GetSettlementPaymentsSettlementsResponseSelfTypedDict(TypedDict):
...
class GetSettlementPaymentsSettlementsResponseSelf(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetSettlementPaymentsPaymentTypedDict(TypedDict):
...
class GetSettlementPaymentsPayment(BaseModel):
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class GetSettlementPaymentsSettlementsResponse200LinksTypedDict(TypedDict):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: GetSettlementPaymentsSettlementsResponseSelfTypedDict
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: GetSettlementPaymentsPaymentTypedDict
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""


class GetSettlementPaymentsSettlementsResponse200Links(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: Annotated[
        GetSettlementPaymentsSettlementsResponseSelf, pydantic.Field(alias="self")
    ]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    payment: GetSettlementPaymentsPayment
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""
...
class GetSettlementPaymentsRoutingTypedDict(TypedDict):
    ...
    """
    amount: GetSettlementPaymentsSettlementsResponseAmountTypedDict
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    destination: GetSettlementPaymentsDestinationTypedDict
    r"""The destination of this portion of the payment."""
    created_at: str
...
class GetSettlementPaymentsRouting(BaseModel):
    ...
    amount: GetSettlementPaymentsSettlementsResponseAmount
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
...
class GetSettlementPaymentsStatusReasonTypedDict(TypedDict):
...
class GetSettlementPaymentsStatusReason(BaseModel):
    r"""This object offers details about the status of a payment. Currently it is only available for point-of-sale payments.
...
class GetSettlementPaymentsSettlementsSelfTypedDict(TypedDict):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetSettlementPaymentsSettlementsSelf(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetSettlementPaymentsCheckoutTypedDict(TypedDict):
...
class GetSettlementPaymentsCheckout(BaseModel):
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""
...
class GetSettlementPaymentsMobileAppCheckoutTypedDict(TypedDict):
...
class GetSettlementPaymentsMobileAppCheckout(BaseModel):
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
...
class GetSettlementPaymentsChangePaymentStateTypedDict(TypedDict):
...
class GetSettlementPaymentsChangePaymentState(BaseModel):
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different payment states.
...
class GetSettlementPaymentsDashboardTypedDict(TypedDict):
...
class GetSettlementPaymentsDashboard(BaseModel):
    r"""Direct link to the payment in the Mollie Dashboard."""
...
class GetSettlementPaymentsRefundsTypedDict(TypedDict):
...
class GetSettlementPaymentsRefunds(BaseModel):
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
...
class GetSettlementPaymentsChargebacksTypedDict(TypedDict):
...
class GetSettlementPaymentsChargebacks(BaseModel):
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this payment."""
...
class GetSettlementPaymentsCapturesTypedDict(TypedDict):
...
class GetSettlementPaymentsCaptures(BaseModel):
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
...
class GetSettlementPaymentsSettlementTypedDict(TypedDict):
...
class GetSettlementPaymentsSettlement(BaseModel):
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""
...
class GetSettlementPaymentsCustomerTypedDict(TypedDict):
...
class GetSettlementPaymentsCustomer(BaseModel):
    r"""The API resource URL of the [customer](get-customer)."""
...
class GetSettlementPaymentsMandateTypedDict(TypedDict):
...
class GetSettlementPaymentsMandate(BaseModel):
    r"""The API resource URL of the [mandate](get-mandate)."""
...
class GetSettlementPaymentsSubscriptionTypedDict(TypedDict):
...
class GetSettlementPaymentsSubscription(BaseModel):
    r"""The API resource URL of the [subscription](get-subscription)."""
...
class GetSettlementPaymentsOrderTypedDict(TypedDict):
...
class GetSettlementPaymentsOrder(BaseModel):
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""
...
class GetSettlementPaymentsTerminalTypedDict(TypedDict):
...
class GetSettlementPaymentsTerminal(BaseModel):
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""
...
class GetSettlementPaymentsSettlementsResponseDocumentationTypedDict(TypedDict):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetSettlementPaymentsSettlementsResponseDocumentation(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetSettlementPaymentsSettlementsResponseLinksTypedDict(TypedDict):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: GetSettlementPaymentsSettlementsSelfTypedDict
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    ...
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
    change_payment_state: NotRequired[GetSettlementPaymentsChangePaymentStateTypedDict]
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different payment states.
    ...
    Secondly, for paid test mode payments. The payment state screen will then allow you to create a refund or chargeback for the test payment.
    """
    refunds: NotRequired[GetSettlementPaymentsRefundsTypedDict]
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
    chargebacks: NotRequired[GetSettlementPaymentsChargebacksTypedDict]
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this payment."""
    captures: NotRequired[GetSettlementPaymentsCapturesTypedDict]
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
    settlement: NotRequired[GetSettlementPaymentsSettlementTypedDict]
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""
    customer: NotRequired[GetSettlementPaymentsCustomerTypedDict]
    r"""The API resource URL of the [customer](get-customer)."""
    mandate: NotRequired[GetSettlementPaymentsMandateTypedDict]
    r"""The API resource URL of the [mandate](get-mandate)."""
    subscription: NotRequired[GetSettlementPaymentsSubscriptionTypedDict]
    r"""The API resource URL of the [subscription](get-subscription)."""
    order: NotRequired[GetSettlementPaymentsOrderTypedDict]
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""
...
class GetSettlementPaymentsSettlementsResponseLinks(BaseModel):
    ...
    self_: Annotated[GetSettlementPaymentsSettlementsSelf, pydantic.Field(alias="self")]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    ...
    mobile_app_checkout: Annotated[
        Optional[GetSettlementPaymentsMobileAppCheckout],
        pydantic.Field(alias="mobileAppCheckout"),
    ] = None
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""

    change_payment_state: Annotated[
        Optional[GetSettlementPaymentsChangePaymentState],
    ...
    refunds: Optional[GetSettlementPaymentsRefunds] = None
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""

    chargebacks: Optional[GetSettlementPaymentsChargebacks] = None
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this payment."""

    captures: Optional[GetSettlementPaymentsCaptures] = None
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""

    settlement: Optional[GetSettlementPaymentsSettlement] = None
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""

    customer: Optional[GetSettlementPaymentsCustomer] = None
    r"""The API resource URL of the [customer](get-customer)."""

    mandate: Optional[GetSettlementPaymentsMandate] = None
    r"""The API resource URL of the [mandate](get-mandate)."""

    subscription: Optional[GetSettlementPaymentsSubscription] = None
    r"""The API resource URL of the [subscription](get-subscription)."""

    order: Optional[GetSettlementPaymentsOrder] = None
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""
...
class GetSettlementPaymentsPaymentsTypedDict(TypedDict):
    ...
    """
    amount: GetSettlementPaymentsAmountTypedDict
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
    ...
    links: GetSettlementPaymentsSettlementsResponseLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
    amount_refunded: NotRequired[GetSettlementPaymentsAmountRefundedTypedDict]
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""
    amount_remaining: NotRequired[GetSettlementPaymentsAmountRemainingTypedDict]
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
    amount_captured: NotRequired[GetSettlementPaymentsAmountCapturedTypedDict]
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
    amount_charged_back: NotRequired[GetSettlementPaymentsAmountChargedBackTypedDict]
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""
    settlement_amount: NotRequired[GetSettlementPaymentsSettlementAmountTypedDict]
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
    ...
    """
    lines: NotRequired[Nullable[List[GetSettlementPaymentsLinesTypedDict]]]
    ...
    """
    billing_address: NotRequired[GetSettlementPaymentsBillingAddressTypedDict]
    r"""The customer's billing address details. We advise to provide these details to improve fraud protection and conversion.
    ...
    Required for payment method `in3`, `klarna`, `billie` and `riverty`.
    """
    shipping_address: NotRequired[GetSettlementPaymentsShippingAddressTypedDict]
    r"""The customer's shipping address details. We advise to provide these details to improve fraud protection and conversion.
    ...
    """
    metadata: NotRequired[Nullable[GetSettlementPaymentsMetadataTypedDict]]
    r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB."""
    ...
    application_fee: NotRequired[Nullable[GetSettlementPaymentsApplicationFeeTypedDict]]
    r"""With Mollie Connect you can charge fees on payments that your app is processing on behalf of other Mollie merchants.
    ...
    If instead you want to split a payment on your own account between yourself and a connected merchant, refer to the `routing` parameter.
    """
    routing: NotRequired[Nullable[List[GetSettlementPaymentsRoutingTypedDict]]]
    ...
    status_reason: NotRequired[Nullable[GetSettlementPaymentsStatusReasonTypedDict]]
    r"""This object offers details about the status of a payment. Currently it is only available for point-of-sale payments.
...
class GetSettlementPaymentsPayments(BaseModel):
    resource: str
    r"""Indicates the response contains a payment object. Will always contain the string `payment` for this endpoint."""
    ...
    links: Annotated[
        GetSettlementPaymentsSettlementsResponseLinks, pydantic.Field(alias="_links")
    ]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    amount_refunded: Annotated[
        Optional[GetSettlementPaymentsAmountRefunded],
        pydantic.Field(alias="amountRefunded"),
    ] = None
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""

    amount_remaining: Annotated[
        Optional[GetSettlementPaymentsAmountRemaining],
        pydantic.Field(alias="amountRemaining"),
    ] = None
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""

    amount_captured: Annotated[
        Optional[GetSettlementPaymentsAmountCaptured],
        pydantic.Field(alias="amountCaptured"),
    ] = None
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""

    amount_charged_back: Annotated[
        Optional[GetSettlementPaymentsAmountChargedBack],
        pydantic.Field(alias="amountChargedBack"),
    ] = None
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""

    settlement_amount: Annotated[
        Optional[GetSettlementPaymentsSettlementAmount],
    ...
    lines: OptionalNullable[List[GetSettlementPaymentsLines]] = UNSET
    r"""Optionally provide the order lines for the payment. Each line contains details such as a description of the item ordered and its price.
    ...
    billing_address: Annotated[
        Optional[GetSettlementPaymentsBillingAddress],
    ...
    shipping_address: Annotated[
        Optional[GetSettlementPaymentsShippingAddress],
    ...
    metadata: OptionalNullable[GetSettlementPaymentsMetadata] = UNSET
    r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB."""
    ...
    application_fee: Annotated[
        OptionalNullable[GetSettlementPaymentsApplicationFee],
    ...
    routing: OptionalNullable[List[GetSettlementPaymentsRouting]] = UNSET
    r"""*This functionality is not enabled by default. Reach out to our partner management team if you wish to use it.*
    ...
    status_reason: Annotated[
        OptionalNullable[GetSettlementPaymentsStatusReason],
...
class GetSettlementPaymentsEmbeddedTypedDict(TypedDict):
    payments: NotRequired[List[GetSettlementPaymentsPaymentsTypedDict]]
    r"""An array of payment objects."""


class GetSettlementPaymentsEmbedded(BaseModel):
    payments: Optional[List[GetSettlementPaymentsPayments]] = None
    r"""An array of payment objects."""


class GetSettlementPaymentsSelfTypedDict(TypedDict):
...
class GetSettlementPaymentsSelf(BaseModel):
    r"""The URL to the current set of items."""
...
class GetSettlementPaymentsPreviousTypedDict(TypedDict):
...
class GetSettlementPaymentsPrevious(BaseModel):
    r"""The previous set of items, if available."""
...
class GetSettlementPaymentsNextTypedDict(TypedDict):
...
class GetSettlementPaymentsNext(BaseModel):
    r"""The next set of items, if available."""
...
class GetSettlementPaymentsLinksTypedDict(TypedDict):
    ...
    self_: NotRequired[GetSettlementPaymentsSelfTypedDict]
    r"""The URL to the current set of items."""
    previous: NotRequired[Nullable[GetSettlementPaymentsPreviousTypedDict]]
    r"""The previous set of items, if available."""
    next: NotRequired[Nullable[GetSettlementPaymentsNextTypedDict]]
    r"""The next set of items, if available."""
...
class GetSettlementPaymentsLinks(BaseModel):
    ...
    self_: Annotated[
        Optional[GetSettlementPaymentsSelf], pydantic.Field(alias="self")
    ] = None
    r"""The URL to the current set of items."""

    previous: OptionalNullable[GetSettlementPaymentsPrevious] = UNSET
    r"""The previous set of items, if available."""

    next: OptionalNullable[GetSettlementPaymentsNext] = UNSET
    r"""The next set of items, if available."""
...
class GetSettlementPaymentsResponseBodyTypedDict(TypedDict):
    ...
    """
    embedded: NotRequired[GetSettlementPaymentsEmbeddedTypedDict]
    links: NotRequired[GetSettlementPaymentsLinksTypedDict]
    r"""Links to help navigate through the lists of items. Every URL object will contain an `href` and a `type` field."""


class GetSettlementPaymentsResponseBody(BaseModel):
    r"""A list of payment objects."""
    ...
    embedded: Annotated[
        Optional[GetSettlementPaymentsEmbedded], pydantic.Field(alias="_embedded")
    ] = None
