...
class GetPaymentRequestTypedDict(TypedDict):
    ...
    include: NotRequired[Nullable[QueryParamInclude]]
    r"""This endpoint allows you to include additional information via the `include` query string parameter."""
    embed: NotRequired[Nullable[Embed]]
    r"""This endpoint allows embedding related API items by appending the following values via the `embed` query string parameter."""
...
class GetPaymentRequest(BaseModel):
    ...
    include: Annotated[
        OptionalNullable[QueryParamInclude],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""This endpoint allows you to include additional information via the `include` query string parameter."""

    embed: Annotated[
        OptionalNullable[Embed],
        FieldMetadata(query=QueryParamMetadata(style="form", explode=True)),
    ] = UNSET
    r"""This endpoint allows embedding related API items by appending the following values via the `embed` query string parameter."""
    ...
    def serialize_model(self, handler):
        optional_fields = ["include", "embed", "testmode"]
        nullable_fields = ["include", "embed", "testmode"]
        null_default_fields = []
...
class GetPaymentPaymentsResponseBody(Exception):
    ...
    data: GetPaymentPaymentsResponseBodyData

    def __init__(self, data: GetPaymentPaymentsResponseBodyData):
        self.data = data

    def __str__(self) -> str:
        return utils.marshal_json(self.data, GetPaymentPaymentsResponseBodyData)


class GetPaymentAmountTypedDict(TypedDict):
...
class GetPaymentAmount(BaseModel):
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
...
class GetPaymentAmountRefundedTypedDict(TypedDict):
...
class GetPaymentAmountRefunded(BaseModel):
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""
...
class GetPaymentAmountRemainingTypedDict(TypedDict):
...
class GetPaymentAmountRemaining(BaseModel):
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
...
class GetPaymentAmountCapturedTypedDict(TypedDict):
...
class GetPaymentAmountCaptured(BaseModel):
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
...
class GetPaymentAmountChargedBackTypedDict(TypedDict):
...
class GetPaymentAmountChargedBack(BaseModel):
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""
...
class GetPaymentSettlementAmountTypedDict(TypedDict):
...
class GetPaymentSettlementAmount(BaseModel):
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
...
class GetPaymentUnitPriceTypedDict(TypedDict):
...
class GetPaymentUnitPrice(BaseModel):
    r"""The price of a single item including VAT.
...
class GetPaymentDiscountAmountTypedDict(TypedDict):
...
class GetPaymentDiscountAmount(BaseModel):
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type."""
...
class GetPaymentPaymentsResponse200AmountTypedDict(TypedDict):
...
class GetPaymentPaymentsResponse200Amount(BaseModel):
    r"""Total amount and currency of the recurring item."""
...
class GetPaymentRecurringTypedDict(TypedDict):
    ...
    amount: NotRequired[GetPaymentPaymentsResponse200AmountTypedDict]
    r"""Total amount and currency of the recurring item."""
...
class GetPaymentRecurring(BaseModel):
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout to inform the shopper of the details for recurring products in the payments."""
    ...
    amount: Optional[GetPaymentPaymentsResponse200Amount] = None
    r"""Total amount and currency of the recurring item."""
...
class GetPaymentTotalAmountTypedDict(TypedDict):
...
class GetPaymentTotalAmount(BaseModel):
    r"""The total amount of the line, including VAT and discounts.
...
class GetPaymentVatAmountTypedDict(TypedDict):
...
class GetPaymentVatAmount(BaseModel):
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
...
class GetPaymentCategories(str, Enum):
    MEAL = "meal"
    ECO = "eco"
    GIFT = "gift"
...
class GetPaymentLinesTypedDict(TypedDict):
    ...
    The unit price can be zero in case of free items.
    """
    total_amount: GetPaymentTotalAmountTypedDict
    r"""The total amount of the line, including VAT and discounts.
    ...
    discount_amount: NotRequired[GetPaymentDiscountAmountTypedDict]
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type."""
    recurring: NotRequired[GetPaymentRecurringTypedDict]
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout to inform the shopper of the details for recurring products in the payments."""
    ...
    vat_amount: NotRequired[GetPaymentVatAmountTypedDict]
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
    ...
    categories: NotRequired[List[GetPaymentCategories]]
...
class GetPaymentLines(BaseModel):
    description: str
    r"""A description of the line item. For example *LEGO 4440 Forest Police Station*."""
    ...
    unit_price: Annotated[GetPaymentUnitPrice, pydantic.Field(alias="unitPrice")]
    r"""The price of a single item including VAT.
    ...
    total_amount: Annotated[GetPaymentTotalAmount, pydantic.Field(alias="totalAmount")]
    r"""The total amount of the line, including VAT and discounts.
    ...
    discount_amount: Annotated[
        Optional[GetPaymentDiscountAmount], pydantic.Field(alias="discountAmount")
    ] = None
    r"""Any line-specific discounts, as a positive amount. Not relevant if the line itself is already a discount type."""

    recurring: Optional[GetPaymentRecurring] = None
    r"""The details of subsequent recurring billing cycles. These parameters are used in the Mollie Checkout to inform the shopper of the details for recurring products in the payments."""
    ...
    vat_amount: Annotated[
        Optional[GetPaymentVatAmount], pydantic.Field(alias="vatAmount")
    ] = None
    r"""The amount of value-added tax on the line. The `totalAmount` field includes VAT, so the `vatAmount` can be calculated with the formula `totalAmount × (vatRate / (100 + vatRate))`.
    ...
    categories: Optional[List[GetPaymentCategories]] = None
    r"""An array with the voucher categories, in case of a line eligible for a voucher. See the [Integrating Vouchers](integrating-vouchers) guide for more information."""
...
class GetPaymentBillingAddressTypedDict(TypedDict):
...
class GetPaymentBillingAddress(BaseModel):
    r"""The customer's billing address details. We advise to provide these details to improve fraud protection and conversion.
...
class GetPaymentShippingAddressTypedDict(TypedDict):
...
class GetPaymentShippingAddress(BaseModel):
    r"""The customer's shipping address details. We advise to provide these details to improve fraud protection and conversion.
...
class GetPaymentMetadata2TypedDict(TypedDict):
    pass


class GetPaymentMetadata2(BaseModel):
    pass


GetPaymentMetadataTypedDict = TypeAliasType(
    "GetPaymentMetadataTypedDict", Union[GetPaymentMetadata2TypedDict, str, List[str]]
)
...
GetPaymentMetadata = TypeAliasType(
    "GetPaymentMetadata", Union[GetPaymentMetadata2, str, List[str]]
)
r"""Provide any data you like, for example a string or a JSON object. We will save the data alongside the entity. Whenever you fetch the entity with our API, we will also include the metadata. You can use up to approximately 1kB."""


class GetPaymentPaymentsAmountTypedDict(TypedDict):
...
class GetPaymentPaymentsAmount(BaseModel):
    r"""The fee that you wish to charge.
...
class GetPaymentApplicationFeeTypedDict(TypedDict):
    ...
    amount: NotRequired[GetPaymentPaymentsAmountTypedDict]
    r"""The fee that you wish to charge.
...
class GetPaymentApplicationFee(BaseModel):
    r"""With Mollie Connect you can charge fees on payments that your app is processing on behalf of other Mollie merchants.
    ...
    amount: Optional[GetPaymentPaymentsAmount] = None
    r"""The fee that you wish to charge.
...
class GetPaymentPaymentsResponseAmountTypedDict(TypedDict):
...
class GetPaymentPaymentsResponseAmount(BaseModel):
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
...
class GetPaymentDestinationTypedDict(TypedDict):
...
class GetPaymentDestination(BaseModel):
    r"""The destination of this portion of the payment."""
...
class GetPaymentPaymentsSelfTypedDict(TypedDict):
...
class GetPaymentPaymentsSelf(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentPaymentTypedDict(TypedDict):
...
class GetPaymentPaymentsLinksTypedDict(TypedDict):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: GetPaymentPaymentsSelfTypedDict
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    payment: GetPaymentPaymentTypedDict
    r"""The API resource URL of the [payment](get-payment) that belong to this route."""


class GetPaymentPaymentsLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: Annotated[GetPaymentPaymentsSelf, pydantic.Field(alias="self")]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentRoutingTypedDict(TypedDict):
    resource: str
    ...
    """
    amount: GetPaymentPaymentsResponseAmountTypedDict
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    destination: GetPaymentDestinationTypedDict
    r"""The destination of this portion of the payment."""
    created_at: str
    r"""The date and time when the route was created. The date is given in ISO 8601 format."""
    links: GetPaymentPaymentsLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class GetPaymentRouting(BaseModel):
    resource: str
    r"""Indicates the response contains a route object. Will always contain the string `route` for this endpoint."""
    ...
    amount: GetPaymentPaymentsResponseAmount
    r"""The portion of the total payment amount being routed. Currently only `EUR` payments can be routed."""
    ...
    links: Annotated[GetPaymentPaymentsLinks, pydantic.Field(alias="_links")]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
...
class GetPaymentStatusReasonTypedDict(TypedDict):
...
class GetPaymentStatusReason(BaseModel):
    r"""This object offers details about the status of a payment. Currently it is only available for point-of-sale payments.
...
class GetPaymentSelfTypedDict(TypedDict):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentSelf(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentCheckoutTypedDict(TypedDict):
...
class GetPaymentCheckout(BaseModel):
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""
...
class GetPaymentMobileAppCheckoutTypedDict(TypedDict):
...
class GetPaymentMobileAppCheckout(BaseModel):
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
...
class GetPaymentChangePaymentStateTypedDict(TypedDict):
...
class GetPaymentChangePaymentState(BaseModel):
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different payment states.
...
class GetPaymentDashboardTypedDict(TypedDict):
...
class GetPaymentDashboard(BaseModel):
    r"""Direct link to the payment in the Mollie Dashboard."""
...
class GetPaymentRefundsTypedDict(TypedDict):
...
class GetPaymentRefunds(BaseModel):
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
...
class GetPaymentChargebacksTypedDict(TypedDict):
...
class GetPaymentChargebacks(BaseModel):
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this payment."""
...
class GetPaymentCapturesTypedDict(TypedDict):
...
class GetPaymentCaptures(BaseModel):
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
...
class GetPaymentSettlementTypedDict(TypedDict):
...
class GetPaymentSettlement(BaseModel):
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""
...
class GetPaymentCustomerTypedDict(TypedDict):
...
class GetPaymentCustomer(BaseModel):
    r"""The API resource URL of the [customer](get-customer)."""
...
class GetPaymentMandateTypedDict(TypedDict):
...
class GetPaymentMandate(BaseModel):
    r"""The API resource URL of the [mandate](get-mandate)."""
...
class GetPaymentSubscriptionTypedDict(TypedDict):
...
class GetPaymentSubscription(BaseModel):
    r"""The API resource URL of the [subscription](get-subscription)."""
...
class GetPaymentOrderTypedDict(TypedDict):
...
class GetPaymentOrder(BaseModel):
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""
...
class GetPaymentTerminalTypedDict(TypedDict):
...
class GetPaymentTerminal(BaseModel):
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""
...
class GetPaymentDocumentationTypedDict(TypedDict):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentDocumentation(BaseModel):
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
...
class GetPaymentLinksTypedDict(TypedDict):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: GetPaymentSelfTypedDict
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""
    dashboard: GetPaymentDashboardTypedDict
    r"""Direct link to the payment in the Mollie Dashboard."""
    checkout: NotRequired[GetPaymentCheckoutTypedDict]
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""
    mobile_app_checkout: NotRequired[GetPaymentMobileAppCheckoutTypedDict]
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""
    change_payment_state: NotRequired[GetPaymentChangePaymentStateTypedDict]
    r"""For test mode payments in certain scenarios, a hosted interface is available to help you test different payment states.
    ...
    Secondly, for paid test mode payments. The payment state screen will then allow you to create a refund or chargeback for the test payment.
    """
    refunds: NotRequired[GetPaymentRefundsTypedDict]
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""
    chargebacks: NotRequired[GetPaymentChargebacksTypedDict]
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this payment."""
    captures: NotRequired[GetPaymentCapturesTypedDict]
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""
    settlement: NotRequired[GetPaymentSettlementTypedDict]
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""
    customer: NotRequired[GetPaymentCustomerTypedDict]
    r"""The API resource URL of the [customer](get-customer)."""
    mandate: NotRequired[GetPaymentMandateTypedDict]
    r"""The API resource URL of the [mandate](get-mandate)."""
    subscription: NotRequired[GetPaymentSubscriptionTypedDict]
    r"""The API resource URL of the [subscription](get-subscription)."""
    order: NotRequired[GetPaymentOrderTypedDict]
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""
    terminal: NotRequired[GetPaymentTerminalTypedDict]
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""
    documentation: NotRequired[GetPaymentDocumentationTypedDict]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""


class GetPaymentLinks(BaseModel):
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    self_: Annotated[GetPaymentSelf, pydantic.Field(alias="self")]
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""

    dashboard: GetPaymentDashboard
    r"""Direct link to the payment in the Mollie Dashboard."""

    checkout: Optional[GetPaymentCheckout] = None
    r"""The URL your customer should visit to make the payment. This is where you should redirect the customer to."""

    mobile_app_checkout: Annotated[
        Optional[GetPaymentMobileAppCheckout], pydantic.Field(alias="mobileAppCheckout")
    ] = None
    r"""The deeplink URL to the app of the payment method. Currently only available for `bancontact`."""

    change_payment_state: Annotated[
        Optional[GetPaymentChangePaymentState],
    ...
    refunds: Optional[GetPaymentRefunds] = None
    r"""The API resource URL of the [refunds](list-payment-refunds) that belong to this payment."""

    chargebacks: Optional[GetPaymentChargebacks] = None
    r"""The API resource URL of the [chargebacks](list-payment-chargebacks) that belong to this payment."""

    captures: Optional[GetPaymentCaptures] = None
    r"""The API resource URL of the [captures](list-payment-captures) that belong to this payment."""

    settlement: Optional[GetPaymentSettlement] = None
    r"""The API resource URL of the [settlement](get-settlement) this payment has been settled with. Not present if not yet settled."""

    customer: Optional[GetPaymentCustomer] = None
    r"""The API resource URL of the [customer](get-customer)."""

    mandate: Optional[GetPaymentMandate] = None
    r"""The API resource URL of the [mandate](get-mandate)."""

    subscription: Optional[GetPaymentSubscription] = None
    r"""The API resource URL of the [subscription](get-subscription)."""

    order: Optional[GetPaymentOrder] = None
    r"""The API resource URL of the [order](get-order) this payment was created for. Not present if not created for an order."""

    terminal: Optional[GetPaymentTerminal] = None
    r"""The API resource URL of the [terminal](get-terminal) this payment was created for. Only present for point-of-sale payments."""

    documentation: Optional[GetPaymentDocumentation] = None
    r"""In v2 endpoints, URLs are commonly represented as objects with an `href` and `type` field."""


class GetPaymentResponseBodyTypedDict(TypedDict):
    ...
    """
    amount: GetPaymentAmountTypedDict
    r"""The amount that you want to charge, e.g. `{currency:\"EUR\", value:\"1000.00\"}` if you would want to charge €1000.00.
    ...
    links: GetPaymentLinksTypedDict
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""
    amount_refunded: NotRequired[GetPaymentAmountRefundedTypedDict]
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""
    amount_remaining: NotRequired[GetPaymentAmountRemainingTypedDict]
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""
    amount_captured: NotRequired[GetPaymentAmountCapturedTypedDict]
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""
    amount_charged_back: NotRequired[GetPaymentAmountChargedBackTypedDict]
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""
    settlement_amount: NotRequired[GetPaymentSettlementAmountTypedDict]
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
    ...
    """
    lines: NotRequired[Nullable[List[GetPaymentLinesTypedDict]]]
    ...
    """
    billing_address: NotRequired[GetPaymentBillingAddressTypedDict]
    r"""The customer's billing address details. We advise to provide these details to improve fraud protection and conversion.
    ...
    Required for payment method `in3`, `klarna`, `billie` and `riverty`.
    """
    shipping_address: NotRequired[GetPaymentShippingAddressTypedDict]
    r"""The customer's shipping address details. We advise to provide these details to improve fraud protection and conversion.
    ...
    application_fee: NotRequired[Nullable[GetPaymentApplicationFeeTypedDict]]
    r"""With Mollie Connect you can charge fees on payments that your app is processing on behalf of other Mollie merchants.
    ...
    If instead you want to split a payment on your own account between yourself and a connected merchant, refer to the `routing` parameter.
    """
    routing: NotRequired[Nullable[List[GetPaymentRoutingTypedDict]]]
    ...
    status_reason: NotRequired[Nullable[GetPaymentStatusReasonTypedDict]]
    r"""This object offers details about the status of a payment. Currently it is only available for point-of-sale payments.
...
class GetPaymentResponseBody(BaseModel):
    r"""The payment object."""
    ...
    links: Annotated[GetPaymentLinks, pydantic.Field(alias="_links")]
    r"""An object with several relevant URLs. Every URL object will contain an `href` and a `type` field."""

    amount_refunded: Annotated[
        Optional[GetPaymentAmountRefunded], pydantic.Field(alias="amountRefunded")
    ] = None
    r"""The total amount that is already refunded. Only available when refunds are available for this payment. For some payment methods, this amount may be higher than the payment amount, for example to allow reimbursement of the costs for a return shipment to the customer."""

    amount_remaining: Annotated[
        Optional[GetPaymentAmountRemaining], pydantic.Field(alias="amountRemaining")
    ] = None
    r"""The remaining amount that can be refunded. Only available when refunds are available for this payment."""

    amount_captured: Annotated[
        Optional[GetPaymentAmountCaptured], pydantic.Field(alias="amountCaptured")
    ] = None
    r"""The total amount that is already captured for this payment. Only available when this payment supports captures."""

    amount_charged_back: Annotated[
        Optional[GetPaymentAmountChargedBack], pydantic.Field(alias="amountChargedBack")
    ] = None
    r"""The total amount that was charged back for this payment. Only available when the total charged back amount is not zero."""

    settlement_amount: Annotated[
        Optional[GetPaymentSettlementAmount], pydantic.Field(alias="settlementAmount")
    ] = None
    r"""This optional field will contain the approximate amount that will be settled to your account, converted to the currency your account is settled in.
    ...
    lines: OptionalNullable[List[GetPaymentLines]] = UNSET
    r"""Optionally provide the order lines for the payment. Each line contains details such as a description of the item ordered and its price.
    ...
    billing_address: Annotated[
        Optional[GetPaymentBillingAddress], pydantic.Field(alias="billingAddress")
    ] = None
    r"""The customer's billing address details. We advise to provide these details to improve fraud protection and conversion.
    ...
    shipping_address: Annotated[
        Optional[GetPaymentShippingAddress], pydantic.Field(alias="shippingAddress")
    ] = None
    r"""The customer's shipping address details. We advise to provide these details to improve fraud protection and conversion.
    ...
    application_fee: Annotated[
        OptionalNullable[GetPaymentApplicationFee],
    ...
    routing: OptionalNullable[List[GetPaymentRouting]] = UNSET
    r"""*This functionality is not enabled by default. Reach out to our partner management team if you wish to use it.*
    ...
    status_reason: Annotated[
        OptionalNullable[GetPaymentStatusReason], pydantic.Field(alias="statusReason")
    ] = UNSET
    r"""This object offers details about the status of a payment. Currently it is only available for point-of-sale payments.
