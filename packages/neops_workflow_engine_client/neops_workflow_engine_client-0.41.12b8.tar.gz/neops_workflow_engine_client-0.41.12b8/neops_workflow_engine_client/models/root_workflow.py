...
from neops_workflow_engine_client.models.workflow_steps_inner import WorkflowStepsInner
...
class RootWorkflow(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["id", "name", "retryConfig", "condition", "continueOnError", "delay", "parameters", "runOn", "repeatConfig", "type", "config", "steps", "version", "description", "cron", "hideForExecution", "parameterSchema"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "steps": [WorkflowStepsInner.from_dict(_item) for _item in obj["steps"]] if obj.get("steps") is not None else None,
