...
class CreateWorkflowDefinitionDto(BaseModel):
    ...
    """ # noqa: E501
    workflow: RootWorkflow = Field(description="The complete workflow definition following the RootWorkflow schema")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of CreateWorkflowDefinitionDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of CreateWorkflowDefinitionDto from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "workflow": RootWorkflow.from_dict(obj["workflow"]) if obj.get("workflow") is not None else None
        })
        return _obj
