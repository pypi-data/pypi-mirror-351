...
class FunctionBlockFullIdentificationDto(BaseModel):
    """
    FunctionBlockFullIdentificationDto
    """ # noqa: E501
    name: StrictStr = Field(description="The name of the function block")
    package: StrictStr = Field(description="The package/namespace the function block belongs to")
    ...
    __properties: ClassVar[List[str]] = ["name", "package", "majorVersion", "minorVersion", "patchVersion"]
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FunctionBlockFullIdentificationDto from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FunctionBlockFullIdentificationDto from a dict"""
        if obj is None:
            return None
