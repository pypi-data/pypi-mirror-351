...
class TimeIntervalFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["from_time", b"from_time", "to_time", b"to_time"]) -> None: ...
...
class DispatchFilter(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["_is_active", b"_is_active", "_is_dry_run", b"_is_dry_run", "end_time_interval", b"end_time_interval", "filter", b"filter", "is_active", b"is_active", "is_dry_run", b"is_dry_run", "is_recurring", b"is_recurring", "recurrence", b"recurrence", "start_time_interval", b"start_time_interval", "targets", b"targets", "update_time_interval", b"update_time_interval"]) -> None: ...
    @typing.overload
...
class TargetComponents(google.protobuf.message.Message):
    ...
    class CategoryAndType(google.protobuf.message.Message):
        ...
        category: frequenz.api.common.v1.microgrid.components.components_pb2.ComponentCategory.ValueType
        """The category of the target component (required)"""
        battery: frequenz.api.common.v1.microgrid.components.battery_pb2.BatteryType.ValueType
        """The type of battery
        Only applicable if the category is COMPONENT_CATEGORY_BATTERY
        """
        inverter: frequenz.api.common.v1.microgrid.components.inverter_pb2.InverterType.ValueType
        """The type of solar array
        Only applicable if the category is COMPONENT_CATEGORY_INVERTER
        """
        ev_charger: frequenz.api.common.v1.microgrid.components.ev_charger_pb2.EvChargerType.ValueType
