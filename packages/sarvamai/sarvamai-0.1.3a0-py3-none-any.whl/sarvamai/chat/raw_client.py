...
class RawChatClient:
    ...
    def completions(
        ...
        *,
        ...
        messages : typing.Sequence[ChatCompletionRequestMessageParams]
            Messages are a list of objects that contain a `role` and `content`.
        ...
        reasoning_effort : typing.Optional[ReasoningEffort]
            Enables the model's internal 'thinking mode'. While this field accepts multiple string values, all values behave identically. We do not currently support tuning different levels of reasoning effort — any provided value will simply enable the same enhanced reasoning process.
