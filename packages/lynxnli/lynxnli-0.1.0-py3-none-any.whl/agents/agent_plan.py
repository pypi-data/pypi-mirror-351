...
class PlanAgent(BaseAgent):
    ...
    def prompt(self, query:str) -> str:
        ...
        Your task is to understand the user's query '{query}' and transfer the query into
        task object(s) with array."""
    ...
    def generate(self, query: str) -> List[Task]:
        """
        ...
        well_promput = self.prompt(query)
