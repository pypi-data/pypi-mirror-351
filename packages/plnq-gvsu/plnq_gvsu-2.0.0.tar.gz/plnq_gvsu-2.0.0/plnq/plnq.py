...
def destroy_existing_target(directory):
    ...
    has_extra = any(item not in expected_contents for item in observed_contents)
    if has_extra:
...
def main():
    ...
    for cell_index, cell in enumerate(nb.cells):
        ...
        if f'!!!{PLNQ_IGNORE}!!!' in block_content:
            if (args.verbose):
        ...
        if f'!!!{PLNQ_PASS_THROUGH}!!!' in block_content:
            if (args.verbose):
            ...
            if cell.cell_type == 'markdown':    
                ...
                cell.source = strip_plnq_passthrough_comments(cell.source, f'!!!{PLNQ_PASS_THROUGH}!!!')
