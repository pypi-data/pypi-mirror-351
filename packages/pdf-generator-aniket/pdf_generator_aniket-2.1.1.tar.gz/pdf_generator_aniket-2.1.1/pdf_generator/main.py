...
def main():
    global logo_image, root, entries, placement_var, color_mode_var, x_entry, y_entry, overlay, loading_label, progress_bar, stop_button, version_label, flash_stop_button
