...
def pretty_format_duration(duration_s: float, n_digits: int = 1) -> str:
    ...
    :param duration_s: The duration to be printed in seconds.
    :type duration_s: float
    :param n_digits: The number of digits to show. Defaults to 1.
...
def rreplace(inp_string: str, old_string: str, new_string: str, counts: int) -> str:
    ...
    :type inp_string: str
    :param old_string: The old substring to be matched
    :type old_string: str
