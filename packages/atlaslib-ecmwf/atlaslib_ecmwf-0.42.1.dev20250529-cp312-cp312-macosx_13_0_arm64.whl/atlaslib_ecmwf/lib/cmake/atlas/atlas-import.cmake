...
set( atlas_HAVE_EIGEN                        True )
set( atlas_HAVE_GRIDTOOLS_STORAGE            0 )
set( atlas_HAVE_TESSELATION                  True )
set( ATLAS_LIBRARIES                         atlas )
set( atlas_VERSION_STR                       0.42.1.dev20250529 )
set( atlas_REQUIRES_PRIVATE_DEPENDENCIES     FALSE )

## eckit
find_dependency( eckit HINTS ${CMAKE_CURRENT_LIST_DIR}/../eckit /tmp/atlas/prereqs/eckitlib/lib/cmake/eckit  )
...
## Eigen3
set( Eigen3_HINT /opt/homebrew/share/eigen3/cmake )
...
if( atlas_HAVE_TESSELATION AND atlas_REQUIRES_PRIVATE_DEPENDENCIES )
    find_dependency( Qhull HINTS /tmp/qhull/target/lib/cmake/Qhull )
endif()
