...
class Switch(BaseModel):
    ...
    __properties = ["node_id", "node_type", "case_spec", "case_objs"]
    ...
    def to_dict(self):
        ...
        # set to None if case_spec (nullable) is None
        # and __fields_set__ contains the field
        if self.case_spec is None and "case_spec" in self.__fields_set__:
            _dict['case_spec'] = None

        # set to None if case_objs (nullable) is None
        # and __fields_set__ contains the field
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> Switch:
        """Create an instance of Switch from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return Switch.parse_obj(obj)

        _obj = Switch.parse_obj({
