...
class IEnum(BaseModel):
    """
    Class representing an enum-valued field in an intent. This is a value that can take on one of a discrete set of string values.  # noqa: E501
    """
    is_nullable: Optional[Any] = None
    options: Optional[Any] = Field(...)
    additional_properties: Dict[str, Any] = {}
    __properties = ["is_nullable", "options"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IEnum:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IEnum:
        """Create an instance of IEnum from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IEnum.parse_obj(obj)

        _obj = IEnum.parse_obj({
