...
class IReal(BaseModel):
    """
    Class representing a real (continuous number) valued field in an intent.  # noqa: E501
    """
    is_nullable: Optional[Any] = None
    allow_negative: Optional[Any] = Field(...)
    additional_properties: Dict[str, Any] = {}
    __properties = ["is_nullable", "allow_negative"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> IReal:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> IReal:
        """Create an instance of IReal from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return IReal.parse_obj(obj)

        _obj = IReal.parse_obj({
