...
class ServerManager:
    ...
    async def _initialize_servers(self) -> None:
        ...
        for server_cfg in self.servers_cfg:
            Console.write_stdout(f"Initializing server {server_cfg['name']} of type {server_cfg['type']}")
            ...
            try:
                ...
                Console.write_stdout(f"Server {server.name} initialized successfully")       
                        ...
                        if tool_name:
                            ...
                            if text_parts:
                                ...
                                try:
                                    ...
                                    Console.write_exception(f"Error sending result:", e)
                            else:
