...
class Report:
    ...
    def avg_time_between_ath(self):
        ...
        cummax = self.dt_pf_values.cummax()
        # Find where we hit new highs
        new_highs = self.dt_pf_values == cummax
        # Get the timestamps of new highs
        ath_dates = self.dt_pf_values.index[new_highs]
