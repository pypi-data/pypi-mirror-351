...
cdef extern from *:
    ...
    GEN dirpowerssum0(GEN, GEN, GEN, long)
    ...
    GEN ellE(GEN, long)
    GEN ellK(GEN, long)
    GEN ellL1_bitprec(GEN, long, long)
    GEN elladd(GEN, GEN, GEN)
    GEN akell(GEN, GEN)
    GEN ellan(GEN, long)
    GEN ellanalyticrank_bitprec(GEN, GEN, long)
    GEN ellap(GEN, GEN)
    ...
    GEN ellpadicfrobenius(GEN, long, long)
    ...
    GEN lfunabelianrelinit(GEN, GEN, GEN, GEN, long, long)
