...
module_dir = os.path.join(__location__, "../src/singler")
try:
...
try:
    from singler import __version__ as version
except ImportError:
    version = ""
...
latex_documents = [
    ("index", "user_guide.tex", "singler Documentation", "Aaron Lun", "manual")
]
