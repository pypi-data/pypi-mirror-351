            ...
            if isinstance(net, str):
                ...
                if 'ip' in nets[index] and index == 0:
                    ...
                    if needs_ignition and ip is not None and netmask is not None and gateway is not None:
                        ...
                        del nets[index]['ip']
                ptpxml = "<driver name='vhost' ptp='on'/>" if 'ptp' in nets[index] and nets[index]['ptp'] else ""
...
%s
%s
</interface>""" % (netxml, iftype, ptpxml, mtuxml, macxml, sourcexml, ovsxml, nicnumaxml, filterxml, nettype,
                   multiqueuexml, bootdevxml, addressxml)
