...
class UnitProjectsManager:
    ...
    def list(self, update: bool = True, return_info: bool = False):
    ...
    def get(self, project_name: str) -> 'Project':
        ...
        Returns:
            Project or None: The project or None if not found.
        """
    ...
    def create_from_compose_yaml(self, compose: yaml) -> 'Project':
        """
...
class Project:
    ...
    def detail(self, update_data: bool = True, print_info: bool = False):
        """
    ...
    def list_containers(self, print_info: bool = True, return_info: bool = False):
        if print_info:
    ...
    def logs(self, container_id: str = None, print_info: bool = True, realtime: bool = False, return_info: bool = False):

        if realtime:
            return self.realtime_logs(container_id=container_id)
    ...
    def realtime_logs(self, container_id: str = None, time_interval: int = 1):
        if container_id:
