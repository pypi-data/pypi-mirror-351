...
from queries_lib.schema import String, Int, Float, Boolean, ID, BigInt, BigFloat, Cursor, Datetime, JwtToken, Base64EncodedBinary, JSON, LdataNodeType, LdataNodesOrderBy, PermLevel, LdataDataCreator, DatasetAvailability, DatasetDownloadStatus, LdataEventType, ExecutionNodeStatus, PodBackupStatus, LdataTagType, LdataTreeEdgesOrderBy, LdataObjectMetasOrderBy, AccountInfosOrderBy, LdataWfExStatus, DatasetDownloadInfosOrderBy, DatasetInfoTagsOrderBy, DatasetPurchasesOrderBy, DatasetRequestsOrderBy, LdataNodeEventsOrderBy, ExecutionStatus, WorkflowGraphNodeType, WorkflowGraphNodesOrderBy, WorkflowGraphBranchType, WorkflowGraphBranchesOrderBy, TaskExecutionStatus, ContainerInfosOrderBy, TaskExecutionInfosOrderBy, ExecutionGraphNodesOrderBy, WorkflowGraphEdgesOrderBy, WorkflowSubscriptionsOrderBy, ExecutionInfosOrderBy, LpInfosOrderBy, WorkflowTagsOrderBy, WorkflowInfosOrderBy, TaskExecutionMessagesOrderBy, NotificationStatus, ExecutionBatchMembersOrderBy, NotificationType, ExecutionNotificationInfosOrderBy, LdataWfExesOrderBy, LdataLinkDataOrderBy, LdataShareInvitesOrderBy, LdataSharePermissionsOrderBy, LdataNodeTagsOrderBy, IgvGenomesOrderBy, IgvTracksOrderBy, PollockStatus, PollockDeploymentInfosOrderBy, LdataNodeAccessibleInWorkspaceCachesOrderBy, TaskInfosOrderBy, ExecutionCreatorsOrderBy, BenchlingApiTokensOrderBy, LdataS3MountAccessProvensOrderBy, LdataS3MountConfiguratorRolesOrderBy, CreditsOrderBy, TeamRole, TeamInvitesOrderBy, TeamMembersOrderBy, LdataShareLinkNodesOrderBy, PodStatus, InstanceSize, PodInfosOrderBy, PodTemplateVersionsOrderBy, PodSessionsOrderBy, EbsSessionsOrderBy, PodBackupsOrderBy, PublicKeyInfosOrderBy, BasespaceApiTokensOrderBy, WorkflowPinsOrderBy, AccountAccessPoliciesOrderBy, CatalogEventType, CatalogEventsOrderBy, CatalogExperimentColumnDefinitionsOrderBy, CatalogSampleColumnDataOrderBy, CatalogSamplesOrderBy, CatalogExperimentsOrderBy, CatalogProjectsOrderBy, AccountSecretsOrderBy, PodTemplatesOrderBy, ExecutionBatchInfosOrderBy, VerifiedEmailsOrderBy, PodGroupInfosOrderBy, TeamInfosOrderBy, WorkflowPersonalizationsOrderBy, DatasetAgreementActivatedsOrderBy, DatasetInfosOrderBy, ExecutionRefLpInfosOrderBy, GithubPersonalAccessTokensOrderBy, IncidentInfosOrderBy, LdataNodeEventChildRemovesOrderBy, LdataNodeEventIngressesOrderBy, LdataNodeEventMovesOrderBy, LdataNodeEventRemovesOrderBy, LdataS3MountRolesOrderBy, SharingReceiverSharedDataTypesOrderBy, TeamMemberSharedDataTypesOrderBy, UserInfosOrderBy, WorkflowFamilyInfosOrderBy, WorkflowGraphSubWfsOrderBy, WorkflowPreviewsOrderBy
...
query_str_node_info_fragment = "fragment NodeInfo on LdataNode{id name type removed ldataObjectMeta{contentSize modifyTime accessTime birthTime}}"
...
query_str_l_data_subtree_by_path_query = query_str_node_info_fragment + "query LDataSubtreeByPath($path:String!){ldataResolvePathData(argPath:$path){id childLdataTreeEdges{nodes{child{...NodeInfo finalLinkTarget{...NodeInfo}}}}}}"
