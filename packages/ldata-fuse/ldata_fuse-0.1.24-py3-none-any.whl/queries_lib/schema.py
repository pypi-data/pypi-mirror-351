...
class PackageRedemptionsOrderBy(Enum):
    ...
    package_version_info_by_package_version_id__multi_use_code_asc = "PACKAGE_VERSION_INFO_BY_PACKAGE_VERSION_ID__MULTI_USE_CODE_ASC"
    package_version_info_by_package_version_id__multi_use_code_desc = "PACKAGE_VERSION_INFO_BY_PACKAGE_VERSION_ID__MULTI_USE_CODE_DESC"
