...
project = 'dcm2niix'
copyright = '2021 The dcm2niix contributors'
author = 'The dcm2niix contributors'
...
latex_documents = [
    (master_doc, 'dcm2niix.tex', 'dcm2niix Documentation',
     author, 'manual'),
]
...
man_pages = [
    ('dcm2niix', 'dcm2niix', 'DICOM to NifTI converter',
     ['This manual was developed by Ghislain Antony Vaillant and is maintained by the community'], 1),
    ('dcm2niibatch', 'dcm2niibatch', 'DICOM to NifTI batch converter',
...
texinfo_documents = [
    (master_doc, 'dcm2niix', 'dcm2niix Documentation',
