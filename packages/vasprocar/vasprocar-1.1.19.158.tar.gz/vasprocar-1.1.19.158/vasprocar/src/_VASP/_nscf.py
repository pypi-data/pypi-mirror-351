...
for wp in range(1, (n_procar+1)):
    ...
    #----------------------------------------------------------------------------
    if (read_orb  == 1): file_orb  = open(dir_files + '/output/Orbitais.dat', "a")
    if (read_spin == 1): file_spin = open(dir_files + '/output/Spin.dat', "a")
    if (read_psi  == 1): file_psi  = open(dir_files + '/output/Psi/Psi.dat', "a")
    if (read_reg  == 1): file_reg  = open(dir_files + '/output/Localizacao/Localizacao.dat', 'a')
    #--------------------------------------------------------------------------------------------
                      ...
                      for ion_n in range (1, (ni+1)):
                          ...
                          if (esc_ions == 0 or (esc_ions == 1 and temp_sn == "sim")):  
                             ...
                             for i in range(1,(n_orb+1)):
                                 if (Orb_spin[i-1] == 1):                                                
                                    #------------------------------------------------------
                                    if (float(VTemp[i]) >= 0.0): Sx_up   += float(VTemp[i])
                                    if (float(VTemp[i]) <= 0.0): Sx_down += float(VTemp[i])
                                    #------------------------------------------------------
                      ...
                      for ion_n in range (1, (ni+1)):
                          ...
                          if (esc_ions == 0 or (esc_ions == 1 and temp_sn == "sim")):  
                             ...
                             for i in range(1,(n_orb+1)):
                                 if (Orb_spin[i-1] == 1):
                                    #------------------------------------------------------
                                    if (float(VTemp[i]) >= 0.0): Sy_up   += float(VTemp[i])
                                    if (float(VTemp[i]) <= 0.0): Sy_down += float(VTemp[i])
                                    #------------------------------------------------------
                      ...
                      for ion_n in range (1, (ni+1)):
                          ...
                          if (esc_ions == 0 or (esc_ions == 1 and temp_sn == "sim")):  
                             ...
                             for i in range(1,(n_orb+1)):
                                 if (Orb_spin[i-1] == 1):
                                    #------------------------------------------------------
                                    if (float(VTemp[i]) >= 0.0): Sz_up   += float(VTemp[i])
                                    if (float(VTemp[i]) <= 0.0): Sz_down += float(VTemp[i])
                                    #------------------------------------------------------
    ...
    procar.close()
    #------------------------------------
    if (read_orb  == 1): file_orb.close()
    if (read_spin == 1): file_spin.close()
    if (read_psi  == 1): file_psi.close()
    if (read_reg  == 1): file_reg.close()
    #------------------------------------
