...
class TestService:
    ...
    def create(
        ...
        Args:
            ...
            variants (list[str], optional): Whether we should create variants in the synthetic data. Only makes sense for tests created by Galtea.
                Be cautious with this parameter, as it will create more test cases and be more expensive.\n
                Example: `["paraphrased", "typos", "incorrect", "cognitively_diverse", "linguistic_diverse"]`.\n
                To check the available variants, please refer to the documentation: https://docs.galtea.ai/concepts/product/test/red-teaming-threats.\n
            strategies (list[str], optional): Red teaming strategies to apply. A red teaming strategy is a specific technique applied to an initial prompt (derived from a selected threat) to modify or obfuscate it.\n
            ...
            language (str, optional): Language for generating the synthetic test cases. Defaults to the language used in the ground truth file.\n
                ...
                More information can be found here: https://en.wikipedia.org/wiki/List_of_ISO_639_language_codes.
            max_test_cases (int, optional): Maximum number of test cases to generate. It's only applicable for tests generated by Galtea\n
