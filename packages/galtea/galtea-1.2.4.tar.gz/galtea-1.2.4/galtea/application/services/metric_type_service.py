...
class MetricTypeService:
    ...
    def create(
        ...
        Args:
            ...
            evaluation_params (list[str]): parameters that will be used for defining the criteria or evaluation_steps for the evaluation steps.
