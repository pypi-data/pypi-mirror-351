...
class RawDocumentsClient:
    ...
    def generate_document_preview(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[GenerateDocumentPreviewResponse]:
        """
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            json={
                ...
                "data": data,
                "formatOpts": convert_and_respect_annotation_metadata(
                    object_=format_opts, annotation=GenerateDocumentPreviewRequestFormatOpts, direction="write"
                ),
            },
            headers={
                "content-type": "application/json",
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    parse_obj_as(
                        type_=GenerateDocumentPreviewResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawDocumentsClient:
    ...
    async def generate_document_preview(
        ...
        *,
        ...
        format_opts: typing.Optional[GenerateDocumentPreviewRequestFormatOpts] = OMIT,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[GenerateDocumentPreviewResponse]:
        """
        Generates a preview by creating a single-page render job, processing it immediately, and returning the output URL. Used for template visualization.
