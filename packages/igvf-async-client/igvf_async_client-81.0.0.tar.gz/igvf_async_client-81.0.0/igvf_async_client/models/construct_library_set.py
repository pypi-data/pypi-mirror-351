...
class ConstructLibrarySet(BaseModel):
    ...
    assay_titles: Optional[List[StrictStr]] = Field(default=None, description="The assay titles of the file sets that used this construct library set.")
    ...
    def control_type_validate_enum(cls, value):
        ...
        if value not in set(['reference transduction', 'non-targeting']):
            raise ValueError("must be one of enum values ('reference transduction', 'non-targeting')")
        return value
