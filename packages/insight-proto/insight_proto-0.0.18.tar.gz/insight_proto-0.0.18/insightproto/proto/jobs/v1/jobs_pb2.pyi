...
class JobMessage(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["aether_job", b"aether_job", "insight_job", b"insight_job", "job", b"job", "org", b"org"]) -> builtins.bool: ...
    def ClearField(self, field_name: typing.Literal["aether_job", b"aether_job", "id", b"id", "insight_job", b"insight_job", "job", b"job", "org", b"org"]) -> None: ...
    def WhichOneof(self, oneof_group: typing.Literal["job", b"job"]) -> typing.Literal["aether_job", "insight_job"] | None: ...
...
class AetherJob(google.protobuf.message.Message):
    ...
    def HasField(self, field_name: typing.Literal["DiscussionId", b"DiscussionId", "IssueId", b"IssueId", "JobId", b"JobId", "MergeRequestId", b"MergeRequestId", "NoteId", b"NoteId", "_DiscussionId", b"_DiscussionId", "_IssueId", b"_IssueId", "_JobId", b"_JobId", "_MergeRequestId", b"_MergeRequestId", "_NoteId", b"_NoteId", "project", b"project"]) -> builtins.bool: ...
...
class ProviderProject(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["id", b"id", "name", b"name", "provider", b"provider"]) -> None: ...

global___ProviderProject = ProviderProject

@typing.final
class Provider(google.protobuf.message.Message):
    """Provider describes the provider source info e.g. the gitlab integration id so we can look up the tokens"""
    ...
    id: builtins.str
    """the id of the integration used"""
    source: builtins.str
    """the type of the integration (e.g. gitlab/github)"""
    gitUrl: builtins.str
...
class Trigger(google.protobuf.message.Message):
    ...
    def ClearField(self, field_name: typing.Literal["reference_id", b"reference_id", "source", b"source", "text", b"text"]) -> None: ...
