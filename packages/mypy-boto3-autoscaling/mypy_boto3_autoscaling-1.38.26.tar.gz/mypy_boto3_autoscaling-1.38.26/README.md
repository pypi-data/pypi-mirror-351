...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-autoscaling)](https://pypistats.org/packages/mypy-boto3-autoscaling)
...
`mypy-boto3-autoscaling` dependency in production. However, there is an issue
