...
def load_model(model_path):
    ...
    model = model_class(**checkpoint["attributes"])
...
def save_model(model_instance, model_source, attributes, input_channels, model_name=None, path=None, le=None):
