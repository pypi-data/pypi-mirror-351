...
from achatbot.common.types import AgoraParams
from achatbot.transports.agora import AgoraTransport
from achatbot.cmd.bots.base_agora import AgoraChannelBot
from achatbot.cmd.bots import register_ai_room_bots
from achatbot.types.frames.data_frames import (
    LLMMessagesFrame,
)
from achatbot.services.mcp_client import MCPClient
...
class AgoraNASABot(AgoraChannelBot):
    """
    agora webrtc channel + llm(gemini) + nasa mcp bot
    """
