...
from achatbot.common.types import DEFAULT_SYSTEM_PROMPT, MODELS_DIR, PersonalAIProxyArgs
...
class LLMEnvInit:
    ...
    def _get_llm_generate_args(prefix: str = "") -> dict:
        from achatbot.types.llm.sampling import LMGenerateArgs
    ...
    def get_llm_vllm_generator_args() -> dict:
        # from achatbot.types.llm.vllm import VllmEngineArgs, AsyncEngineArgs
    ...
    def get_llm_sglang_generator_args() -> dict:
        # from achatbot.types.llm.sglang import SGLangEngineArgs, ServerArgs
    ...
    def get_llm_trtllm_generator_args() -> dict:
        # from achatbot.types.llm.tensorrt_llm import TensorRTLLMEngineArgs, LlmArgs
    ...
    def get_llm_trtllm_runner_generator_args() -> dict:
        # from achatbot.types.llm.tensorrt_llm import TensorRTLLMRunnerEngineArgs, TensorRTLLMRunnerArgs
    ...
    def get_qwen2_5omni_transformers_args() -> dict:
        from achatbot.types.llm.transformers import TransformersLMArgs
        from achatbot.thirdparty.qwen2_code2wav import Code2WavEngineConfig, Code2WavGenerationConfig
        from achatbot.types.omni.qwen2_vision_voice import Qwen2_5TransformersVisionVoiceLMArgs
    ...
    def get_kimi_audio_transformers_args() -> dict:
        from achatbot.types.omni.kimi_voice import (
    ...
    def get_vita_audio_transformers_args() -> dict:
        from achatbot.types.omni.vita_voice import (
