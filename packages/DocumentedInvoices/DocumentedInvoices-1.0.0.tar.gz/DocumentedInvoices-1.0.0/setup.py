...
setup(
  name='DocumentedInvoices',         #* Your package will have this name
  ...
  author='Lakshya Dhingra',                   # Your name
  author_email='dlakshya223@gmail.com',  # Your email
  url='https://github.com/LakshyaDhingra/InvoicePDFPackage',    # Homepage of your library (e.g. github or your website)
