...
def generate_keys(N, p, lam, omega, delta, save_dir = "Keys_FHEMP"):
    ...
    save_json(k_vec, os.path.join(save_dir, "keys/secret_vector.json"))
    save_json(evk, os.path.join(save_dir, "keys/evaluation_key.json"))
