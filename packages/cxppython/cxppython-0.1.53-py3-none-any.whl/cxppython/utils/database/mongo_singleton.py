...
class MongoDBSingleton:
    ...
    @staticmethod
    def create(connection: Union[str, Dict[str, Any]], max_pool_size: int = 20) -> 'MongoDBSingleton':
        """
        ...
        with MongoDBSingleton.__lock:
            if isinstance(connection, str):
                try:
                    client = MongoClient(connection, maxPoolSize=max_pool_size)
                ...
                try:
                    ...
                    raise ValueError(f"无效的连接配置: {str(e)}")
            else:
