...
Welcome to `biocsetup` contributor's guide.
...
If you experience bugs or general issues with `biocsetup`, please have a look
...
You can help improve `biocsetup` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`biocsetup` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `biocsetup`'s files. While this mechanism can
...
```
conda create -n biocsetup python=3 six virtualenv pytest pytest-cov
conda activate biocsetup
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/biocsetup.git
   cd biocsetup
   ```
...
5. Install [pre-commit]:
   ...
   `biocsetup` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/biocsetup
[issue tracker]: https://github.com/<USERNAME>/biocsetup/issues
