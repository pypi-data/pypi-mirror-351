...
class RobotCommandFeedback(CommandFeedback):
    class FinishCode:
        ...
        InitializedFailed: typing.ClassVar[RobotCommandFeedback.FinishCode]  # value = <FinishCode.InitializedFailed: 4>
        ...
        __members__: typing.ClassVar[dict[str, RobotCommandFeedback.FinishCode]]  # value = {'Unknown': <FinishCode.Unknown: 0>, 'Ok': <FinishCode.Ok: 1>, 'Canceled': <FinishCode.Canceled: 2>, 'Preempted': <FinishCode.Preempted: 3>, 'InitializedFailed': <FinishCode.InitializedFailed: 4>, 'ControlManagerIdle': <FinishCode.ControlManagerIdle: 5>, 'ControlManagerFault': <FinishCode.ControlManagerFault: 6>, 'UnexpectedState': <FinishCode.UnexpectedState: 7>}
        def __eq__(self, other: typing.Any) -> bool:
            ...
        def __getstate__(self) -> int:
            ...
...
class RobotState_M:
    ...
    def ft_sensor_right(self) -> FTSensorData:
        ...
    @property
    def is_ready(self) -> numpy.ndarray[bool[26, 1]]:
        ...
    @property
...
class RobotState_T5:
    ...
    def ft_sensor_right(self) -> FTSensorData:
        ...
    @property
    def is_ready(self) -> numpy.ndarray[bool[23, 1]]:
        ...
    @property
...
class RobotState_UB:
    ...
    def ft_sensor_right(self) -> FTSensorData:
        ...
    @property
    def is_ready(self) -> numpy.ndarray[bool[18, 1]]:
        ...
    @property
