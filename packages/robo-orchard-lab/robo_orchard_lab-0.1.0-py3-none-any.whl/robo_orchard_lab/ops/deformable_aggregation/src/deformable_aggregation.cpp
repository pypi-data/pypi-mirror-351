...
at::Tensor deformable_aggregation_forward(const at::Tensor& _mc_ms_feat,
  ...
  deformable_aggregation(output.data_ptr<float>(), mc_ms_feat, spatial_shape,
                         scale_start_index, sampling_location, weights,
                         batch_size, num_cams, num_feat, num_embeds, num_scale,
                         num_pts, num_groups);
  return output;
}
...
void deformable_aggregation_backward(
    ...
    const at::Tensor& _weights, const at::Tensor& _grad_output,
  ...
  deformable_aggregation_grad(mc_ms_feat, spatial_shape, scale_start_index,
                              sampling_location, weights, grad_output,
                              grad_mc_ms_feat, grad_sampling_location,
                              grad_weights, batch_size, num_cams, num_feat,
