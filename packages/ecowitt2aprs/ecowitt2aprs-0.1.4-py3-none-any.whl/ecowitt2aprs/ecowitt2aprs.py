...
class Ecowitt:
    ...
    def get_instant_data(self):
        ...
        return {
            ...
            "rain_hour": find(wx, "rainfall/hourly") * 100,
    ...
    def get_history(self):
        ...
        rain_rate_in_per_hr = np.array(
            [
                float(x)
                for x in content["data"]["rainfall"]["rain_rate"]["list"].values()
            ]
        )

        return {"rain_24h": rain_rate_in_per_hr.sum() / 12}
