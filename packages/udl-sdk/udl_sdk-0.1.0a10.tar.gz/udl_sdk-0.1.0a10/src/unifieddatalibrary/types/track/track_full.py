...
class TrackFull(BaseModel):
    ...
    asset_nat: Optional[str] = FieldInfo(alias="assetNat", default=None)
    ...
    ecef_acc: Optional[List[float]] = FieldInfo(alias="ecefAcc", default=None)
    """Track object acceleration in ECEF [x'', y'', z''], meters/sec^2.
    ...
    e_nu_pos: Optional[List[float]] = FieldInfo(alias="eNUPos", default=None)
    """East, North, Up position components, in meters.

    When provided, array must always contain 3 values.
    """

    e_nu_vel: Optional[List[float]] = FieldInfo(alias="eNUVel", default=None)
    """East, North, Up velocity components, in meters/sec.
    ...
    env_conf: Optional[float] = FieldInfo(alias="envConf", default=None)
    ...
    ident_cred: Optional[int] = FieldInfo(alias="identCred", default=None)
    """Track object identity credibility."""

    ident_rel: Optional[int] = FieldInfo(alias="identRel", default=None)
    """Track object identity reliability."""

    j_series: Optional[str] = FieldInfo(alias="jSeries", default=None)
    ...
    lc_acc: Optional[List[float]] = FieldInfo(alias="lcAcc", default=None)
    """
    ...
    lco: Optional[List[float]] = None
    """Origin of a local coordinate system [lat, lon, altitude].

    When provided, array must always contain 3 values.
    """

    lc_pos: Optional[List[float]] = FieldInfo(alias="lcPos", default=None)
    """
    ...
    """x, y, and z-axis rotations about ECEF that define a local cartesian system.
    ...
    m3av: Optional[int] = None
    """Mode-3/A validity status."""

    mod_type: Optional[str] = FieldInfo(alias="modType", default=None)
    ...
    msn_id: Optional[str] = FieldInfo(alias="msnId", default=None)
    """Mission ID related to the track."""

    multi_source: Optional[bool] = FieldInfo(alias="multiSource", default=None)
    ...
    obj_id: Optional[str] = FieldInfo(alias="objId", default=None)
    """The UID or designation of the tracked object."""

    obj_ident: Optional[str] = FieldInfo(alias="objIdent", default=None)
    """
    ...
    obj_spec: Optional[str] = FieldInfo(alias="objSpec", default=None)
    ...
    sen_qual: Optional[str] = FieldInfo(alias="senQual", default=None)
    """Sensor quality."""
    ...
    trk_itm_id: Optional[str] = FieldInfo(alias="trkItmId", default=None)
    ...
    trk_pt_type: Optional[str] = FieldInfo(alias="trkPtType", default=None)
    """
    ...
    trk_stat: Optional[str] = FieldInfo(alias="trkStat", default=None)
    """
