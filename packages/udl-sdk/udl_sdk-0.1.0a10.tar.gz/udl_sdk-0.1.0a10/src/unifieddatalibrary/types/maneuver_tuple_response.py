...
__all__ = [
    ...
    "ManeuverTupleResponseItem",
    "ManeuverTupleResponseItemPostEventElset",
    "ManeuverTupleResponseItemPostEventStateVector",
    "ManeuverTupleResponseItemPreEventElset",
    "ManeuverTupleResponseItemPreEventStateVector",
]
...
class ManeuverTupleResponseItem(BaseModel):
    ...
    post_event_elset: Optional[ManeuverTupleResponseItemPostEventElset] = FieldInfo(
        alias="postEventElset", default=None
    )
    """
    ...
    post_event_state_vector: Optional[ManeuverTupleResponseItemPostEventStateVector] = FieldInfo(
    ...
    pre_event_elset: Optional[ManeuverTupleResponseItemPreEventElset] = FieldInfo(alias="preEventElset", default=None)
    """
    An element set is a collection of Keplerian orbital elements describing an orbit
    of a particular satellite. The data is used along with an orbit propagator in
    order to predict the motion of a satellite. The element set, or elset for short,
    ...
    pre_event_state_vector: Optional[ManeuverTupleResponseItemPreEventStateVector] = FieldInfo(
...
ManeuverTupleResponse: TypeAlias = List[ManeuverTupleResponseItem]
