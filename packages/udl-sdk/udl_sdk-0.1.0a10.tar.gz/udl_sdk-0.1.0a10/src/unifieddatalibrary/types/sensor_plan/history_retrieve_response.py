...
__all__ = [
    ...
    "HistoryRetrieveResponseItem",
    "HistoryRetrieveResponseItemCollectRequest",
    "HistoryRetrieveResponseItemCollectRequestElset",
    "HistoryRetrieveResponseItemCollectRequestStateVector",
]


class HistoryRetrieveResponseItemCollectRequestElset(BaseModel):
...
class HistoryRetrieveResponseItemCollectRequestStateVector(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class HistoryRetrieveResponseItemCollectRequest(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    elset: Optional[HistoryRetrieveResponseItemCollectRequestElset] = None
    """
    ...
    state_vector: Optional[HistoryRetrieveResponseItemCollectRequestStateVector] = FieldInfo(
        alias="stateVector", default=None
    )
    """
...
class HistoryRetrieveResponseItem(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    collect_requests: Optional[List[HistoryRetrieveResponseItemCollectRequest]] = FieldInfo(
        alias="collectRequests", default=None
    )
...
HistoryRetrieveResponse: TypeAlias = List[HistoryRetrieveResponseItem]
