...
__all__ = ["CollectRequestAbridged", "Elset", "StateVector"]
...
class CollectRequestAbridged(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    state_vector: Optional[StateVector] = FieldInfo(alias="stateVector", default=None)
    """
