...
__all__ = ["OrbitdeterminationUnvalidatedPublishParams", "Body", "BodyAprioriElset", "BodyAprioriStateVector"]


class OrbitdeterminationUnvalidatedPublishParams(TypedDict, total=False):
...
class BodyAprioriStateVector(TypedDict, total=False):
    classification_marking: Required[Annotated[str, PropertyInfo(alias="classificationMarking")]]
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class Body(TypedDict, total=False):
    ...
    apriori_elset: Annotated[BodyAprioriElset, PropertyInfo(alias="aprioriElset")]
    """
    ...
    apriori_state_vector: Annotated[BodyAprioriStateVector, PropertyInfo(alias="aprioriStateVector")]
    """
