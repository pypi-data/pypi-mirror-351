...
__all__ = ["OrbitdeterminationCreateParams", "AprioriElset", "AprioriStateVector"]


class OrbitdeterminationCreateParams(TypedDict, total=False):
    ...
    apriori_elset: Annotated[AprioriElset, PropertyInfo(alias="aprioriElset")]
    """
    ...
    apriori_state_vector: Annotated[AprioriStateVector, PropertyInfo(alias="aprioriStateVector")]
    """
...
class AprioriElset(TypedDict, total=False):
    classification_marking: Required[Annotated[str, PropertyInfo(alias="classificationMarking")]]
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class AprioriStateVector(TypedDict, total=False):
    classification_marking: Required[Annotated[str, PropertyInfo(alias="classificationMarking")]]
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
