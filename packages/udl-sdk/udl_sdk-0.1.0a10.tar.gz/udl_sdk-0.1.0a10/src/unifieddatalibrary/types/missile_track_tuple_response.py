...
__all__ = ["MissileTrackTupleResponse", "MissileTrackTupleResponseItem", "MissileTrackTupleResponseItemVector"]


class MissileTrackTupleResponseItemVector(BaseModel):
    epoch: datetime
...
class MissileTrackTupleResponseItem(BaseModel):
    ...
    vectors: Optional[List[MissileTrackTupleResponseItemVector]] = None
...
MissileTrackTupleResponse: TypeAlias = List[MissileTrackTupleResponseItem]
