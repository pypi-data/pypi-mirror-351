...
from ..types import (
    drift_history_list_params,
    drift_history_count_params,
    drift_history_tuple_params,
...
class DriftHistoryResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> DriftHistoryResourceWithRawResponse:
        ...
        """
        return DriftHistoryResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> DriftHistoryResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/Bluestaq/udl-python-sdk#with_streaming_response
        """
        return DriftHistoryResourceWithStreamingResponse(self)
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    drift_history_retrieve_params.DriftHistoryRetrieveParams,
                ),
            ),
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    drift_history_count_params.DriftHistoryCountParams,
                ),
            ),
            cast_to=str,
        )
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    drift_history_tuple_params.DriftHistoryTupleParams,
                ),
            ),
            cast_to=DriftHistoryTupleResponse,
        )
...
class AsyncDriftHistoryResource(AsyncAPIResource):
    ...
    def with_raw_response(self) -> AsyncDriftHistoryResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/Bluestaq/udl-python-sdk#accessing-raw-response-data-eg-headers
        """
        return AsyncDriftHistoryResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncDriftHistoryResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/Bluestaq/udl-python-sdk#with_streaming_response
        """
        return AsyncDriftHistoryResourceWithStreamingResponse(self)
...
class DriftHistoryResourceWithRawResponse:
    def __init__(self, drift_history: DriftHistoryResource) -> None:
        self._drift_history = drift_history

        self.retrieve = to_raw_response_wrapper(
            drift_history.retrieve,
        )
...
class AsyncDriftHistoryResourceWithRawResponse:
    def __init__(self, drift_history: AsyncDriftHistoryResource) -> None:
        self._drift_history = drift_history
...
class DriftHistoryResourceWithStreamingResponse:
    def __init__(self, drift_history: DriftHistoryResource) -> None:
        self._drift_history = drift_history
...
class AsyncDriftHistoryResourceWithStreamingResponse:
    def __init__(self, drift_history: AsyncDriftHistoryResource) -> None:
        self._drift_history = drift_history
