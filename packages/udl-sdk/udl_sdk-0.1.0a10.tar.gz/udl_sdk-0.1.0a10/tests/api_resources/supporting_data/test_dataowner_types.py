...
class TestDataownerTypes:
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.supporting_data.dataowner_types.with_streaming_response.list() as response:
...
class TestAsyncDataownerTypes:
    ...
    async def test_raw_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.supporting_data.dataowner_types.with_raw_response.list()
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.supporting_data.dataowner_types.with_streaming_response.list() as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
