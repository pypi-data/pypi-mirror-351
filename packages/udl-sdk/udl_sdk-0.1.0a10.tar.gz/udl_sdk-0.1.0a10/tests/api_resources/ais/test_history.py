...
from unifieddatalibrary.types.shared import AIsFull
...
class TestHistory:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        ...
        assert_matches_type(SyncOffsetPage[AIsFull], history, path=["response"])
    ...
    def test_raw_response_list(self, client: Unifieddatalibrary) -> None:
        response = client.ais.history.with_raw_response.list(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.ais.history.with_streaming_response.list(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    def test_raw_response_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.ais.history.with_raw_response.aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_aodr(self, client: Unifieddatalibrary) -> None:
        with client.ais.history.with_streaming_response.aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        ...
        assert_matches_type(AsyncOffsetPage[AIsFull], history, path=["response"])
    ...
    async def test_raw_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.ais.history.with_raw_response.list(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.ais.history.with_streaming_response.list(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.ais.history.with_raw_response.aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.ais.history.with_streaming_response.aodr(
            ts=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
