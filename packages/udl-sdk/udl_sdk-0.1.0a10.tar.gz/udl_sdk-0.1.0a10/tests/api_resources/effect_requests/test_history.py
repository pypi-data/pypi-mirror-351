...
class TestHistory:
    ...
    def test_method_list(self, client: Unifieddatalibrary) -> None:
        history = client.effect_requests.history.list(
    ...
    def test_raw_response_list(self, client: Unifieddatalibrary) -> None:
        response = client.effect_requests.history.with_raw_response.list(
            created_at=parse_date("2019-12-27"),
        )
    ...
    def test_streaming_response_list(self, client: Unifieddatalibrary) -> None:
        with client.effect_requests.history.with_streaming_response.list(
            created_at=parse_date("2019-12-27"),
        ) as response:
    ...
    def test_method_aodr(self, client: Unifieddatalibrary) -> None:
        history = client.effect_requests.history.aodr(
            created_at=parse_date("2019-12-27"),
        )
    ...
    def test_raw_response_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.effect_requests.history.with_raw_response.aodr(
            created_at=parse_date("2019-12-27"),
        )
    ...
    def test_streaming_response_aodr(self, client: Unifieddatalibrary) -> None:
        with client.effect_requests.history.with_streaming_response.aodr(
            created_at=parse_date("2019-12-27"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_method_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.effect_requests.history.list(
            created_at=parse_date("2019-12-27"),
        )
    ...
    async def test_raw_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.effect_requests.history.with_raw_response.list(
            created_at=parse_date("2019-12-27"),
        )
    ...
    async def test_streaming_response_list(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.effect_requests.history.with_streaming_response.list(
            created_at=parse_date("2019-12-27"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_method_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.effect_requests.history.aodr(
            created_at=parse_date("2019-12-27"),
        )
        assert history is None
    ...
    async def test_raw_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.effect_requests.history.with_raw_response.aodr(
            created_at=parse_date("2019-12-27"),
        )
    ...
    async def test_streaming_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.effect_requests.history.with_streaming_response.aodr(
            created_at=parse_date("2019-12-27"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
