...
class TestHistory:
    ...
    def test_method_aodr(self, client: Unifieddatalibrary) -> None:
        history = client.conjunctions.history.aodr(
    ...
    def test_raw_response_aodr(self, client: Unifieddatalibrary) -> None:
        response = client.conjunctions.history.with_raw_response.aodr(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_aodr(self, client: Unifieddatalibrary) -> None:
        with client.conjunctions.history.with_streaming_response.aodr(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
    ...
    def test_raw_response_count(self, client: Unifieddatalibrary) -> None:
        response = client.conjunctions.history.with_raw_response.count(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    def test_streaming_response_count(self, client: Unifieddatalibrary) -> None:
        with client.conjunctions.history.with_streaming_response.count(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
...
class TestAsyncHistory:
    ...
    async def test_method_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        history = await async_client.conjunctions.history.aodr(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
        assert history is None
    ...
    async def test_raw_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.conjunctions.history.with_raw_response.aodr(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_aodr(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.conjunctions.history.with_streaming_response.aodr(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
    ...
    async def test_raw_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        response = await async_client.conjunctions.history.with_raw_response.count(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        )
    ...
    async def test_streaming_response_count(self, async_client: AsyncUnifieddatalibrary) -> None:
        async with async_client.conjunctions.history.with_streaming_response.count(
            tca=parse_datetime("2019-12-27T18:11:19.117Z"),
        ) as response:
            assert not response.is_closed
            assert response.http_request.headers.get("X-Stainless-Lang") == "python"
