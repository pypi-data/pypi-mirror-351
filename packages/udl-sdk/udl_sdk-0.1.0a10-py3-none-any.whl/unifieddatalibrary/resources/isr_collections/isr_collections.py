...
from ...types import (
    ...
    isr_collection_unvalidated_publish_params,
)
from .history import (
    HistoryResource,
...
class IsrCollectionsResource(SyncAPIResource):
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    isr_collection_count_params.IsrCollectionCountParams,
                ),
            ),
            cast_to=str,
        )
    ...
    def create_bulk(
        self,
        *,
        body: Iterable[isr_collection_create_bulk_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[isr_collection_create_bulk_params.Body]),
            options=make_request_options(
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    ...
                    isr_collection_tuple_params.IsrCollectionTupleParams,
                ),
            ),
            cast_to=IsrCollectionTupleResponse,
        )

    def unvalidated_publish(
        self,
        *,
        body: Iterable[isr_collection_unvalidated_publish_params.Body],
        # Use the following arguments if you need to pass additional parameters to the API that aren't available via kwargs.
        # The extra values given here take precedence over values defined on the client or passed to this method.
        extra_headers: Headers | None = None,
        extra_query: Query | None = None,
        ...
        return self._post(
            ...
            body=maybe_transform(body, Iterable[isr_collection_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class AsyncIsrCollectionsResource(AsyncAPIResource):
    ...
    async def create_bulk(
        ...
        *,
        ...
        return await self._post(
            "/udl/isrcollection/createBulk",
            body=await async_maybe_transform(body, Iterable[isr_collection_create_bulk_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
    ...
    async def unvalidated_publish(
        ...
        *,
        ...
        return await self._post(
            "/filedrop/udl-isrcollection",
            body=await async_maybe_transform(body, Iterable[isr_collection_unvalidated_publish_params.Body]),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
            cast_to=NoneType,
...
class IsrCollectionsResourceWithRawResponse:
    def __init__(self, isr_collections: IsrCollectionsResource) -> None:
        ...
        self.tuple = to_raw_response_wrapper(
            isr_collections.tuple,
        )
        self.unvalidated_publish = to_raw_response_wrapper(
            isr_collections.unvalidated_publish,
        )
