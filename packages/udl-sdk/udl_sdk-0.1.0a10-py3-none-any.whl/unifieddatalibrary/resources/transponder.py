...
class TransponderResource(SyncAPIResource):
    ...
    def with_raw_response(self) -> TransponderResourceWithRawResponse:
        ...
        """
        return TransponderResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> TransponderResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/Bluestaq/udl-python-sdk#with_streaming_response
        """
        return TransponderResourceWithStreamingResponse(self)
    ...
    def create(
        ...
        *,
        ...
        Args:
          ...
          id_comm: ID of the parent Comm object for this transponder.

          source: Source of the data.

          id: Unique identifier of the record, auto-generated by the system.

          fec: Forward error correction, e.g. 0=Auto, 1 = 1/2, 2 = 2/3, 3 = 3/4, 4 = 5/6, 5 =
              7/8, 6 = 8/9, 7 = 3/5, 8 = 4/5, 9 = 9/10, 15 = None.

          format: Format.

          modulation: Transponder modulation, e.g. Auto, QPSK, 8PSK.

          name: Optional name of the transponder.

          nid: Optional external network id as provided data source.
          ...
          symbol_rate: Symbol rate is the number of symbol changes, waveform changes, or signaling
              events, across the transmission medium per time unit using a digitally modulated
              signal or a line code. Also measured in Hz.

          system: Transponder system, e.g. DVB-S, DVB-S2.

          tid: Optional external transponder id as provided data source.

          ttf: Transponder Translation Factor. This is the frequency difference between the
        ...
        return self._post(
            ...
            body=maybe_transform(
                ...
                transponder_create_params.TransponderCreateParams,
            ),
        ...
        *,
        ...
        return self._put(
            ...
            body=maybe_transform(
                ...
                transponder_update_params.TransponderUpdateParams,
            ),
            options=make_request_options(
                extra_headers=extra_headers, extra_query=extra_query, extra_body=extra_body, timeout=timeout
            ),
...
class AsyncTransponderResource(AsyncAPIResource):
    ...
    def with_raw_response(self) -> AsyncTransponderResourceWithRawResponse:
        ...
        For more information, see https://www.github.com/Bluestaq/udl-python-sdk#accessing-raw-response-data-eg-headers
        """
        return AsyncTransponderResourceWithRawResponse(self)

    @cached_property
    def with_streaming_response(self) -> AsyncTransponderResourceWithStreamingResponse:
        """
        An alternative to `.with_raw_response` that doesn't eagerly read the response body.

        For more information, see https://www.github.com/Bluestaq/udl-python-sdk#with_streaming_response
        """
        return AsyncTransponderResourceWithStreamingResponse(self)
...
class TransponderResourceWithRawResponse:
    def __init__(self, transponder: TransponderResource) -> None:
...
class AsyncTransponderResourceWithRawResponse:
    def __init__(self, transponder: AsyncTransponderResource) -> None:
        self._transponder = transponder
...
class TransponderResourceWithStreamingResponse:
    def __init__(self, transponder: TransponderResource) -> None:
        self._transponder = transponder
...
class AsyncTransponderResourceWithStreamingResponse:
    def __init__(self, transponder: AsyncTransponderResource) -> None:
        self._transponder = transponder
