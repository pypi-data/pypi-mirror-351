...
__all__ = ["SensorPlanUpdateParams", "CollectRequest", "CollectRequestElset", "CollectRequestStateVector"]


class SensorPlanUpdateParams(TypedDict, total=False):
    ...
    collect_requests: Annotated[Iterable[CollectRequest], PropertyInfo(alias="collectRequests")]
...
class CollectRequest(TypedDict, total=False):
    ...
    state_vector: Annotated[CollectRequestStateVector, PropertyInfo(alias="stateVector")]
    """
