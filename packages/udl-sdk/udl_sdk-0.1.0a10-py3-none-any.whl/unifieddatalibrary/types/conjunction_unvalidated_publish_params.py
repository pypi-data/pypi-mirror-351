...
__all__ = ["ConjunctionUnvalidatedPublishParams", "Body", "BodyStateVector1", "BodyStateVector2"]


class ConjunctionUnvalidatedPublishParams(TypedDict, total=False):
...
class Body(TypedDict, total=False):
    ...
    state_vector1: Annotated[BodyStateVector1, PropertyInfo(alias="stateVector1")]
    """
    ...
    state_vector2: Annotated[BodyStateVector2, PropertyInfo(alias="stateVector2")]
    """
    This service provides operations for querying and manipulation of state vectors
    for OnOrbit objects. State vectors are cartesian vectors of position (r) and
    velocity (v) that, together with their time (epoch) (t), uniquely determine the
