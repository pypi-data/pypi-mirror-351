...
__all__ = ["ConjunctionCreateUdlParams", "StateVector1", "StateVector2"]


class ConjunctionCreateUdlParams(TypedDict, total=False):
    ...
    convert_pos_vel: Annotated[bool, PropertyInfo(alias="convertPosVel")]
    ...
    state_vector1: Annotated[StateVector1, PropertyInfo(alias="stateVector1")]
    """
    ...
    state_vector2: Annotated[StateVector2, PropertyInfo(alias="stateVector2")]
    """
    This service provides operations for querying and manipulation of state vectors
    for OnOrbit objects. State vectors are cartesian vectors of position (r) and
    velocity (v) that, together with their time (epoch) (t), uniquely determine the
