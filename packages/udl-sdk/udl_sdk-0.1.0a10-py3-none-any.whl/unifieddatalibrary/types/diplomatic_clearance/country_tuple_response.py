...
__all__ = [
    ...
    "CountryTupleResponseItem",
    "CountryTupleResponseItemDiplomaticClearanceCountryContact",
    "CountryTupleResponseItemDiplomaticClearanceCountryEntryExitPoint",
    "CountryTupleResponseItemDiplomaticClearanceCountryProfile",
]


class CountryTupleResponseItemDiplomaticClearanceCountryContact(BaseModel):
...
class CountryTupleResponseItemDiplomaticClearanceCountryEntryExitPoint(BaseModel):
...
class CountryTupleResponseItemDiplomaticClearanceCountryProfile(BaseModel):
...
class CountryTupleResponseItem(BaseModel):
    ...
    diplomatic_clearance_country_contacts: Optional[List[CountryTupleResponseItemDiplomaticClearanceCountryContact]] = (
    ...
    diplomatic_clearance_country_entry_exit_points: Optional[
        List[CountryTupleResponseItemDiplomaticClearanceCountryEntryExitPoint]
    ] = FieldInfo(alias="diplomaticClearanceCountryEntryExitPoints", default=None)
    """Collection of diplomatic clearance profile information for this country."""

    diplomatic_clearance_country_profiles: Optional[List[CountryTupleResponseItemDiplomaticClearanceCountryProfile]] = (
...
CountryTupleResponse: TypeAlias = List[CountryTupleResponseItem]
