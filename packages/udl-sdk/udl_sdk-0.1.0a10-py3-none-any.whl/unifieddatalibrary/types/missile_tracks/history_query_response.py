...
__all__ = ["HistoryQueryResponse", "HistoryQueryResponseItem", "HistoryQueryResponseItemVector"]


class HistoryQueryResponseItemVector(BaseModel):
    epoch: datetime
...
class HistoryQueryResponseItem(BaseModel):
    ...
    vectors: Optional[List[HistoryQueryResponseItemVector]] = None
