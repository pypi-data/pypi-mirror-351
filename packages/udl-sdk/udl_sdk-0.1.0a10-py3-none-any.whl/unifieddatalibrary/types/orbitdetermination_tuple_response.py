...
__all__ = [
    ...
    "OrbitdeterminationTupleResponseItem",
    "OrbitdeterminationTupleResponseItemAprioriElset",
    "OrbitdeterminationTupleResponseItemAprioriStateVector",
]


class OrbitdeterminationTupleResponseItemAprioriElset(BaseModel):
...
class OrbitdeterminationTupleResponseItemAprioriStateVector(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
...
class OrbitdeterminationTupleResponseItem(BaseModel):
    classification_marking: str = FieldInfo(alias="classificationMarking")
    """Classification marking of the data in IC/CAPCO Portion-marked format."""
    ...
    apriori_elset: Optional[OrbitdeterminationTupleResponseItemAprioriElset] = FieldInfo(
    ...
    apriori_state_vector: Optional[OrbitdeterminationTupleResponseItemAprioriStateVector] = FieldInfo(
...
OrbitdeterminationTupleResponse: TypeAlias = List[OrbitdeterminationTupleResponseItem]
