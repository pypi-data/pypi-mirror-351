...
__all__ = ["CalibrationQueryResponse", "CalibrationQueryResponseItem"]


class CalibrationQueryResponseItem(BaseModel):
...
CalibrationQueryResponse: TypeAlias = List[CalibrationQueryResponseItem]
