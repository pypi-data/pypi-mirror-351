...
class FloatValue(BaseModel):
    ...
    value_type: Optional[StrictStr] = Field(default='float', description="Input/Output floating number representation.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FloatValue from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FloatValue from a dict"""
        if obj is None:
            return None
