...
const KPIComponent = ({ rawMetrics }) => {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: { width: '100%' } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Stack, { direction: "row", sx: { gap: 2, display: 'flex', justifyContent: 'flex-end' } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, { variant: "h6" },
                ...
                " ",
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br", null)),
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, null,
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Stack, { direction: "row", gap: 2 }, kpiCardsData.map(props => {
            var _a;
            return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_KpiValue__WEBPACK_IMPORTED_MODULE_10__["default"], { value: (_a = kpi === null || kpi === void 0 ? void 0 : kpi[props.key]) !== null && _a !== void 0 ? _a : 0, unit: props.unit, color: props.color, Icon: props.icon }));
        }))));
};
...
function KpiValue(props) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { size: "grow", sx: { color } },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Paper, { elevation: 0, sx: { ...styles.paperKpi, border: `1px solid ${color}` } },
            Icon,
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, { sx: { ...styles.typographyValue, color } }, value),
...
function GeneralDashboard({ startDate, endDate, setStartDate, setEndDate, metrics, dataMap, selectedMetric, setSelectedMetric, loading }) {
    ...
    return (react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div", { style: styles.main },
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Paper, { key: "grid-element-main", style: {
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Typography, { variant: "caption", sx: { textWrap: 'wrap' } }, "No metrics available/loaded. Write your username on the textfield above and click \"Fetch Metrics\" to see the metrics."))) : (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: { width: '100%', height: '100%' } },
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: {
                    display: 'flex',
                    flexDirection: 'row',
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.8005c76afa2aad55a347.js.map