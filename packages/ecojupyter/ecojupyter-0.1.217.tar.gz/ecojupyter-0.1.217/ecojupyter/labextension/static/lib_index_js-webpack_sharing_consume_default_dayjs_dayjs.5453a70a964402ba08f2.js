...
const kpiCardsData = [
    {
        ...
        icon: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_EnergySavingsLeafOutlined__WEBPACK_IMPORTED_MODULE_7__["default"], { sx: { fontSize: '56px', 'svg': { fill: _helpers_constants__WEBPACK_IMPORTED_MODULE_6__.mainColour01 } } }))
    },
    {
        key: 'sciPerUnit',
        unit: 'gCO₂',
        color: _helpers_constants__WEBPACK_IMPORTED_MODULE_6__.mainColour02,
        icon: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_BoltOutlined__WEBPACK_IMPORTED_MODULE_8__["default"], { sx: { fontSize: '56px', 'svg': { fill: _helpers_constants__WEBPACK_IMPORTED_MODULE_6__.mainColour01 } } }))
    },
    {
        key: 'energyPerUnit',
        unit: 'kWh/unit',
        color: _helpers_constants__WEBPACK_IMPORTED_MODULE_6__.mainColour03,
        icon: (react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_icons_material_SolarPowerOutlined__WEBPACK_IMPORTED_MODULE_9__["default"], { sx: { fontSize: '56px', svg: { fill: _helpers_constants__WEBPACK_IMPORTED_MODULE_6__.mainColour01 } } }))
    }
];
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.5453a70a964402ba08f2.js.map