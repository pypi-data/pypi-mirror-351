...
function calculateKPIs(metrics) {
    const { energyConsumed: E, carbonIntensity: I, embodiedEmissions: M, functionalUnit: R, hepScore23 } = metrics;
    // SCI calculation
    // SCI = ((E * I) + M) / R
...
const KPIComponent = ({ metrics }) => {
    const kpi = react__WEBPACK_IMPORTED_MODULE_0___default().useMemo(() => calculateKPIs(metrics), [metrics]);
        ...
        react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Paper, { key: "grid-element-main", style: {
            ...
            react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: {
                ...
                react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_mui_material__WEBPACK_IMPORTED_MODULE_1__.Grid2, { sx: {
                    ...
                    react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_components_KPIComponent__WEBPACK_IMPORTED_MODULE_6__.KPIComponent, { metrics: DEFAULT_METRICS }))),
...
//# sourceMappingURL=lib_index_js-webpack_sharing_consume_default_dayjs_dayjs.397b9f9ced1f9a0ca9a8.js.map