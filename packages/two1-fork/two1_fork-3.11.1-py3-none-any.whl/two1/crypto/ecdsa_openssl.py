...
class ECPointAffine(object):
    ...
    def __add__(self, b):
        ...
        a_pt = ossl.point_new_from_ints(
            self.curve.os_group, self.x, self.y, self.infinity
        )
...
class EllipticCurve(EllipticCurveBase):
    ...
    def _sign(self, message, private_key, do_hash=True, secret=None):
        ...
        while r == 0 or s == 0:
            ...
            sig_r = ossl.bn_to_int(ossl.lc.ECDSA_SIG_get0_r(sig))
            sig_s = ossl.bn_to_int(ossl.lc.ECDSA_SIG_get0_s(sig))
