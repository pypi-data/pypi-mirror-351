...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-datasync)](https://pypistats.org/packages/mypy-boto3-datasync)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for [boto3 DataSync 1.38.26](https://pypi.org/project/boto3/)
...
`mypy-boto3-datasync` dependency in production. However, there is an issue in
