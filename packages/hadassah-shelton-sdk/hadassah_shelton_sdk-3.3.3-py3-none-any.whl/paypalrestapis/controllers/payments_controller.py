...
from paypalrestapis.configuration import Server
from paypalrestapis.controllers.base_controller import BaseController
from apimatic_core.request_builder import RequestBuilder
from apimatic_core.response_handler import ResponseHandler
from apimatic_core.types.parameter import Parameter
from paypalrestapis.http.http_method_enum import HttpMethodEnum
from apimatic_core.authentication.multiple.single_auth import Single
from paypalrestapis.models.payment_authorization import PaymentAuthorization
from paypalrestapis.models.captured_payment import CapturedPayment
from paypalrestapis.models.refund import Refund
from paypalrestapis.exceptions.error_exception import ErrorException
from paypalrestapis.exceptions.api_exception import APIException


class PaymentsController(BaseController):

    """A Controller to access Endpoints in the paypalrestapis API."""
    ...
    def authorizations_get(self,
        ...
        Returns:
            PaymentAuthorization: Response from the API. A successful request
                returns the HTTP <code>200 OK</code> status code and a JSON
    ...
    def authorizations_capture(self,
        ...
        Returns:
            CapturedPayment: Response from the API. A successful request
                returns the HTTP <code>201 Created</code> status code and a
    ...
    def authorizations_void(self,
        ...
        Returns:
            PaymentAuthorization: Response from the API. A successful request
                returns the HTTP <code>200 OK</code> status code and a JSON
                response body that shows authorization details. This response
                is returned when the Prefer header is set to
    ...
    def captures_refund(self,
        ...
        Returns:
            Refund: Response from the API. A successful request returns the
                HTTP <code>201 Created</code> status code and a JSON response
    ...
    def refunds_get(self,
        ...
        Returns:
            Refund: Response from the API. A successful request returns the
                HTTP <code>200 OK</code> status code and a JSON response body
                that shows refund details.
