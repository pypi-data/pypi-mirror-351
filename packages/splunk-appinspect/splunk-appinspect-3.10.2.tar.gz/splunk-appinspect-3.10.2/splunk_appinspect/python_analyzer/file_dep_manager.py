...
import magic
from fissix.main import main as exec_two_to_three
        ...
        try:
            ...
            try:
                ...
                if (
                    ...
                    exec_two_to_three(
                        fixer_pkg="fissix.fixes",
                        args=["-w", str(filepath), "--no-diffs", "-j", "2"],
                    )
                else:
                    exec_two_to_three(
                        fixer_pkg="fissix.fixes",
                        args=["-w", str(filepath), "--no-diffs"],
                    )
