    ...
    def __init__(self) -> None:
        super().__init__(
            config=CheckConfig(
                ...
                f"are explicitly set the python.version to {PYTHON_3_VERSION}.",
                depends_on_config=("authentication",),
                tags=(
                    Tags.SPLUNK_APPINSPECT,
                    Tags.CLOUD,
