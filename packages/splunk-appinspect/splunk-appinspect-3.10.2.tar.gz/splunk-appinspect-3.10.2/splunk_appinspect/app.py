...
class App(object):
    ...
    def file_exists(self, *path_parts: str | Path) -> bool:
        ...
        """
        file_path = Path(self.app_dir, *path_parts)
    ...
    def get_config_file_paths(
        self, config_file_name: str, basedir: list[str] | list[Path] = ["default", "local"]
    ) -> dict[str | Path, str]:
