...
class Element(db.Model):
    ...
    found_in_plm = db.Column(db.Boolean)
    ...
    plm_comp_status=db.Column(db.String(50))
    ...
    plm_log_deliv_date=db.Column(db.String(50))
    ...
    plm_log_goodsin_date=db.Column(db.String(50))
