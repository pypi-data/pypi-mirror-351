...
class QueueEntryState(int, metaclass=_enum_type_wrapper.EnumTypeWrapper):
    __slots__ = ()
    QUEUE_ENTRY_STATE_UNSPECIFIED: _ClassVar[QueueEntryState]
    QUEUE_ENTRY_STATE_PENDING: _ClassVar[QueueEntryState]
    QUEUE_ENTRY_STATE_CLAIMED: _ClassVar[QueueEntryState]
    QUEUE_ENTRY_STATE_CANCELED: _ClassVar[QueueEntryState]
...
QUEUE_ENTRY_STATE_UNSPECIFIED: QueueEntryState
QUEUE_ENTRY_STATE_PENDING: QueueEntryState
QUEUE_ENTRY_STATE_CLAIMED: QueueEntryState
QUEUE_ENTRY_STATE_CANCELED: QueueEntryState
...
class SlotGroups(_message.Message):
    __slots__ = ("budget_reference", "workspace_reference", "user_reference", "job_priority", "workload_count", "job_count", "preemptible")
    ...
    job_count: int
    preemptible: bool
    def __init__(self, budget_reference: _Optional[str] = ..., workspace_reference: _Optional[str] = ..., user_reference: _Optional[str] = ..., job_priority: _Optional[_Union[JobPriority, str]] = ..., workload_count: _Optional[int] = ..., job_count: _Optional[int] = ..., preemptible: bool = ...) -> None: ...
...
class QueueWorker(_message.Message):
    ...
    queue_id: str
    heartbeat: _timestamp_pb2.Timestamp
    def __init__(self, id: _Optional[str] = ..., name: _Optional[str] = ..., created: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., queue_id: _Optional[str] = ..., heartbeat: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ...) -> None: ...

class QueueEntryStatus(_message.Message):
    __slots__ = ("state", "created", "expiry", "claimed", "finalized", "message")
    ...
    created: _timestamp_pb2.Timestamp
    expiry: _timestamp_pb2.Timestamp
    claimed: _timestamp_pb2.Timestamp
    finalized: _timestamp_pb2.Timestamp
    message: str
    def __init__(self, state: _Optional[_Union[QueueEntryState, str]] = ..., created: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., expiry: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., claimed: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., finalized: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., message: _Optional[str] = ...) -> None: ...

class QueueEntryResult(_message.Message):
    __slots__ = ("created", "output")
    CREATED_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_FIELD_NUMBER: _ClassVar[int]
    created: _timestamp_pb2.Timestamp
    output: _struct_pb2.Struct
    def __init__(self, created: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., output: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class QueueEntry(_message.Message):
    __slots__ = ("id", "queue_id", "input", "status", "worker_id", "results")
    ID_FIELD_NUMBER: _ClassVar[int]
    QUEUE_ID_FIELD_NUMBER: _ClassVar[int]
    INPUT_FIELD_NUMBER: _ClassVar[int]
    STATUS_FIELD_NUMBER: _ClassVar[int]
    ...
    worker_id: str
    results: _containers.RepeatedCompositeFieldContainer[QueueEntryResult]
    def __init__(self, id: _Optional[str] = ..., queue_id: _Optional[str] = ..., input: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., status: _Optional[_Union[QueueEntryStatus, _Mapping]] = ..., worker_id: _Optional[str] = ..., results: _Optional[_Iterable[_Union[QueueEntryResult, _Mapping]]] = ...) -> None: ...

class QueueEntryMetadata(_message.Message):
    __slots__ = ("queue_id", "entry_id", "worker_id")
    QUEUE_ID_FIELD_NUMBER: _ClassVar[int]
    ...
    entry_id: str
    worker_id: str
    def __init__(self, queue_id: _Optional[str] = ..., entry_id: _Optional[str] = ..., worker_id: _Optional[str] = ...) -> None: ...
...
class QueueWorkerInput(_message.Message):
    ...
    input: _struct_pb2.Struct
    def __init__(self, metadata: _Optional[_Union[QueueEntryMetadata, _Mapping]] = ..., input: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ...) -> None: ...

class QueueWorkerOutput(_message.Message):
    __slots__ = ("metadata", "output", "rejection", "done")
    METADATA_FIELD_NUMBER: _ClassVar[int]
    OUTPUT_FIELD_NUMBER: _ClassVar[int]
    ...
    output: _struct_pb2.Struct
    rejection: str
    done: _empty_pb2.Empty
    def __init__(self, metadata: _Optional[_Union[QueueEntryMetadata, _Mapping]] = ..., output: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., rejection: _Optional[str] = ..., done: _Optional[_Union[_empty_pb2.Empty, _Mapping]] = ...) -> None: ...
...
class ResolveDatasetNameRequest(_message.Message):
    __slots__ = ("author_name", "dataset_name")
    AUTHOR_NAME_FIELD_NUMBER: _ClassVar[int]
    DATASET_NAME_FIELD_NUMBER: _ClassVar[int]
    author_name: str
    dataset_name: str
    def __init__(self, author_name: _Optional[str] = ..., dataset_name: _Optional[str] = ...) -> None: ...

class ResolveDatasetNameResponse(_message.Message):
    __slots__ = ("dataset_id",)
    DATASET_ID_FIELD_NUMBER: _ClassVar[int]
    dataset_id: str
    def __init__(self, dataset_id: _Optional[str] = ...) -> None: ...
...
class CreateQueueRequest(_message.Message):
    ...
    max_claimed_entries: int
    wait_timeout: _duration_pb2.Duration
    def __init__(self, name: _Optional[str] = ..., workspace_id: _Optional[str] = ..., input_schema: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., output_schema: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., batch_size: _Optional[int] = ..., max_claimed_entries: _Optional[int] = ..., wait_timeout: _Optional[_Union[_duration_pb2.Duration, _Mapping]] = ...) -> None: ...
...
class ListQueuesRequest(_message.Message):
    __slots__ = ("next_page_token", "options")
    class Opts(_message.Message):
        __slots__ = ("sort_clause", "page_size", "organization_id", "workspace_id")
        class SortClause(_message.Message):
            __slots__ = ("sort_order", "created")
            SORT_ORDER_FIELD_NUMBER: _ClassVar[int]
            CREATED_FIELD_NUMBER: _ClassVar[int]
        ...
        ORGANIZATION_ID_FIELD_NUMBER: _ClassVar[int]
        WORKSPACE_ID_FIELD_NUMBER: _ClassVar[int]
        sort_clause: ListQueuesRequest.Opts.SortClause
        page_size: int
        organization_id: str
        workspace_id: str
        def __init__(self, sort_clause: _Optional[_Union[ListQueuesRequest.Opts.SortClause, _Mapping]] = ..., page_size: _Optional[int] = ..., organization_id: _Optional[str] = ..., workspace_id: _Optional[str] = ...) -> None: ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    OPTIONS_FIELD_NUMBER: _ClassVar[int]
    next_page_token: str
    options: ListQueuesRequest.Opts
    def __init__(self, next_page_token: _Optional[str] = ..., options: _Optional[_Union[ListQueuesRequest.Opts, _Mapping]] = ...) -> None: ...

class ListQueuesResponse(_message.Message):
    __slots__ = ("next_page_token", "queues")
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    QUEUES_FIELD_NUMBER: _ClassVar[int]
    next_page_token: str
    queues: _containers.RepeatedCompositeFieldContainer[Queue]
    def __init__(self, next_page_token: _Optional[str] = ..., queues: _Optional[_Iterable[_Union[Queue, _Mapping]]] = ...) -> None: ...

class DeleteQueuesRequest(_message.Message):
    __slots__ = ("queue_ids",)
    QUEUE_IDS_FIELD_NUMBER: _ClassVar[int]
    queue_ids: _containers.RepeatedScalarFieldContainer[str]
    def __init__(self, queue_ids: _Optional[_Iterable[str]] = ...) -> None: ...

class DeleteQueuesResponse(_message.Message):
    __slots__ = ()
    def __init__(self) -> None: ...

class CreateQueueWorkerRequest(_message.Message):
    __slots__ = ("queue_id",)
    QUEUE_ID_FIELD_NUMBER: _ClassVar[int]
    queue_id: str
    def __init__(self, queue_id: _Optional[str] = ...) -> None: ...

class CreateQueueWorkerResponse(_message.Message):
    __slots__ = ("queue_worker",)
    QUEUE_WORKER_FIELD_NUMBER: _ClassVar[int]
    queue_worker: QueueWorker
    def __init__(self, queue_worker: _Optional[_Union[QueueWorker, _Mapping]] = ...) -> None: ...

class ListQueueWorkersRequest(_message.Message):
    __slots__ = ("next_page_token", "options")
    class Opts(_message.Message):
        __slots__ = ("sort_clause", "page_size", "queue_id")
        class SortClause(_message.Message):
            __slots__ = ("sort_order", "created")
            SORT_ORDER_FIELD_NUMBER: _ClassVar[int]
            CREATED_FIELD_NUMBER: _ClassVar[int]
        ...
        PAGE_SIZE_FIELD_NUMBER: _ClassVar[int]
        QUEUE_ID_FIELD_NUMBER: _ClassVar[int]
        sort_clause: ListQueueWorkersRequest.Opts.SortClause
        page_size: int
        queue_id: str
        def __init__(self, sort_clause: _Optional[_Union[ListQueueWorkersRequest.Opts.SortClause, _Mapping]] = ..., page_size: _Optional[int] = ..., queue_id: _Optional[str] = ...) -> None: ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    OPTIONS_FIELD_NUMBER: _ClassVar[int]
    next_page_token: str
    options: ListQueueWorkersRequest.Opts
    def __init__(self, next_page_token: _Optional[str] = ..., options: _Optional[_Union[ListQueueWorkersRequest.Opts, _Mapping]] = ...) -> None: ...

class ListQueueWorkersResponse(_message.Message):
    __slots__ = ("next_page_token", "queue_workers")
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    QUEUE_WORKERS_FIELD_NUMBER: _ClassVar[int]
    next_page_token: str
    queue_workers: _containers.RepeatedCompositeFieldContainer[QueueWorker]
    def __init__(self, next_page_token: _Optional[str] = ..., queue_workers: _Optional[_Iterable[_Union[QueueWorker, _Mapping]]] = ...) -> None: ...

class CreateQueueEntryRequest(_message.Message):
    __slots__ = ("queue_id", "input", "expiry")
    QUEUE_ID_FIELD_NUMBER: _ClassVar[int]
    INPUT_FIELD_NUMBER: _ClassVar[int]
    EXPIRY_FIELD_NUMBER: _ClassVar[int]
    ...
    input: _struct_pb2.Struct
    expiry: _timestamp_pb2.Timestamp
    def __init__(self, queue_id: _Optional[str] = ..., input: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., expiry: _Optional[_Union[_timestamp_pb2.Timestamp, _Mapping]] = ..., **kwargs) -> None: ...

class CreateQueueEntryResponse(_message.Message):
    __slots__ = ("pending_entry", "result", "finalized_entry")
    PENDING_ENTRY_FIELD_NUMBER: _ClassVar[int]
    RESULT_FIELD_NUMBER: _ClassVar[int]
    FINALIZED_ENTRY_FIELD_NUMBER: _ClassVar[int]
    pending_entry: QueueEntry
    result: _struct_pb2.Struct
    finalized_entry: QueueEntry
    def __init__(self, pending_entry: _Optional[_Union[QueueEntry, _Mapping]] = ..., result: _Optional[_Union[_struct_pb2.Struct, _Mapping]] = ..., finalized_entry: _Optional[_Union[QueueEntry, _Mapping]] = ...) -> None: ...

class ProcessQueueEntriesRequest(_message.Message):
    __slots__ = ("init", "worker_output")
    ...
    WORKER_OUTPUT_FIELD_NUMBER: _ClassVar[int]
    init: ProcessQueueEntriesRequest.Init
    worker_output: QueueWorkerOutput
    def __init__(self, init: _Optional[_Union[ProcessQueueEntriesRequest.Init, _Mapping]] = ..., worker_output: _Optional[_Union[QueueWorkerOutput, _Mapping]] = ...) -> None: ...

class ProcessQueueEntriesResponse(_message.Message):
    __slots__ = ("batch",)
    class WorkerInputBatch(_message.Message):
        __slots__ = ("worker_input",)
        WORKER_INPUT_FIELD_NUMBER: _ClassVar[int]
        worker_input: _containers.RepeatedCompositeFieldContainer[QueueWorkerInput]
        def __init__(self, worker_input: _Optional[_Iterable[_Union[QueueWorkerInput, _Mapping]]] = ...) -> None: ...
    BATCH_FIELD_NUMBER: _ClassVar[int]
    batch: ProcessQueueEntriesResponse.WorkerInputBatch
    def __init__(self, batch: _Optional[_Union[ProcessQueueEntriesResponse.WorkerInputBatch, _Mapping]] = ...) -> None: ...

class GetQueueEntryRequest(_message.Message):
    __slots__ = ("queue_entry_id",)
    QUEUE_ENTRY_ID_FIELD_NUMBER: _ClassVar[int]
    queue_entry_id: str
    def __init__(self, queue_entry_id: _Optional[str] = ...) -> None: ...

class GetQueueEntryResponse(_message.Message):
    __slots__ = ("queue_entry",)
    QUEUE_ENTRY_FIELD_NUMBER: _ClassVar[int]
    queue_entry: QueueEntry
    def __init__(self, queue_entry: _Optional[_Union[QueueEntry, _Mapping]] = ...) -> None: ...

class ListQueueEntriesRequest(_message.Message):
    __slots__ = ("next_page_token", "options")
    class Opts(_message.Message):
        __slots__ = ("sort_clause", "page_size", "queue_id")
        class SortClause(_message.Message):
        ...
        PAGE_SIZE_FIELD_NUMBER: _ClassVar[int]
        QUEUE_ID_FIELD_NUMBER: _ClassVar[int]
        sort_clause: ListQueueEntriesRequest.Opts.SortClause
        page_size: int
        queue_id: str
        def __init__(self, sort_clause: _Optional[_Union[ListQueueEntriesRequest.Opts.SortClause, _Mapping]] = ..., page_size: _Optional[int] = ..., queue_id: _Optional[str] = ...) -> None: ...
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
    OPTIONS_FIELD_NUMBER: _ClassVar[int]
    next_page_token: str
    options: ListQueueEntriesRequest.Opts
    def __init__(self, next_page_token: _Optional[str] = ..., options: _Optional[_Union[ListQueueEntriesRequest.Opts, _Mapping]] = ...) -> None: ...

class ListQueueEntriesResponse(_message.Message):
    __slots__ = ("next_page_token", "entries")
    NEXT_PAGE_TOKEN_FIELD_NUMBER: _ClassVar[int]
