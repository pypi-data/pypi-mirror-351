...
def get_memory(state: Dict[str, Any], memory_key: str = "memory") -> List[Dict[str, str]]:
    """
...
def add_message(state: Dict[str, Any], role: str, content: str, 
                memory_key: str = "memory") -> Dict[str, Any]:
    """
...
def add_user_message(state: Dict[str, Any], content: str, 
                     memory_key: str = "memory") -> Dict[str, Any]:
    """Add a user message to conversation history."""
    return add_message(state, "user", content, memory_key)


def add_assistant_message(state: Dict[str, Any], content: str, 
                          memory_key: str = "memory") -> Dict[str, Any]:
    """Add an assistant message to conversation history."""
    return add_message(state, "assistant", content, memory_key)


def add_system_message(state: Dict[str, Any], content: str, 
                       memory_key: str = "memory") -> Dict[str, Any]:
...
def truncate_memory(state: Dict[str, Any], max_messages: int, 
                    memory_key: str = "memory") -> Dict[str, Any]:
    """
