...
class NativeCallData(slangpy.Object):
    ...
    @property
    def kernel(self) -> slangpy.ComputeKernel:
        """N/A"""

    @kernel.setter
    def kernel(self, arg: slangpy.ComputeKernel, /) -> None: ...
...
class NativeFunctionNode(NativeObject):
    ...
    def _native_append_to(self, cache: NativeCallDataCache, command_buffer: slangpy.CommandEncoder, *args, **kwargs) -> None:
        """N/A"""
