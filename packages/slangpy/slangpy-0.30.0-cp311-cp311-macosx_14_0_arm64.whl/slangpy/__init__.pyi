...
class BufferUsage(enum.IntFlag):
    ...
    _flag_mask_: int = 4095

    _singles_mask_: int = 4095
...
class DataStruct(Object):
    ...
    @overload
    def append(self, name: str, type: DataStruct.Type, flags: DataStruct.Flags = 0, default_value: float = 0.0, blend: Sequence[tuple[float, str]] = []) -> DataStruct:
        """
        Append a field to the struct.
...
class Device(Object):
    ...
    @overload
    def create_buffer(self, size: int = 0, element_count: int = 0, struct_size: int = 0, struct_type: object | None = None, format: Format = Format.undefined, memory_type: MemoryType = MemoryType.device_local, usage: BufferUsage = 0, label: str = '', data: ArrayLike | None = None) -> Buffer:
        """
        Create a new buffer.
...
class FormatSupport(enum.IntFlag):
    ...
    _flag_mask_: int = 65535

    _singles_mask_: int = 65535

    _all_bits_: int = 131071
...
class Surface(Object):
    ...
    @overload
    def configure(self, width: int, height: int, format: Format = Format.undefined, usage: TextureUsage = 4, desired_image_count: int = 3, vsync: bool = True) -> None:
...
class TextureUsage(enum.IntFlag):
    ...
    _flag_mask_: int = 2047

    _singles_mask_: int = 2047
