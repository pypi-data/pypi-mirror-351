...
from .core.utils import create_device as create_device
...
from .torchintegration.torchmodule import TorchModule as TorchModule
...
class AccelerationStructureBuildDesc:
    ...
    @property
    def inputs(self) -> list[AccelerationStructureBuildInputInstances | AccelerationStructureBuildInputTriangles | AccelerationStructureBuildInputProceduralPrimitives]:
        """List of build inputs. All inputs must be of the same type."""

    @inputs.setter
    def inputs(self, arg: Sequence[AccelerationStructureBuildInputInstancesParam | AccelerationStructureBuildInputTrianglesParam | AccelerationStructureBuildInputProceduralPrimitivesParam], /) -> None: ...
...
AccelerationStructureBuildDescDict = TypedDict("AccelerationStructureBuildDescDict", {
    "inputs": Sequence[AccelerationStructureBuildInputInstancesParam | AccelerationStructureBuildInputTrianglesParam | AccelerationStructureBuildInputProceduralPrimitivesParam],
...
class AccelerationStructureInstanceList(DeviceResource):
    @property
    def size(self) -> int: ...
...
class AppWindow(Object):
    def __init__(self, app: App, width: int = 1920, height: int = 1280, title: str = 'sgl', mode: WindowMode = WindowMode.normal, resizable: bool = True, surface_format: Format = Format.undefined, enable_vsync: bool = False) -> None: ...
...
class Bitmap(Object):
    @overload
    def __init__(self, pixel_format: Bitmap.PixelFormat, component_type: DataStruct.Type, width: int, height: int, channel_count: int = 0, channel_names: Sequence[str] = []) -> None: ...
    ...
    def convert(self, pixel_format: Bitmap.PixelFormat | None = None, component_type: DataStruct.Type | None = None, srgb_gamma: bool | None = None) -> Bitmap: ...
...
class CommandEncoder(DeviceResource):
    ...
    def build_acceleration_structure(self, desc: AccelerationStructureBuildDescParam, dst: AccelerationStructure, src: AccelerationStructure | None, scratch_buffer: BufferOffsetPairParam, queries: Sequence[AccelerationStructureQueryDescParam] = []) -> None: ...
...
class ComputeKernel(Kernel):
    ...
    def dispatch(self, thread_count: uint3param, vars: dict = {}, command_encoder: CommandEncoder | None = None, **kwargs) -> None: ...
...
class Device(Object):
    ...
    @overload
    def create_buffer(self, size: int = 0, element_count: int = 0, struct_size: int = 0, struct_type: object | None = None, format: Format = Format.undefined, memory_type: MemoryType = MemoryType.device_local, usage: BufferUsage = BufferUsage.none, label: str = '', data: ArrayLike | None = None) -> Buffer:
        """
        Create a new buffer.
    ...
    def submit_command_buffers(self, command_buffers: Sequence[CommandBuffer], wait_fences: Sequence[Fence] = [], wait_fence_values: Sequence[int] = [], signal_fences: Sequence[Fence] = [], signal_fence_values: Sequence[int] = [], queue: CommandQueueType = CommandQueueType.graphics) -> int: ...
    ...
    @overload
    def create_render_pipeline(self, program: ShaderProgram, input_layout: InputLayout | None, primitive_topology: PrimitiveTopology = PrimitiveTopology.triangle_list, targets: Sequence[ColorTargetDescParam] = [], depth_stencil: DepthStencilDescParam | None = None, rasterizer: RasterizerDescParam | None = None, multisample: MultisampleDescParam | None = None) -> RenderPipeline: ...

    @overload
    def create_render_pipeline(self, desc: RenderPipelineDescParam) -> RenderPipeline: ...

    @overload
    def create_ray_tracing_pipeline(self, program: ShaderProgram, hit_groups: Sequence[HitGroupDescParam], max_recursion: int = 0, max_ray_payload_size: int = 0, max_attribute_size: int = 8, flags: RayTracingPipelineFlags = RayTracingPipelineFlags.none) -> RayTracingPipeline: ...
    ...
    @overload
    def coopvec_convert_matrix_device(self, src: Buffer, src_desc: CoopVecMatrixDesc, dst: Buffer, dst_desc: CoopVecMatrixDesc, encoder: CommandEncoder | None = None) -> None:
        """N/A"""

    @overload
    def coopvec_convert_matrix_device(self, src: Buffer, src_desc: Sequence[CoopVecMatrixDesc], dst: Buffer, dst_desc: Sequence[CoopVecMatrixDesc], encoder: CommandEncoder | None = None) -> None: ...
...
class Feature(enum.IntEnum):
    ...
    rasterizer_ordered_views = 8

    conservative_rasterization = 9

    custom_border_color = 10

    fragment_shading_rate = 11

    sampler_feedback = 12

    acceleration_structure = 13

    acceleration_structure_spheres = 14

    acceleration_structure_linear_swept_spheres = 15

    ray_tracing = 16

    ray_query = 17

    shader_execution_reordering = 18

    ray_tracing_validation = 19

    timestamp_query = 20

    realtime_clock = 21

    cooperative_vector = 22

    cooperative_matrix = 23
    ...
    conservative_rasterization1 = 45

    conservative_rasterization2 = 46

    conservative_rasterization3 = 47

    programmable_sample_positions1 = 48

    programmable_sample_positions2 = 49

    shader_resource_min_lod = 50

    argument_buffer_tier2 = 51
...
class RenderPassDesc:
    ...
    @property
    def depth_stencil_attachment(self) -> RenderPassDepthStencilAttachment | None: ...
...
SGL_BUILD_TYPE: str = 'Release'

SGL_GIT_VERSION: str = 'commit: 76f5f1e / branch: unknown'

SGL_VERSION: str = '0.30.0'

SGL_VERSION_MAJOR: int = 0

SGL_VERSION_MINOR: int = 30

SGL_VERSION_PATCH: int = 0
...
class Surface(Object):
    ...
    @overload
    def configure(self, width: int, height: int, format: Format = Format.undefined, usage: TextureUsage = TextureUsage.render_target, desired_image_count: int = 3, vsync: bool = True) -> None:
...
class TextureView(DeviceResource):
    @property
...
build_dir: str = 'D:/a/slangpy/slangpy/build/pip/Release'
...
package_dir: str = 'D:\\a\\slangpy\\slangpy\\slangpy'
