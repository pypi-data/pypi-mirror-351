...
class AccelerationStructureBuildDesc:
    ...
    @property
    def inputs(self) -> list[Union[AccelerationStructureBuildInputInstances, AccelerationStructureBuildInputTriangles, AccelerationStructureBuildInputProceduralPrimitives]]:
        """List of build inputs. All inputs must be of the same type."""

    @inputs.setter
    def inputs(self, arg: Sequence[Union[AccelerationStructureBuildInputInstancesParam, AccelerationStructureBuildInputTrianglesParam, AccelerationStructureBuildInputProceduralPrimitivesParam]], /) -> None: ...
...
AccelerationStructureBuildDescDict = TypedDict("AccelerationStructureBuildDescDict", {
    "inputs": Sequence[Union[AccelerationStructureBuildInputInstancesParam, AccelerationStructureBuildInputTrianglesParam, AccelerationStructureBuildInputProceduralPrimitivesParam]],
...
class Bitmap(Object):
    ...
    @overload
    def __init__(self, data: Annotated[ArrayLike, dict(device='cpu')], pixel_format: Optional[Bitmap.PixelFormat] = None, channel_names: Optional[Sequence[str]] = None) -> None: ...
...
class ComputeKernel(Kernel):
    ...
    def dispatch(self, thread_count: uint3param, vars: dict = {}, command_encoder: Optional[CommandEncoder] = None, **kwargs) -> None: ...
...
class Device(Object):
    @overload
    def __init__(self, type: DeviceType = DeviceType.automatic, enable_debug_layers: bool = False, enable_cuda_interop: bool = False, enable_print: bool = False, enable_hot_reload: bool = True, adapter_luid: Optional[Sequence[int]] = None, compiler_options: Optional[SlangCompilerOptionsParam] = None, shader_cache_path: Optional[str | os.PathLike] = None) -> None: ...
    ...
    @overload
    def create_buffer(self, size: int = 0, element_count: int = 0, struct_size: int = 0, struct_type: Optional[object] = None, format: Format = Format.undefined, memory_type: MemoryType = MemoryType.device_local, usage: BufferUsage = BufferUsage.none, label: str = '', data: Optional[ArrayLike] = None) -> Buffer:
        """
        Create a new buffer.
