...
class GoogleADKAgent(BaseAgent):
    ...
    def __init__(self, name: str, instruction: str, model: str, tools: list[Callable | GoogleADKBaseTool] | None = None, description: str | None = None, max_iterations: int = 3, **kwargs: Any) -> None:
