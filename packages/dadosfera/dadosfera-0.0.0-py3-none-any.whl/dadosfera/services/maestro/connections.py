...
def get_connections(
    ...
    return fetch_paginated_connections(maestro_base_url=maestro_base_url, token=token, additional_params=additional_params)

def bulk_delete_connections(
    maestro_base_url: str, token: str, additional_params: Dict[str, str] = {}
):
    return delete_inactive_connections(maestro_base_url=maestro_base_url, token=token, additional_params=additional_params)