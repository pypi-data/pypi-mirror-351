...
def send_notification(teams_webhook_url: str, message_title: str, message_body: str) -> None:
    ...
    try:
        ...
        logger.error(f"Erro ao enviar notificação. Status Code: {response.status_code}, Resposta: {response.text}")
        raise e