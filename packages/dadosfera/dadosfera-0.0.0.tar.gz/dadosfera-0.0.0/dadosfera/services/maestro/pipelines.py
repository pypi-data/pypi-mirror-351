...
def get_status_by_pipeline( maestro_base_url: str,
    token: str,
    pipeline_id: str
    ):
    return fetch_pipeline_execution_history(maestro_base_url,
    token,
    pipeline_id
    )


def get_status_of_all_pipelines(maestro_base_url: str,
    token: str):
