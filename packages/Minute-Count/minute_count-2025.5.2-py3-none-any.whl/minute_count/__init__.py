...
from minute_count.minute_count import minute_overview, _generate_overview
...
def main():
    ...
    parser.add_argument("--no-seconds", action="store_true", help="Hides the seconds part of the duration")
    parser.add_argument("-s", "--summary", action="store_true", help="Only shows the total for all files looked at (only has an effect if -r is given)")
    ...
    if args.summary:
        _generate_overview(args.file,total, not args.no_seconds)
