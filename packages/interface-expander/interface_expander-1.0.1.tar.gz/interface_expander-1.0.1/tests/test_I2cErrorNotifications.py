...
from interface_expander.I2cInterface import (I2cInterface, I2cConfig, ClockFreq, AddressWidth, I2cId, I2cMasterRequest,
                                             I2cStatusCode, I2C_SLAVE_BUFFER_SPACE)
...
class TestI2cErrorNotifications:
    ...
    def test_i2c_error_notifications(self):
        # Test master using external FRAM
        expander = InterfaceExpander()
        expander.reset()
        expander.connect()

        cfg0 = I2cConfig(clock_freq=TestI2cErrorNotifications.I2C_CLOCK_FREQ,
                         slave_addr=0x01,
        ...
        with pytest.raises(ValueError):
            rid = i2c_send_request(i2c0, [write_request])
