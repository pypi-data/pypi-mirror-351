...
T = TypeVar("T", bound="PutVehicleIdVehicleBody")


@_attrs_define
class PutVehicleIdVehicleBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_vehicle_id_vehicle_body = cls(
            id=id,
            label=label,
            height_mm=height_mm,
            length_mm=length_mm,
        ...
        put_vehicle_id_vehicle_body.additional_properties = d
        return put_vehicle_id_vehicle_body
