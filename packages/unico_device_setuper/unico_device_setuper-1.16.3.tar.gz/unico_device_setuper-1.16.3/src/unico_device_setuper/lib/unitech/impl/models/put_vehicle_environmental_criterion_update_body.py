...
T = TypeVar("T", bound="PutVehicleEnvironmentalCriterionUpdateBody")


@_attrs_define
class PutVehicleEnvironmentalCriterionUpdateBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_vehicle_environmental_criterion_update_body = cls(
            id=id,
            label=label,
            height_mm=height_mm,
            length_mm=length_mm,
        ...
        put_vehicle_environmental_criterion_update_body.additional_properties = d
        return put_vehicle_environmental_criterion_update_body
