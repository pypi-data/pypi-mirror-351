...
T = TypeVar("T", bound="PutStreamByIdIdBody")


@_attrs_define
class PutStreamByIdIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_stream_by_id_id_body.additional_properties = d
        return put_stream_by_id_id_body
