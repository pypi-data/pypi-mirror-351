...
T = TypeVar("T", bound="PutContainerUpdateStateByIdIdBody")


@_attrs_define
class PutContainerUpdateStateByIdIdBody:
    """
    Attributes:
        state (Union[Unset, Any]):  Example: any.
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_container_update_state_by_id_id_body = cls(
            state=state,
        ...
        put_container_update_state_by_id_id_body.additional_properties = d
        return put_container_update_state_by_id_id_body
