...
T = TypeVar("T", bound="PutVehicleSectorsSectorIdBody")


@_attrs_define
class PutVehicleSectorsSectorIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_vehicle_sectors_sector_id_body = cls(
            id=id,
            label=label,
            height_mm=height_mm,
            length_mm=length_mm,
        ...
        put_vehicle_sectors_sector_id_body.additional_properties = d
        return put_vehicle_sectors_sector_id_body
