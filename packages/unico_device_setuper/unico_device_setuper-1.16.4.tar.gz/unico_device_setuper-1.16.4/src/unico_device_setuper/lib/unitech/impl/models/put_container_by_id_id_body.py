...
T = TypeVar("T", bound="PutContainerByIdIdBody")


@_attrs_define
class PutContainerByIdIdBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_container_by_id_id_body = cls(
        ...
        put_container_by_id_id_body.additional_properties = d
        return put_container_by_id_id_body
