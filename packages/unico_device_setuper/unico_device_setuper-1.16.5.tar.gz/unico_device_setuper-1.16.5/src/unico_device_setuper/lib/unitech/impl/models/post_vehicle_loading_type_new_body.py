...
T = TypeVar("T", bound="PostVehicleLoadingTypeNewBody")


@_attrs_define
class PostVehicleLoadingTypeNewBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        post_vehicle_loading_type_new_body = cls(
            label=label,
            id=id,
            height_mm=height_mm,
            length_mm=length_mm,
        ...
        post_vehicle_loading_type_new_body.additional_properties = d
        return post_vehicle_loading_type_new_body
