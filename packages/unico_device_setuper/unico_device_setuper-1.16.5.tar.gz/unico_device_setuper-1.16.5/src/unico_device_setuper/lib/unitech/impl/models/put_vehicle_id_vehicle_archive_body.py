...
T = TypeVar("T", bound="PutVehicleIdVehicleArchiveBody")


@_attrs_define
class PutVehicleIdVehicleArchiveBody:
    """
    Attributes:
    ...
    def from_dict(cls: Type[T], src_dict: Dict[str, Any]) -> T:
        ...
        put_vehicle_id_vehicle_archive_body = cls(
            id=id,
            label=label,
            height_mm=height_mm,
            length_mm=length_mm,
        ...
        put_vehicle_id_vehicle_archive_body.additional_properties = d
        return put_vehicle_id_vehicle_archive_body
