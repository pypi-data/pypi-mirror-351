...
setup(
    ...
    version='0.2.2',  # İlk sürüm
    description='Türkçe fonksiyonlarla sade istatistik kütüphanesi',
    long_description=open('README.md', encoding='utf-8').read(),
    long_description_content_type='text/markdown',
    author='PozStudio',  # İstersen tam adını yazabilirsin
    author_email='pozstudiosh@gmail.com',  # Dilersen geçici bir mail yaz
    url='https://github.com/pozstudiox/pystatic',  # GitHub reposu (opsiyonel)
