...
def main():
    ...
    subprocess.run([
        "python", "-m", "openssl_encrypt.crypt", "keystore",
        "--create-keystore", "--keystore", keystore_file,
    ...
    result = subprocess.run([
        ...
        "--keystore", keystore_file, "--keystore-password", "test123",
        "--password", "test123", "--force-password", "--verbose"
    ...
    subprocess.run([
        "python", "-m", "openssl_encrypt.crypt", "keystore",
        "--list-keys", "--keystore", keystore_file,
        "--keystore-password", "test123"
    ], check=True)
    ...
    result = subprocess.run([
        "./pqc_decrypt_wrapper.py", "decrypt",
