import { g as At, a as Yt, d as xe, b as Te, c as ye, e as Ee } from "./chunk-D6G4REZN-B4mbVtV-.js";
import { I as be } from "./chunk-XZIHB7SX-DVIMV2tR.js";
import { _ as u, s as Gt, c as me, n as we, g as ve, b as Ie, o as Le, d as $, t as _e, l as G, i as Lt, x as Pe, e as I, L as ot, M as bt, u as Y, a as Ae, j as _t, k as ke, m as Zt, N as Qt, E as Ct, O as jt, Z as Ne } from "./mermaid.core-P98EGgmN.js";
var Ot = function() {
...
var Se = Ot, Me = {
  ...
  constructor() {
    ...
    })), this.setAccTitle = Gt, this.setAccDescription = me, this.setDiagramTitle = we, this.getAccTitle = ve, this.getAccDescription = Ie, this.getDiagramTitle = Le, this.apply = this.apply.bind(this), this.parseBoxData = this.parseBoxData.bind(this), this.parseMessage = this.parseMessage.bind(this), this.clear(), this.setWrap($().wrap), this.LINETYPE = Me, this.ARROWTYPE = Re, this.PLACEMENT = De;
  }
  addBox(t) {
...
`, "getStyles"), Be = Oe, ut = 18 * 2, $t = "actor-top", te = "actor-bottom", Ve = "actor-box", Xt = "actor-man", Wt = /* @__PURE__ */ u(function(e, t) {
  ...
  const a = await Qt(t.text, Ct()), n = s.append("xhtml:div").attr("style", "width: fit-content;").attr("xmlns", "http://www.w3.org/1999/xhtml").html(a).node().getBoundingClientRect();
  ...
  let c = 0, s = 0;
  const a = t.text.split(I.lineBreakRegex), [i, n] = jt(t.fontSize);
  ...
  function t(i, n, h, d, r, f, E, g) {
    const { actorFontSize: T, actorFontFamily: m, actorFontWeight: w } = g, [A, O] = jt(T), S = i.split(I.lineBreakRegex);
  ...
  async function s(i, n, h, d, r, f, E, g) {
    ...
    A.append("div").style("text-align", "center").style("vertical-align", "middle").html(await Qt(i, Ct())), t(i, m, h, d, r, f, E, g), a(A, E);
  }
  u(s, "byKatex");
  function a(i, n) {
    for (const h in n)
...
var rs = /* @__PURE__ */ u(async function(e, t, c, s) {
  ...
  Ae(o, e), e.fontFamily && (o.actorFontFamily = o.noteFontFamily = o.messageFontFamily = e.fontFamily), e.fontSize && (o.actorFontSize = o.noteFontSize = o.messageFontSize = e.fontSize), e.fontWeight && (o.actorFontWeight = o.noteFontWeight = o.messageFontWeight = e.fontWeight);
...
var ns = /* @__PURE__ */ u(async function(e, t, c, s) {
  ...
  A && r.append("text").text(A).attr("x", (M.stopx - M.startx) / 2 - 2 * o.diagramMarginX).attr("y", -25), ke(r, K, et, o.useMaxWidth);
  const N = A ? 40 : 0;
  r.attr(
    "viewBox",
...
var cs = /* @__PURE__ */ u(async function(e, t, c) {
  ...
  styles: Be,
  init: /* @__PURE__ */ u((e) => {
    e.sequence || (e.sequence = {}), e.wrap && (e.sequence.wrap = e.wrap, Pe({ sequence: { wrap: e.wrap } }));
  }, "init")
};
export {
  fs as diagram
