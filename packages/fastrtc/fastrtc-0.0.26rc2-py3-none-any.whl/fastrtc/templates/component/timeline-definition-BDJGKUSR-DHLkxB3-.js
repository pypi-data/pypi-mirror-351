import { _ as s, B as xt, U as kt, t as vt, j as U, d as _t, l as T, V as bt, W as wt, X as St, Y as Et } from "./mermaid.core-P98EGgmN.js";
import { d as nt } from "./arc-moz_RrKT.js";
var X = function() {
...
var z = "", lt = 0, Y = [], q = [], W = [], ot = /* @__PURE__ */ s(() => kt, "getCommonDb"), ct = /* @__PURE__ */ s(function() {
  Y.length = 0, q.length = 0, z = "", W.length = 0, vt();
...
var Ft = /* @__PURE__ */ s(function(n, t, e, l) {
  ...
  T.debug("bounds", B), _ && p.append("text").text(_).attr("x", B.width / 2 - h).attr("font-size", "4ex").attr("font-weight", "bold").attr("y", 20), d = k ? i + a + 150 : a + 100, p.append("g").attr("class", "lineWrapper").append("line").attr("x1", h).attr("y1", d).attr("x2", B.width + 3 * h).attr("y2", d).attr("stroke-width", 4).attr("stroke", "black").attr("marker-end", "url(#arrowhead)"), bt(
    void 0,
    p,
