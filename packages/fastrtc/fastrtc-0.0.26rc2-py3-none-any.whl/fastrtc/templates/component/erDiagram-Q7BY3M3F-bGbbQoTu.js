import { g as Dt, s as wt } from "./chunk-RZ5BOZE2-lKx_xar5.js";
import { _ as u, s as Vt, g as Lt, c as Mt, b as Bt, n as Ft, o as Yt, d as tt, l as D, t as Pt, r as zt, B as Gt, y as Kt, z as Zt, j as Ut, u as jt, A as Wt } from "./mermaid.core-P98EGgmN.js";
import { c as Qt } from "./channel-CCm-gGmT.js";
var dt = function() {
...
var Ht = /* @__PURE__ */ u(async function(s, i, h, d) {
  ...
  Array.from(V).length > 0 && V.each(function() {
    const S = Ut(this), U = S.attr("id").replace("-background", ""), T = E.select(`#${CSS.escape(U)}`);
    if (!T.empty()) {
