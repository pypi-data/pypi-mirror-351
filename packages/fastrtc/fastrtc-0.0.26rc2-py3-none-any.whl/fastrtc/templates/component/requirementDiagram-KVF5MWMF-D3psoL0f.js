import { g as ze, s as Ge } from "./chunk-RZ5BOZE2-lKx_xar5.js";
import { _ as f, s as Xe, g as Je, c as Ze, b as et, n as tt, o as st, d as Ne, l as qe, t as it, B as rt, y as nt, z as at, u as lt } from "./mermaid.core-P98EGgmN.js";
var Ae = function() {
  var e = /* @__PURE__ */ f(function(P, i, r, l) {
    ...
    parse: /* @__PURE__ */ f(function(i) {
      var r = this, l = [0], s = [], E = [null], t = [], de = this.table, n = "", ye = 0, Pe = 0, He = 2, $e = 1, Ke = t.slice.call(arguments, 1), S = Object.create(this.lexer), z = { yy: {} };
      ...
      for (var b, G, q, Te, J = {}, ge, F, Ye, _e; ; ) {
        if (G = l[l.length - 1], this.defaultActions[G] ? q = this.defaultActions[G] : ((b === null || typeof b > "u") && (b = Ue()), q = de[G] && de[G][b]), typeof q > "u" || !q.length || !q[0]) {
          var ke = "";
          _e = [];
          for (ge in de[G])
