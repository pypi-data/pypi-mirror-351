import { e as x, c as b, g as m, k as P, h as p, j as w, l as N, m as c, n as I, t as A, o as M } from "./_baseUniq-DeDZcj55.js";
import { aJ as g, az as E, aK as F, aL as _, aM as $, aN as l, aO as B, aP as T, aQ as y, aR as L } from "./mermaid.core-P98EGgmN.js";
var R = /\s/;
function S(n) {
...
var z = /^\s+/;
function G(n) {
  return n && n.slice(0, S(n) + 1).replace(z, "");
}
...
var v = 1 / 0, Q = 17976931348623157e292;
function W(n) {
  if (!n)
    return n === 0 ? n : 0;
  if (n = J(n), n === v || n === -v) {
