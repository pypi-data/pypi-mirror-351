...
class InterfacesApiRouter(VersionRouter):
    ...
    function_library = {
        "get_interfaces": {"4.8.4-6.x.x": get_interfaces},
        "get_system_interface_details": {"4.8.4-6.x.x": get_system_interface_details},
        "get_system_interfaces": {"4.8.4-6.x.x": get_system_interfaces},
        "put_update_system_interface": {"4.8.4-6.x.x": put_update_system_interface},
        "post_create_system_interface": {"4.8.4-6.x.x": post_create_system_interface},
        "delete_gre_interface": {"4.8.4-6.x.x": delete_gre_interface},
        "get_gre_interfaces": {"4.8.4-6.x.x": get_gre_interfaces},
        "put_update_gre_interface": {"4.8.4-6.x.x": put_update_gre_interface},
        "get_gre_interface_details": {"4.8.4-6.x.x": get_gre_interface_details},
        "post_create_gre_interface": {"4.8.4-6.x.x": post_create_gre_interface},
        "delete_system_interface": {"4.8.4-6.x.x": delete_system_interface},
        "post_interfaces_action": {"4.8.4-6.x.x": post_interfaces_action},
        "get_interface_addresses": {"5.1.1-6.x.x": get_interface_addresses},
        "create_interface_address": {"5.1.1-6.x.x": create_interface_address},
        "get_interface_address": {"5.1.1-6.x.x": get_interface_address},
        "put_update_interface_address": {"5.1.1-6.x.x": put_update_interface_address},
        "delete_interface_address": {"5.1.1-6.x.x": delete_interface_address},
    }
