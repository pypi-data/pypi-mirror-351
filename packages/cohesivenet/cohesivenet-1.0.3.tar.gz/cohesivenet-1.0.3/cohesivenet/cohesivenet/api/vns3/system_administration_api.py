...
class SystemAdministrationApiRouter(VersionRouter):
    function_library = {
        "get_cloud_data": {"4.8.4-6.x.x": get_cloud_data},
        "get_runtime_status": {"4.8.4-6.x.x": get_runtime_status},
        "get_task_status": {"4.8.4-6.x.x": get_task_status},
        "get_system_status": {"4.8.4-6.x.x": get_system_status},
