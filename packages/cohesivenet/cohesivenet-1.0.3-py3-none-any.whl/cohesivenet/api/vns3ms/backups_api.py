...
class BackupsApiRouter(VersionRouter):
    ...
    function_library = {
        "get_backups": {"2.1.1-2.5.4": get_backups},
        "delete_backup": {"2.1.1-2.5.4": delete_backup},
        "get_download_backup": {"2.1.1-2.5.4": get_download_backup},
        "post_upload_backup": {"2.1.1-2.5.4": post_upload_backup},
        "post_create_backup": {"2.1.1-2.5.4": post_create_backup},
        "get_backup_job": {"2.1.1-2.5.4": get_backup_job},
        "wait_for_backup": {"2.1.1-2.5.4": wait_for_backup},
        "post_restore_backup": {"2.1.1-2.5.4": post_restore_backup},
        "get_snapshots_backup": {"2.1.1-2.5.4": get_snapshots_backup},
        "delete_snapshots_backup": {"2.1.1-2.5.4": delete_snapshots_backup},
        "get_download_snapshots_backup": {"2.1.1-2.5.4": get_download_snapshots_backup},
        "post_upload_snapshots_backup": {"2.1.1-2.5.4": post_upload_snapshots_backup},
        "get_snapshots_upload_status": {"2.1.1-2.5.4": get_snapshots_upload_status},
        "post_create_snapshots_backup": {"2.1.1-2.5.4": post_create_snapshots_backup},
        "get_snapshots_backup_status": {"2.1.1-2.5.4": get_snapshots_backup_status},
        "post_restore_snapshots_backup": {"2.1.1-2.5.4": post_restore_snapshots_backup},
    }
