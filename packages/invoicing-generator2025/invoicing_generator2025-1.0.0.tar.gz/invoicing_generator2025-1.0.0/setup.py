...
setup(
  name = 'invoicing-generator2025',         #* Your package will have this name
  ...
  author = 'Navid-Ul-Islam',                   # Your name
  author_email = 'nibirislam56@gmail.com',  # Your email
  url = 'https://github.com/Nibir2405',              # Homepage of your library (e.g. github or your website)
