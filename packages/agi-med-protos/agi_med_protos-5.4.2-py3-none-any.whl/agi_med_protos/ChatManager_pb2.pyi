...
class ChatManagerRequest(_message.Message):
    __slots__ = ("Text", "OuterContext", "ResourceId")
    ...
    ResourceId: str
    def __init__(self, Text: _Optional[str] = ..., OuterContext: _Optional[_Union[_commons_pb2.OuterContextItem, _Mapping]] = ..., ResourceId: _Optional[str] = ...) -> None: ...

class ChatManagerResponse(_message.Message):
    __slots__ = ("Text", "State", "Action", "ResourceId", "Widget")
    TEXT_FIELD_NUMBER: _ClassVar[int]
    ...
    ResourceId: str
    Widget: str
    def __init__(self, Text: _Optional[str] = ..., State: _Optional[str] = ..., Action: _Optional[str] = ..., ResourceId: _Optional[str] = ..., Widget: _Optional[str] = ...) -> None: ...
...
class EntrypointsResponse(_message.Message):
    ...
    def __init__(self, Entrypoints: _Optional[_Iterable[_Union[EntrypointInfo, _Mapping]]] = ...) -> None: ...
