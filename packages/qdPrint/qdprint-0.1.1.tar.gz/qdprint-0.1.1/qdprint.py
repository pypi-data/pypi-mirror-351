...
def main():
    ...
    redTagPrint("RED", "This is an red tag message!", "This is appended red tag text!")
    yelTagPrint("YELLOW", "This is a yellow tag message!", "This is appended yellow tag text!")
    greTagPrint("GREEN", "This is a green tag message!", "This is appended green tag text!")
