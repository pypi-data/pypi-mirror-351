...
class MspManagedDevice(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["address", "chassisSerial", "configState", "conflictDetectionState", "connectivityState", "deviceType", "hardwareModel", "labels", "managedTenantDisplayName", "managedTenantName", "managedTenantRegion", "managedTenantUid", "modelNumber", "name", "redundancyMode", "serial", "softwareVersion", "tenantUid", "uid"]
