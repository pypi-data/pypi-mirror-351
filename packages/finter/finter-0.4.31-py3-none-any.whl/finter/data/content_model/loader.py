        ...
        for match in self.match_list:
            ...
            try:
                ...
                if self.universe_name == "us_etf":
                    ...
                    if cm_name_category in ["price_volume", "classification", "universe"]:
                        net_cm_list = [
                            cm.replace("us-stock-", "")
                            for cm in net_cm_list
                            if "us-stock-" in cm
                        ...
                        if self.client.user_group != "quantit":
                            ...
                            identity_format = match.split(".")[4]
                            if identity_format[-2] == "-":
                                net_cm_list = [cm.replace("us-stock-", "") for cm in net_cm_list]
                            elif identity_format[-2] == "_":
                                net_cm_list = [cm.replace("us-stock_", "") for cm in net_cm_list]
