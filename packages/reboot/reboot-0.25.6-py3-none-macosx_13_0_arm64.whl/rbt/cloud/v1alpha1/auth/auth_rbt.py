    ...
    async def __Create(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.auth.APIKey.Create') {type(decode_error).__name__}: {decode_error}; " +
    ...
    async def __Revoke(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.auth.APIKey.Revoke') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
    ...
    async def __Authenticate(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.auth.APIKey.Authenticate') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
...
class APIKeyServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    class _State:
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: APIKeyServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
        ...
        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID) -> APIKeyServicer._State._Idempotently:
            ...
...
class APIKey:
    ...
    Effects: IMPORT_typing.TypeAlias = APIKeyServicer.Effects
    ...
    RevokeEffects: IMPORT_typing.TypeAlias = Servicer.RevokeEffects
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID) -> APIKey._ConstructIdempotently:
        ...
