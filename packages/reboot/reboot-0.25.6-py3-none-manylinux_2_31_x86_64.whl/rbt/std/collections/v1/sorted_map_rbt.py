...
class SortedMapServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    async def __Insert(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.std.collections.v1.SortedMap.Insert') {type(decode_error).__name__}: {decode_error}; " +
    ...
    async def __Remove(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.std.collections.v1.SortedMap.Remove') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.std.collections.v1.SortedMap.Get') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.std.collections.v1.SortedMap.Get') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.std.collections.v1.SortedMap.Get') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
    ...
    async def __Range(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.std.collections.v1.SortedMap.Range') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
    ...
    async def __ReverseRange(
        ...
        *,
        ...
        try:
            response = (
                await self._servicer.ReverseRange(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.std.collections.v1.SortedMap.ReverseRange') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
...
class SortedMapAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        self._Get = Get
        self._Range = Range
        self._ReverseRange = ReverseRange
    ...
    async def ReverseRange(
        ...
        *,
        ...
        return await (self._ReverseRange or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.SortedMap, state),
            request=IMPORT_typing.cast(rbt.std.collections.v1.sorted_map_pb2.ReverseRangeRequest, request),
        )
...
class SortedMapServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    class InlineWriterCallable(IMPORT_typing.Protocol[InlineWriterCallableResult]):
        async def __call__(
            self,
            state: rbt.std.collections.v1.sorted_map_pb2.SortedMap
        ) -> SortedMapServicer.InlineWriterCallableResult:
            ...
    ...
    class _State:
        ...
        async def write(
            ...
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: SortedMapServicer.InlineWriterCallable[None],
        ...
        async def write(
            ...
            idempotency_alias: str,
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: SortedMapServicer.InlineWriterCallable[SortedMapServicer.InlineWriterCallableResult],
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            *,
            type: type[SortedMapServicer.InlineWriterCallableResult],
        ) -> SortedMapServicer.InlineWriterCallableResult:
            ...
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: SortedMapServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                method_name = f"SortedMap.{task.method_name} "
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: str, *, each_iteration: bool = False) -> SortedMapServicer._State._Idempotently:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID) -> SortedMapServicer._State._Idempotently:
            ...
        ...
        class _Unidempotently:
            ...
            async def write(
                ...
                return await SortedMapServicer._State._Idempotently(
                    servicer=self._servicer,
                    idempotency=IMPORT_reboot_aio_contexts.Context.idempotency(
        ...
        def unidempotently(self):
            return SortedMapServicer._State._Unidempotently(
                servicer=self._servicer,
            )

    @property
    def state(self):
        return SortedMapServicer._State(
            servicer=self
        )
...
class SortedMap:
    ...
    Effects: IMPORT_typing.TypeAlias = SortedMapServicer.Effects
    ...
    InsertEffects: IMPORT_typing.TypeAlias = Servicer.InsertEffects
    ...
    RemoveEffects: IMPORT_typing.TypeAlias = Servicer.RemoveEffects
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID) -> SortedMap._ConstructIdempotently:
        ...
...
class SortedMapServicerNodeAdaptor(SortedMap.Servicer):
