...
IMPORT_reboot_versioning.check_generated_code_compatible("0.25.6")
...
class ApplicationServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
        ...
        if 'Create' == task.method_name:
            ...
            async def run_UpWorkflow(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response_or_loop = await self.__UpWorkflow(
                            context,
            ...
            async def run_DownWorkflow(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response_or_loop = await self.__DownWorkflow(
                            context,
    ...
    async def __Create(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Create') {type(decode_error).__name__}: {decode_error}; " +
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.PushInfo') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
    ...
    async def __Up(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Up') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
    ...
    async def __UpWorkflow(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowResponse | IMPORT_reboot_aio_tasks.Loop:
        try:
            response = (
                await self._servicer.UpWorkflow(
                    context=context,
                    request=request
                )
            )
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.UpWorkflow') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
    ...
    async def __Down(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Down') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
    ...
    async def __DownWorkflow(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowResponse | IMPORT_reboot_aio_tasks.Loop:
        try:
            response = (
                await self._servicer.DownWorkflow(
                    context=context,
                    request=request
                )
            )
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.DownWorkflow') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
    ...
    async def __RevisionStatus(
        ...
        *,
        ...
        try:
            response = (
                await self._servicer.RevisionStatus(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.RevisionStatus') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
    ...
    async def __Logs(
        ...
        *,
        ...
        try:
            async for response in self._servicer.Logs(
                context=context,
                state=state,
                request=request
            ):
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Logs') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
    ...
    async def __ActiveRevisions(
        ...
        *,
        ...
        try:
            response = (
                await self._servicer.ActiveRevisions(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.ActiveRevisions') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.Status') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.application.Application.IsAdmin') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
...
class ApplicationAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        self._Up = Up
        self._UpWorkflow = UpWorkflow
        self._Down = Down
        self._DownWorkflow = DownWorkflow
        self._RevisionStatus = RevisionStatus
        self._Logs = Logs
        self._ActiveRevisions = ActiveRevisions
        self._Status = Status
    ...
    async def PushInfo(
        ...
        *,
        ...
        return await (self._PushInfo or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.PushInfoRequest, request),
        )
    ...
    async def UpWorkflow(
        ...
        *,
        ...
        return await (self._UpWorkflow or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.UpWorkflowRequest, request),
        )
    ...
    async def DownWorkflow(
        ...
        *,
        ...
        return await (self._DownWorkflow or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.DownWorkflowRequest, request),
        )
    ...
    async def RevisionStatus(
        ...
        *,
        ...
        return await (self._RevisionStatus or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.RevisionStatusRequest, request),
        )
    ...
    async def ActiveRevisions(
        ...
        *,
        ...
        return await (self._ActiveRevisions or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.ActiveRevisionsRequest, request),
        )
    ...
    async def IsAdmin(
        ...
        *,
        ...
        return await (self._IsAdmin or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.Application, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.application.application_pb2.IsAdminRequest, request),
        )
...
class Application:
            ...
            *,
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'UpWorkflow' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].idempotently([...]).spawn([...]).UpWorkflow(context, [...])`"
                else:
                    return f"'UpWorkflow' is a workflow and can not be called from '{type(__context__).__name__}'"
        ...
        async def DownWorkflow(
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'DownWorkflow' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].idempotently([...]).spawn([...]).DownWorkflow(context, [...])`"
                else:
                    return f"'DownWorkflow' is a workflow and can not be called from '{type(__context__).__name__}'"
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID) -> Application._ConstructIdempotently:
        ...
