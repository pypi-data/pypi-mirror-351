...
class SecretServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    def __init__(
        ...
        *,
        ...
        super().__init__(
            ...
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.secrets.Secret'),
            service_names = [
                IMPORT_reboot_aio_types.ServiceName("rbt.cloud.v1alpha1.secrets.SecretMethods"),
            ],
        ...
        if method == 'Write':
            ...
            async with self._state_manager.reactively(
                ...
                async for (state, idempotency_keys) in states:
                    ...
                    async def run__Read(validating_effects: bool) -> IMPORT_google_protobuf_message.Message:
    ...
    async def react_mutate(
        ...
        if method == 'Write':
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.InvalidMethod(),
                message=
                f"Method 'Write' can not be called via React (for now)"
            )
        elif method == 'Read':
            # Invariant here is that users should not have called this
            # directly but only through code generated React
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.InvalidMethod(),
                message=
                f"Method 'Delete' can not be called via React (for now)"
            )
        else:
            logger.warning(
                "Got a react mutate request with an invalid method name: "
        ...
        if 'Write' == task.method_name:
            ...
            async def run_Write(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response_or_loop = await self.__Write(
                            context,
                            IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest, task.request),
                            validating_effects=validating_effects,
                        )
            ...
            @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
            async def run_Write_reactively(
                validating_effects: bool,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ):
                async with self._state_manager.reactively(
                        ...
                        try:
                            ...
                            while True:
                                ...
                                if len(done) == 0:
                                    ...
                                    logger.warning(
                                        f'Still waiting for method Secret.Write '
            ...
            return await run_Write_reactively(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response = await (SecretWorkflowStub(
                            ...
                            IMPORT_typing.cast(google.protobuf.empty_pb2.Empty, task.request),
            ...
            async def run_Delete(
                ...
                async with self._state_manager.task_workflow(
                    ...
                    try:
                        response_or_loop = await self.__Delete(
                            context,
                            IMPORT_typing.cast(google.protobuf.empty_pb2.Empty, task.request),
                            validating_effects=validating_effects,
                        )
            ...
            @IMPORT_reboot_aio_internals_middleware.maybe_run_function_twice_to_validate_effects
            async def run_Delete_reactively(
                validating_effects: bool,
                context: IMPORT_reboot_aio_contexts.WorkflowContext,
            ):
                async with self._state_manager.reactively(
                        ...
                        try:
                            ...
                            while True:
                                ...
                                if len(done) == 0:
                                    assert validating_effects and timeout is not None
                                    logger.warning(
                                        f'Still waiting for method Secret.Delete '
                                        'to complete after re-running to validate effects.'
                                    )
                                    timeout += 5  # seconds
                                    continue
            ...
            return await run_Delete_reactively(
                self.create_context(
                    headers=IMPORT_reboot_aio_headers.Headers(
                        application_id=self.application_id,
                        state_ref=IMPORT_reboot_aio_types.StateRef(task.task_id.state_ref),
    ...
    async def __Write(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteResponse | IMPORT_reboot_aio_tasks.Loop:
        try:
            response = (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Write') {type(decode_error).__name__}: {decode_error}; " +
            ...
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Write') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
    ...
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteResponse]:
    ...
    async def __Read(
        ...
        *,
        ...
        try:
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Read') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Read') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
    ...
    async def _schedule_Read(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.secrets.Secret'),
            context_type=IMPORT_reboot_aio_contexts.WriterContext,
    ...
    async def __Delete(
        ...
        *,
        validating_effects: bool,
    ) -> rbt.cloud.v1alpha1.secrets.secrets_pb2.DeleteResponse | IMPORT_reboot_aio_tasks.Loop:
        try:
            response = (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Delete') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
                message=f"unhandled (in 'rbt.cloud.v1alpha1.secrets.Secret.Delete') {decode_error}; "
                        "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                        "See the limits here: https://protobuf.dev/programming-guides/proto-limits/"
            )
        except BaseException as exception:
    ...
    async def _schedule_Delete(
        ...
        *,
        ...
        headers: IMPORT_reboot_aio_headers.Headers,
        grpc_context: IMPORT_grpc.aio.ServicerContext,
    ) -> tuple[IMPORT_reboot_aio_contexts.WriterContext, rbt.cloud.v1alpha1.secrets.secrets_pb2.DeleteResponse]:
        context: IMPORT_reboot_aio_contexts.WriterContext = self.create_context(
            headers=headers,
            state_type_name = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.secrets.Secret'),
            context_type=IMPORT_reboot_aio_contexts.WriterContext,
    ...
    def _maybe_authorize(
        ...
        *,
        ...
        request: IMPORT_typing.Optional[SecretRequestTypes] = None,
    ) -> IMPORT_typing.Optional[IMPORT_typing.Callable[[IMPORT_typing.Optional[SecretStateType]], IMPORT_typing.Awaitable[None]]]:
        ...
        async def authorize(state: IMPORT_typing.Optional[SecretStateType]) -> None:
...
class _SecretStub(IMPORT_reboot_aio_stubs.Stub):

    __state_type_name__ = IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.secrets.Secret')
    ...
    async def Read(
        ...
        *,
        ...
        async with self._call(
            IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.secrets.Secret'),
            IMPORT_reboot_aio_types.ServiceName('rbt.cloud.v1alpha1.secrets.SecretMethods'),
            'Read',
    ...
    async def Write(
        ...
        *,
        ...
        with self._idempotency_manager.idempotently(
            ...
            service_name=IMPORT_reboot_aio_types.ServiceName('rbt.cloud.v1alpha1.secrets.SecretMethods'),
            method='Write',
            request=request,
            metadata=metadata,
                ...
                for (key, value) in await call.trailing_metadata():  # type: ignore[misc, attr-defined]
                    if key == IMPORT_reboot_aio_headers.TASK_ID_UUID:
                        return IMPORT_rbt_v1alpha1.tasks_pb2.TaskId(
                            state_type=IMPORT_reboot_aio_types.StateTypeName('rbt.cloud.v1alpha1.secrets.Secret'),
...
SecretStateType: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret
SecretRequestTypes: IMPORT_typing.TypeAlias = \
        rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest \
        | google.protobuf.empty_pb2.Empty

class SecretAuthorizer(
    IMPORT_rebootdev.aio.auth.authorizers.Authorizer[SecretStateType, SecretRequestTypes],
):
    StateType: IMPORT_typing.TypeAlias = SecretStateType
    RequestTypes: IMPORT_typing.TypeAlias = SecretRequestTypes
    Decision: IMPORT_typing.TypeAlias = IMPORT_rebootdev.aio.auth.authorizers.Authorizer.Decision

    def __init__(
        self,
        *,
        Write: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret,
              rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest,
            ]
        ] = None,
        Read: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret,
              google.protobuf.empty_pb2.Empty,
            ]
        ] = None,
        Delete: IMPORT_typing.Optional[
            IMPORT_rebootdev.aio.auth.authorizers.AuthorizerRule[
              rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret,
              google.protobuf.empty_pb2.Empty,
            ]
    ...
    async def authorize(
        ...
        *,
        method_name: str,
        context: IMPORT_reboot_aio_contexts.ReaderContext,
        state: IMPORT_typing.Optional[SecretStateType],
        request: IMPORT_typing.Optional[SecretRequestTypes],
        **kwargs,
        ...
        if method_name == 'rbt.cloud.v1alpha1.secrets.SecretMethods.Write':
            return await self.Write(
                context=context,
                state=IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
                request=IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest, request),
            )
    ...
    async def Write(
        ...
        *,
        ...
        return await (self._Write or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest, request),
        )
    ...
    async def Read(
        ...
        *,
        ...
        return await (self._Read or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
            request=IMPORT_typing.cast(google.protobuf.empty_pb2.Empty, request),
        )
    ...
    async def Delete(
        ...
        *,
        ...
        return await (self._Delete or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret, state),
            request=IMPORT_typing.cast(google.protobuf.empty_pb2.Empty, request),
        )
...
class SecretServicer(IMPORT_reboot_aio_servicers.Servicer):
    Authorizer: IMPORT_typing.TypeAlias = SecretAuthorizer
    ...
    def __init__(self):
        ...
        # 'create_middleware()'.
        self._middleware: IMPORT_typing.Optional[SecretServicerMiddleware] = None
    ...
    class Effects(IMPORT_reboot_aio_state_managers.Effects):
        def __init__(
            ...
            *,
            ...
            IMPORT_reboot_aio_types.assert_type(state, [rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret])
    ...
    class _State:
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: SecretServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
        ...
        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID) -> SecretServicer._State._Idempotently:
            ...
...
Secret_ScheduleTypeVar = IMPORT_typing.TypeVar('Secret_ScheduleTypeVar', 'Secret.WeakReference._Schedule', 'Secret.WeakReference._WriterSchedule')
Secret_IdempotentlyScheduleTypeVar = IMPORT_typing.TypeVar('Secret_IdempotentlyScheduleTypeVar', 'Secret.WeakReference._Schedule', 'Secret.WeakReference._WriterSchedule')

class Secret:

    Servicer: IMPORT_typing.TypeAlias = SecretServicer

    Effects: IMPORT_typing.TypeAlias = SecretServicer.Effects

    Authorizer: IMPORT_typing.TypeAlias = SecretAuthorizer

    State: IMPORT_typing.TypeAlias = rbt.cloud.v1alpha1.secrets.secrets_pb2.Secret
    ...
    class WriteTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteResponse]:
    ...
    class WriteAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class ReadTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class ReadAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class DeleteTask:
        ...
        def __await__(self) -> IMPORT_typing.Generator[None, None, rbt.cloud.v1alpha1.secrets.secrets_pb2.DeleteResponse]:
            """Awaits for task to finish and returns it's response."""
    ...
    class DeleteAborted(IMPORT_rebootdev.aio.aborted.Aborted):
    ...
    class WeakReference(IMPORT_typing.Generic[Secret_ScheduleTypeVar]):
        ...
        def __init__(
            ...
            *,
            ...
            self._reader_stub: IMPORT_typing.Optional[SecretReaderStub] = None
            self._writer_stub: IMPORT_typing.Optional[SecretWriterStub] = None
            self._workflow_stub: IMPORT_typing.Optional[SecretWorkflowStub] = None
            self._tasks_stub: IMPORT_typing.Optional[SecretTasksStub] = None
        ...
        class _Reactively:
            ...
            async def Read(
            ...
            ) -> IMPORT_typing.AsyncIterator[rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse]:
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=google.protobuf.empty_pb2.Empty)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=google.protobuf.empty_pb2.Empty)
                ...
                __request__ = google.protobuf.empty_pb2.Empty(
                )
                    ...
                    try:
                        async with __context__.channel_manager.get_channel_to_state(
                            ...
                            async for __query_response__ in __call__:
                                ...
                                __response__ = rbt.cloud.v1alpha1.secrets.secrets_pb2.ReadResponse()
        ...
        class _Idempotently(IMPORT_typing.Generic[Secret_IdempotentlyScheduleTypeVar]):
            ...
            def spawn(
                ...
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
            ) -> Secret.WeakReference._Spawn:
                return Secret.WeakReference._Spawn(
                    self._weak_reference._application_id,
                    self._weak_reference._tasks,
                    when=when,
                    idempotency=self._idempotency,
            ...
            async def Write(
                ...
                *,
                ...
                # UX improvement: check that neither positional argument was accidentally
                # given a gRPC request type.
                IMPORT_reboot_aio_types.assert_not_request_type(__context__, request_type=rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest)
                IMPORT_reboot_aio_types.assert_not_request_type(__options__, request_type=rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest)
                ...
                def error_message_supplement():
                    if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                        return f"'Write' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].schedule([...]).Write(context, [...])`"
                    else:
                        return f"'Write' is a workflow and can not be called from '{type(__context__).__name__}'"
            ...
            async def Delete(
                ...
                def error_message_supplement():
                    if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                        return f"'Delete' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].schedule([...]).Delete(context, [...])`"
                    else:
                        return f"'Delete' is a workflow and can not be called from '{type(__context__).__name__}'"
        ...
        class _Schedule:
            ...
            def __init__(
                self,
                application_id: IMPORT_typing.Optional[IMPORT_reboot_aio_types.ApplicationId],
                tasks: IMPORT_typing.Callable[[IMPORT_reboot_aio_contexts.TransactionContext | IMPORT_reboot_aio_contexts.WorkflowContext | IMPORT_reboot_aio_external.ExternalContext], SecretTasksStub],
                *,
                when: IMPORT_typing.Optional[IMPORT_datetime_datetime | IMPORT_datetime_timedelta] = None,
                idempotency: IMPORT_typing.Optional[IMPORT_reboot_aio_idempotency.Idempotency] = None,
            ) -> None:
            ...
            async def Write(
                ...
                *,
                ...
                # always non-None, when in reality they are optional.
                __request__ = rbt.cloud.v1alpha1.secrets.secrets_pb2.WriteRequest(
            ...
            *,
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'Write' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].idempotently([...]).spawn([...]).Write(context, [...])`"
                else:
                    return f"'Write' is a workflow and can not be called from '{type(__context__).__name__}'"
        ...
        async def Read(
            ...
            if __options__ is not None:
                ...
                if __options__.bearer_token is not None:
                    __bearer_token__ = __options__.bearer_token
            return await __this__._reader(__context__).Read(
                __request__,
                metadata=__metadata__,
                bearer_token=__bearer_token__,
            )
        async def Delete(
            ...
            def error_message_supplement():
                if any([isinstance(__context__, t) for t in [IMPORT_reboot_aio_contexts.WriterContext, IMPORT_reboot_aio_contexts.TransactionContext]]):
                    ...
                    return f"'Delete' is a workflow and must be scheduled from a '{type(__context__).__name__}' via `await [...].idempotently([...]).spawn([...]).Delete(context, [...])`"
                else:
                    return f"'Delete' is a workflow and can not be called from '{type(__context__).__name__}'"
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, alias: IMPORT_typing.Optional[str] = None, *, each_iteration: bool = False) -> Secret._ConstructIdempotently:
        ...

    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID) -> Secret._ConstructIdempotently:
        ...
...
class SecretServicerNodeAdaptor(Secret.Servicer):
    ...
    async def Write(
        ...
        raise RuntimeError("Unexpected result from Write")
    ...
    async def Read(
        ...
        raise RuntimeError("Unexpected result from Read")
    ...
    async def Delete(
        ...
        raise RuntimeError("Unexpected result from Delete")
