...
class ApplicationLogsServicerMiddleware(IMPORT_reboot_aio_internals_middleware.Middleware):
    ...
    def __init__(
        self,
        *,
        servicer: ApplicationLogsServicer,
    ...
    async def __Ensure(
        ...
        *,
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.Ensure') {aborted}"
                        )
                elif (
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.Ensure') {type(decode_error).__name__}: {decode_error}; " +
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.Ensure') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
        ...
        *,
        ...
        async with self._state_manager.transactionally(
            ...
            async with self._state_manager.writer(
                ...
                task = ApplicationLogsServicerTasksStub(
                    context=context,
                    state_ref=context._state_ref,
                ).Ensure(
                    request,
    ...
    async def __RegisterConsensus(
        ...
        *,
        ...
        try:
            response = (
                await self._servicer.RegisterConsensus(
                    context=context,
                    state=state,
                    request=request
                )
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.RegisterConsensus') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.RegisterConsensus') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.RegisterConsensus') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
        ...
        try:
            ...
            if isinstance(aborted, IMPORT_rebootdev.aio.aborted.SystemAborted):
                ...
                if (
                    ...
                    if context.task is None:
                        logger.warning(
                            f"Propagating unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.Logs') {aborted}"
                        )
                elif (
                    aborted_type is None or
                    not isinstance(aborted, aborted_type)
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.Logs') {type(decode_error).__name__}: {decode_error}; " +
                    "This is usually caused by a deeply nested protobuf message, which is not supported by protobuf.\n"
                    "See the limits here: https://protobuf.dev/programming-guides/proto-limits/" +
                    ''.join(IMPORT_traceback.format_exception(decode_error))
                )
            ...
            if IMPORT_reboot_nodejs_python.should_print_stacktrace():
                logger.warning(
                    f"Unhandled (in 'rbt.cloud.v1alpha1.logs.ApplicationLogs.Logs') {type(exception).__name__}: {exception}; propagating as 'Unknown'\n" +
                    ''.join(IMPORT_traceback.format_exception(exception))
                )
            raise IMPORT_rebootdev.aio.aborted.SystemAborted(
                IMPORT_rbt_v1alpha1.errors_pb2.Unknown(),
...
class ApplicationLogsServicerTasksStub(_ApplicationLogsStub):
...
class ApplicationLogsAuthorizer(
    ...
    def __init__(
        ...
        *,
        ...
        self._Ensure = Ensure
        self._RegisterConsensus = RegisterConsensus
        self._Logs = Logs
    ...
    async def RegisterConsensus(
        ...
        *,
        ...
        return await (self._RegisterConsensus or self.__default).execute(
            context=context,
            state=IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.ApplicationLogs, state),
            request=IMPORT_typing.cast(rbt.cloud.v1alpha1.logs.logs_pb2.RegisterConsensusRequest, request),
        )
...
class ApplicationLogsServicer(IMPORT_reboot_aio_servicers.Servicer):
    ...
    class InlineWriterCallable(IMPORT_typing.Protocol[InlineWriterCallableResult]):
        async def __call__(
            self,
            state: rbt.cloud.v1alpha1.logs.logs_pb2.ApplicationLogs
        ) -> ApplicationLogsServicer.InlineWriterCallableResult:
            ...
    ...
    class _State:
        ...
        async def write(
            ...
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: ApplicationLogsServicer.InlineWriterCallable[None],
        ...
        async def write(
            ...
            idempotency_alias: str,
            context: IMPORT_reboot_aio_contexts.WorkflowContext,
            writer: ApplicationLogsServicer.InlineWriterCallable[ApplicationLogsServicer.InlineWriterCallableResult],
            __options__: IMPORT_reboot_aio_call.Options = IMPORT_reboot_aio_call.Options(),
            *,
            type: type[ApplicationLogsServicer.InlineWriterCallableResult],
        ) -> ApplicationLogsServicer.InlineWriterCallableResult:
            ...
                ...
                with context.idempotently(
                    ...
                    with servicer._middleware.use_context(
                        ...
                        if idempotent_mutation is not None:
                            ...
                            response.ParseFromString(idempotent_mutation.response)
                            result: ApplicationLogsServicer.InlineWriterCallableResult = IMPORT_pickle.loads(response.value)
                        ...
                        async with servicer._middleware._state_manager.transactionally(
                            ...
                            async with servicer._middleware._state_manager.writer(
                                ...
                                effects = ApplicationLogsServicer.Effects(
                                    state=state,
                                    tasks=context._tasks,
                                    response=IMPORT_google_protobuf_wrappers_pb2.BytesValue(
                                ...
                                method_name = f"ApplicationLogs.{task.method_name} "
        ...
        @IMPORT_typing.overload
        def idempotently(self, alias: str, *, each_iteration: bool = False) -> ApplicationLogsServicer._State._Idempotently:
            ...

        @IMPORT_typing.overload
        def idempotently(self, *, key: IMPORT_uuid.UUID) -> ApplicationLogsServicer._State._Idempotently:
            ...
        ...
        ) -> ApplicationLogsServicer._State._Idempotently:
            if alias is None and key is None:
                raise ValueError(
                    'Inline writers require either an idempotency alias or key'
                )
            return ApplicationLogsServicer._State._Idempotently(
        ...
        class _Unidempotently:
            ...
            async def write(
                ...
                return await ApplicationLogsServicer._State._Idempotently(
                    servicer=self._servicer,
                    idempotency=IMPORT_reboot_aio_contexts.Context.idempotency(
        ...
        def unidempotently(self):
            return ApplicationLogsServicer._State._Unidempotently(
                servicer=self._servicer,
            )

    @property
    def state(self):
        return ApplicationLogsServicer._State(
            servicer=self
        )
...
class ApplicationLogs:
    ...
    Effects: IMPORT_typing.TypeAlias = ApplicationLogsServicer.Effects
    ...
    EnsureEffects: IMPORT_typing.TypeAlias = Servicer.EnsureEffects
    ...
    RegisterConsensusEffects: IMPORT_typing.TypeAlias = Servicer.RegisterConsensusEffects
        ...
        class _WriterSchedule:
            ...
            async def Ensure(
                ...
                if isinstance(__context__, IMPORT_reboot_aio_contexts.WriterContext):
                    return ApplicationLogsServicerTasksStub(
                        context=__context__,
    ...
    @IMPORT_typing.overload
    @classmethod
    def idempotently(cls, *, key: IMPORT_uuid.UUID) -> ApplicationLogs._ConstructIdempotently:
        ...
...
class ApplicationLogsServicerNodeAdaptor(ApplicationLogs.Servicer):
    ...
    async def _schedule(  # type: ignore[override]
        ...
        *,
        ...
        if isinstance(context, IMPORT_reboot_aio_contexts.WriterContext):
            task = getattr(
                ApplicationLogsServicerTasksStub(
                    context=context,
                    state_ref=context._state_ref,
                ),
                method,
