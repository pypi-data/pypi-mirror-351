...
[![PyPI - Downloads](https://static.pepy.tech/badge/mypy-boto3-amplify)](https://pypistats.org/packages/mypy-boto3-amplify)
...
`mypy-boto3-amplify` dependency in production. However, there is an issue in
