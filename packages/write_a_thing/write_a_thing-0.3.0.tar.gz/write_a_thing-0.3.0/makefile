...
install: ## Install dependencies
	@echo "Installing the 'write_a_thing' project..."
...
publish-docs:  ## Publish documentation to GitHub Pages
	...
	@echo "Updated documentation website: https://alexandrainst.github.io/write_a_thing"

test:  ## Run tests
	@uv run pytest && uv run readme-cov

docker:  ## Build Docker image and run container
	@docker build -t write_a_thing .
	@docker run -it --rm write_a_thing
