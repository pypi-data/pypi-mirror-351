...
class CLLogger:
    ...
    def _log_with_extra(
        ...
        try:
            ...
            # If anything goes wrong, fall back to standard logging
            self.logger.log(level, msg, *kwargs.get("args", ()), **kwargs)
    ...
    def error(self, msg: str, *args, extra: Optional[Dict[str, Any]] = None, **kwargs):
        ...
        kwargs.setdefault("exc_info", True)  # Set exc_info=True by default for error logs
        kwargs["args"] = args
    ...
    def critical(self, msg: str, *args, extra: Optional[Dict[str, Any]] = None, **kwargs):
        ...
        kwargs.setdefault("exc_info", True)  # Set exc_info=True by default for critical logs
        kwargs["args"] = args
