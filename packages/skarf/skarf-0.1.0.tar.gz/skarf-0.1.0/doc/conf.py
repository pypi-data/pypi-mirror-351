...
project = "skarf: scikit autoregressive models for functional connectivity"
copyright = "2025, Child Mind Institute"
author = "C. Lane"
release = get_version("skarf")
...
html_logo = "_static/img/skarf_logo.png"
...
html_theme_options = {
    "external_links": [],
    "github_url": "https://github.com/childmindresearch/skarf",
