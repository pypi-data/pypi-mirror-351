...
class GramFunctionCalling:
    ...
    def tools(
        ...
        for tool in instance.tools:
            ...
            tool_call = GramFunctionCallingCall(tool.id, project, toolset, environment, self.environment_variables)
    ...
    def _create_tool_function(self, tool_call: GramFunctionCallingCall):
        async def wrapper(inp: str):
            ...
            if tool_call.environment_variables:
                data["environmentVariables"] = tool_call.environment_variables
            req = httpx.Request(
                method="POST",
                url=url,
                params=params,
