...
keys: {
    ...
    action(sound): {
        label(left): {
            vals(key,sound): {
                1=0,2=1,3=2,4=3,5=4,q=5,w=6,e=7,r=8=t=9,6=10,y=11
                a=12,s=13,d:14,f:15,g:16,z:17,x:18,c=19,v=20,b=21,alt_l=22,h=23
            }
        }
        label(right): {
            vals(key, sound): {
                j=0,k=1,l=2,';'=3,"'"=4,n=5,m=6,','=7,'.'=8,'/'=9,'\\'=11,enter=11,alt_r=10
                7=12,8=13,9=14,0=15,'-'=16,u=17,i=18,o=19,p=20,'['=21,'='=22,']'=23
            }
        }
    }
    action(mode): {
