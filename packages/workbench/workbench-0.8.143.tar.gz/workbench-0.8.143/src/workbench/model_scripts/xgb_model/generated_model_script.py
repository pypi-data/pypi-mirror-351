...
TEMPLATE_PARAMS = {
    ...
    "model_metrics_s3_path": "s3://ideaya-sageworks-bucket/models/test-sol-reg-1/training",
...
if __name__ == "__main__":
    ...
    if model_type == "classifier":
        print(f"Creating XGBClassifier with random_state=42...")
        ...
        print(f"Creating XGBRegressor with random_state=42...")
