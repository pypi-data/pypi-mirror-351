...
class Param:
    ...
    user is expected to specify at least the type (at index 0) and the name (at index 1, or using 
    the :py:class:`Name` class).
    ...
    def __class_getitem__(cls, args : Any | tuple[Any | Name | Default | Factory]):
        ...
        if not isinstance(args, tuple):
            ...
            raise ValueError(
                f"Only one object was passed for Param, where at least a type and a name were"
                f"  expected;"
            )
        ...
        if "name" not in metadata:
            ...
            raise ValueError(
                f"Name was not specified for Param object;"
            )
...
class Args:
    ...
    def __init__(self, args : tuple[Any, ...] | Any, params : _ArgsAlias):
        ...
        for i in range(len(params)):
            ...
            arg   : Any            = args[i] if i < args_len else None
            param : dict[str, Any] = params[i]
    ...
    def __class_getitem__(cls, params : Param | tuple[Param]) -> _ArgsAlias:
        ...
        if isinstance(params, tuple):
            ...
            for i, param in enumerate(params):
                ...
                dict_params.append(typing.get_args(param)[0])
