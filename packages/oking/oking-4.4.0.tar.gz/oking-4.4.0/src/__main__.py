...
from src.jobs import product_jobs, order_jobs, deliver_jobs, photo_jobs, client_payment_plan_jobs, \
    representative_jobs, colect_job
...
def job_send_transportadora_to_okvendas(job_config: dict) -> None:
    """
...
def job_send_distribution_center(job_config: dict) -> None:
    """
...
def run_thread_job_send_distribution_center(job_config: dict) -> None:
    """
    Instancia o job de envio dos Centros de Distribuição para a api okVendas
    Args:
        job_config: Configuração do job obtida na api do oking
...
def job_send_filial(job_config: dict) -> None:
    """
...
def run_thread_job_send_filial(job_config: dict) -> None:
    """
    Instancia o job de envio das Filiais para a api okVendas
    Args:
        job_config: Configuração do job obtida na api do oking
...
def send_points_to_okvendas(job_config: dict) -> None:
    try:
        logger.info(job_config.get('job_name') + ' | Iniciando execucao')
...
def get_job_from_name(job_name: str):
    ...
    # CLIENTE
        ...
        return job_send_transportadora_to_okvendas
    ...
    # Representante
        ...
        return send_points_to_okvendas

    elif job_name == 'envia_centro_distribuicao_job':
        return job_send_distribution_center

    elif job_name == 'envia_filial_job':
        return job_send_filial
...
def get_thread_job_from_name(job_name: str):
    ...
    # Imposto
        ...
        return run_thread_job_send_distribution_center

    elif job_name == 'envia_filial_job':
        return run_thread_job_send_filial
    ...
    for module in modules:
        ...
        if module.ativo == 'S':
            ...
            schedule_job({
                ...
                'enviar_logs_debug': module.send_logs_debug,
