...
from paypalrestapis.models.authorization_with_additional_data import AuthorizationWithAdditionalData
from paypalrestapis.models.capture import Capture
...
class PaymentCollection(object):
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'captures={(self.captures if hasattr(self, "captures") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'captures={(self.captures if hasattr(self, "captures") else None)!s}, '
