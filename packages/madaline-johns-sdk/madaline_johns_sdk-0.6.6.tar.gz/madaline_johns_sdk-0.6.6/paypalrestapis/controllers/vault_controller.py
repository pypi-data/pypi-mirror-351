...
from paypalrestapis.models.payment_token_response import PaymentTokenResponse
from paypalrestapis.models.customer_vault_payment_tokens_response import CustomerVaultPaymentTokensResponse
from paypalrestapis.models.setup_token_response import SetupTokenResponse
...
class VaultController(BaseController):
    ...
    def payment_tokens_create(self,
        ...
        Returns:
            PaymentTokenResponse: Response from the API. Idempotent response
                for a successful creation of payment token.
    ...
    def customer_payment_tokens_get(self,
        ...
        Returns:
            CustomerVaultPaymentTokensResponse: Response from the API.
    ...
    def payment_tokens_get(self,
        ...
        Returns:
            PaymentTokenResponse: Response from the API. Successful execution.
    ...
    def payment_tokens_delete(self,
        ...
        Returns:
            void: Response from the API. The server has successfully executed
                the method, but there is no entity body to return.
    ...
    def setup_tokens_create(self,
        ...
        Returns:
            SetupTokenResponse: Response from the API. Idempotent response for
    ...
    def setup_tokens_get(self,
        ...
        Returns:
            SetupTokenResponse: Response from the API. Found requested
                setup-token, returned a payment method associated with the
                token.
