...
from paypalrestapis.models.customer_request import CustomerRequest
from paypalrestapis.models.link_description import LinkDescription
from paypalrestapis.models.setup_token_response_payment_source import SetupTokenResponsePaymentSource
...
class SetupTokenResponse(object):
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'ordinal={(self.ordinal if hasattr(self, "ordinal") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'ordinal={(self.ordinal if hasattr(self, "ordinal") else None)!s}, '
