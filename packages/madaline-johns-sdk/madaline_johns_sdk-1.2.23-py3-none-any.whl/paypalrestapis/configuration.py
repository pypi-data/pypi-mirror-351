...
class Configuration(HttpClientConfiguration):
    ...
    def o_auth_client_id(self):
        return self._client_credentials_auth_credentials.o_auth_client_id

    @property
    def o_auth_client_secret(self):
        return self._client_credentials_auth_credentials.o_auth_client_secret

    @property
    def o_auth_token(self):
        return self._client_credentials_auth_credentials.o_auth_token
    ...
    def create_auth_credentials_object(o_auth_client_id, o_auth_client_secret,
        ...
        warnings.warn(message=('The \'o_auth_client_id\', \'o_auth_client_secre'
                               't\', \'o_auth_token\' params are deprecated. Us'
                               'e \'client_credentials_auth_credentials\' param'
                               ' instead.'),
