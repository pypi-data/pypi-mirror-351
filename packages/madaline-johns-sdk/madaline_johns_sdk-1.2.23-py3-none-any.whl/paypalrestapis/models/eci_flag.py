...
class ECIFlag(object):
    ...
    Attributes:
        MASTERCARD_NON_3D_SECURE_TRANSACTION: The enum member of type str.
        MASTERCARD_ATTEMPTED_AUTHENTICATION_TRANSACTION: The enum member of
            type str.
        MASTERCARD_FULLY_AUTHENTICATED_TRANSACTION: The enum member of type
            str.
        FULLY_AUTHENTICATED_TRANSACTION: The enum member of type str.
        ATTEMPTED_AUTHENTICATION_TRANSACTION: The enum member of type str.
        NON_3D_SECURE_TRANSACTION: The enum member of type str.
