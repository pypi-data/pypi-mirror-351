...
from paypalrestapis.models.order_authorize_response_payment_source import OrderAuthorizeResponsePaymentSource
from paypalrestapis.models.payer import Payer
from paypalrestapis.models.purchase_unit import PurchaseUnit
...
class OrderAuthorizeResponse(object):
    ...
    def __repr__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'processing_instruction={(self.processing_instruction if hasattr(self, "processing_instruction") else None)!r}, '
    ...
    def __str__(self):
        return (f'{self.__class__.__name__}('
                ...
                f'processing_instruction={(self.processing_instruction if hasattr(self, "processing_instruction") else None)!s}, '
