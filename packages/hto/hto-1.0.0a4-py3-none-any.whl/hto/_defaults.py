...
OPTIONS = {
    ...
    "adata_out": click.option("--adata-out", "-o", type=click.Path(), help=DESCRIPTIONS["adata_out"], default=DEFAULTS["adata_out"], required=True),
    "csv_out": click.option("--csv-out", "-c", type=click.Path(), help=DESCRIPTIONS["csv_out"], default=DEFAULTS["csv_out"]),
