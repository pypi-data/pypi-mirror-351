...
def jmerge(data1: list[dict], data2: list[dict], key1: str, key2: str) -> list[dict]:
    """
    ...
    # Create a lookup dictionary for data2 for faster access
    lookup = {}
    for d2 in data2:
        if key2 in d2:
            lookup[d2[key2]] = d2
    
    # Merge dictionaries where keys match
    for d1 in data1:
