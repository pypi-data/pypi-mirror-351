...
class TestMainModule:
    ...
    def test_main_module_execution_mock(self):
        ...
        import claude_code_cost_analyzer.__main__ as main_module

        # Verify it imports the main function
        from claude_code_cost_analyzer.main import main
    ...
    def test_main_module_content(self):
        ...
        with open("claude_code_cost_analyzer/__main__.py", "r") as f:
            content = f.read()
    ...
    def test_main_module_import(self):
        ...
        try:
            import claude_code_cost_analyzer.__main__  # noqa: F401
    ...
    @patch("claude_code_cost_analyzer.main.main")
    def test_main_module_python_m_execution(self, mock_main):
        """Test execution via python -m claude_cost_analyzer."""
