"""
End-to-end integration tests for Claude Code Cost Analyzer.
...
class TestEndToEndIntegration:
    ...
    def test_help_option(self):
        ...
        assert result.returncode == 0
        assert "usage:" in result.stdout.lower() or "Claude Code Cost Analyzer" in result.stdout
    ...
    def test_version_option(self):
        ...
        assert result.returncode == 0
        assert "claude-code-cost-analyzer" in result.stdout
