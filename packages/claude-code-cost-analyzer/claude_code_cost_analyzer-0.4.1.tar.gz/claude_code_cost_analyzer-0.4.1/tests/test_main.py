...
from claude_code_cost_analyzer.main import (
    main,
    setup_logging,
    filter_entries_by_date_range,
)
from claude_code_cost_analyzer.models import ProcessedLogEntry
...
class TestMainFunction:
    ...
    @patch("claude_code_cost_analyzer.main.parse_arguments")
    @patch("claude_code_cost_analyzer.main.load_config")
    @patch("claude_code_cost_analyzer.main.validate_config")
    @patch("claude_code_cost_analyzer.main.collect_log_files")
    @patch("claude_code_cost_analyzer.main.parse_multiple_log_files")
    @patch("claude_code_cost_analyzer.main.aggregate_data")
    @patch("claude_code_cost_analyzer.main.format_data")
    ...
    def test_main_config_error(self, mock_parse_args, mock_args):
        ...
        from claude_code_cost_analyzer.config import ConfigError

        mock_parse_args.return_value = mock_args

        with patch("claude_code_cost_analyzer.main.load_config") as mock_load:
    ...
    def test_main_no_log_files(self, mock_print, mock_collect, mock_validate, mock_load, mock_parse_args, mock_args):
        ...
        assert result == 0
        mock_print.assert_called_with("ログファイルが見つかりませんでした。")
    ...
    def test_main_no_parseable_entries(
        ...
        assert result == 0
        mock_print.assert_called_with("解析可能なログエントリが見つかりませんでした。")
    ...
    def test_main_log_parse_error(self, mock_parse_files, mock_collect, mock_validate, mock_load, mock_parse_args, mock_args):
        ...
        from claude_code_cost_analyzer.parser import LogParseError
    ...
    @patch("claude_code_cost_analyzer.main.collect_log_files")
    @patch("claude_code_cost_analyzer.main.parse_multiple_log_files")
    @patch("claude_code_cost_analyzer.main.filter_entries_by_date_range")
    @patch("builtins.print")
    def test_main_date_filtering_no_results(
        ...
        assert result == 0
        mock_print.assert_called_with("指定された日付範囲にログエントリが見つかりませんでした。")
    ...
    def test_main_aggregation_error(
        ...
        from claude_code_cost_analyzer.aggregator import AggregationError
    ...
    def test_main_formatter_error(
        ...
        from claude_code_cost_analyzer.formatter import FormatterError
