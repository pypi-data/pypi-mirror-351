...
from ds_catalog.api_response import ApiResponse, T as ApiResponseT
import ds_catalog.models
from ds_catalog import rest
from ds_catalog.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ds_catalog.models, klass)
