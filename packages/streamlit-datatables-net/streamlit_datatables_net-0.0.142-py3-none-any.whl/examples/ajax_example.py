...
def ajax_table_example():
    ...
    with content_column:
        with st.container(border=True):
            ...
            reload_and_export_button = {
                "text": "Reload and Export", "action": stringify_javascript_function(
                    JAVASCRIPT_FILE_PATH, 'reloadExcelExport')
            }
            ...
            options["buttons"] = ['pageLength', 'colvis',
                                  'excel', reload_and_export_button, streamlit_action_button, return_table_values_button]
            options["layout"] = {
                "top2Start": "buttons",
            ...
            options["columnControl"] = [["orderAsc", "orderDesc", "search"]]
