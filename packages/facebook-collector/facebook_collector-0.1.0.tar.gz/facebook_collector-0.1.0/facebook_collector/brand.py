...
from facebook_collector.profile_handler.profile_by_graphAPI import UserInfoHandler
            ...
            for i in posts:
                ...
                try:
                    post_info = {
                            ...
                            "caption": caption,
                            "hashtag": ", ".join(self._hashtag_detect(i["message"])) if "message" in i and i[
                                "message"] else "",
                            ...
                            "num_like": int(
                                i["reactions"]["summary"]["total_count"]) if "reactions" in i and "summary" in i[
                                "reactions"] else 0,
                            "num_comment": int(
                                i["comments"]["summary"]["total_count"]) if "comments" in i and "summary" in i[
                                "comments"] else 0,
