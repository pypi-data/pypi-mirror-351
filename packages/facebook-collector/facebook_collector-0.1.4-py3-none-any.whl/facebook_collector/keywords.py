...
class FacebookKeywordCollector:
    ...
    def _search_posts(self, keyword, max_posts=100):
        ...
        while len(posts) < max_posts and retry_count < self.MAX_KEYWORD_POST_RETRY:
            ...
            for log in logs:
                try:
                    ...
                    try:
                        ...
                        retry_count += 1
                        if retry_count >= self.MAX_KEYWORD_POST_RETRY:
                            print(f"Max retries reached ({self.MAX_KEYWORD_POST_RETRY}). Stopping collection.")
                            return posts
                        continue
                except Exception as e:
