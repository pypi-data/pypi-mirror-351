...
class FacebookKeywordCollector:
    ...
    def __init__(self, cookie, max_post_by_keyword, max_keyword_post_retry):
        """
    ...
    def collect_posts_by_keyword(self, keyword):
        ...
        """
        try:
            content_list = self._search_posts(keyword, self.MAX_POST_BY_KEYWORD)
    ...
    def _search_posts(self, keyword, max_posts):
        """
                ...
                try:
                    ...
                    try:
                        ...
                        if start_idx != -1:
                            ...
                            print(f"Error parsing body: {body}")
                ...
                if item:
                    ...
                    if post_id:
                        ...
                        response_data.append({
                            ...
                            'content_type':"PHOTO" if view is not None else "VIDEO",
                        })
                    if other_post:
...
def main():
    ...
    try:
        posts = collector.collect_posts_by_keyword('tạo video')
