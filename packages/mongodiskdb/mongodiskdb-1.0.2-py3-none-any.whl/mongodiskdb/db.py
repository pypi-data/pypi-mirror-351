...
class DiskDB:
    ...
    def __init__(self, base_directory: Union[str, Path] = None):
        ...
        if base_directory is None:
            base_directory = Path(Path.home() / '.mongodiskdb')
        elif isinstance(base_directory, Path):
            base_directory = base_directory / '.mongodiskdb'
        elif isinstance(base_directory, str):
            base_directory = Path(base_directory) / '.mongodiskdb'
        else:
