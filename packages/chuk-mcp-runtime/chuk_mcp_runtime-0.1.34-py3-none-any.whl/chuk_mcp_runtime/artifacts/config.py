# -*- coding: utf-8 -*-
# chuk_mcp_runtime/artifacts/config.py
"""
...
```python
from chuk_mcp_runtime.artifacts.config import development_setup
...
```python
from chuk_mcp_runtime.artifacts.config import testing_setup
...
**Production with S3:**
```python
from chuk_mcp_runtime.artifacts.config import production_setup
...
```python
from chuk_mcp_runtime.artifacts.config import configure_s3, configure_redis_session, create_store
