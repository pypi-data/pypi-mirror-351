...
class FindToolbar(QtWidgets.QToolBar):
    def __init__(self, parent=None):
        ...
        self.match_case_button.setCursor(Qt.PointingHandCursor)
        ...
        self.match_regex_button.setCursor(Qt.PointingHandCursor)
        ...
        self.match_exactly_button.setCursor(Qt.PointingHandCursor)
    ...
    def query(self, text):
        ...
        current_pgdf = self.parent().store.selected_pgdf
