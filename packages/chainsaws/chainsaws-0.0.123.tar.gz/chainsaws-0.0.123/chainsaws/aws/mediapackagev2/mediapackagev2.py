...
class MediaPackageV2API:
    ...
    def __init__(self, channel_group_name: str, config: Optional[MediaPackageV2Config] = None) -> None:
        """
        Initialize the MediaPackageV2API Client.
        """
        self.channel_group_name = channel_group_name
        self.config = config or MediaPackageV2Config()
