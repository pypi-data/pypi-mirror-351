...
class SDK:
    ...
    def assign_batches(self, project_id: str, asset_ids: List[str], batches: List[str]) -> Dict:
        ...
        payload = {"assets": asset_ids, "batches": batches}
        return self.make_request("POST", endpoint, payload)
    ...
    def create_issue(self, task_id: str, content: str, position: str) -> Dict:
        """
        Create an issue for a task.
        """
        endpoint = "/v2/issues"
        payload = {"content": content, "labelTask": str(task_id), "position": str(position)}
        return self.make_request("POST", endpoint, payload)
    ...
    def get_tasks(self, project_id: str, page: int = 1, limit: int = 10, status: Optional[str] = None,
                  stage: Optional[str] = None, batches: Optional[List[str]] = None) -> Dict:
        """
    ...
    def upload_files(self, project_id: str, file_paths: List, storage_id: str = None, batches: List[str] = None):
        ...
        response = self.upload_files_cloud(project_id, assets, storage_id, batches, upload_local="true")
        return response
    ...
    def upload_files_cloud(self, project_id: str, assets, storage_id: str = None, batches: List[str] = None,
        ...
        payload = json.dumps({"assets": assets, "uploadLocal": upload_local})
        headers = {
    ...
    def upload_chat_assets(
        ...
        """
        request_url = f"{self.host}/v2/project/{chat_asset_creation_config.project_id}/chat"
        headers = {"apikey": self.api_key}
        ...
        # Base request data
        data = {
            "projectId": chat_asset_creation_config.project_id,
    ...
    def get_project_performance(self, project_id: str, interval: List[datetime] = None, batches: List[str] = None) -> Dict:
        """
    ...
    def upload_files_with_asset_builder(self, project_id, template_id, input_file_path, parse_config={}):
        ...
        self.upload_files_cloud(project_id, assets, None, None, True)
        self.logger.info(f"Successfully uploaded {len(assets)} assets to project {project_id}")

    def annotate_task(self, task_id: str, answer: dict, overwrite=False, send_to_next_stage=False) -> bool:
        return self._annotate_task(task_id, answer, overwrite, send_to_next_stage)

    # ------------------------------------------------------------------------------------------------------------------
    # Private Functions
    # ------------------------------------------------------------------------------------------------------------------
    def _annotate_task(self, task_id: str, answer: dict, overwrite=False, send_to_next_stage=False,
