...
class TaskDefinitionManager(TaskDefinitionManagerMixin, Boto3ModelManager):
    ...
    def get(
        self, taskDefinition: str, *, include: List[Literal["TAGS"]] | None = None
...
class Cluster(TagsDictMixin, PrimaryBoto3Model):
    ...
    """
    defaultCapacityProviderStrategy: List["CapacityProviderStrategyItem"] | None = None
    """
...
class TaskDefinition(TagsDictMixin, TaskDefinitionModelMixin, PrimaryBoto3Model):
    ...
    *Amazon Elastic Container Service Developer Guide*.
    ...
    A platform family is specified only for tasks using the Fargate launch type.
    """
    requiresCompatibilities: List[Literal["EC2", "FARGATE", "EXTERNAL"]] | None = None
    """
...
class Task(TagsDictMixin, PrimaryBoto3Model):
    ...
    Container Service Developer Guide*.
    """
    launchType: Literal["EC2", "FARGATE", "EXTERNAL"] | None = "FARGATE"
    """
...
class InstanceHealthCheckResult(Boto3Model):
    ...
    """
    status: Literal["OK", "IMPAIRED", "INSUFFICIENT_DATA", "INITIALIZING"] | None = None
    """
...
class ContainerInstanceHealthStatus(Boto3Model):
    ...
    overallStatus: (
        Literal["OK", "IMPAIRED", "INSUFFICIENT_DATA", "INITIALIZING"] | None
    ) = None
    """
...
class ContainerInstance(
    ...
    """
    agentUpdateStatus: (
        Literal["PENDING", "STAGING", "STAGED", "UPDATING", "UPDATED", "FAILED"] | None
    ) = None
    """
...
class ServiceDeploymentCircuitBreaker(Boto3Model):
    ...
    status: (
        Literal["TRIGGERED", "MONITORING", "MONITORING_COMPLETE", "DISABLED"] | None
    ) = None
    """
