...
class JobsService(FolderContext, BaseService):
    ...
    def get_api_payload(self, inbox_id: str) -> Any:
        ...
        """
        spec = self._get_api_payload_spec(inbox_id=inbox_id)
    ...
    async def get_api_payload_async(self, inbox_id: str) -> Any:
