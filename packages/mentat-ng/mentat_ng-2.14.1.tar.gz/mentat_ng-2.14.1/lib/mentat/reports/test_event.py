...
class TestMentatReportsEvent(unittest.TestCase):
    ...
    def test_03_filter_events(self):
        ...
        events, aggr, fltlog, flt_cnt = self.reporter.filter_events(abuse_group.name, self.ideas_obj, False)
    ...
    def test_05_j2t_idea_path_valueset(self):
        ...
        self.assertEqual(self.reporter.j2t_idea_path_valueset(self.ideas_obj[1], "Source.Proto"), [])
        self.assertEqual(
