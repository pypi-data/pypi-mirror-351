...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["name", "base_path", "no_content_change_since", "prn", "pulp_labels", "pulp_created", "pulp_href", "hidden", "pulp_last_updated", "content_guard", "base_url"]
