...
class ArtifactDistributionResponse(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["prn", "pulp_labels", "content_guard", "name", "pulp_last_updated", "pulp_created", "hidden", "base_path", "base_url", "no_content_change_since", "pulp_href"]
