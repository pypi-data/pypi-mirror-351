            ...
            if condition is not None:
                if isinstance(condition, HookCondition):
                    ...
                    for new, old in zip(new_records_local, old_records_local):
                        # only log field‐lookup if this is a single‐field HookCondition
                        ...
                        # always call the .check() (works for single or composite)
                    ...
                    # any non-HookCondition (including your composite if you wrap it) falls back here
                    passed = condition(
