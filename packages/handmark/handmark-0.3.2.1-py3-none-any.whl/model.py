...
class Model:
    ...
    def from_dict(cls, data: dict) -> "Model":
        return cls(
            name=data["name"],
            pretty_name=data.get("pretty_name", data["name"]),  # fallback to name if pretty_name missing
...
def get_available_models() -> List[Model]:
    ...
    return [
        Model("microsoft/Phi-4-multimodal-instruct", "Phi-4-multimodal-instruct", "Microsoft", "150 requests/day"),
        ...
        Model("microsoft/Phi-3.5-vision-instruct", "Phi-3.5-vision-instruct", "Microsoft", "150 requests/day"),
        Model("meta/Llama-4-Maverick-17B-128E-Instruct-FP8", "Llama-4-Maverick-17B-128E-Instruct-FP8", "Meta", "50 requests/day"),
        Model("meta/Llama-4-Scout-17B-16E-Instruct", "Llama-4-Scout-17B-16E-Instruct", "Meta", "50 requests/day"),
    ]
