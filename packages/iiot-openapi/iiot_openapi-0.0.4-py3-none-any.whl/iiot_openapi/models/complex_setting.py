...
class ComplexSetting(BaseModel):
    """
    ComplexSetting
    """ # noqa: E501
    ...
    subevents: Optional[List[SubEventPropSetting]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "outputs": PropGenOutput.from_dict(obj["outputs"]) if obj.get("outputs") is not None else None,
            "subevents": [SubEventPropSetting.from_dict(_item) for _item in obj["subevents"]] if obj.get("subevents") is not None else None
        })
        return _obj
