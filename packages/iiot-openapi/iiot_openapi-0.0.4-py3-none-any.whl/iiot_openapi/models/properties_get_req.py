...
class PropertiesGetReq(BaseModel):
    """
    PropertiesGetReq
    """ # noqa: E501
    properties: Optional[List[StrictStr]] = None
    components: Optional[Dict[str, PropertiesGetReq]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "components": dict(
                (_k, PropertiesGetReq.from_dict(_v))
...
PropertiesGetReq.model_rebuild(raise_errors=False)
