...
class UpdateTableRequest(BaseModel):
    ...
    table_schema: Optional[UpdateTableSchema] = None
    aging_settings: Optional[AgingSettings] = None
    __properties: ClassVar[List[str]] = ["table_name", "catalog_id", "description", "table_schema", "aging_settings"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "table_schema": UpdateTableSchema.from_dict(obj["table_schema"]) if obj.get("table_schema") is not None else None,
