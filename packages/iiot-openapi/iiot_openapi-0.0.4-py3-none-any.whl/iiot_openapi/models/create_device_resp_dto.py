...
class CreateDeviceRespDTO(BaseModel):
    """
    CreateDeviceRespDTO
    """ # noqa: E501
    ...
    auth_info: Optional[AuthInfoDTO] = None
    create_time: Optional[StrictStr] = None
    update_time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["device_id", "device_name", "device_type", "auth_info", "create_time", "update_time"]
    ...
    def to_dict(self) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        if self.auth_info:
            _dict['auth_info'] = self.auth_info.to_dict()
        return _dict
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "auth_info": AuthInfoDTO.from_dict(obj["auth_info"]) if obj.get("auth_info") is not None else None,
