...
class ListTablesResp(BaseModel):
    """
    ListTablesResp
    """ # noqa: E501
    count: Optional[StrictInt] = None
    tables: Optional[List[BriefTable]] = None
    __properties: ClassVar[List[str]] = ["count", "tables"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "count": obj.get("count"),
            "tables": [BriefTable.from_dict(_item) for _item in obj["tables"]] if obj.get("tables") is not None else None
        })
        return _obj
