...
class ListDictionariesResp(BaseModel):
    """
    ListDictionariesResp
    """ # noqa: E501
    dictionaries: Optional[List[BriefDictionary]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["dictionaries", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "dictionaries": [BriefDictionary.from_dict(_item) for _item in obj["dictionaries"]] if obj.get("dictionaries") is not None else None,
            "count": obj.get("count")
        })
        return _obj
