...
class BriefModel(BaseModel):
    ...
    sync_count: Optional[StrictInt] = None
    create_time: Optional[StrictStr] = None
    update_time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["model_id", "model_name", "description", "type", "sync_count", "create_time", "update_time"]
