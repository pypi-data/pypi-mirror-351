...
class View(BaseModel):
    ...
    levels: Optional[List[ViewLevel]] = None
    create_time: Optional[StrictStr] = None
    update_time: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["view_id", "view_name", "description", "levels", "create_time", "update_time"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "levels": [ViewLevel.from_dict(_item) for _item in obj["levels"]] if obj.get("levels") is not None else None,
