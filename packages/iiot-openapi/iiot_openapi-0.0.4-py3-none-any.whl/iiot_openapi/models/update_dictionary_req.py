...
class UpdateDictionaryReq(BaseModel):
    """
    UpdateDictionaryReq
    """ # noqa: E501
    dic_name: Optional[StrictStr] = None
    catalog_id: Optional[StrictStr] = None
    values: Optional[List[DicItem]] = None
    __properties: ClassVar[List[str]] = ["dic_name", "catalog_id", "values"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "values": [DicItem.from_dict(_item) for _item in obj["values"]] if obj.get("values") is not None else None
        })
        return _obj
