...
class ThingListDTO(BaseModel):
    """
    ThingListDTO
    """ # noqa: E501
    things: Optional[List[ThingDTO]] = None
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "things": [ThingDTO.from_dict(_item) for _item in obj["things"]] if obj.get("things") is not None else None,
            "count": obj.get("count")
        })
        return _obj
