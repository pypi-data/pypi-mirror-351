...
class BatchListThingSnapshotsResp(BaseModel):
    """
    BatchListThingSnapshotsResp
    """ # noqa: E501
    things: Optional[List[BatchListThingSnapshotsRespThingsInner]] = None
    __properties: ClassVar[List[str]] = ["things"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "things": [BatchListThingSnapshotsRespThingsInner.from_dict(_item) for _item in obj["things"]] if obj.get("things") is not None else None
        })
        return _obj
