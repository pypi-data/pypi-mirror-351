...
class UpdateAnalysisTaskReq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clean_settings", "event_class", "event_gen_settings", "complex_settings", "expression_settings", "task_name", "enabled", "period", "tag_matchers", "condition", "expressions"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "expressions": [Expression.from_dict(_item) for _item in obj["expressions"]] if obj.get("expressions") is not None else None
        })
        return _obj
