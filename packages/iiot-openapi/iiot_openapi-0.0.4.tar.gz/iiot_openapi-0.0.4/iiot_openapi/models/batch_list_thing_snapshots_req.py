...
class BatchListThingSnapshotsReq(BaseModel):
    """
    BatchListThingSnapshotsReq
    """ # noqa: E501
    things: List[BatchListThingSnapshotsReqThingsInner]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "things": [BatchListThingSnapshotsReqThingsInner.from_dict(_item) for _item in obj["things"]] if obj.get("things") is not None else None
        })
        return _obj
