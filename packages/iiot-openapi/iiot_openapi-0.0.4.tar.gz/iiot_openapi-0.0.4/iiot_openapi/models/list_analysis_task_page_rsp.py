...
class ListAnalysisTaskPageRsp(BaseModel):
    """
    ListAnalysisTaskPageRsp
    """ # noqa: E501
    tasks: Optional[List[BriefAnalysisTask]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["tasks", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "tasks": [BriefAnalysisTask.from_dict(_item) for _item in obj["tasks"]] if obj.get("tasks") is not None else None,
            "count": obj.get("count")
        })
        return _obj
