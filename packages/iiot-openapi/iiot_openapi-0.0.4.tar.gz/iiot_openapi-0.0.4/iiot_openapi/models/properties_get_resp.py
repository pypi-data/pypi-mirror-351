...
class PropertiesGetResp(BaseModel):
    """
    PropertiesGetResp
    """ # noqa: E501
    properties: Optional[Dict[str, PropertyValueObject]] = None
    components: Optional[Dict[str, ComponentProperty]] = None
    result_code: Optional[StrictInt] = None
    result_desc: Optional[StrictStr] = None
    __properties: ClassVar[List[str]] = ["properties", "components", "result_code", "result_desc"]
