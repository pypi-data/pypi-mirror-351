...
class ListViewsResp(BaseModel):
    """
    ListViewsResp
    """ # noqa: E501
    views: Optional[List[BriefView]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["views", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "views": [BriefView.from_dict(_item) for _item in obj["views"]] if obj.get("views") is not None else None,
            "count": obj.get("count")
        })
        return _obj
