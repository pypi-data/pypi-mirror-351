...
class UpdateCatalogsResp(BaseModel):
    """
    UpdateCatalogsResp
    """ # noqa: E501
    catalogs: Optional[List[CatalogOrder]] = None
    __properties: ClassVar[List[str]] = ["catalogs"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "catalogs": [CatalogOrder.from_dict(_item) for _item in obj["catalogs"]] if obj.get("catalogs") is not None else None
        })
        return _obj
