...
class SubEventGenSetting(BaseModel):
    """
    SubEventGenSetting
    """ # noqa: E501
    name: StrictStr
    start_trigger: EventTrigger
    end_trigger: Optional[EventTrigger] = None
    expressions: Optional[List[EventGenExpression]] = None
    outputs: Optional[EventGenOutput] = None
    __properties: ClassVar[List[str]] = ["name", "start_trigger", "end_trigger", "expressions", "outputs"]
