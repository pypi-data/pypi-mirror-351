...
class EventGenOutput(BaseModel):
    """
    EventGenOutput
    """ # noqa: E501
    columns: List[EventOutputExpression]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [EventOutputExpression.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None
        })
        return _obj
