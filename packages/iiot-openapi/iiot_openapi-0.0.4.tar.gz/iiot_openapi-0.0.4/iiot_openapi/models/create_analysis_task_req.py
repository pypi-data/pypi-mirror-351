...
class CreateAnalysisTaskReq(BaseModel):
    """
    ...
    __properties: ClassVar[List[str]] = ["clean_settings", "event_class", "event_gen_settings", "complex_settings", "expression_settings", "task_name", "enabled", "calc_type", "schedule_type", "period", "tag_matchers"]
