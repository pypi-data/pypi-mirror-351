...
class TableSchema(BaseModel):
    ...
    primary_key: List[StrictStr]
    indexes: Optional[List[IndexSchema]] = None
    __properties: ClassVar[List[str]] = ["columns", "primary_key", "indexes"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "columns": [ColumnSchema.from_dict(_item) for _item in obj["columns"]] if obj.get("columns") is not None else None,
            "primary_key": obj.get("primary_key"),
            "indexes": [IndexSchema.from_dict(_item) for _item in obj["indexes"]] if obj.get("indexes") is not None else None
        })
        return _obj
