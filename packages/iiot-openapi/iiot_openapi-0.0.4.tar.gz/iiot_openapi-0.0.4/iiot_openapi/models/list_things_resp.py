...
class ListThingsResp(BaseModel):
    """
    ListThingsResp
    """ # noqa: E501
    things: Optional[List[BriefThing]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["things", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "things": [BriefThing.from_dict(_item) for _item in obj["things"]] if obj.get("things") is not None else None,
            "count": obj.get("count")
        })
        return _obj
