...
class ListModelsResp(BaseModel):
    ...
    ListModelsResp
    """ # noqa: E501
    models: Optional[List[BriefModel]] = None
    count: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["models", "count"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "models": [BriefModel.from_dict(_item) for _item in obj["models"]] if obj.get("models") is not None else None,
            "count": obj.get("count")
        })
        return _obj
