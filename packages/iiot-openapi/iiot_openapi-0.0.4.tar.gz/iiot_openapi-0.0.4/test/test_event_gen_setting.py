...
class TestEventGenSetting(unittest.TestCase):
    """EventGenSetting unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EventGenSetting:
        """Test EventGenSetting
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EventGenSetting`
        """
        model = EventGenSetting()
        if include_optional:
            return EventGenSetting(
