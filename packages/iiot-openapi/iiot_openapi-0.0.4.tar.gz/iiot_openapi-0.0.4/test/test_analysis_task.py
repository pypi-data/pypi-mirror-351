...
class TestAnalysisTask(unittest.TestCase):
    ...
    def make_instance(self, include_optional) -> AnalysisTask:
        """Test AnalysisTask
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `AnalysisTask`
        """
        model = AnalysisTask()
        if include_optional:
            return AnalysisTask(
