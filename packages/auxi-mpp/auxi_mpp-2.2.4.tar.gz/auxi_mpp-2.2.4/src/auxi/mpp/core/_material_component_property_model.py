...
class MaterialComponentPropertyModel[T: floatPositiveOrZero, p: floatPositiveOrZero, x: dict[str, floatFraction]](
    Object
):
    r"""
    ...
    @abstractmethod
    def calculate(self, T: T, p: p, x: x) -> dict[str, float]:
        """
