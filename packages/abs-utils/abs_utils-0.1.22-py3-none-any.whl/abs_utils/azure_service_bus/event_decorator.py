    ...
    def decorator(func: Callable) -> Callable:
        ...
        async def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            event_payload = {
                ...
                "payload": data,
                "user": {
                    "id": request.state.user.id if request.state.user else None,
                    "uuid": request.state.user.uuid if request.state.user else None,
                    "email": request.state.user.email if request.state.user else None,
                    "name": request.state.user.name if request.state.user else None,
                },
            }
