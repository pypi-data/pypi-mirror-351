<a id="types-boto3-ce"></a>

# types-boto3-ce

[![PyPI - types-boto3-ce](https://img.shields.io/pypi/v/types-boto3-ce.svg?color=blue)](https://pypi.org/project/types-boto3-ce/)
[![PyPI - Python Version](https://img.shields.io/pypi/pyversions/types-boto3-ce.svg?color=blue)](https://pypi.org/project/types-boto3-ce/)
[![Docs](https://img.shields.io/readthedocs/boto3-stubs.svg?color=blue)](https://youtype.github.io/types_boto3_docs/)
[![PyPI - Downloads](https://static.pepy.tech/badge/types-boto3-ce)](https://pypistats.org/packages/types-boto3-ce)

![boto3.typed](https://github.com/youtype/mypy_boto3_builder/raw/main/logo.png)

Type annotations for
[boto3 CostExplorer 1.38.24](https://pypi.org/project/boto3/) compatible with
...
[types-boto3-ce docs](https://youtype.github.io/types_boto3_docs/types_boto3_ce/).

See how it helps you find and fix potential bugs:

![types-boto3 demo](https://github.com/youtype/mypy_boto3_builder/raw/main/demo.gif)

- [types-boto3-ce](#types-boto3-ce)
...
1. Run mypy-boto3-builder in your package root directory:
   `uvx --with 'boto3==1.38.24' mypy-boto3-builder`
...
- Install `types-boto3[ce]` in your environment:
...
- Install `types-boto3[ce]` with services you use in your environment:
...
`types-boto3-ce` dependency in production. However, there is an issue in
...
from types_boto3_ce import CostExplorerClient
...
`types_boto3_ce.paginator` module contains type annotations for all paginators.
...
`types_boto3_ce.literals` module contains literals extracted from shapes that
can be used in user code for type checking.

Full list of `CostExplorer` Literals can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_ce/literals/).
...
`types_boto3_ce.type_defs` module contains structures and shapes assembled to
typed dictionaries and unions for additional type checking.

Full list of `CostExplorer` TypeDefs can be found in
[docs](https://youtype.github.io/types_boto3_docs/types_boto3_ce/type_defs/).
...
`types-boto3-ce` version is the same as related `boto3` version and follows
...
[boto3 docs](https://youtype.github.io/types_boto3_docs/types_boto3_ce/)
