...
from string import whitespace, punctuation, printable
from sklearn.metrics.pairwise import cosine_similarity
from sklearn.feature_extraction.text import CountVectorizer, TfidfVectorizer


from ._internal.texts.requoter import *
from ._internal.texts.splitter import *
from ._internal.texts.nlp_stuff import *
from .type_utils import is_str, is_array
from .common import *
...
def has_digit(text: str):
    return any([x.isdigit() for x in text.strip()])
...
def _fix_lines_structure(entry: str, sep: str = "\n\n"):
    """Wip function, not fully tested."""
    results = []
