...
def searchSiteNacClients(mist_session:_APISession, site_id:str, nacrule_id:str|None=None, nacrule_matched:bool|None=None, auth_type:str|None=None, vlan:str|None=None, nas_vendor:str|None=None, idp_id:str|None=None, ssid:str|None=None, username:str|None=None, timestamp:float|None=None, ap:str|None=None, mac:str|None=None, mxedge_id:str|None=None, nacrule_name:str|None=None, status:str|None=None, type:str|None=None, mdm_compliance:str|None=None, mdm_provider:str|None=None, sort:str|None=None, ingress_vlan:str|None=None, start:int|None=None, end:int|None=None, duration:str="1d", limit:int=100, page:int=1) -> _APIResponse:
    """
