...
def getMspSle(mist_session:_APISession, msp_id:str, metric:str, sle:str|None=None, duration:str="1d", interval:str|None=None, start:int|None=None, end:int|None=None) -> _APIResponse:
    """
