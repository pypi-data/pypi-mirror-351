...
def searchOrgWiredClients(mist_session:_APISession, org_id:str, site_id:str|None=None, device_mac:str|None=None, mac:str|None=None, port_id:str|None=None, vlan:int|None=None, ip_address:str|None=None, manufacture:str|None=None, text:str|None=None, auth_state:str|None=None, auth_method:str|None=None, nacrule_id:str|None=None, dhcp_hostname:str|None=None, dhcp_fqdn:str|None=None, dhcp_client_identifier:str|None=None, dhcp_vendor_class_identifier:str|None=None, dhcp_request_params:str|None=None, limit:int=100, start:int|None=None, end:int|None=None, duration:str="1d") -> _APIResponse:
    """
