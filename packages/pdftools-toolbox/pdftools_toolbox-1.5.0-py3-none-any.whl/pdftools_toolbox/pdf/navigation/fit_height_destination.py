...
class FitHeightDestination(pdftools_toolbox.pdf.navigation.direct_destination.DirectDestination):
    ...
    "fit width".
    A `pdftools_toolbox.pdf.navigation.fit_height_destination.FitHeightDestination` will change the current viewing mode to
    ...
    def create(target_document: Document, page: Page, fit_actual_content: bool) -> FitHeightDestination:
        ...
        Args:
            ...
            fitActualContent (bool): 
                ...
                See property `pdftools_toolbox.pdf.navigation.fit_height_destination.FitHeightDestination.fit_actual_content` for more information.
