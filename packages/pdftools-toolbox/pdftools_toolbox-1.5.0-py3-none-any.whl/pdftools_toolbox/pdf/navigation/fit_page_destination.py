...
class FitPageDestination(pdftools_toolbox.pdf.navigation.direct_destination.DirectDestination):
    """
    ...
    "fit width".
    A `pdftools_toolbox.pdf.navigation.fit_page_destination.FitPageDestination` will change the current viewing mode to
    ...
    """
    @staticmethod
    def create(target_document: Document, page: Page, fit_actual_content: bool) -> FitPageDestination:
        """
        ...
        Args:
            ...
            fitActualContent (bool): 
                ...
                See property `pdftools_toolbox.pdf.navigation.fit_page_destination.FitPageDestination.fit_actual_content` for more information.
        ...
        _lib.PtxPdfNav_FitPageDestination_Create.argtypes = [c_void_p, c_void_p, c_bool]
        _lib.PtxPdfNav_FitPageDestination_Create.restype = c_void_p
        ret_val = _lib.PtxPdfNav_FitPageDestination_Create(target_document._handle, page._handle, fit_actual_content)
        if ret_val is None:
            _NativeBase._throw_last_error(False)
        return FitPageDestination._create_dynamic_type(ret_val)
    ...
    def fit_actual_content(self) -> bool:
        ...
        """
        _lib.PtxPdfNav_FitPageDestination_GetFitActualContent.argtypes = [c_void_p]
        _lib.PtxPdfNav_FitPageDestination_GetFitActualContent.restype = c_bool
        ret_val = _lib.PtxPdfNav_FitPageDestination_GetFitActualContent(self._handle)
        if not ret_val:
    ...
    def _from_handle(cls, handle):
        ...
        """
        instance = FitPageDestination.__new__(cls)  # Bypass __init__
