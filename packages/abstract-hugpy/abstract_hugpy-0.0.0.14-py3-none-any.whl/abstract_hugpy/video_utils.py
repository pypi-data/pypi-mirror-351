...
import_keybert_model()
import_summarizer_model()
...
class VideoDirectoryManager(metaclass=SingletonMeta):
    ...
    def get_whisper_result(self, url):
        data = self.get_data(url)
    ...
    def get_whisper_text(self, url):
        whisper_result = self.get_whisper_result(url)
        return whisper_result.get('text')
    def get_whisper_segments(self, url):
        whisper_result = self.get_whisper_result(url)
...
def get_video_whisper_result(url): return video_mgr.get_whisper_result(url)
def get_video_whisper_text(url): return video_mgr.get_whisper_text(url)
def get_video_whisper_segments(url): return video_mgr.get_whisper_segments(url)
...
def get_audio_path(url): return video_mgr.get_data(url).get('audio_path')
def get_srt_path(url): return video_mgr.get_data(url).get('srt_path')
def get_metadata_path(url): return video_mgr.get_data(url).get('metadata_path')
