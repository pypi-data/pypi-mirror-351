...
import pydmtxlib
from pydmtxlib.pydmtxlib import ENCODING_SCHEME_NAMES, ENCODING_SIZE_NAMES, encode
...
def main(args=None):
    ...
    parser.add_argument("data", help="Data to be written; will be utf-8 encoded")
    parser.add_argument(
        "--size",
    ...
    encoded = encode(args.data.encode("utf-8"), size=args.size, scheme=args.scheme)
