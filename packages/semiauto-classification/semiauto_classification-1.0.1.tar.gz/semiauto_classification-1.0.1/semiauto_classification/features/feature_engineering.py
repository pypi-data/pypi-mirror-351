...
class FeatureEngineer:
    ...
    def _setup_paths(self):
        ...
        self.transformation_pipeline_path = f"model/pipelines/preprocessing_{self.dataset_name}/transformation.pkl"
        self.processor_pipeline_path = f"model/pipelines/preprocessing_{self.dataset_name}/processor.pkl"
        self.train_transformed_path = f"data/processed/data_{self.dataset_name}/train_transformed.csv"
        self.test_transformed_path = f"data/processed/data_{self.dataset_name}/test_transformed.csv"
    ...
    def _save_pipelines(self, transformation_pipeline):
        try:
            # SAVE USING RELATIVE PATHS
            transformation_dir = Path(f"model/pipelines/preprocessing_{self.dataset_name}")
            transformation_dir.mkdir(parents=True, exist_ok=True)

            with open(transformation_dir / "transformation.pkl", 'wb') as f:
            ...
            with open(transformation_dir / "processor.pkl", 'wb') as f:
